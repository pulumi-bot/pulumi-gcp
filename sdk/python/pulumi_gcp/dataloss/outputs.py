...
class PreventionInspectTemplateInspectConfigRuleSetRuleExclusionRuleRegex(dict):
    def __init__(__self__, *,
                 pattern: str,
                 group_indexes: Optional[Sequence[float]] = None):
        """
        :param str pattern: Pattern defining the regular expression.
               Its syntax (https://github.com/google/re2/wiki/Syntax) can be found under the google/re2 repository on GitHub.
        :param Sequence[float] group_indexes: The index of the submatch to extract as findings. When not specified, the entire match is returned. No more than 3 may be included.
        """
    ...
    def group_indexes(self) -> Optional[Sequence[float]]:
        """
