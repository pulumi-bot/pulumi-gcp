...
class Job(pulumi.CustomResource):
    copy: pulumi.Output[Optional['outputs.JobCopy']] = pulumi.property("copy")
    """
    Copies a table.
    Structure is documented below.
    """

    extract: pulumi.Output[Optional['outputs.JobExtract']] = pulumi.property("extract")
    """
    ...
    job_timeout_ms: pulumi.Output[Optional[str]] = pulumi.property("jobTimeoutMs")
    """
    Job timeout in milliseconds. If this time limit is exceeded, BigQuery may attempt to terminate the job.
    """

    job_type: pulumi.Output[str] = pulumi.property("jobType")
    """
    The type of the job.
    """
    ...
    load: pulumi.Output[Optional['outputs.JobLoad']] = pulumi.property("load")
    """
    ...
    query: pulumi.Output[Optional['outputs.JobQuery']] = pulumi.property("query")
    """
    Configures a query job.
    Structure is documented below.
    """

    user_email: pulumi.Output[str] = pulumi.property("userEmail")
    """
