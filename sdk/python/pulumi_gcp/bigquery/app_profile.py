...
class AppProfile(pulumi.CustomResource):
    app_profile_id: pulumi.Output[str] = pulumi.output_property("appProfileId")
    """
    ...
    """
    ignore_warnings: pulumi.Output[Optional[bool]] = pulumi.output_property("ignoreWarnings")
    """
    If true, ignore safety checks when deleting/updating the app profile.
    """
    instance: pulumi.Output[Optional[str]] = pulumi.output_property("instance")
    """
    The name of the instance to create the app profile within.
    """
    multi_cluster_routing_use_any: pulumi.Output[Optional[bool]] = pulumi.output_property("multiClusterRoutingUseAny")
    """
    ...
    """
    single_cluster_routing: pulumi.Output[Optional['outputs.AppProfileSingleClusterRouting']] = pulumi.output_property("singleClusterRouting")
    """
    Use a single-cluster routing policy.  Structure is documented below.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, app_profile_id: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, ignore_warnings: Optional[pulumi.Input[bool]] = None, instance: Optional[pulumi.Input[str]] = None, multi_cluster_routing_use_any: Optional[pulumi.Input[bool]] = None, project: Optional[pulumi.Input[str]] = None, single_cluster_routing: Optional[pulumi.Input[pulumi.InputType['AppProfileSingleClusterRoutingArgs']]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        :param pulumi.Input[str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[pulumi.InputType['AppProfileSingleClusterRoutingArgs']] single_cluster_routing: Use a single-cluster routing policy.  Structure is documented below.
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, app_profile_id: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, ignore_warnings: Optional[pulumi.Input[bool]] = None, instance: Optional[pulumi.Input[str]] = None, multi_cluster_routing_use_any: Optional[pulumi.Input[bool]] = None, name: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, single_cluster_routing: Optional[pulumi.Input[pulumi.InputType['AppProfileSingleClusterRoutingArgs']]] = None) -> 'AppProfile':
        """
