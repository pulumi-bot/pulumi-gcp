...
class DatasetIamBinding(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, condition=None, dataset_id=None, members=None, project=None, role=None, __props__=None, __name__=None, __opts__=None):
        """
