...
class DatasetAccess(pulumi.CustomResource):
    ...
    """
    domain: pulumi.Output[Optional[str]] = pulumi.output_property("domain")
    """
    A domain to grant access to. Any users signed in with the
    domain specified will be granted the specified access
    """
    group_by_email: pulumi.Output[Optional[str]] = pulumi.output_property("groupByEmail")
    """
    An email address of a Google Group to grant access to.
    """
    iam_member: pulumi.Output[Optional[str]] = pulumi.output_property("iamMember")
    """
    ...
    """
    special_group: pulumi.Output[Optional[str]] = pulumi.output_property("specialGroup")
    """
    A special group to grant access to. Possible values include:
    """
    user_by_email: pulumi.Output[Optional[str]] = pulumi.output_property("userByEmail")
    """
    An email address of a user to grant access to. For example:
    fred@example.com
    """
    view: pulumi.Output[Optional['outputs.DatasetAccessView']] = pulumi.output_property("view")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, dataset_id: Optional[pulumi.Input[str]] = None, domain: Optional[pulumi.Input[str]] = None, group_by_email: Optional[pulumi.Input[str]] = None, iam_member: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, role: Optional[pulumi.Input[str]] = None, special_group: Optional[pulumi.Input[str]] = None, user_by_email: Optional[pulumi.Input[str]] = None, view: Optional[pulumi.Input[pulumi.InputType['DatasetAccessViewArgs']]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, dataset_id: Optional[pulumi.Input[str]] = None, domain: Optional[pulumi.Input[str]] = None, group_by_email: Optional[pulumi.Input[str]] = None, iam_member: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, role: Optional[pulumi.Input[str]] = None, special_group: Optional[pulumi.Input[str]] = None, user_by_email: Optional[pulumi.Input[str]] = None, view: Optional[pulumi.Input[pulumi.InputType['DatasetAccessViewArgs']]] = None) -> 'DatasetAccess':
        """
