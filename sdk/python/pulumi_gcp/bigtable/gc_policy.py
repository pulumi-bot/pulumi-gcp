...
class GCPolicy(pulumi.CustomResource):
    column_family: pulumi.Output[str] = pulumi.property("columnFamily")
    """
    ...
    max_ages: pulumi.Output[Optional[List['outputs.GCPolicyMaxAge']]] = pulumi.property("maxAges")
    """
    GC policy that applies to all cells older than the given age.
    """

    max_versions: pulumi.Output[Optional[List['outputs.GCPolicyMaxVersion']]] = pulumi.property("maxVersions")
    """
    ...
    table: pulumi.Output[str] = pulumi.property("table")
    """
