...
class GCPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, column_family: Optional[pulumi.Input[str]] = None, instance_name: Optional[pulumi.Input[str]] = None, max_ages: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['GCPolicyMaxAgeArgs']]]]] = None, max_versions: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['GCPolicyMaxVersionArgs']]]]] = None, mode: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, table: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, column_family: Optional[pulumi.Input[str]] = None, instance_name: Optional[pulumi.Input[str]] = None, max_ages: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['GCPolicyMaxAgeArgs']]]]] = None, max_versions: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['GCPolicyMaxVersionArgs']]]]] = None, mode: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, table: Optional[pulumi.Input[str]] = None) -> 'GCPolicy':
        """
