...
class Table(pulumi.CustomResource):
    column_families: pulumi.Output[Optional[List['outputs.TableColumnFamily']]] = pulumi.property("columnFamilies")
    """
    ...
    split_keys: pulumi.Output[Optional[List[str]]] = pulumi.property("splitKeys")
    """
