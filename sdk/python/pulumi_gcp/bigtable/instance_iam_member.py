...
class InstanceIamMember(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, instance=None, member=None, project=None, role=None, __props__=None, __name__=None, __opts__=None):
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, etag=None, instance=None, member=None, project=None, role=None):
        """
