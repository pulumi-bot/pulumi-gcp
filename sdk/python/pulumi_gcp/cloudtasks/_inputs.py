...
class QueueRateLimitsArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "maxBurstSize", max_burst_size)
        pulumi.set(__self__, "maxConcurrentDispatches", max_concurrent_dispatches)
        pulumi.set(__self__, "maxDispatchesPerSecond", max_dispatches_per_second)
...
class QueueRetryConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] min_backoff: A task will be scheduled for retry between minBackoff and
               ...
               specifies that the task should be retried.
        """
        pulumi.set(__self__, "maxAttempts", max_attempts)
        pulumi.set(__self__, "maxBackoff", max_backoff)
        pulumi.set(__self__, "maxDoublings", max_doublings)
        pulumi.set(__self__, "maxRetryDuration", max_retry_duration)
        pulumi.set(__self__, "minBackoff", min_backoff)
