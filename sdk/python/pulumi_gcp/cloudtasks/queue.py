...
class Queue(pulumi.CustomResource):
    ...
    * System throttling due to 429 (Too Many Requests) or 503 (Service
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, app_engine_routing_override=None, location=None, name=None, project=None, rate_limits=None, retry_config=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        :param pulumi.Input['QueueRateLimitsArgs'] rate_limits: Rate limits for task dispatches.
               ...
               * System throttling due to 429 (Too Many Requests) or 503 (Service
               Unavailable) responses from the worker, high error rates, or to
               smooth sudden large traffic spikes.  Structure is documented below.
        :param pulumi.Input['QueueRetryConfigArgs'] retry_config: Settings that determine the retry behavior.  Structure is documented below.
        """
