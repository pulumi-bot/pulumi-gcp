...
class Queue(pulumi.CustomResource):
    app_engine_routing_override: pulumi.Output[Optional['outputs.QueueAppEngineRoutingOverride']] = pulumi.property("appEngineRoutingOverride")
    """
    ...
    rate_limits: pulumi.Output['outputs.QueueRateLimits'] = pulumi.property("rateLimits")
    """
    ...
    * System throttling due to 429 (Too Many Requests) or 503 (Service
    ...
    retry_config: pulumi.Output['outputs.QueueRetryConfig'] = pulumi.property("retryConfig")
    """
