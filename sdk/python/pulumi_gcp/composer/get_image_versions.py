...
class GetImageVersionsResult:
    ...
    def __init__(__self__, id=None, image_versions=None, project=None, region=None) -> None:
...
def get_image_versions(project: Optional[str] = None, region: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetImageVersionsResult:
    """
