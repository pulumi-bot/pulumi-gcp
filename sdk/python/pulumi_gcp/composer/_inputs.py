...
class EnvironmentConfigArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "airflowUri", airflow_uri)
        pulumi.set(__self__, "dagGcsPrefix", dag_gcs_prefix)
        pulumi.set(__self__, "gkeCluster", gke_cluster)
        pulumi.set(__self__, "nodeConfig", node_config)
        pulumi.set(__self__, "nodeCount", node_count)
        pulumi.set(__self__, "privateEnvironmentConfig", private_environment_config)
        pulumi.set(__self__, "softwareConfig", software_config)
        pulumi.set(__self__, "webServerNetworkAccessControl", web_server_network_access_control)
...
class EnvironmentConfigNodeConfigArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "ipAllocationPolicy", ip_allocation_policy)
...
class EnvironmentConfigNodeConfigIpAllocationPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] services_secondary_range_name: The name of the services' secondary range used to allocate IP addresses to the cluster.
               ...
               This field is applicable only when `use_ip_aliases` is true.
        """
        pulumi.set(__self__, "useIpAliases", use_ip_aliases)
...
class EnvironmentConfigPrivateEnvironmentConfigArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "cloudSqlIpv4CidrBlock", cloud_sql_ipv4_cidr_block)
        ...
        pulumi.set(__self__, "webServerIpv4CidrBlock", web_server_ipv4_cidr_block)
...
class EnvironmentConfigSoftwareConfigArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "airflowConfigOverrides", airflow_config_overrides)
        pulumi.set(__self__, "envVariables", env_variables)
        pulumi.set(__self__, "imageVersion", image_version)
        pulumi.set(__self__, "pypiPackages", pypi_packages)
...
class EnvironmentConfigWebServerNetworkAccessControlArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "allowedIpRanges", allowed_ip_ranges)
