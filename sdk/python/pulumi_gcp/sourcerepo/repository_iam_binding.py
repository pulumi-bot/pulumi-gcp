...
class RepositoryIamBinding(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, condition=None, members=None, project=None, repository=None, role=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, condition=None, etag=None, members=None, project=None, repository=None, role=None):
        """
