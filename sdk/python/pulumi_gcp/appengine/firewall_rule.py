...
class FirewallRule(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, action=None, description=None, priority=None, project=None, source_range=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
