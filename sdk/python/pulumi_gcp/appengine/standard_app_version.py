...
class StandardAppVersion(pulumi.CustomResource):
    automatic_scaling: pulumi.Output[Optional['outputs.StandardAppVersionAutomaticScaling']] = pulumi.property("automaticScaling")
    """
    ...
    basic_scaling: pulumi.Output[Optional['outputs.StandardAppVersionBasicScaling']] = pulumi.property("basicScaling")
    """
    ...
    deployment: pulumi.Output['outputs.StandardAppVersionDeployment'] = pulumi.property("deployment")
    """
    Code and application artifacts that make up this version.  Structure is documented below.
    """

    entrypoint: pulumi.Output[Optional['outputs.StandardAppVersionEntrypoint']] = pulumi.property("entrypoint")
    """
    ...
    handlers: pulumi.Output[List['outputs.StandardAppVersionHandler']] = pulumi.property("handlers")
    """
    ...
    libraries: pulumi.Output[Optional[List['outputs.StandardAppVersionLibrary']]] = pulumi.property("libraries")
    """
    ...
    manual_scaling: pulumi.Output[Optional['outputs.StandardAppVersionManualScaling']] = pulumi.property("manualScaling")
    """
    ...
    runtime_api_version: pulumi.Output[Optional[str]] = pulumi.property("runtimeApiVersion")
    """
    ...
    threadsafe: pulumi.Output[Optional[bool]] = pulumi.property("threadsafe")
    """
