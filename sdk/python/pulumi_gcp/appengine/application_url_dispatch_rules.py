...
class ApplicationUrlDispatchRules(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, dispatch_rules=None, project=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        * [API documentation](https://cloud.google.com/appengine/docs/admin-api/reference/rest/v1/apps#UrlDispatchRule)
        ...
        :param pulumi.Input[List[pulumi.Input['ApplicationUrlDispatchRulesDispatchRuleArgs']]] dispatch_rules: Rules to match an HTTP request and dispatch that request to a service.  Structure is documented below.
