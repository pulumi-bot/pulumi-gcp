...
class FlexibleAppVersion(pulumi.CustomResource):
    api_config: pulumi.Output[Optional['outputs.FlexibleAppVersionApiConfig']] = pulumi.property("apiConfig")
    """
    Serving configuration for Google Cloud Endpoints.  Structure is documented below.
    """

    automatic_scaling: pulumi.Output[Optional['outputs.FlexibleAppVersionAutomaticScaling']] = pulumi.property("automaticScaling")
    """
    ...
    beta_settings: pulumi.Output[Optional[Mapping[str, str]]] = pulumi.property("betaSettings")
    """
    Metadata settings that are supplied to this version to enable beta runtime features.
    """

    default_expiration: pulumi.Output[Optional[str]] = pulumi.property("defaultExpiration")
    """
    Duration that static files should be cached by web proxies and browsers.
    Only applicable if the corresponding StaticFilesHandler does not specify its own expiration time.
    """

    delete_service_on_destroy: pulumi.Output[Optional[bool]] = pulumi.property("deleteServiceOnDestroy")
    """
    If set to `true`, the service will be deleted if it is the last version.
    """

    deployment: pulumi.Output[Optional['outputs.FlexibleAppVersionDeployment']] = pulumi.property("deployment")
    """
    Code and application artifacts that make up this version.  Structure is documented below.
    """

    endpoints_api_service: pulumi.Output[Optional['outputs.FlexibleAppVersionEndpointsApiService']] = pulumi.property("endpointsApiService")
    """
    Code and application artifacts that make up this version.  Structure is documented below.
    """

    entrypoint: pulumi.Output[Optional['outputs.FlexibleAppVersionEntrypoint']] = pulumi.property("entrypoint")
    """
    The entrypoint for the application.  Structure is documented below.
    """

    env_variables: pulumi.Output[Optional[Mapping[str, str]]] = pulumi.property("envVariables")
    """
    Environment variables available to the application.  As these are not returned in the API request, the provider will not detect any changes made outside of the config.
    """

    handlers: pulumi.Output[List['outputs.FlexibleAppVersionHandler']] = pulumi.property("handlers")
    """
    ...
    inbound_services: pulumi.Output[Optional[List[str]]] = pulumi.property("inboundServices")
    """
    Before an application can receive email or XMPP messages, the application must be configured to enable the service.
    """

    instance_class: pulumi.Output[Optional[str]] = pulumi.property("instanceClass")
    """
    ...
    liveness_check: pulumi.Output['outputs.FlexibleAppVersionLivenessCheck'] = pulumi.property("livenessCheck")
    """
    ...
    manual_scaling: pulumi.Output[Optional['outputs.FlexibleAppVersionManualScaling']] = pulumi.property("manualScaling")
    """
    ...
    network: pulumi.Output[Optional['outputs.FlexibleAppVersionNetwork']] = pulumi.property("network")
    """
    Extra network settings  Structure is documented below.
    """

    nobuild_files_regex: pulumi.Output[Optional[str]] = pulumi.property("nobuildFilesRegex")
    """
    Files that match this pattern will not be built into this version. Only applicable for Go runtimes.
    """

    noop_on_destroy: pulumi.Output[Optional[bool]] = pulumi.property("noopOnDestroy")
    """
    ...
    readiness_check: pulumi.Output['outputs.FlexibleAppVersionReadinessCheck'] = pulumi.property("readinessCheck")
    """
    ...
    resources: pulumi.Output[Optional['outputs.FlexibleAppVersionResources']] = pulumi.property("resources")
    """
    ...
    runtime_api_version: pulumi.Output[str] = pulumi.property("runtimeApiVersion")
    """
    The version of the API in the given runtime environment.
    Please see the app.yaml reference for valid values at https://cloud.google.com/appengine/docs/standard//config/appref
    """

    runtime_channel: pulumi.Output[Optional[str]] = pulumi.property("runtimeChannel")
    """
    The channel of the runtime to use. Only available for some runtimes.
    """

    runtime_main_executable_path: pulumi.Output[Optional[str]] = pulumi.property("runtimeMainExecutablePath")
    """
    ...
    serving_status: pulumi.Output[Optional[str]] = pulumi.property("servingStatus")
    """
    Current serving status of this version. Only the versions with a SERVING status create instances and can be billed.
    """

    version_id: pulumi.Output[Optional[str]] = pulumi.property("versionId")
    """
    Relative name of the version within the service. For example, `v1`. Version names can contain only lowercase letters, numbers, or hyphens.
    Reserved names,"default", "latest", and any name with the prefix "ah-".
    """

    vpc_access_connector: pulumi.Output[Optional['outputs.FlexibleAppVersionVpcAccessConnector']] = pulumi.property("vpcAccessConnector")
    """
