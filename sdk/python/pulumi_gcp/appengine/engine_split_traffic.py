...
class EngineSplitTraffic(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, migrate_traffic=None, project=None, service=None, split=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        * [API documentation](https://cloud.google.com/appengine/docs/admin-api/reference/rest/v1/apps.services)
        ...
        :param pulumi.Input['EngineSplitTrafficSplitArgs'] split: Mapping that defines fractional HTTP traffic diversion to different versions within the service.  Structure is documented below.
        """
