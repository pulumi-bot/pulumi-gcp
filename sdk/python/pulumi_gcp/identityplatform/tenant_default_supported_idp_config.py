...
class TenantDefaultSupportedIdpConfig(pulumi.CustomResource):
    ...
    * `yahoo.com`
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, client_id=None, client_secret=None, enabled=None, idp_id=None, project=None, tenant=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
