...
class Tenant(pulumi.CustomResource):
    allow_password_signup: pulumi.Output[Optional[bool]] = pulumi.property("allowPasswordSignup")
    """
    Whether to allow email/password user authentication.
    """

    disable_auth: pulumi.Output[Optional[bool]] = pulumi.property("disableAuth")
    """
    ...
    enable_email_link_signin: pulumi.Output[Optional[bool]] = pulumi.property("enableEmailLinkSignin")
    """
