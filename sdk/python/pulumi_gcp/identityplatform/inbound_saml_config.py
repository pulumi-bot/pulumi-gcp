...
class InboundSamlConfig(pulumi.CustomResource):
    ...
    idp_config: pulumi.Output['outputs.InboundSamlConfigIdpConfig'] = pulumi.property("idpConfig")
    """
    ...
    sp_config: pulumi.Output['outputs.InboundSamlConfigSpConfig'] = pulumi.property("spConfig")
    """
