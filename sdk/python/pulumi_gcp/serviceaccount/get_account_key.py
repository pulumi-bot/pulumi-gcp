...
@pulumi.output_type
class _GetAccountKeyResult(dict):
    id: str = pulumi.property("id")
    key_algorithm: str = pulumi.property("keyAlgorithm")
    name: str = pulumi.property("name")
    project: Optional[str] = pulumi.property("project")
    public_key: str = pulumi.property("publicKey")
    public_key_type: Optional[str] = pulumi.property("publicKeyType")
...
def get_account_key(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('gcp:serviceAccount/getAccountKey:getAccountKey', __args__, opts=opts, typ=_GetAccountKeyResult).value

    return AwaitableGetAccountKeyResult(
        id=_utilities.get_dict_value(__ret__, 'id'),
        key_algorithm=_utilities.get_dict_value(__ret__, 'keyAlgorithm'),
        name=_utilities.get_dict_value(__ret__, 'name'),
        project=_utilities.get_dict_value(__ret__, 'project'),
        public_key=_utilities.get_dict_value(__ret__, 'publicKey'),
        public_key_type=_utilities.get_dict_value(__ret__, 'publicKeyType'))
