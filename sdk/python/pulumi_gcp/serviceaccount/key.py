...
class Key(pulumi.CustomResource):
    key_algorithm: pulumi.Output[Optional[str]] = pulumi.output_property("keyAlgorithm")
    """
    ...
    """
    private_key_type: pulumi.Output[Optional[str]] = pulumi.output_property("privateKeyType")
    """
    ...
    """
    public_key_type: pulumi.Output[Optional[str]] = pulumi.output_property("publicKeyType")
    """
    The output format of the public key requested. X509_PEM is the default output format.
    """
    service_account_id: pulumi.Output[str] = pulumi.output_property("serviceAccountId")
    """
    The Service account id of the Key Pair. This can be a string in the format
    `{ACCOUNT}` or `projects/{PROJECT_ID}/serviceAccounts/{ACCOUNT}`, where `{ACCOUNT}` is the email address or
    unique id of the service account. If the `{ACCOUNT}` syntax is used, the project will be inferred from the account.
    """
    valid_after: pulumi.Output[str] = pulumi.output_property("validAfter")
    """
    The key can be used after this timestamp. A timestamp in RFC3339 UTC "Zulu" format, accurate to nanoseconds. Example: "2014-10-02T15:01:23.045123456Z".
    """
    valid_before: pulumi.Output[str] = pulumi.output_property("validBefore")
    """
    The key can be used before this timestamp.
    A timestamp in RFC3339 UTC "Zulu" format, accurate to nanoseconds. Example: "2014-10-02T15:01:23.045123456Z".
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, key_algorithm: Optional[pulumi.Input[str]] = None, private_key_type: Optional[pulumi.Input[str]] = None, public_key_type: Optional[pulumi.Input[str]] = None, service_account_id: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, key_algorithm: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, private_key: Optional[pulumi.Input[str]] = None, private_key_type: Optional[pulumi.Input[str]] = None, public_key: Optional[pulumi.Input[str]] = None, public_key_type: Optional[pulumi.Input[str]] = None, service_account_id: Optional[pulumi.Input[str]] = None, valid_after: Optional[pulumi.Input[str]] = None, valid_before: Optional[pulumi.Input[str]] = None) -> 'Key':
        """
