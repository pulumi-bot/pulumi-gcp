...
class GetAccountAccessTokenResult:
    ...
    def __init__(__self__, access_token=None, delegates=None, id=None, lifetime=None, scopes=None, target_service_account=None) -> None:
...
def get_account_access_token(delegates: Optional[List[str]] = None, lifetime: Optional[str] = None, scopes: Optional[List[str]] = None, target_service_account: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAccountAccessTokenResult:
    """
