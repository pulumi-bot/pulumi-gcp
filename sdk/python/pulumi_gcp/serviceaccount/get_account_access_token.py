...
@pulumi.output_type
class _GetAccountAccessTokenResult(dict):
    access_token: str = pulumi.property("accessToken")
    delegates: Optional[List[str]] = pulumi.property("delegates")
    id: str = pulumi.property("id")
    lifetime: Optional[str] = pulumi.property("lifetime")
    scopes: List[str] = pulumi.property("scopes")
    target_service_account: str = pulumi.property("targetServiceAccount")
...
def get_account_access_token(delegates: Optional[List[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('gcp:serviceAccount/getAccountAccessToken:getAccountAccessToken', __args__, opts=opts, typ=_GetAccountAccessTokenResult).value
    ...
    return AwaitableGetAccountAccessTokenResult(
        ...
        lifetime=_utilities.get_dict_value(__ret__, 'lifetime'),
        scopes=_utilities.get_dict_value(__ret__, 'scopes'),
