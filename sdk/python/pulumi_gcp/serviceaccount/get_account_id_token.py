...
class GetAccountIdTokenResult:
    ...
    def __init__(__self__, delegates=None, id=None, id_token=None, include_email=None, target_audience=None, target_service_account=None) -> None:
...
def get_account_id_token(delegates: Optional[List[str]] = None, include_email: Optional[bool] = None, target_audience: Optional[str] = None, target_service_account: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAccountIdTokenResult:
    """
