...
@pulumi.output_type
class _GetAccountIdTokenResult(dict):
    delegates: Optional[List[str]] = pulumi.property("delegates")
    id: str = pulumi.property("id")
    id_token: str = pulumi.property("idToken")
    include_email: Optional[bool] = pulumi.property("includeEmail")
    target_audience: str = pulumi.property("targetAudience")
    target_service_account: Optional[str] = pulumi.property("targetServiceAccount")
...
def get_account_id_token(delegates: Optional[List[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('gcp:serviceAccount/getAccountIdToken:getAccountIdToken', __args__, opts=opts, typ=_GetAccountIdTokenResult).value

    return AwaitableGetAccountIdTokenResult(
        delegates=_utilities.get_dict_value(__ret__, 'delegates'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        id_token=_utilities.get_dict_value(__ret__, 'idToken'),
        include_email=_utilities.get_dict_value(__ret__, 'includeEmail'),
        target_audience=_utilities.get_dict_value(__ret__, 'targetAudience'),
        target_service_account=_utilities.get_dict_value(__ret__, 'targetServiceAccount'))
