...
class GetAccountResult:
    ...
    def __init__(__self__, account_id=None, display_name=None, email=None, id=None, name=None, project=None, unique_id=None) -> None:
...
def get_account(account_id: Optional[str] = None, project: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAccountResult:
    """
