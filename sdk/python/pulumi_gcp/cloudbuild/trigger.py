...
class Trigger(pulumi.CustomResource):
    build: pulumi.Output[Optional['outputs.TriggerBuild']] = pulumi.property("build")
    """
    ...
    filename: pulumi.Output[Optional[str]] = pulumi.property("filename")
    """
    Path, from the source root, to a file whose contents is used for the template. Either a filename or build template must be provided.
    """

    github: pulumi.Output[Optional['outputs.TriggerGithub']] = pulumi.property("github")
    """
    ...
    ignored_files: pulumi.Output[Optional[List[str]]] = pulumi.property("ignoredFiles")
    """
    ...
    included_files: pulumi.Output[Optional[List[str]]] = pulumi.property("includedFiles")
    """
    ignoredFiles and includedFiles are file glob matches using https://golang.org/pkg/path/filepath/#Match
    extended with support for `**`.
    ...
    substitutions: pulumi.Output[Optional[Mapping[str, str]]] = pulumi.property("substitutions")
    """
    ...
    trigger_id: pulumi.Output[str] = pulumi.property("triggerId")
    """
    The unique identifier for the trigger.
    """

    trigger_template: pulumi.Output[Optional['outputs.TriggerTriggerTemplate']] = pulumi.property("triggerTemplate")
    """
