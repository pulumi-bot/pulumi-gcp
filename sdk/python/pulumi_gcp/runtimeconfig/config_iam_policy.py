...
class ConfigIamPolicy(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, config=None, policy_data=None, project=None, __props__=None, __name__=None, __opts__=None):
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, config=None, etag=None, policy_data=None, project=None):
        """
