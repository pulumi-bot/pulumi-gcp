...
class Instance(pulumi.CustomResource):
    alternative_location_id: pulumi.Output[str] = pulumi.output_property("alternativeLocationId")
    """
    ...
    [locationId].
    """
    authorized_network: pulumi.Output[str] = pulumi.output_property("authorizedNetwork")
    """
    The full name of the Google Compute Engine network to which the
    instance is connected. If left unspecified, the default network
    will be used.
    """
    connect_mode: pulumi.Output[Optional[str]] = pulumi.output_property("connectMode")
    """
    ...
    """
    current_location_id: pulumi.Output[str] = pulumi.output_property("currentLocationId")
    """
    ...
    """
    memory_size_gb: pulumi.Output[float] = pulumi.output_property("memorySizeGb")
    """
    ...
    """
    redis_configs: pulumi.Output[Optional[Dict[str, str]]] = pulumi.output_property("redisConfigs")
    """
    Redis configuration parameters, according to http://redis.io/topics/config.
    Please check Memorystore documentation for the list of supported parameters:
    https://cloud.google.com/memorystore/docs/redis/reference/rest/v1/projects.locations.instances#Instance.FIELDS.redis_configs
    """
    redis_version: pulumi.Output[str] = pulumi.output_property("redisVersion")
    """
    ...
    """
    reserved_ip_range: pulumi.Output[str] = pulumi.output_property("reservedIpRange")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, alternative_location_id: Optional[pulumi.Input[str]] = None, authorized_network: Optional[pulumi.Input[str]] = None, connect_mode: Optional[pulumi.Input[str]] = None, display_name: Optional[pulumi.Input[str]] = None, labels: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, location_id: Optional[pulumi.Input[str]] = None, memory_size_gb: Optional[pulumi.Input[float]] = None, name: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, redis_configs: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, redis_version: Optional[pulumi.Input[str]] = None, region: Optional[pulumi.Input[str]] = None, reserved_ip_range: Optional[pulumi.Input[str]] = None, tier: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        * How-to Guides
        ...
        :param pulumi.Input[str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[Dict[str, pulumi.Input[str]]] redis_configs: Redis configuration parameters, according to http://redis.io/topics/config.
               Please check Memorystore documentation for the list of supported parameters:
               https://cloud.google.com/memorystore/docs/redis/reference/rest/v1/projects.locations.instances#Instance.FIELDS.redis_configs
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, alternative_location_id: Optional[pulumi.Input[str]] = None, authorized_network: Optional[pulumi.Input[str]] = None, connect_mode: Optional[pulumi.Input[str]] = None, create_time: Optional[pulumi.Input[str]] = None, current_location_id: Optional[pulumi.Input[str]] = None, display_name: Optional[pulumi.Input[str]] = None, host: Optional[pulumi.Input[str]] = None, labels: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, location_id: Optional[pulumi.Input[str]] = None, memory_size_gb: Optional[pulumi.Input[float]] = None, name: Optional[pulumi.Input[str]] = None, port: Optional[pulumi.Input[float]] = None, project: Optional[pulumi.Input[str]] = None, redis_configs: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, redis_version: Optional[pulumi.Input[str]] = None, region: Optional[pulumi.Input[str]] = None, reserved_ip_range: Optional[pulumi.Input[str]] = None, tier: Optional[pulumi.Input[str]] = None) -> 'Instance':
        """
