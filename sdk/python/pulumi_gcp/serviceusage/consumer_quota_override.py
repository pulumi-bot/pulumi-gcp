...
class ConsumerQuotaOverride(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, dimensions: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, force: Optional[pulumi.Input[bool]] = None, limit: Optional[pulumi.Input[str]] = None, metric: Optional[pulumi.Input[str]] = None, override_value: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, service: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, dimensions: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, force: Optional[pulumi.Input[bool]] = None, limit: Optional[pulumi.Input[str]] = None, metric: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, override_value: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, service: Optional[pulumi.Input[str]] = None) -> 'ConsumerQuotaOverride':
        """
