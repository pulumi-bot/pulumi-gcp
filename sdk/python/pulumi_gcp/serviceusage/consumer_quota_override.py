...
class ConsumerQuotaOverride(pulumi.CustomResource):
    ...
    force: pulumi.Output[Optional[bool]] = pulumi.property("force")
    """
    If the new quota would decrease the existing quota by more than 10%, the request is rejected.
    If `force` is `true`, that safety check is ignored.
    """

    limit: pulumi.Output[str] = pulumi.property("limit")
    """
    The limit on the metric, e.g. `/project/region`.
    """

    metric: pulumi.Output[str] = pulumi.property("metric")
    """
    ...
    override_value: pulumi.Output[str] = pulumi.property("overrideValue")
    """
