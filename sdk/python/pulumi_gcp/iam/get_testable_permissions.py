...
@pulumi.output_type
class _GetTestablePermissionsResult(dict):
...
def get_testable_permissions(custom_support_level: Optional[str] = None,
    ...
    return AwaitableGetTestablePermissionsResult(
        custom_support_level=_utilities.get_dict_value(__ret__, 'customSupportLevel'),
        full_resource_name=_utilities.get_dict_value(__ret__, 'fullResourceName'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        permissions=_utilities.get_dict_value(__ret__, 'permissions'),
        stages=_utilities.get_dict_value(__ret__, 'stages'))
