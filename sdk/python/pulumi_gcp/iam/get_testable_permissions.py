...
class GetTestablePermissionsResult:
    ...
    def __init__(__self__, custom_support_level=None, full_resource_name=None, id=None, permissions=None, stages=None) -> None:
...
def get_testable_permissions(custom_support_level: Optional[str] = None, full_resource_name: Optional[str] = None, stages: Optional[List[str]] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTestablePermissionsResult:
    """
