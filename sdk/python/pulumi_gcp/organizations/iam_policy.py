...
class IAMPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, org_id=None, policy_data=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
