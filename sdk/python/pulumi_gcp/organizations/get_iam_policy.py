...
class GetIAMPolicyResult:
    ...
    def __init__(__self__, audit_configs=None, bindings=None, id=None, policy_data=None) -> None:
...
def get_iam_policy(audit_configs: Optional[List[pulumi.InputType['GetIAMPolicyAuditConfigArgs']]] = None, bindings: Optional[List[pulumi.InputType['GetIAMPolicyBindingArgs']]] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIAMPolicyResult:
    """
