...
@pulumi.output_type
class _GetIAMPolicyResult(dict):
    audit_configs: Optional[List['outputs.GetIAMPolicyAuditConfigResult']] = pulumi.property("auditConfigs")
    bindings: Optional[List['outputs.GetIAMPolicyBindingResult']] = pulumi.property("bindings")
    id: str = pulumi.property("id")
    policy_data: str = pulumi.property("policyData")
...
def get_iam_policy(audit_configs: Optional[List[pulumi.InputType['GetIAMPolicyAuditConfigArgs']]] = None,
    ...
    **Note:** Several restrictions apply when setting IAM policies through this API.
    ...
    __ret__ = pulumi.runtime.invoke('gcp:organizations/getIAMPolicy:getIAMPolicy', __args__, opts=opts, typ=_GetIAMPolicyResult).value

    return AwaitableGetIAMPolicyResult(
        audit_configs=_utilities.get_dict_value(__ret__, 'auditConfigs'),
        bindings=_utilities.get_dict_value(__ret__, 'bindings'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        policy_data=_utilities.get_dict_value(__ret__, 'policyData'))
