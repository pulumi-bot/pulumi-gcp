...
def get_iam_policy(audit_configs=None, bindings=None, opts=None):
    ...
    **Note:** Several restrictions apply when setting IAM policies through this API.
    ...
    :param List['GetIAMPolicyAuditConfigArgs'] audit_configs: A nested configuration block that defines logging additional configuration for your project.
    :param List['GetIAMPolicyBindingArgs'] bindings: A nested configuration block (described below)
