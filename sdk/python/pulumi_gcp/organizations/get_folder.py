...
def get_folder(folder=None, lookup_organization=None, opts=None):
    ...
    my_folder1 = gcp.organizations.get_folder(gcp.organizations.GetFolderArgsArgs(
        folder="folders/12345",
        lookup_organization=True,
    ))
    my_folder2 = gcp.organizations.get_folder(gcp.organizations.GetFolderArgsArgs(
