...
class Project(pulumi.CustomResource):
    auto_create_network: pulumi.Output[Optional[bool]] = pulumi.property("autoCreateNetwork")
    """
    ...
    billing_account: pulumi.Output[Optional[str]] = pulumi.property("billingAccount")
    """
    ...
    number: pulumi.Output[str] = pulumi.property("number")
    """
    ...
    project_id: pulumi.Output[str] = pulumi.property("projectId")
    """
    The project ID. Changing this forces a new project to be created.
    """

    skip_delete: pulumi.Output[bool] = pulumi.property("skipDelete")
    """
