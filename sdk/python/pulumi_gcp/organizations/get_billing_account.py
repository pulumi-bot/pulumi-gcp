...
class GetBillingAccountResult:
    ...
    def __init__(__self__, billing_account=None, display_name=None, id=None, name=None, open=None, project_ids=None) -> None:
...
def get_billing_account(billing_account: Optional[str] = None, display_name: Optional[str] = None, open: Optional[bool] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBillingAccountResult:
    """
