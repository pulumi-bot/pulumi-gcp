...
class Policy(pulumi.CustomResource):
    boolean_policy: pulumi.Output[Optional['outputs.PolicyBooleanPolicy']] = pulumi.property("booleanPolicy")
    """
    ...
    list_policy: pulumi.Output[Optional['outputs.PolicyListPolicy']] = pulumi.property("listPolicy")
    """
    ...
    restore_policy: pulumi.Output[Optional['outputs.PolicyRestorePolicy']] = pulumi.property("restorePolicy")
    """
