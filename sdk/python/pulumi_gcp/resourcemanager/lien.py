...
class Lien(pulumi.CustomResource):
    ...
    """
    reason: pulumi.Output[str] = pulumi.output_property("reason")
    """
    Concise user-visible strings indicating why an action cannot be performed
    on a resource. Maximum length of 200 characters.
    """
    restrictions: pulumi.Output[List[str]] = pulumi.output_property("restrictions")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, origin: Optional[pulumi.Input[str]] = None, parent: Optional[pulumi.Input[str]] = None, reason: Optional[pulumi.Input[str]] = None, restrictions: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, create_time: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, origin: Optional[pulumi.Input[str]] = None, parent: Optional[pulumi.Input[str]] = None, reason: Optional[pulumi.Input[str]] = None, restrictions: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None) -> 'Lien':
        """
