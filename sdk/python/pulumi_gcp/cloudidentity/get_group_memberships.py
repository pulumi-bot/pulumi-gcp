...
class GetGroupMembershipsResult:
    ...
    def __init__(__self__, group=None, id=None, memberships=None) -> None:
...
def get_group_memberships(group: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGroupMembershipsResult:
    """
