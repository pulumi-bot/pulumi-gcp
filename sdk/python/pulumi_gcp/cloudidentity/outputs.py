...
class GetGroupMembershipsMembership(dict):
    ...
    def member_keys(self) -> List['outputs.GetGroupMembershipsMembershipMemberKey']:
        ...
    ...
    def preferred_member_keys(self) -> List['outputs.GetGroupMembershipsMembershipPreferredMemberKey']:
        ...

    @property
    @pulumi.getter
    def roles(self) -> List['outputs.GetGroupMembershipsMembershipRole']:
        """
...
class GetGroupsGroup(dict):
    ...
    def group_keys(self) -> List['outputs.GetGroupsGroupGroupKey']:
        ...
