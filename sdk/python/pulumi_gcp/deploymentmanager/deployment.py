...
class Deployment(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, create_policy=None, delete_policy=None, description=None, labels=None, name=None, preview=None, project=None, target=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        :param pulumi.Input[List[pulumi.Input['DeploymentLabelArgs']]] labels: Key-value pairs to apply to this labels.  Structure is documented below.
