...
class Deployment(pulumi.CustomResource):
    create_policy: pulumi.Output[Optional[str]] = pulumi.output_property("createPolicy")
    """
    ...
    """
    delete_policy: pulumi.Output[Optional[str]] = pulumi.output_property("deletePolicy")
    """
    ...
    """
    labels: pulumi.Output[Optional[List['outputs.DeploymentLabel']]] = pulumi.output_property("labels")
    """
    Key-value pairs to apply to this labels.  Structure is documented below.
    """
    manifest: pulumi.Output[str] = pulumi.output_property("manifest")
    """
    ...
    configuration.
    """
    preview: pulumi.Output[Optional[bool]] = pulumi.output_property("preview")
    """
    ...
    """
    target: pulumi.Output['outputs.DeploymentTarget'] = pulumi.output_property("target")
    """
    Parameters that define your deployment, including the deployment
    configuration and relevant templates.  Structure is documented below.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, create_policy: Optional[pulumi.Input[str]] = None, delete_policy: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, labels: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['DeploymentLabelArgs']]]]] = None, name: Optional[pulumi.Input[str]] = None, preview: Optional[pulumi.Input[bool]] = None, project: Optional[pulumi.Input[str]] = None, target: Optional[pulumi.Input[pulumi.InputType['DeploymentTargetArgs']]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, create_policy: Optional[pulumi.Input[str]] = None, delete_policy: Optional[pulumi.Input[str]] = None, deployment_id: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, labels: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['DeploymentLabelArgs']]]]] = None, manifest: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, preview: Optional[pulumi.Input[bool]] = None, project: Optional[pulumi.Input[str]] = None, self_link: Optional[pulumi.Input[str]] = None, target: Optional[pulumi.Input[pulumi.InputType['DeploymentTargetArgs']]] = None) -> 'Deployment':
        """
