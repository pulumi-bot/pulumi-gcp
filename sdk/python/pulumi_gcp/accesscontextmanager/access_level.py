...
class AccessLevel(pulumi.CustomResource):
    basic: pulumi.Output[Optional['outputs.AccessLevelBasic']] = pulumi.output_property("basic")
    """
    A set of predefined conditions for the access level and a combining function.  Structure is documented below.
    """
    custom: pulumi.Output[Optional['outputs.AccessLevelCustom']] = pulumi.output_property("custom")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, basic: Optional[pulumi.Input[pulumi.InputType['AccessLevelBasicArgs']]] = None, custom: Optional[pulumi.Input[pulumi.InputType['AccessLevelCustomArgs']]] = None, description: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, parent: Optional[pulumi.Input[str]] = None, title: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        * How-to Guides
        ...
        :param pulumi.Input[pulumi.InputType['AccessLevelBasicArgs']] basic: A set of predefined conditions for the access level and a combining function.  Structure is documented below.
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, basic: Optional[pulumi.Input[pulumi.InputType['AccessLevelBasicArgs']]] = None, custom: Optional[pulumi.Input[pulumi.InputType['AccessLevelCustomArgs']]] = None, description: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, parent: Optional[pulumi.Input[str]] = None, title: Optional[pulumi.Input[str]] = None) -> 'AccessLevel':
        """
