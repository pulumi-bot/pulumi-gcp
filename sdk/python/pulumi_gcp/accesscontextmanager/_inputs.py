...
class AccessLevelBasicArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "combiningFunction", combining_function)
...
class AccessLevelBasicConditionArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "devicePolicy", device_policy)
        pulumi.set(__self__, "ipSubnetworks", ip_subnetworks)
        pulumi.set(__self__, "members", members)
        pulumi.set(__self__, "negate", negate)
        pulumi.set(__self__, "regions", regions)
        pulumi.set(__self__, "requiredAccessLevels", required_access_levels)
...
class AccessLevelBasicConditionDevicePolicyArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "allowedDeviceManagementLevels", allowed_device_management_levels)
        pulumi.set(__self__, "allowedEncryptionStatuses", allowed_encryption_statuses)
        pulumi.set(__self__, "osConstraints", os_constraints)
        pulumi.set(__self__, "requireAdminApproval", require_admin_approval)
        pulumi.set(__self__, "requireCorpOwned", require_corp_owned)
        pulumi.set(__self__, "requireScreenLock", require_screen_lock)
...
class AccessLevelBasicConditionDevicePolicyOsConstraintArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "minimumVersion", minimum_version)
...
class ServicePerimeterSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ServicePerimeterSpecVpcAccessibleServicesArgs'] vpc_accessible_services: Specifies how APIs are allowed to communicate within the Service
               ...
               Structure is documented below.
        """
        pulumi.set(__self__, "accessLevels", access_levels)
        pulumi.set(__self__, "resources", resources)
        pulumi.set(__self__, "restrictedServices", restricted_services)
        pulumi.set(__self__, "vpcAccessibleServices", vpc_accessible_services)
...
class ServicePerimeterSpecVpcAccessibleServicesArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "allowedServices", allowed_services)
        pulumi.set(__self__, "enableRestriction", enable_restriction)
