...
class Service(pulumi.CustomResource):
    autogenerate_revision_name: pulumi.Output[Optional[bool]] = pulumi.output_property("autogenerateRevisionName")
    """
    ...
    """
    metadata: pulumi.Output['outputs.ServiceMetadata'] = pulumi.output_property("metadata")
    """
    ...
    """
    status: pulumi.Output['outputs.ServiceStatus'] = pulumi.output_property("status")
    """
    The current status of the Service.
    """
    template: pulumi.Output[Optional['outputs.ServiceTemplate']] = pulumi.output_property("template")
    """
    ...
    """
    traffics: pulumi.Output[List['outputs.ServiceTraffic']] = pulumi.output_property("traffics")
    """
    Traffic specifies how to distribute traffic over a collection of Knative Revisions
    and Configurations  Structure is documented below.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, autogenerate_revision_name: Optional[pulumi.Input[bool]] = None, location: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input[pulumi.InputType['ServiceMetadataArgs']]] = None, name: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, template: Optional[pulumi.Input[pulumi.InputType['ServiceTemplateArgs']]] = None, traffics: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ServiceTrafficArgs']]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, autogenerate_revision_name: Optional[pulumi.Input[bool]] = None, location: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input[pulumi.InputType['ServiceMetadataArgs']]] = None, name: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, status: Optional[pulumi.Input[pulumi.InputType['ServiceStatusArgs']]] = None, template: Optional[pulumi.Input[pulumi.InputType['ServiceTemplateArgs']]] = None, traffics: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ServiceTrafficArgs']]]]] = None) -> 'Service':
        """
