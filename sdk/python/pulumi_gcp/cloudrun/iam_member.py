...
class IamMember(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, condition=None, location=None, member=None, project=None, role=None, service=None, __props__=None, __name__=None, __opts__=None):
        """
