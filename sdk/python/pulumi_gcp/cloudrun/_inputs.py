...
class DomainMappingSpecArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "routeName", route_name)
        pulumi.set(__self__, "certificateMode", certificate_mode)
        pulumi.set(__self__, "forceOverride", force_override)
...
class DomainMappingStatusArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "mappedRouteName", mapped_route_name)
        pulumi.set(__self__, "observedGeneration", observed_generation)
        pulumi.set(__self__, "resourceRecords", resource_records)
...
class ServiceStatusArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "conditions", conditions)
        pulumi.set(__self__, "latestCreatedRevisionName", latest_created_revision_name)
        pulumi.set(__self__, "latestReadyRevisionName", latest_ready_revision_name)
        pulumi.set(__self__, "observedGeneration", observed_generation)
...
class ServiceTemplateSpecArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "containerConcurrency", container_concurrency)
        ...
        pulumi.set(__self__, "servingState", serving_state)
...
class ServiceTemplateSpecContainerArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "envFroms", env_froms)
...
class ServiceTemplateSpecContainerEnvFromConfigMapRefArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "localObjectReference", local_object_reference)
...
class ServiceTrafficArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "latestRevision", latest_revision)
        pulumi.set(__self__, "revisionName", revision_name)
