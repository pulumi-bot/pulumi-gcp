...
class Intent(pulumi.CustomResource):
    ...
    """
    default_response_platforms: pulumi.Output[Optional[List[str]]] = pulumi.output_property("defaultResponsePlatforms")
    """
    ...
    """
    events: pulumi.Output[Optional[List[str]]] = pulumi.output_property("events")
    """
    The collection of event names that trigger the intent. If the collection of input contexts is not empty, all of
    the contexts must be present in the active user session for an event to trigger this intent. See the
    [events reference](https://cloud.google.com/dialogflow/docs/events-overview) for more details.
    """
    followup_intent_infos: pulumi.Output[List['outputs.IntentFollowupIntentInfo']] = pulumi.output_property("followupIntentInfos")
    """
    Information about all followup intents that have this intent as a direct or indirect parent. We populate this field only
    in the output.
    """
    input_context_names: pulumi.Output[Optional[List[str]]] = pulumi.output_property("inputContextNames")
    """
    The list of context names required for this intent to be triggered.
    Format: projects/<Project ID>/agent/sessions/-/contexts/<Context ID>.
    """
    is_fallback: pulumi.Output[bool] = pulumi.output_property("isFallback")
    """
    Indicates whether this is a fallback intent.
    """
    ml_disabled: pulumi.Output[bool] = pulumi.output_property("mlDisabled")
    """
    ...
    """
    parent_followup_intent_name: pulumi.Output[str] = pulumi.output_property("parentFollowupIntentName")
    """
    ...
    """
    reset_contexts: pulumi.Output[bool] = pulumi.output_property("resetContexts")
    """
    Indicates whether to delete all contexts in the current session when this intent is matched.
    """
    root_followup_intent_name: pulumi.Output[str] = pulumi.output_property("rootFollowupIntentName")
    """
    ...
    """
    webhook_state: pulumi.Output[str] = pulumi.output_property("webhookState")
    """
    ...
    * WEBHOOK_STATE_ENABLED_FOR_SLOT_FILLING: Webhook is enabled in the agent and in the intent. Also, each slot
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, action: Optional[pulumi.Input[str]] = None, default_response_platforms: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, display_name: Optional[pulumi.Input[str]] = None, events: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, input_context_names: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, is_fallback: Optional[pulumi.Input[bool]] = None, ml_disabled: Optional[pulumi.Input[bool]] = None, parent_followup_intent_name: Optional[pulumi.Input[str]] = None, priority: Optional[pulumi.Input[float]] = None, project: Optional[pulumi.Input[str]] = None, reset_contexts: Optional[pulumi.Input[bool]] = None, webhook_state: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, action: Optional[pulumi.Input[str]] = None, default_response_platforms: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, display_name: Optional[pulumi.Input[str]] = None, events: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, followup_intent_infos: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['IntentFollowupIntentInfoArgs']]]]] = None, input_context_names: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, is_fallback: Optional[pulumi.Input[bool]] = None, ml_disabled: Optional[pulumi.Input[bool]] = None, name: Optional[pulumi.Input[str]] = None, parent_followup_intent_name: Optional[pulumi.Input[str]] = None, priority: Optional[pulumi.Input[float]] = None, project: Optional[pulumi.Input[str]] = None, reset_contexts: Optional[pulumi.Input[bool]] = None, root_followup_intent_name: Optional[pulumi.Input[str]] = None, webhook_state: Optional[pulumi.Input[str]] = None) -> 'Intent':
        """
