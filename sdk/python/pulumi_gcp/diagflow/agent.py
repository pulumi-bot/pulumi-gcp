...
class Agent(pulumi.CustomResource):
    api_version: pulumi.Output[str] = pulumi.property("apiVersion")
    """
    ...
    * API_VERSION_V2_BETA_1: V2beta1 API.
    ...
    avatar_uri: pulumi.Output[Optional[str]] = pulumi.property("avatarUri")
    """
    ...
    avatar_uri_backend: pulumi.Output[str] = pulumi.property("avatarUriBackend")
    """
    ...
    classification_threshold: pulumi.Output[Optional[float]] = pulumi.property("classificationThreshold")
    """
    ...
    default_language_code: pulumi.Output[str] = pulumi.property("defaultLanguageCode")
    """
    ...
    match_mode: pulumi.Output[str] = pulumi.property("matchMode")
    """
    ...
    * MATCH_MODE_ML_ONLY: Can be used for agents with a large number of examples in intents, especially the ones
    ...
    supported_language_codes: pulumi.Output[Optional[List[str]]] = pulumi.property("supportedLanguageCodes")
    """
