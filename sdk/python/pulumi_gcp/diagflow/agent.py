...
class Agent(pulumi.CustomResource):
    ...
    * TIER_ENTERPRISE_PLUS: Enterprise tier (Plus).
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, api_version=None, avatar_uri=None, classification_threshold=None, default_language_code=None, description=None, display_name=None, enable_logging=None, match_mode=None, project=None, supported_language_codes=None, tier=None, time_zone=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
