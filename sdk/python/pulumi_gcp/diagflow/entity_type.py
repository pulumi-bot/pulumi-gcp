...
class EntityType(pulumi.CustomResource):
    ...
    """
    enable_fuzzy_extraction: pulumi.Output[Optional[bool]] = pulumi.output_property("enableFuzzyExtraction")
    """
    Enables fuzzy entity extraction during classification.
    """
    entities: pulumi.Output[Optional[List['outputs.EntityTypeEntity']]] = pulumi.output_property("entities")
    """
    ...
    * KIND_REGEXP: Regexp entity types allow to specify regular expressions in entries values.
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, display_name: Optional[pulumi.Input[str]] = None, enable_fuzzy_extraction: Optional[pulumi.Input[bool]] = None, entities: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['EntityTypeEntityArgs']]]]] = None, kind: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, display_name: Optional[pulumi.Input[str]] = None, enable_fuzzy_extraction: Optional[pulumi.Input[bool]] = None, entities: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['EntityTypeEntityArgs']]]]] = None, kind: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None) -> 'EntityType':
        """
