...
class EntityType(pulumi.CustomResource):
    ...
    * KIND_REGEXP: Regexp entity types allow to specify regular expressions in entries values.
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, display_name=None, enable_fuzzy_extraction=None, entities=None, kind=None, project=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        * How-to Guides
        ...
        :param pulumi.Input[List[pulumi.Input['EntityTypeEntityArgs']]] entities: The collection of entity entries associated with the entity type.  Structure is documented below.
