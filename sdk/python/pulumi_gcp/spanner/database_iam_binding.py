...
class DatabaseIAMBinding(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, condition=None, database=None, instance=None, members=None, project=None, role=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, condition=None, database=None, etag=None, instance=None, members=None, project=None, role=None):
        """
