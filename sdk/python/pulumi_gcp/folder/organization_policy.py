...
class OrganizationPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, boolean_policy: Optional[pulumi.Input[pulumi.InputType['OrganizationPolicyBooleanPolicyArgs']]] = None, constraint: Optional[pulumi.Input[str]] = None, folder: Optional[pulumi.Input[str]] = None, list_policy: Optional[pulumi.Input[pulumi.InputType['OrganizationPolicyListPolicyArgs']]] = None, restore_policy: Optional[pulumi.Input[pulumi.InputType['OrganizationPolicyRestorePolicyArgs']]] = None, version: Optional[pulumi.Input[float]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, boolean_policy: Optional[pulumi.Input[pulumi.InputType['OrganizationPolicyBooleanPolicyArgs']]] = None, constraint: Optional[pulumi.Input[str]] = None, etag: Optional[pulumi.Input[str]] = None, folder: Optional[pulumi.Input[str]] = None, list_policy: Optional[pulumi.Input[pulumi.InputType['OrganizationPolicyListPolicyArgs']]] = None, restore_policy: Optional[pulumi.Input[pulumi.InputType['OrganizationPolicyRestorePolicyArgs']]] = None, update_time: Optional[pulumi.Input[str]] = None, version: Optional[pulumi.Input[float]] = None) -> 'OrganizationPolicy':
        """
