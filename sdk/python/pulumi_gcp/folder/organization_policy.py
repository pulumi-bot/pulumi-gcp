...
class OrganizationPolicy(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, boolean_policy=None, constraint=None, folder=None, list_policy=None, restore_policy=None, version=None, __name__=None, __opts__=None):
        """
