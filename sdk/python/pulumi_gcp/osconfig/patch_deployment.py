...
class PatchDeployment(pulumi.CustomResource):
    ...
    duration: pulumi.Output[Optional[str]] = pulumi.property("duration")
    """
    Duration of the patch. After the duration ends, the patch times out.
    A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s"
    """

    instance_filter: pulumi.Output['outputs.PatchDeploymentInstanceFilter'] = pulumi.property("instanceFilter")
    """
    VM instances to patch.
    Structure is documented below.
    """

    last_execute_time: pulumi.Output[str] = pulumi.property("lastExecuteTime")
    """
    -
    ...
    one_time_schedule: pulumi.Output[Optional['outputs.PatchDeploymentOneTimeSchedule']] = pulumi.property("oneTimeSchedule")
    """
    Schedule a one-time execution.
    Structure is documented below.
    """

    patch_config: pulumi.Output[Optional['outputs.PatchDeploymentPatchConfig']] = pulumi.property("patchConfig")
    """
    Patch configuration that is applied.
    Structure is documented below.
    """

    patch_deployment_id: pulumi.Output[str] = pulumi.property("patchDeploymentId")
    """
    ...
    * Must be unique within the project.
    ...
    recurring_schedule: pulumi.Output[Optional['outputs.PatchDeploymentRecurringSchedule']] = pulumi.property("recurringSchedule")
    """
