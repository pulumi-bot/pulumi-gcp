...
class PatchDeployment(pulumi.CustomResource):
    ...
    * Must be unique within the project.
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, description=None, duration=None, instance_filter=None, one_time_schedule=None, patch_config=None, patch_deployment_id=None, project=None, recurring_schedule=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        * How-to Guides
        ...
        :param pulumi.Input[str] duration: Duration of the patch. After the duration ends, the patch times out.
               A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s"
        :param pulumi.Input['PatchDeploymentInstanceFilterArgs'] instance_filter: VM instances to patch.  Structure is documented below.
        :param pulumi.Input['PatchDeploymentOneTimeScheduleArgs'] one_time_schedule: Schedule a one-time execution.  Structure is documented below.
        :param pulumi.Input['PatchDeploymentPatchConfigArgs'] patch_config: Patch configuration that is applied.  Structure is documented below.
        ...
        :param pulumi.Input[str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input['PatchDeploymentRecurringScheduleArgs'] recurring_schedule: Schedule recurring executions.  Structure is documented below.
        """
