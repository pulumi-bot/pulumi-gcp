...
class GuestPolicies(pulumi.CustomResource):
    assignment: pulumi.Output['outputs.GuestPoliciesAssignment'] = pulumi.output_property("assignment")
    """
    ...
    """
    guest_policy_id: pulumi.Output[str] = pulumi.output_property("guestPolicyId")
    """
    ...
    * Must be unique within the project.
    ...
    """
    package_repositories: pulumi.Output[Optional[List['outputs.GuestPoliciesPackageRepository']]] = pulumi.output_property("packageRepositories")
    """
    ...
    """
    packages: pulumi.Output[Optional[List['outputs.GuestPoliciesPackage']]] = pulumi.output_property("packages")
    """
    ...
    """
    recipes: pulumi.Output[Optional[List['outputs.GuestPoliciesRecipe']]] = pulumi.output_property("recipes")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, assignment: Optional[pulumi.Input[pulumi.InputType['GuestPoliciesAssignmentArgs']]] = None, description: Optional[pulumi.Input[str]] = None, etag: Optional[pulumi.Input[str]] = None, guest_policy_id: Optional[pulumi.Input[str]] = None, package_repositories: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['GuestPoliciesPackageRepositoryArgs']]]]] = None, packages: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['GuestPoliciesPackageArgs']]]]] = None, project: Optional[pulumi.Input[str]] = None, recipes: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['GuestPoliciesRecipeArgs']]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, assignment: Optional[pulumi.Input[pulumi.InputType['GuestPoliciesAssignmentArgs']]] = None, create_time: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, etag: Optional[pulumi.Input[str]] = None, guest_policy_id: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, package_repositories: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['GuestPoliciesPackageRepositoryArgs']]]]] = None, packages: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['GuestPoliciesPackageArgs']]]]] = None, project: Optional[pulumi.Input[str]] = None, recipes: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['GuestPoliciesRecipeArgs']]]]] = None, update_time: Optional[pulumi.Input[str]] = None) -> 'GuestPolicies':
        """
