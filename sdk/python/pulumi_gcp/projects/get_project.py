...
class GetProjectResult:
    ...
    def __init__(__self__, filter=None, id=None, projects=None) -> None:
...
def get_project(filter: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetProjectResult:
    """
