...
def get_project(filter=None, opts=None):
    ...
    my_org_projects = gcp.projects.get_project(gcp.projects.GetProjectArgsArgs(
        filter="parent.id:012345678910 lifecycleState:DELETE_REQUESTED",
    ))
    deletion_candidate = gcp.organizations.get_project(gcp.organizations.GetProjectArgsArgs(
        project_id=my_org_projects.projects[0].project_id,
    ))
    ```
