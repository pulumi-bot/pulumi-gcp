...
class _GetProjectResult(dict):
    filter: str = pulumi.property("filter")
    id: str = pulumi.property("id")
    projects: List['outputs.GetProjectProjectResult'] = pulumi.property("projects")
...
def get_project(filter: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('gcp:projects/getProject:getProject', __args__, opts=opts, typ=_GetProjectResult).value

    return AwaitableGetProjectResult(
        filter=_utilities.get_dict_value(__ret__, 'filter'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        projects=_utilities.get_dict_value(__ret__, 'projects'))
