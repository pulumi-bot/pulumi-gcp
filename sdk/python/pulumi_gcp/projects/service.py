...
class Service(pulumi.CustomResource):
    disable_dependent_services: pulumi.Output[Optional[bool]] = pulumi.output_property("disableDependentServices")
    """
    ...
    """
    disable_on_destroy: pulumi.Output[Optional[bool]] = pulumi.output_property("disableOnDestroy")
    """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, disable_dependent_services: Optional[pulumi.Input[bool]] = None, disable_on_destroy: Optional[pulumi.Input[bool]] = None, project: Optional[pulumi.Input[str]] = None, service: Optional[pulumi.Input[str]] = None) -> 'Service':
        """
