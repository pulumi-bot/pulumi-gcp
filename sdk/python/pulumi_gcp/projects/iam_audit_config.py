...
class IAMAuditConfig(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, audit_log_configs=None, project=None, service=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
