...
class WebTypeComputeIamBinding(pulumi.CustomResource):
    condition: pulumi.Output[Optional['outputs.WebTypeComputeIamBindingCondition']] = pulumi.output_property("condition")
    """
