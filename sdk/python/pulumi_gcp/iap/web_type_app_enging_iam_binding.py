...
class WebTypeAppEngingIamBinding(pulumi.CustomResource):
    ...
    """
    condition: pulumi.Output[Optional['outputs.WebTypeAppEngingIamBindingCondition']] = pulumi.output_property("condition")
    """
