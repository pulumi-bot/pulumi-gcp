...
class WebTypeComputeIamPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, policy_data=None, project=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
