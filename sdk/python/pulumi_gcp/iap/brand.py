...
class Brand(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, application_title=None, project=None, support_email=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
