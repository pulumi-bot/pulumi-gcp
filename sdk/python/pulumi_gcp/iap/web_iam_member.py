...
__all__ = ['WebIamMember']


class WebIamMember(pulumi.CustomResource):
    condition: pulumi.Output[Optional['outputs.WebIamMemberCondition']] = pulumi.output_property("condition")
    """
