...
class WebTypeAppEngingIamMember(pulumi.CustomResource):
    ...
    """
    condition: pulumi.Output[Optional['outputs.WebTypeAppEngingIamMemberCondition']] = pulumi.output_property("condition")
    """
