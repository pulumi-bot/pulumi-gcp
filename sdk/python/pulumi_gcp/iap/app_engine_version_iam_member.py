...
class AppEngineVersionIamMember(pulumi.CustomResource):
    ...
    """
    condition: pulumi.Output[Optional['outputs.AppEngineVersionIamMemberCondition']] = pulumi.output_property("condition")
    """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, app_id: Optional[pulumi.Input[str]] = None, condition: Optional[pulumi.Input[pulumi.InputType['AppEngineVersionIamMemberConditionArgs']]] = None, etag: Optional[pulumi.Input[str]] = None, member: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, role: Optional[pulumi.Input[str]] = None, service: Optional[pulumi.Input[str]] = None, version_id: Optional[pulumi.Input[str]] = None) -> 'AppEngineVersionIamMember':
        """
