...
class AppEngineVersionIamPolicy(pulumi.CustomResource):
    ...
    a `organizationsgetIAMPolicy` data source.
    """
    ...
    """
    def __init__(__self__, resource_name, opts=None, app_id=None, policy_data=None, project=None, service=None, version_id=None, __props__=None, __name__=None, __opts__=None):
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, app_id=None, etag=None, policy_data=None, project=None, service=None, version_id=None):
        """
