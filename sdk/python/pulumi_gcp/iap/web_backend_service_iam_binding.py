...
class WebBackendServiceIamBinding(pulumi.CustomResource):
    condition: pulumi.Output[Optional['outputs.WebBackendServiceIamBindingCondition']] = pulumi.property("condition")
    """
    ...
    web_backend_service: pulumi.Output[str] = pulumi.property("webBackendService")
    """
