...
class JobAppEngineHttpTargetArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "relativeUri", relative_uri)
        pulumi.set(__self__, "appEngineRouting", app_engine_routing)
        pulumi.set(__self__, "body", body)
        pulumi.set(__self__, "headers", headers)
        pulumi.set(__self__, "httpMethod", http_method)
...
class JobHttpTargetArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "headers", headers)
        pulumi.set(__self__, "httpMethod", http_method)
        pulumi.set(__self__, "oauthToken", oauth_token)
        pulumi.set(__self__, "oidcToken", oidc_token)
...
class JobPubsubTargetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] data: The message payload for PubsubMessage.
               Pubsub message must contain either non-empty data, or at least one attribute.
        """
        pulumi.set(__self__, "topicName", topic_name)
...
class JobRetryConfigArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "maxBackoffDuration", max_backoff_duration)
        pulumi.set(__self__, "maxDoublings", max_doublings)
        pulumi.set(__self__, "maxRetryDuration", max_retry_duration)
        pulumi.set(__self__, "minBackoffDuration", min_backoff_duration)
        pulumi.set(__self__, "retryCount", retry_count)
