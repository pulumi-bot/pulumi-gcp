...
class Job(pulumi.CustomResource):
    app_engine_http_target: pulumi.Output[Optional['outputs.JobAppEngineHttpTarget']] = pulumi.property("appEngineHttpTarget")
    """
    ...
    attempt_deadline: pulumi.Output[Optional[str]] = pulumi.property("attemptDeadline")
    """
    ...
    * For App Engine HTTP targets, between 15 seconds and 24 hours.
    ...
    http_target: pulumi.Output[Optional['outputs.JobHttpTarget']] = pulumi.property("httpTarget")
    """
    HTTP target.
    ...
    pubsub_target: pulumi.Output[Optional['outputs.JobPubsubTarget']] = pulumi.property("pubsubTarget")
    """
    Pub/Sub target
    ...
    retry_config: pulumi.Output[Optional['outputs.JobRetryConfig']] = pulumi.property("retryConfig")
    """
    ...
    time_zone: pulumi.Output[Optional[str]] = pulumi.property("timeZone")
    """
