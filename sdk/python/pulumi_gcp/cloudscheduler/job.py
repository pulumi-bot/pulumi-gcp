...
class Job(pulumi.CustomResource):
    ...
    * For App Engine HTTP targets, between 15 seconds and 24 hours.
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, app_engine_http_target=None, attempt_deadline=None, description=None, http_target=None, name=None, project=None, pubsub_target=None, region=None, retry_config=None, schedule=None, time_zone=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
