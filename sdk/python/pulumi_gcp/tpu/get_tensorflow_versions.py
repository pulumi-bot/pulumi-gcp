...
class GetTensorflowVersionsResult:
    ...
    def __init__(__self__, id=None, project=None, versions=None, zone=None) -> None:
...
def get_tensorflow_versions(project: Optional[str] = None, zone: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTensorflowVersionsResult:
    """
