...
class Dashboard(pulumi.CustomResource):
    dashboard_json: pulumi.Output[str] = pulumi.output_property("dashboardJson")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, dashboard_json: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, dashboard_json: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None) -> 'Dashboard':
        """
