...
@pulumi.output_type
class _GetUptimeCheckIPsResult(dict):
    id: str = pulumi.property("id")
    uptime_check_ips: List['outputs.GetUptimeCheckIPsUptimeCheckIpResult'] = pulumi.property("uptimeCheckIps")
...
def get_uptime_check_ips(                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetUptimeCheckIPsResult:
    ...
    ips = gcp.monitoring.get_uptime_check_ips()
    ...
    __ret__ = pulumi.runtime.invoke('gcp:monitoring/getUptimeCheckIPs:getUptimeCheckIPs', __args__, opts=opts, typ=_GetUptimeCheckIPsResult).value

    return AwaitableGetUptimeCheckIPsResult(
        id=_utilities.get_dict_value(__ret__, 'id'),
        uptime_check_ips=_utilities.get_dict_value(__ret__, 'uptimeCheckIps'))
