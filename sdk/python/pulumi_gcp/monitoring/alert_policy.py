...
class AlertPolicy(pulumi.CustomResource):
    combiner: pulumi.Output[str] = pulumi.property("combiner")
    """
    How to combine the results of multiple conditions to
    determine if an incident should be opened.
    """

    conditions: pulumi.Output[List['outputs.AlertPolicyCondition']] = pulumi.property("conditions")
    """
    ...
    creation_record: pulumi.Output['outputs.AlertPolicyCreationRecord'] = pulumi.property("creationRecord")
    """
    ...
    documentation: pulumi.Output[Optional['outputs.AlertPolicyDocumentation']] = pulumi.property("documentation")
    """
    ...
    notification_channels: pulumi.Output[Optional[List[str]]] = pulumi.property("notificationChannels")
    """
    ...
    user_labels: pulumi.Output[Optional[Mapping[str, str]]] = pulumi.property("userLabels")
    """
