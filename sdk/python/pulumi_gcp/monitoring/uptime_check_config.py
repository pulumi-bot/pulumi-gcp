...
class UptimeCheckConfig(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, content_matchers: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['UptimeCheckConfigContentMatcherArgs']]]]] = None, display_name: Optional[pulumi.Input[str]] = None, http_check: Optional[pulumi.Input[pulumi.InputType['UptimeCheckConfigHttpCheckArgs']]] = None, monitored_resource: Optional[pulumi.Input[pulumi.InputType['UptimeCheckConfigMonitoredResourceArgs']]] = None, period: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, resource_group: Optional[pulumi.Input[pulumi.InputType['UptimeCheckConfigResourceGroupArgs']]] = None, selected_regions: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, tcp_check: Optional[pulumi.Input[pulumi.InputType['UptimeCheckConfigTcpCheckArgs']]] = None, timeout: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        * How-to Guides
        ...
        :param pulumi.Input[pulumi.InputType['UptimeCheckConfigHttpCheckArgs']] http_check: Contains information needed to make an HTTP or HTTPS check.  Structure is documented below.
        ...
        :param pulumi.Input[str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[pulumi.InputType['UptimeCheckConfigResourceGroupArgs']] resource_group: The group resource associated with the configuration.  Structure is documented below.
        ...
        :param pulumi.Input[pulumi.InputType['UptimeCheckConfigTcpCheckArgs']] tcp_check: Contains information needed to make a TCP check.  Structure is documented below.
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, content_matchers: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['UptimeCheckConfigContentMatcherArgs']]]]] = None, display_name: Optional[pulumi.Input[str]] = None, http_check: Optional[pulumi.Input[pulumi.InputType['UptimeCheckConfigHttpCheckArgs']]] = None, monitored_resource: Optional[pulumi.Input[pulumi.InputType['UptimeCheckConfigMonitoredResourceArgs']]] = None, name: Optional[pulumi.Input[str]] = None, period: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, resource_group: Optional[pulumi.Input[pulumi.InputType['UptimeCheckConfigResourceGroupArgs']]] = None, selected_regions: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, tcp_check: Optional[pulumi.Input[pulumi.InputType['UptimeCheckConfigTcpCheckArgs']]] = None, timeout: Optional[pulumi.Input[str]] = None, uptime_check_id: Optional[pulumi.Input[str]] = None) -> 'UptimeCheckConfig':
        """
