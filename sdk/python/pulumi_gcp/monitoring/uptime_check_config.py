...
class UptimeCheckConfig(pulumi.CustomResource):
    content_matchers: pulumi.Output[Optional[List['outputs.UptimeCheckConfigContentMatcher']]] = pulumi.property("contentMatchers")
    """
    ...
    http_check: pulumi.Output[Optional['outputs.UptimeCheckConfigHttpCheck']] = pulumi.property("httpCheck")
    """
    Contains information needed to make an HTTP or HTTPS check.  Structure is documented below.
    """

    monitored_resource: pulumi.Output[Optional['outputs.UptimeCheckConfigMonitoredResource']] = pulumi.property("monitoredResource")
    """
    ...
    period: pulumi.Output[Optional[str]] = pulumi.property("period")
    """
    ...
    resource_group: pulumi.Output[Optional['outputs.UptimeCheckConfigResourceGroup']] = pulumi.property("resourceGroup")
    """
    The group resource associated with the configuration.  Structure is documented below.
    """

    selected_regions: pulumi.Output[Optional[List[str]]] = pulumi.property("selectedRegions")
    """
    The list of regions from which the check will be run. Some regions contain one location, and others contain more than one. If this field is specified, enough regions to include a minimum of 3 locations must be provided, or an error message is returned. Not specifying this field will result in uptime checks running from all regions.
    """

    tcp_check: pulumi.Output[Optional['outputs.UptimeCheckConfigTcpCheck']] = pulumi.property("tcpCheck")
    """
    Contains information needed to make a TCP check.  Structure is documented below.
    """

    timeout: pulumi.Output[str] = pulumi.property("timeout")
    """
    The maximum amount of time to wait for the request to complete (must be between 1 and 60 seconds). Accepted formats https://developers.google.com/protocol-buffers/docs/reference/google.protobuf#google.protobuf.Duration
    """

    uptime_check_id: pulumi.Output[str] = pulumi.property("uptimeCheckId")
    """
