    ...
    def __init__(__self__, resource_name, opts=None, basic_sli=None, calendar_period=None, display_name=None, goal=None, project=None, request_based_sli=None, rolling_period_days=None, service=None, slo_id=None, windows_based_sli=None, __props__=None, __name__=None, __opts__=None):
        ...
        * How-to Guides
        ...
        if opts.id is None:
            ...
            __props__['basicSli'] = basic_sli
            __props__['calendarPeriod'] = calendar_period
            __props__['displayName'] = display_name
            if goal is None:
                raise TypeError("Missing required property 'goal'")
            __props__['goal'] = goal
            __props__['project'] = project
            __props__['requestBasedSli'] = request_based_sli
            __props__['rollingPeriodDays'] = rolling_period_days
            if service is None:
                raise TypeError("Missing required property 'service'")
            __props__['service'] = service
            __props__['sloId'] = slo_id
            __props__['windowsBasedSli'] = windows_based_sli
            __props__['name'] = None
