...
class GetNotificationChannelResult:
    ...
    def __init__(__self__, description=None, display_name=None, enabled=None, id=None, labels=None, name=None, project=None, sensitive_labels=None, type=None, user_labels=None, verification_status=None) -> None:
...
def get_notification_channel(display_name: Optional[str] = None, labels: Optional[Dict[str, str]] = None, project: Optional[str] = None, type: Optional[str] = None, user_labels: Optional[Dict[str, str]] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNotificationChannelResult:
    """
    ...
    * How-to Guides
    ...
    :param Dict[str, str] labels: Labels (corresponding to the
           NotificationChannelDescriptor schema) to filter the notification channels by.
    :param str project: The ID of the project in which the resource belongs.
           If it is not provided, the provider project is used.
    :param str type: The type of the notification channel.
    :param Dict[str, str] user_labels: User-provided key-value labels to filter by.
    """
    __args__ = dict()
