...
class NotificationChannel(pulumi.CustomResource):
    ...
    """
    sensitive_labels: pulumi.Output[Optional['outputs.NotificationChannelSensitiveLabels']] = pulumi.output_property("sensitiveLabels")
    """
    ...
    """
    verification_status: pulumi.Output[str] = pulumi.output_property("verificationStatus")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, description: Optional[pulumi.Input[str]] = None, display_name: Optional[pulumi.Input[str]] = None, enabled: Optional[pulumi.Input[bool]] = None, labels: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, project: Optional[pulumi.Input[str]] = None, sensitive_labels: Optional[pulumi.Input[pulumi.InputType['NotificationChannelSensitiveLabelsArgs']]] = None, type: Optional[pulumi.Input[str]] = None, user_labels: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        ...
        * How-to Guides
        ...
        :param pulumi.Input[Dict[str, pulumi.Input[str]]] labels: Configuration fields that define the channel and its behavior. The
               permissible and required labels are specified in the
               NotificationChannelDescriptor corresponding to the type field.
               Labels with sensitive data are obfuscated by the API and therefore the provider cannot
               determine if there are upstream changes to these fields. They can also be configured via
        ...
        :param pulumi.Input[Dict[str, pulumi.Input[str]]] user_labels: User-supplied key/value data that does not need to conform to the corresponding NotificationChannelDescriptor's schema, unlike the labels field. This field is intended to be used for organizing and identifying the NotificationChannel objects.The field can contain up to 64 entries. Each key and value is limited to 63 Unicode characters or 128 bytes, whichever is smaller. Labels and values can contain only lowercase letters, numerals, underscores, and dashes. Keys must begin with a letter.
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, description: Optional[pulumi.Input[str]] = None, display_name: Optional[pulumi.Input[str]] = None, enabled: Optional[pulumi.Input[bool]] = None, labels: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, name: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, sensitive_labels: Optional[pulumi.Input[pulumi.InputType['NotificationChannelSensitiveLabelsArgs']]] = None, type: Optional[pulumi.Input[str]] = None, user_labels: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, verification_status: Optional[pulumi.Input[str]] = None) -> 'NotificationChannel':
        """
