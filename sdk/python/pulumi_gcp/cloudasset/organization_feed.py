...
class OrganizationFeed(pulumi.CustomResource):
    ...
    """
    feed_output_config: pulumi.Output['outputs.OrganizationFeedFeedOutputConfig'] = pulumi.output_property("feedOutputConfig")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, asset_names: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, asset_types: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, billing_project: Optional[pulumi.Input[str]] = None, content_type: Optional[pulumi.Input[str]] = None, feed_id: Optional[pulumi.Input[str]] = None, feed_output_config: Optional[pulumi.Input[pulumi.InputType['OrganizationFeedFeedOutputConfigArgs']]] = None, org_id: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
