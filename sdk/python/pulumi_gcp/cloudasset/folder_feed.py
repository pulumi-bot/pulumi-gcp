...
class FolderFeed(pulumi.CustomResource):
    ...
    """
    billing_project: pulumi.Output[str] = pulumi.output_property("billingProject")
    """
    ...
    """
    feed_output_config: pulumi.Output['outputs.FolderFeedFeedOutputConfig'] = pulumi.output_property("feedOutputConfig")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, asset_names: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, asset_types: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, billing_project: Optional[pulumi.Input[str]] = None, content_type: Optional[pulumi.Input[str]] = None, feed_id: Optional[pulumi.Input[str]] = None, feed_output_config: Optional[pulumi.Input[pulumi.InputType['FolderFeedFeedOutputConfigArgs']]] = None, folder: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, asset_names: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, asset_types: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, billing_project: Optional[pulumi.Input[str]] = None, content_type: Optional[pulumi.Input[str]] = None, feed_id: Optional[pulumi.Input[str]] = None, feed_output_config: Optional[pulumi.Input[pulumi.InputType['FolderFeedFeedOutputConfigArgs']]] = None, folder: Optional[pulumi.Input[str]] = None, folder_id: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None) -> 'FolderFeed':
        """
