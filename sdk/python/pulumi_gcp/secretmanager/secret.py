...
class Secret(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, labels=None, project=None, replication=None, secret_id=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
