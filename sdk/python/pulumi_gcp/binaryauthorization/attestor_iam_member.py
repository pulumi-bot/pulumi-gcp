...
class AttestorIamMember(pulumi.CustomResource):
    ...
    """
    condition: pulumi.Output[Optional['outputs.AttestorIamMemberCondition']] = pulumi.output_property("condition")
