...
class AttestorAttestationAuthorityNoteArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "noteReference", note_reference)
        pulumi.set(__self__, "delegationServiceAccountEmail", delegation_service_account_email)
        pulumi.set(__self__, "publicKeys", public_keys)
...
class AttestorAttestationAuthorityNotePublicKeyArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "asciiArmoredPgpPublicKey", ascii_armored_pgp_public_key)
        pulumi.set(__self__, "comment", comment)
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "pkixPublicKey", pkix_public_key)
...
class AttestorAttestationAuthorityNotePublicKeyPkixPublicKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] signature_algorithm: The signature algorithm used to verify a message against
               ...
               public key).
        """
        pulumi.set(__self__, "publicKeyPem", public_key_pem)
        pulumi.set(__self__, "signatureAlgorithm", signature_algorithm)
...
class PolicyAdmissionWhitelistPatternArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name_pattern: An image name pattern to whitelist, in the form
               ...
               part.
        """
        pulumi.set(__self__, "namePattern", name_pattern)
...
class PolicyClusterAdmissionRuleArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "enforcementMode", enforcement_mode)
        pulumi.set(__self__, "evaluationMode", evaluation_mode)
        pulumi.set(__self__, "requireAttestationsBies", require_attestations_bies)
