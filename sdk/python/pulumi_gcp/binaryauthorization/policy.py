...
class Policy(pulumi.CustomResource):
    admission_whitelist_patterns: pulumi.Output[Optional[List['outputs.PolicyAdmissionWhitelistPattern']]] = pulumi.output_property("admissionWhitelistPatterns")
    """
    ...
    """
    cluster_admission_rules: pulumi.Output[Optional[List['outputs.PolicyClusterAdmissionRule']]] = pulumi.output_property("clusterAdmissionRules")
    """
    ...
    """
    default_admission_rule: pulumi.Output['outputs.PolicyDefaultAdmissionRule'] = pulumi.output_property("defaultAdmissionRule")
    """
    ...
    """
    global_policy_evaluation_mode: pulumi.Output[str] = pulumi.output_property("globalPolicyEvaluationMode")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, admission_whitelist_patterns: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['PolicyAdmissionWhitelistPatternArgs']]]]] = None, cluster_admission_rules: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['PolicyClusterAdmissionRuleArgs']]]]] = None, default_admission_rule: Optional[pulumi.Input[pulumi.InputType['PolicyDefaultAdmissionRuleArgs']]] = None, description: Optional[pulumi.Input[str]] = None, global_policy_evaluation_mode: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, admission_whitelist_patterns: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['PolicyAdmissionWhitelistPatternArgs']]]]] = None, cluster_admission_rules: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['PolicyClusterAdmissionRuleArgs']]]]] = None, default_admission_rule: Optional[pulumi.Input[pulumi.InputType['PolicyDefaultAdmissionRuleArgs']]] = None, description: Optional[pulumi.Input[str]] = None, global_policy_evaluation_mode: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None) -> 'Policy':
        """
