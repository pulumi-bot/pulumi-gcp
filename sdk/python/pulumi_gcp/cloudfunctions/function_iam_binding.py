...
class FunctionIamBinding(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, cloud_function=None, condition=None, members=None, project=None, region=None, role=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
