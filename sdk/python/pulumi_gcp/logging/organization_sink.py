...
class OrganizationSink(pulumi.CustomResource):
    bigquery_options: pulumi.Output['outputs.OrganizationSinkBigqueryOptions'] = pulumi.property("bigqueryOptions")
    """
    ...
    include_children: pulumi.Output[Optional[bool]] = pulumi.property("includeChildren")
    """
