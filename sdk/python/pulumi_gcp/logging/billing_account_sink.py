...
class BillingAccountSink(pulumi.CustomResource):
    bigquery_options: pulumi.Output['outputs.BillingAccountSinkBigqueryOptions'] = pulumi.output_property("bigqueryOptions")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, bigquery_options: Optional[pulumi.Input[pulumi.InputType['BillingAccountSinkBigqueryOptionsArgs']]] = None, billing_account: Optional[pulumi.Input[str]] = None, destination: Optional[pulumi.Input[str]] = None, filter: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, bigquery_options: Optional[pulumi.Input[pulumi.InputType['BillingAccountSinkBigqueryOptionsArgs']]] = None, billing_account: Optional[pulumi.Input[str]] = None, destination: Optional[pulumi.Input[str]] = None, filter: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, writer_identity: Optional[pulumi.Input[str]] = None) -> 'BillingAccountSink':
        """
