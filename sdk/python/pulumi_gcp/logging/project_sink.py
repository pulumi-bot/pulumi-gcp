...
class ProjectSink(pulumi.CustomResource):
    bigquery_options: pulumi.Output['outputs.ProjectSinkBigqueryOptions'] = pulumi.output_property("bigqueryOptions")
    """
    ...
    used.
    """
    unique_writer_identity: pulumi.Output[Optional[bool]] = pulumi.output_property("uniqueWriterIdentity")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, bigquery_options: Optional[pulumi.Input[pulumi.InputType['ProjectSinkBigqueryOptionsArgs']]] = None, destination: Optional[pulumi.Input[str]] = None, filter: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, unique_writer_identity: Optional[pulumi.Input[bool]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
