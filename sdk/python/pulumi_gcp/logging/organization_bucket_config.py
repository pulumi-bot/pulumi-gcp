...
class OrganizationBucketConfig(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, bucket_id=None, description=None, location=None, organization=None, retention_days=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
