...
class DatabaseInstance(pulumi.CustomResource):
    connection_name: pulumi.Output[str] = pulumi.output_property("connectionName")
    """
    The connection name of the instance to be used in
    connection strings. For example, when connecting with [Cloud SQL Proxy](https://cloud.google.com/sql/docs/mysql/connect-admin-proxy).
    """
    database_version: pulumi.Output[Optional[str]] = pulumi.output_property("databaseVersion")
    """
    ...
    """
    encryption_key_name: pulumi.Output[str] = pulumi.output_property("encryptionKeyName")
    """
    ...
    """
    first_ip_address: pulumi.Output[str] = pulumi.output_property("firstIpAddress")
    """
    The first IPv4 address of any type assigned.
    """
    ip_addresses: pulumi.Output[List['outputs.DatabaseInstanceIpAddress']] = pulumi.output_property("ipAddresses")
    master_instance_name: pulumi.Output[str] = pulumi.output_property("masterInstanceName")
    """
    ...
    """
    replica_configuration: pulumi.Output['outputs.DatabaseInstanceReplicaConfiguration'] = pulumi.output_property("replicaConfiguration")
    """
    The configuration for replication. The
    configuration is detailed below.
    """
    root_password: pulumi.Output[Optional[str]] = pulumi.output_property("rootPassword")
    """
    ...
    """
    server_ca_cert: pulumi.Output['outputs.DatabaseInstanceServerCaCert'] = pulumi.output_property("serverCaCert")
    service_account_email_address: pulumi.Output[str] = pulumi.output_property("serviceAccountEmailAddress")
    """
    The service account email address assigned to the
    instance.
    """
    settings: pulumi.Output['outputs.DatabaseInstanceSettings'] = pulumi.output_property("settings")
    """
    The settings to use for the database. The
    configuration is detailed below.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, database_version: Optional[pulumi.Input[str]] = None, encryption_key_name: Optional[pulumi.Input[str]] = None, master_instance_name: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, region: Optional[pulumi.Input[str]] = None, replica_configuration: Optional[pulumi.Input[pulumi.InputType['DatabaseInstanceReplicaConfigurationArgs']]] = None, root_password: Optional[pulumi.Input[str]] = None, settings: Optional[pulumi.Input[pulumi.InputType['DatabaseInstanceSettingsArgs']]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, connection_name: Optional[pulumi.Input[str]] = None, database_version: Optional[pulumi.Input[str]] = None, encryption_key_name: Optional[pulumi.Input[str]] = None, first_ip_address: Optional[pulumi.Input[str]] = None, ip_addresses: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['DatabaseInstanceIpAddressArgs']]]]] = None, master_instance_name: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, private_ip_address: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, public_ip_address: Optional[pulumi.Input[str]] = None, region: Optional[pulumi.Input[str]] = None, replica_configuration: Optional[pulumi.Input[pulumi.InputType['DatabaseInstanceReplicaConfigurationArgs']]] = None, root_password: Optional[pulumi.Input[str]] = None, self_link: Optional[pulumi.Input[str]] = None, server_ca_cert: Optional[pulumi.Input[pulumi.InputType['DatabaseInstanceServerCaCertArgs']]] = None, service_account_email_address: Optional[pulumi.Input[str]] = None, settings: Optional[pulumi.Input[pulumi.InputType['DatabaseInstanceSettingsArgs']]] = None) -> 'DatabaseInstance':
        """
