...
class GetDatabaseInstanceIpAddress(dict):
    ...
    time_to_retire: str = pulumi.output_property("timeToRetire")
...
class GetDatabaseInstanceReplicaConfiguration(dict):
    ca_certificate: str = pulumi.output_property("caCertificate")
    """
    ...
    """
    connect_retry_interval: float = pulumi.output_property("connectRetryInterval")
    """
    The number of seconds between connect retries.
    """
    dump_file_path: str = pulumi.output_property("dumpFilePath")
    """
    Path to a SQL file in GCS from which slave instances are created.
    """
    failover_target: bool = pulumi.output_property("failoverTarget")
    """
    Specifies if the replica is the failover target.
    """
    master_heartbeat_period: float = pulumi.output_property("masterHeartbeatPeriod")
    """
    ...
    Password for the replication connection.
    """
    ssl_cipher: str = pulumi.output_property("sslCipher")
    username: str = pulumi.output_property("username")
    """
    Username for replication connection.
    """
    verify_server_certificate: bool = pulumi.output_property("verifyServerCertificate")
    """
...
class GetDatabaseInstanceSetting(dict):
    activation_policy: str = pulumi.output_property("activationPolicy")
    """
    This specifies when the instance should be
    active. Can be either `ALWAYS`, `NEVER` or `ON_DEMAND`.
    """
    authorized_gae_applications: List[str] = pulumi.output_property("authorizedGaeApplications")
    """
    ...
    A list of Google App Engine (GAE) project names that are allowed to access this instance.
    """
    availability_type: str = pulumi.output_property("availabilityType")
    """
    The availability type of the Cloud SQL
    instance, high availability (`REGIONAL`) or single zone (`ZONAL`).
    """
    backup_configurations: List['outputs.GetDatabaseInstanceSettingBackupConfiguration'] = pulumi.output_property("backupConfigurations")
    crash_safe_replication: bool = pulumi.output_property("crashSafeReplication")
    """
    (Deprecated) This property is only applicable to First Generation instances.
    First Generation instances are now deprecated, see [here](https://cloud.google.com/sql/docs/mysql/upgrade-2nd-gen)
    """
    database_flags: List['outputs.GetDatabaseInstanceSettingDatabaseFlag'] = pulumi.output_property("databaseFlags")
    disk_autoresize: bool = pulumi.output_property("diskAutoresize")
    """
    Configuration to increase storage size automatically.
    """
    disk_size: float = pulumi.output_property("diskSize")
    """
    ...
    """
    ip_configurations: List['outputs.GetDatabaseInstanceSettingIpConfiguration'] = pulumi.output_property("ipConfigurations")
    location_preferences: List['outputs.GetDatabaseInstanceSettingLocationPreference'] = pulumi.output_property("locationPreferences")
    maintenance_windows: List['outputs.GetDatabaseInstanceSettingMaintenanceWindow'] = pulumi.output_property("maintenanceWindows")
    pricing_plan: str = pulumi.output_property("pricingPlan")
    """
    Pricing plan for this instance.
    """
    replication_type: str = pulumi.output_property("replicationType")
    """
    This property is only applicable to First Generation instances.
    First Generation instances are now deprecated, see [here](https://cloud.google.com/sql/docs/mysql/upgrade-2nd-gen)
    """
    ...
    """
    user_labels: Dict[str, str] = pulumi.output_property("userLabels")
    """
    A set of key/value user label pairs to assign to the instance.
    """
    version: float = pulumi.output_property("version")
...
class GetDatabaseInstanceSettingBackupConfiguration(dict):
    binary_log_enabled: bool = pulumi.output_property("binaryLogEnabled")
    """
...
class GetDatabaseInstanceSettingIpConfiguration(dict):
    authorized_networks: List['outputs.GetDatabaseInstanceSettingIpConfigurationAuthorizedNetwork'] = pulumi.output_property("authorizedNetworks")
    ipv4_enabled: bool = pulumi.output_property("ipv4Enabled")
    """
    Whether this Cloud SQL instance should be assigned a public IPV4 address.
    """
    private_network: str = pulumi.output_property("privateNetwork")
    """
    The VPC network from which the Cloud SQL instance is accessible for private IP.
    """
    require_ssl: bool = pulumi.output_property("requireSsl")
    """
...
class GetDatabaseInstanceSettingLocationPreference(dict):
    follow_gae_application: str = pulumi.output_property("followGaeApplication")
    """
...
class GetDatabaseInstanceSettingMaintenanceWindow(dict):
    ...
    Day of week (`1-7`), starting on Monday.
    """
    hour: float = pulumi.output_property("hour")
    """
    Hour of day (`0-23`), ignored if `day` not set.
    """
    update_track: str = pulumi.output_property("updateTrack")
    """
