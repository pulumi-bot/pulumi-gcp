...
class SslCert(pulumi.CustomResource):
    cert: pulumi.Output[str] = pulumi.output_property("cert")
    """
    The actual certificate data for this client certificate.
    """
    cert_serial_number: pulumi.Output[str] = pulumi.output_property("certSerialNumber")
    """
    The serial number extracted from the certificate data.
    """
    common_name: pulumi.Output[str] = pulumi.output_property("commonName")
    """
    ...
    """
    server_ca_cert: pulumi.Output[str] = pulumi.output_property("serverCaCert")
    """
    The CA cert of the server this client cert was generated from.
    """
    sha1_fingerprint: pulumi.Output[str] = pulumi.output_property("sha1Fingerprint")
    """
    The SHA1 Fingerprint of the certificate.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, common_name: Optional[pulumi.Input[str]] = None, instance: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, cert: Optional[pulumi.Input[str]] = None, cert_serial_number: Optional[pulumi.Input[str]] = None, common_name: Optional[pulumi.Input[str]] = None, create_time: Optional[pulumi.Input[str]] = None, expiration_time: Optional[pulumi.Input[str]] = None, instance: Optional[pulumi.Input[str]] = None, private_key: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, server_ca_cert: Optional[pulumi.Input[str]] = None, sha1_fingerprint: Optional[pulumi.Input[str]] = None) -> 'SslCert':
        """
