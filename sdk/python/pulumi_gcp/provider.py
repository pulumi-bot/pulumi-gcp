...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        if dns_beta_custom_endpoint is not None:
            pulumi.set(__self__, "dns_beta_custom_endpoint", dns_beta_custom_endpoint)
        ...
        if resource_manager_v2beta1_custom_endpoint is not None:
            pulumi.set(__self__, "resource_manager_v2beta1_custom_endpoint", resource_manager_v2beta1_custom_endpoint)
    ...
    def dns_beta_custom_endpoint(self) -> Optional[pulumi.Input[str]]:
        return pulumi.get(self, "dns_beta_custom_endpoint")

    @dns_beta_custom_endpoint.setter
    def dns_beta_custom_endpoint(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "dns_beta_custom_endpoint", value)
    ...
    def resource_manager_v2beta1_custom_endpoint(self) -> Optional[pulumi.Input[str]]:
        return pulumi.get(self, "resource_manager_v2beta1_custom_endpoint")

    @resource_manager_v2beta1_custom_endpoint.setter
    def resource_manager_v2beta1_custom_endpoint(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "resource_manager_v2beta1_custom_endpoint", value)
...
class Provider(pulumi.ProviderResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['dataproc_metastore_custom_endpoint'] = dataproc_metastore_custom_endpoint
