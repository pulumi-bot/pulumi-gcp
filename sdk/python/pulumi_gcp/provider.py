...
class Provider(pulumi.ProviderResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, access_context_manager_custom_endpoint: Optional[pulumi.Input[str]] = None, access_token: Optional[pulumi.Input[str]] = None, app_engine_custom_endpoint: Optional[pulumi.Input[str]] = None, artifact_registry_custom_endpoint: Optional[pulumi.Input[str]] = None, batching: Optional[pulumi.Input[pulumi.InputType['ProviderBatchingArgs']]] = None, big_query_custom_endpoint: Optional[pulumi.Input[str]] = None, bigquery_connection_custom_endpoint: Optional[pulumi.Input[str]] = None, bigquery_data_transfer_custom_endpoint: Optional[pulumi.Input[str]] = None, bigquery_reservation_custom_endpoint: Optional[pulumi.Input[str]] = None, bigtable_custom_endpoint: Optional[pulumi.Input[str]] = None, billing_custom_endpoint: Optional[pulumi.Input[str]] = None, binary_authorization_custom_endpoint: Optional[pulumi.Input[str]] = None, cloud_asset_custom_endpoint: Optional[pulumi.Input[str]] = None, cloud_billing_custom_endpoint: Optional[pulumi.Input[str]] = None, cloud_build_custom_endpoint: Optional[pulumi.Input[str]] = None, cloud_functions_custom_endpoint: Optional[pulumi.Input[str]] = None, cloud_identity_custom_endpoint: Optional[pulumi.Input[str]] = None, cloud_iot_custom_endpoint: Optional[pulumi.Input[str]] = None, cloud_run_custom_endpoint: Optional[pulumi.Input[str]] = None, cloud_scheduler_custom_endpoint: Optional[pulumi.Input[str]] = None, cloud_tasks_custom_endpoint: Optional[pulumi.Input[str]] = None, composer_custom_endpoint: Optional[pulumi.Input[str]] = None, compute_beta_custom_endpoint: Optional[pulumi.Input[str]] = None, compute_custom_endpoint: Optional[pulumi.Input[str]] = None, container_analysis_custom_endpoint: Optional[pulumi.Input[str]] = None, container_beta_custom_endpoint: Optional[pulumi.Input[str]] = None, container_custom_endpoint: Optional[pulumi.Input[str]] = None, credentials: Optional[pulumi.Input[str]] = None, data_catalog_custom_endpoint: Optional[pulumi.Input[str]] = None, data_fusion_custom_endpoint: Optional[pulumi.Input[str]] = None, dataflow_custom_endpoint: Optional[pulumi.Input[str]] = None, dataproc_beta_custom_endpoint: Optional[pulumi.Input[str]] = None, dataproc_custom_endpoint: Optional[pulumi.Input[str]] = None, datastore_custom_endpoint: Optional[pulumi.Input[str]] = None, deployment_manager_custom_endpoint: Optional[pulumi.Input[str]] = None, dialogflow_custom_endpoint: Optional[pulumi.Input[str]] = None, dns_beta_custom_endpoint: Optional[pulumi.Input[str]] = None, dns_custom_endpoint: Optional[pulumi.Input[str]] = None, filestore_custom_endpoint: Optional[pulumi.Input[str]] = None, firebase_custom_endpoint: Optional[pulumi.Input[str]] = None, firestore_custom_endpoint: Optional[pulumi.Input[str]] = None, game_services_custom_endpoint: Optional[pulumi.Input[str]] = None, healthcare_custom_endpoint: Optional[pulumi.Input[str]] = None, iam_credentials_custom_endpoint: Optional[pulumi.Input[str]] = None, iam_custom_endpoint: Optional[pulumi.Input[str]] = None, iap_custom_endpoint: Optional[pulumi.Input[str]] = None, identity_platform_custom_endpoint: Optional[pulumi.Input[str]] = None, kms_custom_endpoint: Optional[pulumi.Input[str]] = None, logging_custom_endpoint: Optional[pulumi.Input[str]] = None, memcache_custom_endpoint: Optional[pulumi.Input[str]] = None, ml_engine_custom_endpoint: Optional[pulumi.Input[str]] = None, monitoring_custom_endpoint: Optional[pulumi.Input[str]] = None, network_management_custom_endpoint: Optional[pulumi.Input[str]] = None, notebooks_custom_endpoint: Optional[pulumi.Input[str]] = None, os_config_custom_endpoint: Optional[pulumi.Input[str]] = None, os_login_custom_endpoint: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, pubsub_custom_endpoint: Optional[pulumi.Input[str]] = None, redis_custom_endpoint: Optional[pulumi.Input[str]] = None, region: Optional[pulumi.Input[str]] = None, request_timeout: Optional[pulumi.Input[str]] = None, resource_manager_custom_endpoint: Optional[pulumi.Input[str]] = None, resource_manager_v2beta1_custom_endpoint: Optional[pulumi.Input[str]] = None, runtime_config_custom_endpoint: Optional[pulumi.Input[str]] = None, runtimeconfig_custom_endpoint: Optional[pulumi.Input[str]] = None, scopes: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, secret_manager_custom_endpoint: Optional[pulumi.Input[str]] = None, security_center_custom_endpoint: Optional[pulumi.Input[str]] = None, security_scanner_custom_endpoint: Optional[pulumi.Input[str]] = None, service_directory_custom_endpoint: Optional[pulumi.Input[str]] = None, service_management_custom_endpoint: Optional[pulumi.Input[str]] = None, service_networking_custom_endpoint: Optional[pulumi.Input[str]] = None, service_usage_custom_endpoint: Optional[pulumi.Input[str]] = None, source_repo_custom_endpoint: Optional[pulumi.Input[str]] = None, spanner_custom_endpoint: Optional[pulumi.Input[str]] = None, sql_custom_endpoint: Optional[pulumi.Input[str]] = None, storage_custom_endpoint: Optional[pulumi.Input[str]] = None, storage_transfer_custom_endpoint: Optional[pulumi.Input[str]] = None, tpu_custom_endpoint: Optional[pulumi.Input[str]] = None, user_project_override: Optional[pulumi.Input[bool]] = None, vpc_access_custom_endpoint: Optional[pulumi.Input[str]] = None, zone: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
