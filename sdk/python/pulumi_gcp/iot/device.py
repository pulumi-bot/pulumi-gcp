...
class Device(pulumi.CustomResource):
    blocked: pulumi.Output[Optional[bool]] = pulumi.output_property("blocked")
    """
    If a device is blocked, connections or requests from this device will fail.
    """
    config: pulumi.Output['outputs.DeviceConfig'] = pulumi.output_property("config")
    """
    The most recent device configuration, which is eventually sent from Cloud IoT Core to the device.
    """
    credentials: pulumi.Output[Optional[List['outputs.DeviceCredential']]] = pulumi.output_property("credentials")
    """
    The credentials used to authenticate this device.  Structure is documented below.
    """
    gateway_config: pulumi.Output[Optional['outputs.DeviceGatewayConfig']] = pulumi.output_property("gatewayConfig")
    """
    Gateway-related configuration and state.  Structure is documented below.
    """
    last_config_ack_time: pulumi.Output[str] = pulumi.output_property("lastConfigAckTime")
    """
    The last time a cloud-to-device config version acknowledgment was received from the device.
    """
    last_config_send_time: pulumi.Output[str] = pulumi.output_property("lastConfigSendTime")
    """
    The last time a cloud-to-device config version was sent to the device.
    """
    last_error_status: pulumi.Output['outputs.DeviceLastErrorStatus'] = pulumi.output_property("lastErrorStatus")
    """
    The error message of the most recent error, such as a failure to publish to Cloud Pub/Sub.
    """
    last_error_time: pulumi.Output[str] = pulumi.output_property("lastErrorTime")
    """
    The time the most recent error occurred, such as a failure to publish to Cloud Pub/Sub.
    """
    last_event_time: pulumi.Output[str] = pulumi.output_property("lastEventTime")
    """
    The last time a telemetry event was received.
    """
    last_heartbeat_time: pulumi.Output[str] = pulumi.output_property("lastHeartbeatTime")
    """
    The last time an MQTT PINGREQ was received.
    """
    last_state_time: pulumi.Output[str] = pulumi.output_property("lastStateTime")
    """
    ...
    """
    num_id: pulumi.Output[str] = pulumi.output_property("numId")
    """
    A server-defined unique numeric ID for the device. This is a more compact way to identify devices, and it is globally
    unique.
    """
    registry: pulumi.Output[str] = pulumi.output_property("registry")
    """
    The name of the device registry where this device should be created.
    """
    state: pulumi.Output['outputs.DeviceState'] = pulumi.output_property("state")
    """
    The state most recently received from the device.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, blocked: Optional[pulumi.Input[bool]] = None, credentials: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['DeviceCredentialArgs']]]]] = None, gateway_config: Optional[pulumi.Input[pulumi.InputType['DeviceGatewayConfigArgs']]] = None, log_level: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, name: Optional[pulumi.Input[str]] = None, registry: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        * How-to Guides
        ...
        :param pulumi.Input[Dict[str, pulumi.Input[str]]] metadata: The metadata key-value pairs assigned to the device.
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, blocked: Optional[pulumi.Input[bool]] = None, config: Optional[pulumi.Input[pulumi.InputType['DeviceConfigArgs']]] = None, credentials: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['DeviceCredentialArgs']]]]] = None, gateway_config: Optional[pulumi.Input[pulumi.InputType['DeviceGatewayConfigArgs']]] = None, last_config_ack_time: Optional[pulumi.Input[str]] = None, last_config_send_time: Optional[pulumi.Input[str]] = None, last_error_status: Optional[pulumi.Input[pulumi.InputType['DeviceLastErrorStatusArgs']]] = None, last_error_time: Optional[pulumi.Input[str]] = None, last_event_time: Optional[pulumi.Input[str]] = None, last_heartbeat_time: Optional[pulumi.Input[str]] = None, last_state_time: Optional[pulumi.Input[str]] = None, log_level: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, name: Optional[pulumi.Input[str]] = None, num_id: Optional[pulumi.Input[str]] = None, registry: Optional[pulumi.Input[str]] = None, state: Optional[pulumi.Input[pulumi.InputType['DeviceStateArgs']]] = None) -> 'Device':
        """
