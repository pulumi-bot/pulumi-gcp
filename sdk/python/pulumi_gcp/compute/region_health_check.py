...
class RegionHealthCheck(pulumi.CustomResource):
    ...
    """
    http2_health_check: pulumi.Output[Optional['outputs.RegionHealthCheckHttp2HealthCheck']] = pulumi.output_property("http2HealthCheck")
    """
    A nested object resource  Structure is documented below.
    """
    http_health_check: pulumi.Output[Optional['outputs.RegionHealthCheckHttpHealthCheck']] = pulumi.output_property("httpHealthCheck")
    """
    A nested object resource  Structure is documented below.
    """
    https_health_check: pulumi.Output[Optional['outputs.RegionHealthCheckHttpsHealthCheck']] = pulumi.output_property("httpsHealthCheck")
    """
    A nested object resource  Structure is documented below.
    """
    log_config: pulumi.Output[Optional['outputs.RegionHealthCheckLogConfig']] = pulumi.output_property("logConfig")
    """
    ...
    """
    ssl_health_check: pulumi.Output[Optional['outputs.RegionHealthCheckSslHealthCheck']] = pulumi.output_property("sslHealthCheck")
    """
    A nested object resource  Structure is documented below.
    """
    tcp_health_check: pulumi.Output[Optional['outputs.RegionHealthCheckTcpHealthCheck']] = pulumi.output_property("tcpHealthCheck")
    """
    A nested object resource  Structure is documented below.
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, check_interval_sec: Optional[pulumi.Input[float]] = None, description: Optional[pulumi.Input[str]] = None, healthy_threshold: Optional[pulumi.Input[float]] = None, http2_health_check: Optional[pulumi.Input[pulumi.InputType['RegionHealthCheckHttp2HealthCheckArgs']]] = None, http_health_check: Optional[pulumi.Input[pulumi.InputType['RegionHealthCheckHttpHealthCheckArgs']]] = None, https_health_check: Optional[pulumi.Input[pulumi.InputType['RegionHealthCheckHttpsHealthCheckArgs']]] = None, log_config: Optional[pulumi.Input[pulumi.InputType['RegionHealthCheckLogConfigArgs']]] = None, name: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, region: Optional[pulumi.Input[str]] = None, ssl_health_check: Optional[pulumi.Input[pulumi.InputType['RegionHealthCheckSslHealthCheckArgs']]] = None, tcp_health_check: Optional[pulumi.Input[pulumi.InputType['RegionHealthCheckTcpHealthCheckArgs']]] = None, timeout_sec: Optional[pulumi.Input[float]] = None, unhealthy_threshold: Optional[pulumi.Input[float]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        * How-to Guides
        ...
        :param pulumi.Input[float] healthy_threshold: A so-far unhealthy instance will be marked healthy after this many
               consecutive successes. The default value is 2.
        :param pulumi.Input[pulumi.InputType['RegionHealthCheckHttp2HealthCheckArgs']] http2_health_check: A nested object resource  Structure is documented below.
        :param pulumi.Input[pulumi.InputType['RegionHealthCheckHttpHealthCheckArgs']] http_health_check: A nested object resource  Structure is documented below.
        :param pulumi.Input[pulumi.InputType['RegionHealthCheckHttpsHealthCheckArgs']] https_health_check: A nested object resource  Structure is documented below.
        ...
        :param pulumi.Input[str] region: The Region in which the created health check should reside.
               If it is not provided, the provider region is used.
        :param pulumi.Input[pulumi.InputType['RegionHealthCheckSslHealthCheckArgs']] ssl_health_check: A nested object resource  Structure is documented below.
        :param pulumi.Input[pulumi.InputType['RegionHealthCheckTcpHealthCheckArgs']] tcp_health_check: A nested object resource  Structure is documented below.
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, check_interval_sec: Optional[pulumi.Input[float]] = None, creation_timestamp: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, healthy_threshold: Optional[pulumi.Input[float]] = None, http2_health_check: Optional[pulumi.Input[pulumi.InputType['RegionHealthCheckHttp2HealthCheckArgs']]] = None, http_health_check: Optional[pulumi.Input[pulumi.InputType['RegionHealthCheckHttpHealthCheckArgs']]] = None, https_health_check: Optional[pulumi.Input[pulumi.InputType['RegionHealthCheckHttpsHealthCheckArgs']]] = None, log_config: Optional[pulumi.Input[pulumi.InputType['RegionHealthCheckLogConfigArgs']]] = None, name: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, region: Optional[pulumi.Input[str]] = None, self_link: Optional[pulumi.Input[str]] = None, ssl_health_check: Optional[pulumi.Input[pulumi.InputType['RegionHealthCheckSslHealthCheckArgs']]] = None, tcp_health_check: Optional[pulumi.Input[pulumi.InputType['RegionHealthCheckTcpHealthCheckArgs']]] = None, timeout_sec: Optional[pulumi.Input[float]] = None, type: Optional[pulumi.Input[str]] = None, unhealthy_threshold: Optional[pulumi.Input[float]] = None) -> 'RegionHealthCheck':
        """
