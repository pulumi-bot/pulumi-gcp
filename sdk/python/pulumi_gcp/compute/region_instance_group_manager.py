...
class RegionInstanceGroupManager(pulumi.CustomResource):
    auto_healing_policies: pulumi.Output[Optional['outputs.RegionInstanceGroupManagerAutoHealingPolicies']] = pulumi.output_property("autoHealingPolicies")
    """
    ...
    group manager.
    """
    distribution_policy_zones: pulumi.Output[List[str]] = pulumi.output_property("distributionPolicyZones")
    """
    ...
    - Version name.
    """
    named_ports: pulumi.Output[Optional[List['outputs.RegionInstanceGroupManagerNamedPort']]] = pulumi.output_property("namedPorts")
    """
    ...
    """
    stateful_disks: pulumi.Output[Optional[List['outputs.RegionInstanceGroupManagerStatefulDisk']]] = pulumi.output_property("statefulDisks")
    """
    ...
    """
    update_policy: pulumi.Output['outputs.RegionInstanceGroupManagerUpdatePolicy'] = pulumi.output_property("updatePolicy")
    """
    The update policy for this managed instance group. Structure is documented below. For more information, see the [official documentation](https://cloud.google.com/compute/docs/instance-groups/updating-managed-instance-groups) and [API](https://cloud.google.com/compute/docs/reference/rest/beta/regionInstanceGroupManagers/patch)
    """
    versions: pulumi.Output[List['outputs.RegionInstanceGroupManagerVersion']] = pulumi.output_property("versions")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, auto_healing_policies: Optional[pulumi.Input[pulumi.InputType['RegionInstanceGroupManagerAutoHealingPoliciesArgs']]] = None, base_instance_name: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, distribution_policy_zones: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, name: Optional[pulumi.Input[str]] = None, named_ports: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['RegionInstanceGroupManagerNamedPortArgs']]]]] = None, project: Optional[pulumi.Input[str]] = None, region: Optional[pulumi.Input[str]] = None, stateful_disks: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['RegionInstanceGroupManagerStatefulDiskArgs']]]]] = None, target_pools: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, target_size: Optional[pulumi.Input[float]] = None, update_policy: Optional[pulumi.Input[pulumi.InputType['RegionInstanceGroupManagerUpdatePolicyArgs']]] = None, versions: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['RegionInstanceGroupManagerVersionArgs']]]]] = None, wait_for_instances: Optional[pulumi.Input[bool]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, auto_healing_policies: Optional[pulumi.Input[pulumi.InputType['RegionInstanceGroupManagerAutoHealingPoliciesArgs']]] = None, base_instance_name: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, distribution_policy_zones: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, fingerprint: Optional[pulumi.Input[str]] = None, instance_group: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, named_ports: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['RegionInstanceGroupManagerNamedPortArgs']]]]] = None, project: Optional[pulumi.Input[str]] = None, region: Optional[pulumi.Input[str]] = None, self_link: Optional[pulumi.Input[str]] = None, stateful_disks: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['RegionInstanceGroupManagerStatefulDiskArgs']]]]] = None, target_pools: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, target_size: Optional[pulumi.Input[float]] = None, update_policy: Optional[pulumi.Input[pulumi.InputType['RegionInstanceGroupManagerUpdatePolicyArgs']]] = None, versions: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['RegionInstanceGroupManagerVersionArgs']]]]] = None, wait_for_instances: Optional[pulumi.Input[bool]] = None) -> 'RegionInstanceGroupManager':
        """
