...
@pulumi.output_type
class _GetSubnetworkResult(dict):
...
def get_subnetwork(name: Optional[str] = None,
    ...
    return AwaitableGetSubnetworkResult(
        ...
        gateway_address=_utilities.get_dict_value(__ret__, 'gatewayAddress'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        ip_cidr_range=_utilities.get_dict_value(__ret__, 'ipCidrRange'),
        name=_utilities.get_dict_value(__ret__, 'name'),
        network=_utilities.get_dict_value(__ret__, 'network'),
        private_ip_google_access=_utilities.get_dict_value(__ret__, 'privateIpGoogleAccess'),
        project=_utilities.get_dict_value(__ret__, 'project'),
        region=_utilities.get_dict_value(__ret__, 'region'),
        secondary_ip_ranges=_utilities.get_dict_value(__ret__, 'secondaryIpRanges'),
