...
class ExternalVpnGateway(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, description=None, interfaces=None, name=None, project=None, redundancy_type=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        * [API documentation](https://cloud.google.com/compute/docs/reference/rest/beta/externalVpnGateways)
        ...
        :param pulumi.Input[List[pulumi.Input['ExternalVpnGatewayInterfaceArgs']]] interfaces: A list of interfaces on this external VPN gateway.  Structure is documented below.
