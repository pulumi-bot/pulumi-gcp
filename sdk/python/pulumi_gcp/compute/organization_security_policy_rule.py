...
class OrganizationSecurityPolicyRule(pulumi.CustomResource):
    ...
    direction: pulumi.Output[Optional[str]] = pulumi.property("direction")
    """
    ...
    match: pulumi.Output['outputs.OrganizationSecurityPolicyRuleMatch'] = pulumi.property("match")
    """
    ...
    target_resources: pulumi.Output[Optional[List[str]]] = pulumi.property("targetResources")
    """
