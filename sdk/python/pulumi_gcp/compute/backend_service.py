...
class BackendService(pulumi.CustomResource):
    affinity_cookie_ttl_sec: pulumi.Output[Optional[float]] = pulumi.property("affinityCookieTtlSec")
    """
    ...
    backends: pulumi.Output[Optional[List['outputs.BackendServiceBackend']]] = pulumi.property("backends")
    """
    The set of backends that serve this BackendService.  Structure is documented below.
    """

    cdn_policy: pulumi.Output['outputs.BackendServiceCdnPolicy'] = pulumi.property("cdnPolicy")
    """
    Cloud CDN configuration for this BackendService.  Structure is documented below.
    """

    circuit_breakers: pulumi.Output[Optional['outputs.BackendServiceCircuitBreakers']] = pulumi.property("circuitBreakers")
    """
    ...
    connection_draining_timeout_sec: pulumi.Output[Optional[float]] = pulumi.property("connectionDrainingTimeoutSec")
    """
    Time for which instance will be drained (not accept new
    connections, but still work to finish started).
    """

    consistent_hash: pulumi.Output[Optional['outputs.BackendServiceConsistentHash']] = pulumi.property("consistentHash")
    """
    ...
    custom_request_headers: pulumi.Output[Optional[List[str]]] = pulumi.property("customRequestHeaders")
    """
    ...
    iap: pulumi.Output[Optional['outputs.BackendServiceIap']] = pulumi.property("iap")
    """
    ...
    locality_lb_policy: pulumi.Output[Optional[str]] = pulumi.property("localityLbPolicy")
    """
    ...
    log_config: pulumi.Output['outputs.BackendServiceLogConfig'] = pulumi.property("logConfig")
    """
    ...
    outlier_detection: pulumi.Output[Optional['outputs.BackendServiceOutlierDetection']] = pulumi.property("outlierDetection")
    """
    ...
    port_name: pulumi.Output[str] = pulumi.property("portName")
    """
    ...
    security_policy: pulumi.Output[Optional[str]] = pulumi.property("securityPolicy")
    """
    ...
    session_affinity: pulumi.Output[str] = pulumi.property("sessionAffinity")
    """
    Type of session affinity to use. The default is NONE. Session affinity is
    not applicable if the protocol is UDP.
    """

    timeout_sec: pulumi.Output[float] = pulumi.property("timeoutSec")
    """
