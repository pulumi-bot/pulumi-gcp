...
class PerInstanceConfig(pulumi.CustomResource):
    ...
    * NONE
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, instance_group_manager=None, minimal_action=None, most_disruptive_allowed_action=None, name=None, preserved_state=None, project=None, remove_instance_state_on_destroy=None, zone=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        * How-to Guides
        ...
        :param pulumi.Input['PerInstanceConfigPreservedStateArgs'] preserved_state: The preserved state for this instance.  Structure is documented below.
