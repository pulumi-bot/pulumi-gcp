...
class PerInstanceConfig(pulumi.CustomResource):
    instance_group_manager: pulumi.Output[str] = pulumi.property("instanceGroupManager")
    """
    ...
    * NONE
    ...
    preserved_state: pulumi.Output[Optional['outputs.PerInstanceConfigPreservedState']] = pulumi.property("preservedState")
    """
