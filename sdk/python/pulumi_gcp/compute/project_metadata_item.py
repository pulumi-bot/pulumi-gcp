...
class ProjectMetadataItem(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, key=None, project=None, value=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
