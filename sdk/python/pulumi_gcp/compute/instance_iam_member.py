...
class InstanceIAMMember(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, instance_name=None, member=None, project=None, role=None, zone=None, __props__=None, __name__=None, __opts__=None):
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, etag=None, instance_name=None, member=None, project=None, role=None, zone=None):
        """
