...
def get_network_endpoint_group(name=None, self_link=None, zone=None, opts=None):
    ...
    neg1 = gcp.compute.get_network_endpoint_group(gcp.compute.GetNetworkEndpointGroupArgsArgs(
        name="k8s1-abcdef01-myns-mysvc-8080-4b6bac43",
        zone="us-central1-a",
    ))
    neg2 = gcp.compute.get_network_endpoint_group(gcp.compute.GetNetworkEndpointGroupArgsArgs(
