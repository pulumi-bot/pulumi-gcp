...
@pulumi.output_type
class _GetLBIPRangesResult(dict):
...
def get_lbip_ranges(                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLBIPRangesResult:
    ...
    return AwaitableGetLBIPRangesResult(
        http_ssl_tcp_internals=_utilities.get_dict_value(__ret__, 'httpSslTcpInternals'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        networks=_utilities.get_dict_value(__ret__, 'networks'))
