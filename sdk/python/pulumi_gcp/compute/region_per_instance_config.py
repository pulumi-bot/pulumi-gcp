...
class RegionPerInstanceConfig(pulumi.CustomResource):
    minimal_action: pulumi.Output[Optional[str]] = pulumi.property("minimalAction")
    """
    ...
    * NONE
    ...
    most_disruptive_allowed_action: pulumi.Output[Optional[str]] = pulumi.property("mostDisruptiveAllowedAction")
    """
    ...
    * NONE
    ...
    preserved_state: pulumi.Output[Optional['outputs.RegionPerInstanceConfigPreservedState']] = pulumi.property("preservedState")
    """
    ...
    region_instance_group_manager: pulumi.Output[str] = pulumi.property("regionInstanceGroupManager")
    """
    The region instance group manager this instance config is part of.
    """

    remove_instance_state_on_destroy: pulumi.Output[Optional[bool]] = pulumi.property("removeInstanceStateOnDestroy")
    """
