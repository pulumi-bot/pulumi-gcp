...
class GetResourcePolicyResult:
    ...
    def __init__(__self__, description=None, id=None, name=None, project=None, region=None, self_link=None) -> None:
...
def get_resource_policy(name: Optional[str] = None, project: Optional[str] = None, region: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetResourcePolicyResult:
    """
