...
class RouterPeer(pulumi.CustomResource):
    advertise_mode: pulumi.Output[Optional[str]] = pulumi.property("advertiseMode")
    """
    User-specified flag to indicate which mode to use for advertisement.
    Valid values of this enum field are: `DEFAULT`, `CUSTOM`
    """

    advertised_groups: pulumi.Output[Optional[List[str]]] = pulumi.property("advertisedGroups")
    """
    ...
    * `ALL_PEER_VPC_SUBNETS`: Advertises peer subnets of the router's VPC network.
    ...
    advertised_ip_ranges: pulumi.Output[Optional[List['outputs.RouterPeerAdvertisedIpRange']]] = pulumi.property("advertisedIpRanges")
    """
    ...
    advertised_route_priority: pulumi.Output[Optional[float]] = pulumi.property("advertisedRoutePriority")
    """
    ...
    interface: pulumi.Output[str] = pulumi.property("interface")
    """
    ...
    management_type: pulumi.Output[str] = pulumi.property("managementType")
    """
    ...
    peer_asn: pulumi.Output[float] = pulumi.property("peerAsn")
    """
    Peer BGP Autonomous System Number (ASN).
    Each BGP interface may use a different value.
    """

    peer_ip_address: pulumi.Output[str] = pulumi.property("peerIpAddress")
    """
