...
class MangedSslCertificate(pulumi.CustomResource):
    ...
    """
    managed: pulumi.Output[Optional['outputs.MangedSslCertificateManaged']] = pulumi.output_property("managed")
    """
