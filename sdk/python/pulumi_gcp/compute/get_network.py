...
def get_network(name: Optional[str] = None,
    ...
    return AwaitableGetNetworkResult(
        ...
        gateway_ipv4=_utilities.get_dict_value(__ret__, 'gatewayIpv4'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        name=_utilities.get_dict_value(__ret__, 'name'),
        project=_utilities.get_dict_value(__ret__, 'project'),
        self_link=_utilities.get_dict_value(__ret__, 'selfLink'),
        subnetworks_self_links=_utilities.get_dict_value(__ret__, 'subnetworksSelfLinks'))
