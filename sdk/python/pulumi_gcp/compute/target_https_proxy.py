...
class TargetHttpsProxy(pulumi.CustomResource):
    ...
    """
    proxy_id: pulumi.Output[float] = pulumi.output_property("proxyId")
    """
    The unique identifier for the resource.
    """
    quic_override: pulumi.Output[Optional[str]] = pulumi.output_property("quicOverride")
    """
    ...
    """
    ssl_certificates: pulumi.Output[List[str]] = pulumi.output_property("sslCertificates")
    """
    A list of SslCertificate resources that are used to authenticate
    connections between users and the load balancer. At least one SSL
    certificate must be specified.
    """
    ssl_policy: pulumi.Output[Optional[str]] = pulumi.output_property("sslPolicy")
    """
    A reference to the SslPolicy resource that will be associated with
    the TargetHttpsProxy resource. If not set, the TargetHttpsProxy
    resource will not have any SSL policy configured.
    """
    url_map: pulumi.Output[str] = pulumi.output_property("urlMap")
    """
    A reference to the UrlMap resource that defines the mapping from URL
    to the BackendService.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, description: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, quic_override: Optional[pulumi.Input[str]] = None, ssl_certificates: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, ssl_policy: Optional[pulumi.Input[str]] = None, url_map: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, creation_timestamp: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, proxy_id: Optional[pulumi.Input[float]] = None, quic_override: Optional[pulumi.Input[str]] = None, self_link: Optional[pulumi.Input[str]] = None, ssl_certificates: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, ssl_policy: Optional[pulumi.Input[str]] = None, url_map: Optional[pulumi.Input[str]] = None) -> 'TargetHttpsProxy':
        """
