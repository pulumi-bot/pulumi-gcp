...
class InterconnectAttachment(pulumi.CustomResource):
    ...
    """
    bandwidth: pulumi.Output[str] = pulumi.output_property("bandwidth")
    """
    ...
    Defaults to BPS_10G
    """
    candidate_subnets: pulumi.Output[Optional[List[str]]] = pulumi.output_property("candidateSubnets")
    """
    ...
    """
    cloud_router_ip_address: pulumi.Output[str] = pulumi.output_property("cloudRouterIpAddress")
    """
    ...
    """
    customer_router_ip_address: pulumi.Output[str] = pulumi.output_property("customerRouterIpAddress")
    """
    ...
    """
    edge_availability_domain: pulumi.Output[str] = pulumi.output_property("edgeAvailabilityDomain")
    """
    ...
    """
    google_reference_id: pulumi.Output[str] = pulumi.output_property("googleReferenceId")
    """
    Google reference ID, to be used when raising support tickets with Google or otherwise to debug backend connectivity
    issues.
    """
    interconnect: pulumi.Output[Optional[str]] = pulumi.output_property("interconnect")
    """
    ...
    """
    pairing_key: pulumi.Output[str] = pulumi.output_property("pairingKey")
    """
    ...
    """
    partner_asn: pulumi.Output[str] = pulumi.output_property("partnerAsn")
    """
    ...
    """
    private_interconnect_info: pulumi.Output['outputs.InterconnectAttachmentPrivateInterconnectInfo'] = pulumi.output_property("privateInterconnectInfo")
    """
    ...
    DEDICATED.
    """
    vlan_tag8021q: pulumi.Output[float] = pulumi.output_property("vlanTag8021q")
    """
    The IEEE 802.1Q VLAN tag for this attachment, in the range 2-4094. When
    using PARTNER type this will be managed upstream.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, admin_enabled: Optional[pulumi.Input[bool]] = None, bandwidth: Optional[pulumi.Input[str]] = None, candidate_subnets: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, description: Optional[pulumi.Input[str]] = None, edge_availability_domain: Optional[pulumi.Input[str]] = None, interconnect: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, region: Optional[pulumi.Input[str]] = None, router: Optional[pulumi.Input[str]] = None, type: Optional[pulumi.Input[str]] = None, vlan_tag8021q: Optional[pulumi.Input[float]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, admin_enabled: Optional[pulumi.Input[bool]] = None, bandwidth: Optional[pulumi.Input[str]] = None, candidate_subnets: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, cloud_router_ip_address: Optional[pulumi.Input[str]] = None, creation_timestamp: Optional[pulumi.Input[str]] = None, customer_router_ip_address: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, edge_availability_domain: Optional[pulumi.Input[str]] = None, google_reference_id: Optional[pulumi.Input[str]] = None, interconnect: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, pairing_key: Optional[pulumi.Input[str]] = None, partner_asn: Optional[pulumi.Input[str]] = None, private_interconnect_info: Optional[pulumi.Input[pulumi.InputType['InterconnectAttachmentPrivateInterconnectInfoArgs']]] = None, project: Optional[pulumi.Input[str]] = None, region: Optional[pulumi.Input[str]] = None, router: Optional[pulumi.Input[str]] = None, self_link: Optional[pulumi.Input[str]] = None, state: Optional[pulumi.Input[str]] = None, type: Optional[pulumi.Input[str]] = None, vlan_tag8021q: Optional[pulumi.Input[float]] = None) -> 'InterconnectAttachment':
        """
