...
class InterconnectAttachment(pulumi.CustomResource):
    ...
    candidate_subnets: pulumi.Output[Optional[List[str]]] = pulumi.property("candidateSubnets")
    """
    ...
    cloud_router_ip_address: pulumi.Output[str] = pulumi.property("cloudRouterIpAddress")
    """
    ...
    customer_router_ip_address: pulumi.Output[str] = pulumi.property("customerRouterIpAddress")
    """
    ...
    edge_availability_domain: pulumi.Output[str] = pulumi.property("edgeAvailabilityDomain")
    """
    ...
    google_reference_id: pulumi.Output[str] = pulumi.property("googleReferenceId")
    """
    Google reference ID, to be used when raising support tickets with Google or otherwise to debug backend connectivity
    issues.
    """

    interconnect: pulumi.Output[Optional[str]] = pulumi.property("interconnect")
    """
    ...
    pairing_key: pulumi.Output[str] = pulumi.property("pairingKey")
    """
    ...
    partner_asn: pulumi.Output[str] = pulumi.property("partnerAsn")
    """
    ...
    private_interconnect_info: pulumi.Output['outputs.InterconnectAttachmentPrivateInterconnectInfo'] = pulumi.property("privateInterconnectInfo")
    """
    ...
    vlan_tag8021q: pulumi.Output[float] = pulumi.property("vlanTag8021q")
    """
