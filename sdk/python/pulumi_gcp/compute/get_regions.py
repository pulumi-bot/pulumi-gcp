...
class GetRegionsResult:
    ...
    def __init__(__self__, id=None, names=None, project=None, status=None) -> None:
...
def get_regions(project: Optional[str] = None, status: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRegionsResult:
    """
