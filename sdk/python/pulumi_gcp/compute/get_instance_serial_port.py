...
@pulumi.output_type
class _GetInstanceSerialPortResult(dict):
    contents: str = pulumi.property("contents")
...
def get_instance_serial_port(instance: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('gcp:compute/getInstanceSerialPort:getInstanceSerialPort', __args__, opts=opts, typ=_GetInstanceSerialPortResult).value

    return AwaitableGetInstanceSerialPortResult(
        contents=_utilities.get_dict_value(__ret__, 'contents'),
