...
def get_instance_serial_port(instance=None, port=None, project=None, zone=None, opts=None):
    ...
    serial = gcp.compute.get_instance_serial_port(gcp.compute.GetInstanceSerialPortArgsArgs(
    ...
    serial = pulumi.Output.all(windows.name, windows.zone).apply(lambda name, zone: gcp.compute.get_instance_serial_port(gcp.compute.GetInstanceSerialPortArgsArgs(
        instance=name,
        zone=zone,
        port=4,
    )))
