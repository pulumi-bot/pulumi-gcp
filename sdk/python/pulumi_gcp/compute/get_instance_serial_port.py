...
class GetInstanceSerialPortResult:
    ...
    def __init__(__self__, contents=None, id=None, instance=None, port=None, project=None, zone=None) -> None:
...
def get_instance_serial_port(instance: Optional[str] = None, port: Optional[float] = None, project: Optional[str] = None, zone: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetInstanceSerialPortResult:
    """
