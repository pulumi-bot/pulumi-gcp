...
class ForwardingRule(pulumi.CustomResource):
    ...
    * TargetVpnGateway: 500, 4500
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, all_ports=None, allow_global_access=None, backend_service=None, description=None, ip_address=None, ip_protocol=None, is_mirroring_collector=None, labels=None, load_balancing_scheme=None, name=None, network=None, network_tier=None, port_range=None, ports=None, project=None, region=None, service_label=None, subnetwork=None, target=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
