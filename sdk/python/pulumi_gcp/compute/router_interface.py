...
class RouterInterface(pulumi.CustomResource):
    interconnect_attachment: pulumi.Output[Optional[str]] = pulumi.output_property("interconnectAttachment")
    """
    ...
    specified.
    """
    ip_range: pulumi.Output[Optional[str]] = pulumi.output_property("ipRange")
    """
    ...
    """
    vpn_tunnel: pulumi.Output[Optional[str]] = pulumi.output_property("vpnTunnel")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, interconnect_attachment: Optional[pulumi.Input[str]] = None, ip_range: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, region: Optional[pulumi.Input[str]] = None, router: Optional[pulumi.Input[str]] = None, vpn_tunnel: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, interconnect_attachment: Optional[pulumi.Input[str]] = None, ip_range: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, region: Optional[pulumi.Input[str]] = None, router: Optional[pulumi.Input[str]] = None, vpn_tunnel: Optional[pulumi.Input[str]] = None) -> 'RouterInterface':
        """
