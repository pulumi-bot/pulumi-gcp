...
class RouterNat(pulumi.CustomResource):
    drain_nat_ips: pulumi.Output[Optional[List[str]]] = pulumi.property("drainNatIps")
    """
    A list of URLs of the IP resources to be drained. These IPs must be
    valid static external IPs that have been assigned to the NAT.
    """

    icmp_idle_timeout_sec: pulumi.Output[Optional[float]] = pulumi.property("icmpIdleTimeoutSec")
    """
    Timeout (in seconds) for ICMP connections. Defaults to 30s if not set.
    """

    log_config: pulumi.Output[Optional['outputs.RouterNatLogConfig']] = pulumi.property("logConfig")
    """
    Configuration for logging on NAT  Structure is documented below.
    """

    min_ports_per_vm: pulumi.Output[Optional[float]] = pulumi.property("minPortsPerVm")
    """
    ...
    nat_ip_allocate_option: pulumi.Output[str] = pulumi.property("natIpAllocateOption")
    """
    ...
    nat_ips: pulumi.Output[Optional[List[str]]] = pulumi.property("natIps")
    """
    ...
    source_subnetwork_ip_ranges_to_nat: pulumi.Output[str] = pulumi.property("sourceSubnetworkIpRangesToNat")
    """
    ...
    subnetworks: pulumi.Output[Optional[List['outputs.RouterNatSubnetwork']]] = pulumi.property("subnetworks")
    """
    One or more subnetwork NAT configurations. Only used if
    `source_subnetwork_ip_ranges_to_nat` is set to `LIST_OF_SUBNETWORKS`  Structure is documented below.
    """

    tcp_established_idle_timeout_sec: pulumi.Output[Optional[float]] = pulumi.property("tcpEstablishedIdleTimeoutSec")
    """
    Timeout (in seconds) for TCP established connections.
    Defaults to 1200s if not set.
    """

    tcp_transitory_idle_timeout_sec: pulumi.Output[Optional[float]] = pulumi.property("tcpTransitoryIdleTimeoutSec")
    """
    Timeout (in seconds) for TCP transitory connections.
    Defaults to 30s if not set.
    """

    udp_idle_timeout_sec: pulumi.Output[Optional[float]] = pulumi.property("udpIdleTimeoutSec")
    """
