...
class SSLPolicy(pulumi.CustomResource):
    ...
    custom_features: pulumi.Output[Optional[List[str]]] = pulumi.property("customFeatures")
    """
    ...
    *must not* be present when using any other profile.
    ...
    enabled_features: pulumi.Output[List[str]] = pulumi.property("enabledFeatures")
    """
    ...
    min_tls_version: pulumi.Output[Optional[str]] = pulumi.property("minTlsVersion")
    """
    ...
    profile: pulumi.Output[Optional[str]] = pulumi.property("profile")
    """
    Profile specifies the set of SSL features that can be used by the
