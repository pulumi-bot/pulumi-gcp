...
class SSLPolicy(pulumi.CustomResource):
    ...
    *must not* be present when using any other profile.
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, custom_features=None, description=None, min_tls_version=None, name=None, profile=None, project=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
