...
class GlobalAddress(pulumi.CustomResource):
    ...
    * VPC_PEERING - for peer networks
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, address=None, address_type=None, description=None, ip_version=None, labels=None, name=None, network=None, prefix_length=None, project=None, purpose=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
