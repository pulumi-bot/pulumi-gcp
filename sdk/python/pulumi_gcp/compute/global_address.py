...
class GlobalAddress(pulumi.CustomResource):
    address: pulumi.Output[str] = pulumi.output_property("address")
    """
    The IP address or beginning of the address range represented by this
    resource. This can be supplied as an input to reserve a specific
    address or omitted to allow GCP to choose a valid one for you.
    """
    address_type: pulumi.Output[Optional[str]] = pulumi.output_property("addressType")
    """
    ...
    * INTERNAL indicates internal IP ranges belonging to some network.
    ...
    """
    prefix_length: pulumi.Output[Optional[float]] = pulumi.output_property("prefixLength")
    """
    ...
    """
    purpose: pulumi.Output[Optional[str]] = pulumi.output_property("purpose")
    """
    ...
    * VPC_PEERING - for peer networks
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, address: Optional[pulumi.Input[str]] = None, address_type: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, ip_version: Optional[pulumi.Input[str]] = None, labels: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, name: Optional[pulumi.Input[str]] = None, network: Optional[pulumi.Input[str]] = None, prefix_length: Optional[pulumi.Input[float]] = None, project: Optional[pulumi.Input[str]] = None, purpose: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        * How-to Guides
        ...
        :param pulumi.Input[Dict[str, pulumi.Input[str]]] labels: Labels to apply to this address.  A list of key->value pairs.
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, address: Optional[pulumi.Input[str]] = None, address_type: Optional[pulumi.Input[str]] = None, creation_timestamp: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, ip_version: Optional[pulumi.Input[str]] = None, label_fingerprint: Optional[pulumi.Input[str]] = None, labels: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, name: Optional[pulumi.Input[str]] = None, network: Optional[pulumi.Input[str]] = None, prefix_length: Optional[pulumi.Input[float]] = None, project: Optional[pulumi.Input[str]] = None, purpose: Optional[pulumi.Input[str]] = None, self_link: Optional[pulumi.Input[str]] = None) -> 'GlobalAddress':
        """
