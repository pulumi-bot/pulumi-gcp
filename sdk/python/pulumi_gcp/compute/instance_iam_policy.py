...
class InstanceIAMPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, instance_name=None, policy_data=None, project=None, zone=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
