...
__all__ = ['SubnetworkIAMMember']


class SubnetworkIAMMember(pulumi.CustomResource):
    condition: pulumi.Output[Optional['outputs.SubnetworkIAMMemberCondition']] = pulumi.output_property("condition")
    """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, condition: Optional[pulumi.Input[pulumi.InputType['SubnetworkIAMMemberConditionArgs']]] = None, etag: Optional[pulumi.Input[str]] = None, member: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, region: Optional[pulumi.Input[str]] = None, role: Optional[pulumi.Input[str]] = None, subnetwork: Optional[pulumi.Input[str]] = None) -> 'SubnetworkIAMMember':
        """
