...
class RegionUrlMap(pulumi.CustomResource):
    ...
    default_url_redirect: pulumi.Output[Optional['outputs.RegionUrlMapDefaultUrlRedirect']] = pulumi.property("defaultUrlRedirect")
    """
    ...
    host_rules: pulumi.Output[Optional[List['outputs.RegionUrlMapHostRule']]] = pulumi.property("hostRules")
    """
    ...
    path_matchers: pulumi.Output[Optional[List['outputs.RegionUrlMapPathMatcher']]] = pulumi.property("pathMatchers")
    """
    ...
    tests: pulumi.Output[Optional[List['outputs.RegionUrlMapTest']]] = pulumi.property("tests")
    """
