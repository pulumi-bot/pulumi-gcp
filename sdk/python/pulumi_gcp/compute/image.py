...
class Image(pulumi.CustomResource):
    archive_size_bytes: pulumi.Output[float] = pulumi.property("archiveSizeBytes")
    """
    ...
    family: pulumi.Output[Optional[str]] = pulumi.property("family")
    """
    ...
    guest_os_features: pulumi.Output[List['outputs.ImageGuestOsFeature']] = pulumi.property("guestOsFeatures")
    """
    ...
    raw_disk: pulumi.Output[Optional['outputs.ImageRawDisk']] = pulumi.property("rawDisk")
    """
    ...
    source_disk: pulumi.Output[Optional[str]] = pulumi.property("sourceDisk")
    """
    ...
    source_image: pulumi.Output[Optional[str]] = pulumi.property("sourceImage")
    """
    ...
    source_snapshot: pulumi.Output[Optional[str]] = pulumi.property("sourceSnapshot")
    """
