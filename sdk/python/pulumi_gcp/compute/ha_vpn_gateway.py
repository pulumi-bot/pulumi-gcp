...
class HaVpnGateway(pulumi.CustomResource):
    ...
    """
    vpn_interfaces: pulumi.Output[List['outputs.HaVpnGatewayVpnInterface']] = pulumi.output_property("vpnInterfaces")
    """
