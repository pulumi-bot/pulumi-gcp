...
@pulumi.output_type
class _GetVPNGatewayResult(dict):
...
def get_vpn_gateway(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('gcp:compute/getVPNGateway:getVPNGateway', __args__, opts=opts, typ=_GetVPNGatewayResult).value
