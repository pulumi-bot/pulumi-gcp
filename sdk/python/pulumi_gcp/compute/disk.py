...
class Disk(pulumi.CustomResource):
    ...
    """
    disk_encryption_key: pulumi.Output[Optional['outputs.DiskDiskEncryptionKey']] = pulumi.output_property("diskEncryptionKey")
    """
    ...
    """
    image: pulumi.Output[Optional[str]] = pulumi.output_property("image")
    """
    ...
    """
    resource_policies: pulumi.Output[List[str]] = pulumi.output_property("resourcePolicies")
    """
    ...
    * `snapshot`
    """
    source_image_encryption_key: pulumi.Output[Optional['outputs.DiskSourceImageEncryptionKey']] = pulumi.output_property("sourceImageEncryptionKey")
    """
    The customer-supplied encryption key of the source image. Required if
    the source image is protected by a customer-supplied encryption key.  Structure is documented below.
    """
    source_image_id: pulumi.Output[str] = pulumi.output_property("sourceImageId")
    """
    ...
    """
    source_snapshot_encryption_key: pulumi.Output[Optional['outputs.DiskSourceSnapshotEncryptionKey']] = pulumi.output_property("sourceSnapshotEncryptionKey")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, description: Optional[pulumi.Input[str]] = None, disk_encryption_key: Optional[pulumi.Input[pulumi.InputType['DiskDiskEncryptionKeyArgs']]] = None, image: Optional[pulumi.Input[str]] = None, labels: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, name: Optional[pulumi.Input[str]] = None, physical_block_size_bytes: Optional[pulumi.Input[float]] = None, project: Optional[pulumi.Input[str]] = None, resource_policies: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, size: Optional[pulumi.Input[float]] = None, snapshot: Optional[pulumi.Input[str]] = None, source_image_encryption_key: Optional[pulumi.Input[pulumi.InputType['DiskSourceImageEncryptionKeyArgs']]] = None, source_snapshot_encryption_key: Optional[pulumi.Input[pulumi.InputType['DiskSourceSnapshotEncryptionKeyArgs']]] = None, type: Optional[pulumi.Input[str]] = None, zone: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, creation_timestamp: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, disk_encryption_key: Optional[pulumi.Input[pulumi.InputType['DiskDiskEncryptionKeyArgs']]] = None, image: Optional[pulumi.Input[str]] = None, label_fingerprint: Optional[pulumi.Input[str]] = None, labels: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, last_attach_timestamp: Optional[pulumi.Input[str]] = None, last_detach_timestamp: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, physical_block_size_bytes: Optional[pulumi.Input[float]] = None, project: Optional[pulumi.Input[str]] = None, resource_policies: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, self_link: Optional[pulumi.Input[str]] = None, size: Optional[pulumi.Input[float]] = None, snapshot: Optional[pulumi.Input[str]] = None, source_image_encryption_key: Optional[pulumi.Input[pulumi.InputType['DiskSourceImageEncryptionKeyArgs']]] = None, source_image_id: Optional[pulumi.Input[str]] = None, source_snapshot_encryption_key: Optional[pulumi.Input[pulumi.InputType['DiskSourceSnapshotEncryptionKeyArgs']]] = None, source_snapshot_id: Optional[pulumi.Input[str]] = None, type: Optional[pulumi.Input[str]] = None, users: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, zone: Optional[pulumi.Input[str]] = None) -> 'Disk':
        """
