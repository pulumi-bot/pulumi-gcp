...
class Disk(pulumi.CustomResource):
    ...
    * `snapshot`
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, description=None, disk_encryption_key=None, image=None, labels=None, name=None, physical_block_size_bytes=None, project=None, resource_policies=None, size=None, snapshot=None, source_image_encryption_key=None, source_snapshot_encryption_key=None, type=None, zone=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
