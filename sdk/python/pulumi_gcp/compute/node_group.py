...
class NodeGroup(pulumi.CustomResource):
    autoscaling_policy: pulumi.Output['outputs.NodeGroupAutoscalingPolicy'] = pulumi.property("autoscalingPolicy")
    """
    -
    ...
    node_template: pulumi.Output[str] = pulumi.property("nodeTemplate")
    """
