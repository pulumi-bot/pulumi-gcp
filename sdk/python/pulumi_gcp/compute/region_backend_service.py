...
class RegionBackendService(pulumi.CustomResource):
    ...
    backends: pulumi.Output[Optional[List['outputs.RegionBackendServiceBackend']]] = pulumi.property("backends")
    """
    The set of backends that serve this RegionBackendService.  Structure is documented below.
    """

    circuit_breakers: pulumi.Output[Optional['outputs.RegionBackendServiceCircuitBreakers']] = pulumi.property("circuitBreakers")
    """
    ...
    consistent_hash: pulumi.Output[Optional['outputs.RegionBackendServiceConsistentHash']] = pulumi.property("consistentHash")
    """
    ...
    failover_policy: pulumi.Output[Optional['outputs.RegionBackendServiceFailoverPolicy']] = pulumi.property("failoverPolicy")
    """
    ...
    health_checks: pulumi.Output[str] = pulumi.property("healthChecks")
    """
    ...
    log_config: pulumi.Output[Optional['outputs.RegionBackendServiceLogConfig']] = pulumi.property("logConfig")
    """
    ...
    outlier_detection: pulumi.Output[Optional['outputs.RegionBackendServiceOutlierDetection']] = pulumi.property("outlierDetection")
    """
