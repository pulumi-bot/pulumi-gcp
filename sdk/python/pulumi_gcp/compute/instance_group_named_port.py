...
class InstanceGroupNamedPort(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, group=None, name=None, port=None, project=None, zone=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
