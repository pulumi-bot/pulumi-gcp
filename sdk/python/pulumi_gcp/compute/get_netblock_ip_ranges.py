...
@pulumi.output_type
class _GetNetblockIPRangesResult(dict):
    cidr_blocks: List[str] = pulumi.property("cidrBlocks")
    cidr_blocks_ipv4s: List[str] = pulumi.property("cidrBlocksIpv4s")
    cidr_blocks_ipv6s: List[str] = pulumi.property("cidrBlocksIpv6s")
    id: str = pulumi.property("id")
    range_type: Optional[str] = pulumi.property("rangeType")
...
def get_netblock_ip_ranges(range_type: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('gcp:compute/getNetblockIPRanges:getNetblockIPRanges', __args__, opts=opts, typ=_GetNetblockIPRangesResult).value

    return AwaitableGetNetblockIPRangesResult(
        cidr_blocks=_utilities.get_dict_value(__ret__, 'cidrBlocks'),
        cidr_blocks_ipv4s=_utilities.get_dict_value(__ret__, 'cidrBlocksIpv4s'),
        cidr_blocks_ipv6s=_utilities.get_dict_value(__ret__, 'cidrBlocksIpv6s'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        range_type=_utilities.get_dict_value(__ret__, 'rangeType'))
