...
class Firewall(pulumi.CustomResource):
    allows: pulumi.Output[Optional[List['outputs.FirewallAllow']]] = pulumi.output_property("allows")
    """
    ...
    """
    denies: pulumi.Output[Optional[List['outputs.FirewallDeny']]] = pulumi.output_property("denies")
    """
    ...
    """
    destination_ranges: pulumi.Output[List[str]] = pulumi.output_property("destinationRanges")
    """
    ...
    """
    source_ranges: pulumi.Output[List[str]] = pulumi.output_property("sourceRanges")
    """
    ...
    """
    source_service_accounts: pulumi.Output[Optional[List[str]]] = pulumi.output_property("sourceServiceAccounts")
    """
    ...
    """
    source_tags: pulumi.Output[Optional[List[str]]] = pulumi.output_property("sourceTags")
    """
    ...
    """
    target_service_accounts: pulumi.Output[Optional[List[str]]] = pulumi.output_property("targetServiceAccounts")
    """
    ...
    network.
    """
    target_tags: pulumi.Output[Optional[List[str]]] = pulumi.output_property("targetTags")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, allows: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['FirewallAllowArgs']]]]] = None, denies: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['FirewallDenyArgs']]]]] = None, description: Optional[pulumi.Input[str]] = None, destination_ranges: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, direction: Optional[pulumi.Input[str]] = None, disabled: Optional[pulumi.Input[bool]] = None, enable_logging: Optional[pulumi.Input[bool]] = None, name: Optional[pulumi.Input[str]] = None, network: Optional[pulumi.Input[str]] = None, priority: Optional[pulumi.Input[float]] = None, project: Optional[pulumi.Input[str]] = None, source_ranges: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, source_service_accounts: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, source_tags: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, target_service_accounts: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, target_tags: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, allows: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['FirewallAllowArgs']]]]] = None, creation_timestamp: Optional[pulumi.Input[str]] = None, denies: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['FirewallDenyArgs']]]]] = None, description: Optional[pulumi.Input[str]] = None, destination_ranges: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, direction: Optional[pulumi.Input[str]] = None, disabled: Optional[pulumi.Input[bool]] = None, enable_logging: Optional[pulumi.Input[bool]] = None, name: Optional[pulumi.Input[str]] = None, network: Optional[pulumi.Input[str]] = None, priority: Optional[pulumi.Input[float]] = None, project: Optional[pulumi.Input[str]] = None, self_link: Optional[pulumi.Input[str]] = None, source_ranges: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, source_service_accounts: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, source_tags: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, target_service_accounts: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, target_tags: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None) -> 'Firewall':
        """
