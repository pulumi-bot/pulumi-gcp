...
class VPNTunnel(pulumi.CustomResource):
    ...
    """
    detailed_status: pulumi.Output[str] = pulumi.output_property("detailedStatus")
    """
    Detailed status message for the VPN tunnel.
    """
    ike_version: pulumi.Output[Optional[float]] = pulumi.output_property("ikeVersion")
    """
    ...
    """
    local_traffic_selectors: pulumi.Output[List[str]] = pulumi.output_property("localTrafficSelectors")
    """
    ...
    """
    peer_external_gateway: pulumi.Output[Optional[str]] = pulumi.output_property("peerExternalGateway")
    """
    URL of the peer side external VPN gateway to which this VPN tunnel is connected.
    """
    peer_external_gateway_interface: pulumi.Output[Optional[float]] = pulumi.output_property("peerExternalGatewayInterface")
    """
    The interface ID of the external VPN gateway to which this VPN tunnel is connected.
    """
    peer_gcp_gateway: pulumi.Output[Optional[str]] = pulumi.output_property("peerGcpGateway")
    """
    ...
    """
    peer_ip: pulumi.Output[str] = pulumi.output_property("peerIp")
    """
    ...
    """
    remote_traffic_selectors: pulumi.Output[List[str]] = pulumi.output_property("remoteTrafficSelectors")
    """
    ...
    Only IPv4 is supported.
    """
    router: pulumi.Output[Optional[str]] = pulumi.output_property("router")
    """
    ...
    """
    shared_secret: pulumi.Output[str] = pulumi.output_property("sharedSecret")
    """
    Shared secret used to set the secure session between the Cloud VPN
    gateway and the peer VPN gateway.  **Note**: This property is sensitive and will not be displayed in the plan.
    """
    shared_secret_hash: pulumi.Output[str] = pulumi.output_property("sharedSecretHash")
    """
    Hash of the shared secret.
    """
    target_vpn_gateway: pulumi.Output[Optional[str]] = pulumi.output_property("targetVpnGateway")
    """
    URL of the Target VPN gateway with which this VPN tunnel is
    associated.
    """
    tunnel_id: pulumi.Output[str] = pulumi.output_property("tunnelId")
    """
    The unique identifier for the resource. This identifier is defined by the server.
    """
    vpn_gateway: pulumi.Output[Optional[str]] = pulumi.output_property("vpnGateway")
    """
    URL of the VPN gateway with which this VPN tunnel is associated.
    This must be used if a High Availability VPN gateway resource is created.
    This field must reference a `compute.HaVpnGateway` resource.
    """
    vpn_gateway_interface: pulumi.Output[Optional[float]] = pulumi.output_property("vpnGatewayInterface")
    """
    The interface ID of the VPN gateway with which this VPN tunnel is associated.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, description: Optional[pulumi.Input[str]] = None, ike_version: Optional[pulumi.Input[float]] = None, labels: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, local_traffic_selectors: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, name: Optional[pulumi.Input[str]] = None, peer_external_gateway: Optional[pulumi.Input[str]] = None, peer_external_gateway_interface: Optional[pulumi.Input[float]] = None, peer_gcp_gateway: Optional[pulumi.Input[str]] = None, peer_ip: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, region: Optional[pulumi.Input[str]] = None, remote_traffic_selectors: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, router: Optional[pulumi.Input[str]] = None, shared_secret: Optional[pulumi.Input[str]] = None, target_vpn_gateway: Optional[pulumi.Input[str]] = None, vpn_gateway: Optional[pulumi.Input[str]] = None, vpn_gateway_interface: Optional[pulumi.Input[float]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        VPN tunnel resource.
        ...
        * How-to Guides
        ...
        :param pulumi.Input[float] ike_version: IKE protocol version to use when establishing the VPN tunnel with
               peer VPN gateway.
               Acceptable IKE versions are 1 or 2. Default version is 2.
        :param pulumi.Input[Dict[str, pulumi.Input[str]]] labels: Labels to apply to this VpnTunnel.
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, creation_timestamp: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, detailed_status: Optional[pulumi.Input[str]] = None, ike_version: Optional[pulumi.Input[float]] = None, label_fingerprint: Optional[pulumi.Input[str]] = None, labels: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, local_traffic_selectors: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, name: Optional[pulumi.Input[str]] = None, peer_external_gateway: Optional[pulumi.Input[str]] = None, peer_external_gateway_interface: Optional[pulumi.Input[float]] = None, peer_gcp_gateway: Optional[pulumi.Input[str]] = None, peer_ip: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, region: Optional[pulumi.Input[str]] = None, remote_traffic_selectors: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, router: Optional[pulumi.Input[str]] = None, self_link: Optional[pulumi.Input[str]] = None, shared_secret: Optional[pulumi.Input[str]] = None, shared_secret_hash: Optional[pulumi.Input[str]] = None, target_vpn_gateway: Optional[pulumi.Input[str]] = None, tunnel_id: Optional[pulumi.Input[str]] = None, vpn_gateway: Optional[pulumi.Input[str]] = None, vpn_gateway_interface: Optional[pulumi.Input[float]] = None) -> 'VPNTunnel':
        """
