...
class Service(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, metadata=None, namespace=None, service_id=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
