...
class ManagedZone(pulumi.CustomResource):
    ...
    dnssec_config: pulumi.Output[Optional['outputs.ManagedZoneDnssecConfig']] = pulumi.property("dnssecConfig")
    """
    DNSSEC configuration  Structure is documented below.
    """

    forwarding_config: pulumi.Output[Optional['outputs.ManagedZoneForwardingConfig']] = pulumi.property("forwardingConfig")
    """
    ...
    peering_config: pulumi.Output[Optional['outputs.ManagedZonePeeringConfig']] = pulumi.property("peeringConfig")
    """
    The presence of this field indicates that DNS Peering is enabled for this
    zone. The value of this field contains the network to peer with.  Structure is documented below.
    """

    private_visibility_config: pulumi.Output[Optional['outputs.ManagedZonePrivateVisibilityConfig']] = pulumi.property("privateVisibilityConfig")
    """
    ...
    reverse_lookup: pulumi.Output[Optional[bool]] = pulumi.property("reverseLookup")
    """
    ...
    service_directory_config: pulumi.Output[Optional['outputs.ManagedZoneServiceDirectoryConfig']] = pulumi.property("serviceDirectoryConfig")
    """
    ...
    visibility: pulumi.Output[Optional[str]] = pulumi.property("visibility")
    """
