...
class TransferJob(pulumi.CustomResource):
    creation_time: pulumi.Output[str] = pulumi.output_property("creationTime")
    """
    When the Transfer Job was created.
    """
    deletion_time: pulumi.Output[str] = pulumi.output_property("deletionTime")
    """
    ...
    """
    last_modification_time: pulumi.Output[str] = pulumi.output_property("lastModificationTime")
    """
    ...
    """
    schedule: pulumi.Output['outputs.TransferJobSchedule'] = pulumi.output_property("schedule")
    """
    ...
    """
    transfer_spec: pulumi.Output['outputs.TransferJobTransferSpec'] = pulumi.output_property("transferSpec")
    """
    Transfer specification. Structure documented below.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, description: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, schedule: Optional[pulumi.Input[pulumi.InputType['TransferJobScheduleArgs']]] = None, status: Optional[pulumi.Input[str]] = None, transfer_spec: Optional[pulumi.Input[pulumi.InputType['TransferJobTransferSpecArgs']]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, creation_time: Optional[pulumi.Input[str]] = None, deletion_time: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, last_modification_time: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, schedule: Optional[pulumi.Input[pulumi.InputType['TransferJobScheduleArgs']]] = None, status: Optional[pulumi.Input[str]] = None, transfer_spec: Optional[pulumi.Input[pulumi.InputType['TransferJobTransferSpecArgs']]] = None) -> 'TransferJob':
        """
