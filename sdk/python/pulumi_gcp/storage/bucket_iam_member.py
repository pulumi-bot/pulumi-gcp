...
class BucketIAMMember(pulumi.CustomResource):
    ...
    """
    condition: pulumi.Output[Optional['outputs.BucketIAMMemberCondition']] = pulumi.output_property("condition")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, bucket=None, condition=None, member=None, role=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
