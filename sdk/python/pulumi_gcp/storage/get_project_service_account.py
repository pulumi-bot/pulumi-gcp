...
@pulumi.output_type
class _GetProjectServiceAccountResult(dict):
...
def get_project_service_account(project: Optional[str] = None,
    ...
    return AwaitableGetProjectServiceAccountResult(
        email_address=_utilities.get_dict_value(__ret__, 'emailAddress'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        project=_utilities.get_dict_value(__ret__, 'project'),
        user_project=_utilities.get_dict_value(__ret__, 'userProject'))
