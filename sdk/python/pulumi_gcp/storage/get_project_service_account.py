...
class GetProjectServiceAccountResult:
    ...
    def __init__(__self__, email_address=None, id=None, project=None, user_project=None) -> None:
...
def get_project_service_account(project: Optional[str] = None, user_project: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetProjectServiceAccountResult:
    """
