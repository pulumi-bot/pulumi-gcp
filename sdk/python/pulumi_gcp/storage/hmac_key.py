...
class HmacKey(pulumi.CustomResource):
    access_id: pulumi.Output[str] = pulumi.output_property("accessId")
    """
    ...
    """
    time_created: pulumi.Output[str] = pulumi.output_property("timeCreated")
    """
    'The creation time of the HMAC key in RFC 3339 format. '
    """
    updated: pulumi.Output[str] = pulumi.output_property("updated")
    """
    'The last modification time of the HMAC key metadata in RFC 3339 format.'
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, project: Optional[pulumi.Input[str]] = None, service_account_email: Optional[pulumi.Input[str]] = None, state: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, access_id: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, secret: Optional[pulumi.Input[str]] = None, service_account_email: Optional[pulumi.Input[str]] = None, state: Optional[pulumi.Input[str]] = None, time_created: Optional[pulumi.Input[str]] = None, updated: Optional[pulumi.Input[str]] = None) -> 'HmacKey':
        """
