...
def get_bucket_object(bucket: Optional[str] = None,
    ...
    return AwaitableGetBucketObjectResult(
        ...
        content=_utilities.get_dict_value(__ret__, 'content'),
        ...
        crc32c=_utilities.get_dict_value(__ret__, 'crc32c'),
        detect_md5hash=_utilities.get_dict_value(__ret__, 'detectMd5hash'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        md5hash=_utilities.get_dict_value(__ret__, 'md5hash'),
        media_link=_utilities.get_dict_value(__ret__, 'mediaLink'),
        metadata=_utilities.get_dict_value(__ret__, 'metadata'),
        name=_utilities.get_dict_value(__ret__, 'name'),
        output_name=_utilities.get_dict_value(__ret__, 'outputName'),
        self_link=_utilities.get_dict_value(__ret__, 'selfLink'),
        source=_utilities.get_dict_value(__ret__, 'source'),
