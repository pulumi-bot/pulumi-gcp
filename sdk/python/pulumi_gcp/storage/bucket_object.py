...
class BucketObject(pulumi.CustomResource):
    ...
    """
    cache_control: pulumi.Output[Optional[str]] = pulumi.output_property("cacheControl")
    """
    [Cache-Control](https://tools.ietf.org/html/rfc7234#section-5.2)
    directive to specify caching behavior of object data. If omitted and object is accessible to all anonymous users, the default will be public, max-age=3600
    """
    content: pulumi.Output[Optional[str]] = pulumi.output_property("content")
    """
    Data as `string` to be uploaded. Must be defined if `source` is not. **Note**: The `content` field is marked as sensitive.
    """
    content_disposition: pulumi.Output[Optional[str]] = pulumi.output_property("contentDisposition")
    """
    [Content-Disposition](https://tools.ietf.org/html/rfc6266) of the object data.
    """
    content_encoding: pulumi.Output[Optional[str]] = pulumi.output_property("contentEncoding")
    """
    [Content-Encoding](https://tools.ietf.org/html/rfc7231#section-3.1.2.2) of the object data.
    """
    content_language: pulumi.Output[Optional[str]] = pulumi.output_property("contentLanguage")
    """
    ...
    """
    crc32c: pulumi.Output[str] = pulumi.output_property("crc32c")
    """
    (Computed) Base 64 CRC32 hash of the uploaded data.
    """
    detect_md5hash: pulumi.Output[Optional[str]] = pulumi.output_property("detectMd5hash")
    md5hash: pulumi.Output[str] = pulumi.output_property("md5hash")
    """
    ...
    """
    output_name: pulumi.Output[str] = pulumi.output_property("outputName")
    """
    ...
    """
    source: pulumi.Output[Optional[Union[pulumi.Asset, pulumi.Archive]]] = pulumi.output_property("source")
    """
    A path to the data you want to upload. Must be defined
    if `content` is not.
    """
    storage_class: pulumi.Output[str] = pulumi.output_property("storageClass")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, bucket: Optional[pulumi.Input[str]] = None, cache_control: Optional[pulumi.Input[str]] = None, content: Optional[pulumi.Input[str]] = None, content_disposition: Optional[pulumi.Input[str]] = None, content_encoding: Optional[pulumi.Input[str]] = None, content_language: Optional[pulumi.Input[str]] = None, content_type: Optional[pulumi.Input[str]] = None, detect_md5hash: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, name: Optional[pulumi.Input[str]] = None, source: Optional[pulumi.Input[Union[pulumi.Asset, pulumi.Archive]]] = None, storage_class: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        :param pulumi.Input[Dict[str, pulumi.Input[str]]] metadata: User-provided metadata, in key/value pairs.
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, bucket: Optional[pulumi.Input[str]] = None, cache_control: Optional[pulumi.Input[str]] = None, content: Optional[pulumi.Input[str]] = None, content_disposition: Optional[pulumi.Input[str]] = None, content_encoding: Optional[pulumi.Input[str]] = None, content_language: Optional[pulumi.Input[str]] = None, content_type: Optional[pulumi.Input[str]] = None, crc32c: Optional[pulumi.Input[str]] = None, detect_md5hash: Optional[pulumi.Input[str]] = None, md5hash: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, name: Optional[pulumi.Input[str]] = None, output_name: Optional[pulumi.Input[str]] = None, self_link: Optional[pulumi.Input[str]] = None, source: Optional[pulumi.Input[Union[pulumi.Asset, pulumi.Archive]]] = None, storage_class: Optional[pulumi.Input[str]] = None) -> 'BucketObject':
        """
