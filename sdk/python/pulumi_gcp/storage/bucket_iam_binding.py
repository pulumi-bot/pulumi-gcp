...
class BucketIAMBinding(pulumi.CustomResource):
    ...
    """
    condition: pulumi.Output[Optional['outputs.BucketIAMBindingCondition']] = pulumi.output_property("condition")
    """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, bucket: Optional[pulumi.Input[str]] = None, condition: Optional[pulumi.Input[pulumi.InputType['BucketIAMBindingConditionArgs']]] = None, etag: Optional[pulumi.Input[str]] = None, members: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, role: Optional[pulumi.Input[str]] = None) -> 'BucketIAMBinding':
        """
