...
class GetTransferProjectServieAccountResult:
    ...
    def __init__(__self__, email=None, id=None, project=None) -> None:
...
def get_transfer_project_servie_account(project: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTransferProjectServieAccountResult:
    """
