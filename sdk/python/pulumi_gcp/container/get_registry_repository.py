...
class GetRegistryRepositoryResult:
    ...
    def __init__(__self__, id=None, project=None, region=None, repository_url=None) -> None:
...
def get_registry_repository(project: Optional[str] = None, region: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRegistryRepositoryResult:
    """
