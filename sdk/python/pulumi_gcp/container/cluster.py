...
class Cluster(pulumi.CustomResource):
    ...
    """
    default_snat_status: pulumi.Output['outputs.ClusterDefaultSnatStatus'] = pulumi.output_property("defaultSnatStatus")
    """
    )
