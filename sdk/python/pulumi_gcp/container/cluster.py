...
class Cluster(pulumi.CustomResource):
    addons_config: pulumi.Output['outputs.ClusterAddonsConfig'] = pulumi.property("addonsConfig")
    """
    The configuration for addons supported by GKE.
    Structure is documented below.
    """

    authenticator_groups_config: pulumi.Output['outputs.ClusterAuthenticatorGroupsConfig'] = pulumi.property("authenticatorGroupsConfig")
    """
    ...
    cluster_autoscaling: pulumi.Output['outputs.ClusterClusterAutoscaling'] = pulumi.property("clusterAutoscaling")
    """
    ...
    cluster_ipv4_cidr: pulumi.Output[str] = pulumi.property("clusterIpv4Cidr")
    """
    ...
    cluster_telemetry: pulumi.Output['outputs.ClusterClusterTelemetry'] = pulumi.property("clusterTelemetry")
    """
    ) Configuration for
    ...
    database_encryption: pulumi.Output['outputs.ClusterDatabaseEncryption'] = pulumi.property("databaseEncryption")
    """
    Structure is documented below.
    """

    default_max_pods_per_node: pulumi.Output[float] = pulumi.property("defaultMaxPodsPerNode")
    """
    ...
    default_snat_status: pulumi.Output['outputs.ClusterDefaultSnatStatus'] = pulumi.property("defaultSnatStatus")
    """
    )
    ...
    enable_binary_authorization: pulumi.Output[Optional[bool]] = pulumi.property("enableBinaryAuthorization")
    """
    Enable Binary Authorization for this cluster.
    If enabled, all container images will be validated by Google Binary Authorization.
    """

    enable_intranode_visibility: pulumi.Output[Optional[bool]] = pulumi.property("enableIntranodeVisibility")
    """
    Whether Intra-node visibility is enabled for this cluster. This makes same node pod to pod traffic visible for VPC network.
    """

    enable_kubernetes_alpha: pulumi.Output[Optional[bool]] = pulumi.property("enableKubernetesAlpha")
    """
    ...
    enable_legacy_abac: pulumi.Output[Optional[bool]] = pulumi.property("enableLegacyAbac")
    """
    ...
    enable_shielded_nodes: pulumi.Output[Optional[bool]] = pulumi.property("enableShieldedNodes")
    """
    Enable Shielded Nodes features on all nodes in this cluster.  Defaults to `false`.
    """

    enable_tpu: pulumi.Output[Optional[bool]] = pulumi.property("enableTpu")
    """
    ...
    initial_node_count: pulumi.Output[Optional[float]] = pulumi.property("initialNodeCount")
    """
    ...
    ip_allocation_policy: pulumi.Output[Optional['outputs.ClusterIpAllocationPolicy']] = pulumi.property("ipAllocationPolicy")
    """
    ...
    logging_service: pulumi.Output[str] = pulumi.property("loggingService")
    """
    ...
    maintenance_policy: pulumi.Output[Optional['outputs.ClusterMaintenancePolicy']] = pulumi.property("maintenancePolicy")
    """
    The maintenance policy to use for the cluster. Structure is
    documented below.
    """

    master_auth: pulumi.Output['outputs.ClusterMasterAuth'] = pulumi.property("masterAuth")
    """
    ...
    master_authorized_networks_config: pulumi.Output[Optional['outputs.ClusterMasterAuthorizedNetworksConfig']] = pulumi.property("masterAuthorizedNetworksConfig")
    """
    ...
    master_version: pulumi.Output[str] = pulumi.property("masterVersion")
    """
    ...
    min_master_version: pulumi.Output[Optional[str]] = pulumi.property("minMasterVersion")
    """
    ...
    monitoring_service: pulumi.Output[str] = pulumi.property("monitoringService")
    """
    ...
    network_policy: pulumi.Output['outputs.ClusterNetworkPolicy'] = pulumi.property("networkPolicy")
    """
    ...
    networking_mode: pulumi.Output[str] = pulumi.property("networkingMode")
    """
    ...
    node_config: pulumi.Output['outputs.ClusterNodeConfig'] = pulumi.property("nodeConfig")
    """
    ...
    node_pools: pulumi.Output[List['outputs.ClusterNodePool']] = pulumi.property("nodePools")
    """
    ...
    **Warning:** node pools defined inside a cluster can't be changed (or added/removed) after
    ...
    node_version: pulumi.Output[str] = pulumi.property("nodeVersion")
    """
    ...
    operation: pulumi.Output[str] = pulumi.property("operation")

    pod_security_policy_config: pulumi.Output[Optional['outputs.ClusterPodSecurityPolicyConfig']] = pulumi.property("podSecurityPolicyConfig")
    """
    Configuration for the
    ...
    private_cluster_config: pulumi.Output['outputs.ClusterPrivateClusterConfig'] = pulumi.property("privateClusterConfig")
    """
    ...
    release_channel: pulumi.Output['outputs.ClusterReleaseChannel'] = pulumi.property("releaseChannel")
    """
    ...
    remove_default_node_pool: pulumi.Output[Optional[bool]] = pulumi.property("removeDefaultNodePool")
    """
    ...
    resource_labels: pulumi.Output[Optional[Mapping[str, str]]] = pulumi.property("resourceLabels")
    """
    The GCE resource labels (a map of key/value pairs) to be applied to the cluster.
    """

    resource_usage_export_config: pulumi.Output[Optional['outputs.ClusterResourceUsageExportConfig']] = pulumi.property("resourceUsageExportConfig")
    """
    Configuration for the
    ...
    services_ipv4_cidr: pulumi.Output[str] = pulumi.property("servicesIpv4Cidr")
    """
    ...
    tpu_ipv4_cidr_block: pulumi.Output[str] = pulumi.property("tpuIpv4CidrBlock")
    """
    ...
    vertical_pod_autoscaling: pulumi.Output[Optional['outputs.ClusterVerticalPodAutoscaling']] = pulumi.property("verticalPodAutoscaling")
    """
    Vertical Pod Autoscaling automatically adjusts the resources of pods controlled by it.
    Structure is documented below.
    """

    workload_identity_config: pulumi.Output[Optional['outputs.ClusterWorkloadIdentityConfig']] = pulumi.property("workloadIdentityConfig")
    """
