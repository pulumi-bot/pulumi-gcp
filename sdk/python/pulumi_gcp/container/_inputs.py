...
class ClusterAddonsConfigArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "cloudrunConfig", cloudrun_config)
        pulumi.set(__self__, "configConnectorConfig", config_connector_config)
        pulumi.set(__self__, "dnsCacheConfig", dns_cache_config)
        pulumi.set(__self__, "gcePersistentDiskCsiDriverConfig", gce_persistent_disk_csi_driver_config)
        pulumi.set(__self__, "horizontalPodAutoscaling", horizontal_pod_autoscaling)
        pulumi.set(__self__, "httpLoadBalancing", http_load_balancing)
        pulumi.set(__self__, "istioConfig", istio_config)
        pulumi.set(__self__, "kalmConfig", kalm_config)
        pulumi.set(__self__, "networkPolicyConfig", network_policy_config)
...
class ClusterAuthenticatorGroupsConfigArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "securityGroup", security_group)
...
class ClusterClusterAutoscalingArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "enabled", enabled)
        pulumi.set(__self__, "autoProvisioningDefaults", auto_provisioning_defaults)
        pulumi.set(__self__, "autoscalingProfile", autoscaling_profile)
        pulumi.set(__self__, "resourceLimits", resource_limits)
...
class ClusterIpAllocationPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] services_secondary_range_name: The name of the existing
               ...
               GKE-managed one.
        """
        pulumi.set(__self__, "clusterIpv4CidrBlock", cluster_ipv4_cidr_block)
        pulumi.set(__self__, "clusterSecondaryRangeName", cluster_secondary_range_name)
        pulumi.set(__self__, "servicesIpv4CidrBlock", services_ipv4_cidr_block)
        pulumi.set(__self__, "servicesSecondaryRangeName", services_secondary_range_name)
...
class ClusterMaintenancePolicyArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "dailyMaintenanceWindow", daily_maintenance_window)
        pulumi.set(__self__, "recurringWindow", recurring_window)
...
class ClusterMasterAuthArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "clientCertificateConfig", client_certificate_config)
        pulumi.set(__self__, "clientKey", client_key)
        pulumi.set(__self__, "clusterCaCertificate", cluster_ca_certificate)
...
class ClusterMasterAuthClientCertificateConfigArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "issueClientCertificate", issue_client_certificate)
...
class ClusterNodeConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ClusterNodeConfigWorkloadMetadataConfigArgs'] workload_metadata_config: Metadata configuration to expose to workloads on the node pool.
               Structure is documented below.
        """
        pulumi.set(__self__, "bootDiskKmsKey", boot_disk_kms_key)
        ...
        pulumi.set(__self__, "imageType", image_type)
        pulumi.set(__self__, "labels", labels)
        pulumi.set(__self__, "localSsdCount", local_ssd_count)
        pulumi.set(__self__, "machineType", machine_type)
        pulumi.set(__self__, "metadata", metadata)
        pulumi.set(__self__, "minCpuPlatform", min_cpu_platform)
        pulumi.set(__self__, "oauthScopes", oauth_scopes)
        pulumi.set(__self__, "preemptible", preemptible)
        pulumi.set(__self__, "sandboxConfig", sandbox_config)
        pulumi.set(__self__, "serviceAccount", service_account)
        pulumi.set(__self__, "shieldedInstanceConfig", shielded_instance_config)
        pulumi.set(__self__, "tags", tags)
        pulumi.set(__self__, "taints", taints)
        pulumi.set(__self__, "workloadMetadataConfig", workload_metadata_config)
...
class ClusterNodeConfigSandboxConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] sandbox_type: Which sandbox to use for pods in the node pool.
               Accepted values are:
        """
        pulumi.set(__self__, "sandboxType", sandbox_type)
...
class ClusterNodeConfigWorkloadMetadataConfigArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "nodeMetadata", node_metadata)
...
class ClusterNodePoolArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "initialNodeCount", initial_node_count)
        pulumi.set(__self__, "instanceGroupUrls", instance_group_urls)
        pulumi.set(__self__, "management", management)
        pulumi.set(__self__, "maxPodsPerNode", max_pods_per_node)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "namePrefix", name_prefix)
        pulumi.set(__self__, "nodeConfig", node_config)
        pulumi.set(__self__, "nodeCount", node_count)
        pulumi.set(__self__, "nodeLocations", node_locations)
        pulumi.set(__self__, "upgradeSettings", upgrade_settings)
...
class ClusterNodePoolAutoscalingArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "maxNodeCount", max_node_count)
        pulumi.set(__self__, "minNodeCount", min_node_count)
...
class ClusterNodePoolManagementArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "autoRepair", auto_repair)
        pulumi.set(__self__, "autoUpgrade", auto_upgrade)
...
class ClusterNodePoolUpgradeSettingsArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "maxSurge", max_surge)
...
class ClusterPrivateClusterConfigArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "enablePrivateEndpoint", enable_private_endpoint)
        pulumi.set(__self__, "enablePrivateNodes", enable_private_nodes)
        pulumi.set(__self__, "masterGlobalAccessConfig", master_global_access_config)
        pulumi.set(__self__, "masterIpv4CidrBlock", master_ipv4_cidr_block)
        pulumi.set(__self__, "peeringName", peering_name)
        pulumi.set(__self__, "privateEndpoint", private_endpoint)
        pulumi.set(__self__, "publicEndpoint", public_endpoint)
...
class ClusterResourceUsageExportConfigArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "bigqueryDestination", bigquery_destination)
        pulumi.set(__self__, "enableNetworkEgressMetering", enable_network_egress_metering)
        pulumi.set(__self__, "enableResourceConsumptionMetering", enable_resource_consumption_metering)
...
class ClusterWorkloadIdentityConfigArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "identityNamespace", identity_namespace)
