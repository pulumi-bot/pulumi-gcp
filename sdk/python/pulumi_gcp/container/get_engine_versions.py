...
@pulumi.output_type
class _GetEngineVersionsResult(dict):
...
def get_engine_versions(location: Optional[str] = None,
    ...
    return AwaitableGetEngineVersionsResult(
        default_cluster_version=_utilities.get_dict_value(__ret__, 'defaultClusterVersion'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        latest_master_version=_utilities.get_dict_value(__ret__, 'latestMasterVersion'),
        latest_node_version=_utilities.get_dict_value(__ret__, 'latestNodeVersion'),
        location=_utilities.get_dict_value(__ret__, 'location'),
        project=_utilities.get_dict_value(__ret__, 'project'),
        release_channel_default_version=_utilities.get_dict_value(__ret__, 'releaseChannelDefaultVersion'),
        valid_master_versions=_utilities.get_dict_value(__ret__, 'validMasterVersions'),
        valid_node_versions=_utilities.get_dict_value(__ret__, 'validNodeVersions'),
        version_prefix=_utilities.get_dict_value(__ret__, 'versionPrefix'))
