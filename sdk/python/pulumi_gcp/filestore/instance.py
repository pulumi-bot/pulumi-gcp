...
class Instance(pulumi.CustomResource):
    ...
    file_shares: pulumi.Output['outputs.InstanceFileShares'] = pulumi.property("fileShares")
    """
    ...
    networks: pulumi.Output[List['outputs.InstanceNetwork']] = pulumi.property("networks")
    """
