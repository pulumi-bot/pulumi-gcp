...
class EntryBigqueryDateShardedSpecArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "shardCount", shard_count)
        pulumi.set(__self__, "tablePrefix", table_prefix)
...
class EntryBigqueryTableSpecArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "tableSourceType", table_source_type)
        pulumi.set(__self__, "tableSpec", table_spec)
        pulumi.set(__self__, "viewSpec", view_spec)
...
class EntryBigqueryTableSpecTableSpecArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "groupedEntry", grouped_entry)
...
class EntryBigqueryTableSpecViewSpecArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "viewQuery", view_query)
...
class EntryGcsFilesetSpecArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "filePatterns", file_patterns)
        pulumi.set(__self__, "sampleGcsFileSpecs", sample_gcs_file_specs)
...
class EntryGcsFilesetSpecSampleGcsFileSpecArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "filePath", file_path)
...
class TagFieldArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "fieldName", field_name)
        pulumi.set(__self__, "boolValue", bool_value)
        pulumi.set(__self__, "displayName", display_name)
        pulumi.set(__self__, "doubleValue", double_value)
        pulumi.set(__self__, "enumValue", enum_value)
        pulumi.set(__self__, "order", order)
        pulumi.set(__self__, "stringValue", string_value)
        pulumi.set(__self__, "timestampValue", timestamp_value)
...
class TagTemplateFieldArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "fieldId", field_id)
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "displayName", display_name)
        pulumi.set(__self__, "isRequired", is_required)
...
class TagTemplateFieldTypeArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "enumType", enum_type)
        pulumi.set(__self__, "primitiveType", primitive_type)
...
class TagTemplateFieldTypeEnumTypeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[List[pulumi.Input['TagTemplateFieldTypeEnumTypeAllowedValueArgs']]] allowed_values: The set of allowed values for this enum. The display names of the
               ...
               Structure is documented below.
        """
        pulumi.set(__self__, "allowedValues", allowed_values)
