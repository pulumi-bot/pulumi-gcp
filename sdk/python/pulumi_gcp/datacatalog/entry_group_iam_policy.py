...
class EntryGroupIamPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, entry_group=None, policy_data=None, project=None, region=None, __props__=None, __name__=None, __opts__=None):
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, entry_group=None, etag=None, policy_data=None, project=None, region=None):
        """
