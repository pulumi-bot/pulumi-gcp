...
class EntryGroupIamPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, entry_group=None, policy_data=None, project=None, region=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
