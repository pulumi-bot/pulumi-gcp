...
class Entry(pulumi.CustomResource):
    bigquery_date_sharded_spec: pulumi.Output['outputs.EntryBigqueryDateShardedSpec'] = pulumi.property("bigqueryDateShardedSpec")
    """
    Specification for a group of BigQuery tables with name pattern [prefix]YYYYMMDD. Context:
    https://cloud.google.com/bigquery/docs/partitioned-tables#partitioning_versus_sharding.
    """

    bigquery_table_spec: pulumi.Output['outputs.EntryBigqueryTableSpec'] = pulumi.property("bigqueryTableSpec")
    """
    ...
    entry_group: pulumi.Output[str] = pulumi.property("entryGroup")
    """
    The name of the entry group this entry is in.
    """

    entry_id: pulumi.Output[str] = pulumi.property("entryId")
    """
    The id of the entry to create.
    """

    gcs_fileset_spec: pulumi.Output[Optional['outputs.EntryGcsFilesetSpec']] = pulumi.property("gcsFilesetSpec")
    """
    Specification that applies to a Cloud Storage fileset. This is only valid on entries of type FILESET.
    Structure is documented below.
    """

    integrated_system: pulumi.Output[str] = pulumi.property("integratedSystem")
    """
    This field indicates the entry's source system that Data Catalog integrates with, such as BigQuery or Pub/Sub.
    """

    linked_resource: pulumi.Output[str] = pulumi.property("linkedResource")
    """
    ...
    user_specified_system: pulumi.Output[Optional[str]] = pulumi.property("userSpecifiedSystem")
    """
    ...
    user_specified_type: pulumi.Output[Optional[str]] = pulumi.property("userSpecifiedType")
    """
