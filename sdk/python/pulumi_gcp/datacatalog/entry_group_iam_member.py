...
class EntryGroupIamMember(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, condition=None, entry_group=None, member=None, project=None, region=None, role=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, condition=None, entry_group=None, etag=None, member=None, project=None, region=None, role=None):
        """
