...
class EntryGroupIamMember(pulumi.CustomResource):
    condition: pulumi.Output[Optional['outputs.EntryGroupIamMemberCondition']] = pulumi.property("condition")
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[str]] = None,
            region: Optional[pulumi.Input[str]] = None,
            role: Optional[pulumi.Input[str]] = None) -> 'EntryGroupIamMember':
        """
