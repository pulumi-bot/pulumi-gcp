...
class SshPublicKey(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, expiration_time_usec=None, key=None, user=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
