...
class AutoscalingPolicy(pulumi.CustomResource):
    basic_algorithm: pulumi.Output[Optional['outputs.AutoscalingPolicyBasicAlgorithm']] = pulumi.output_property("basicAlgorithm")
    """
    ...
    """
    secondary_worker_config: pulumi.Output[Optional['outputs.AutoscalingPolicySecondaryWorkerConfig']] = pulumi.output_property("secondaryWorkerConfig")
    """
    Describes how the autoscaler will operate for secondary workers.  Structure is documented below.
    """
    worker_config: pulumi.Output[Optional['outputs.AutoscalingPolicyWorkerConfig']] = pulumi.output_property("workerConfig")
    """
    Describes how the autoscaler will operate for primary workers.  Structure is documented below.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, basic_algorithm: Optional[pulumi.Input[pulumi.InputType['AutoscalingPolicyBasicAlgorithmArgs']]] = None, location: Optional[pulumi.Input[str]] = None, policy_id: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, secondary_worker_config: Optional[pulumi.Input[pulumi.InputType['AutoscalingPolicySecondaryWorkerConfigArgs']]] = None, worker_config: Optional[pulumi.Input[pulumi.InputType['AutoscalingPolicyWorkerConfigArgs']]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        :param pulumi.Input[pulumi.InputType['AutoscalingPolicyBasicAlgorithmArgs']] basic_algorithm: Basic algorithm for autoscaling.  Structure is documented below.
        ...
        :param pulumi.Input[str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[pulumi.InputType['AutoscalingPolicySecondaryWorkerConfigArgs']] secondary_worker_config: Describes how the autoscaler will operate for secondary workers.  Structure is documented below.
        :param pulumi.Input[pulumi.InputType['AutoscalingPolicyWorkerConfigArgs']] worker_config: Describes how the autoscaler will operate for primary workers.  Structure is documented below.
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, basic_algorithm: Optional[pulumi.Input[pulumi.InputType['AutoscalingPolicyBasicAlgorithmArgs']]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, policy_id: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, secondary_worker_config: Optional[pulumi.Input[pulumi.InputType['AutoscalingPolicySecondaryWorkerConfigArgs']]] = None, worker_config: Optional[pulumi.Input[pulumi.InputType['AutoscalingPolicyWorkerConfigArgs']]] = None) -> 'AutoscalingPolicy':
        """
