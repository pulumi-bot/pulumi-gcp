...
class AutoscalingPolicy(pulumi.CustomResource):
    basic_algorithm: pulumi.Output[Optional['outputs.AutoscalingPolicyBasicAlgorithm']] = pulumi.property("basicAlgorithm")
    """
    ...
    secondary_worker_config: pulumi.Output[Optional['outputs.AutoscalingPolicySecondaryWorkerConfig']] = pulumi.property("secondaryWorkerConfig")
    """
    Describes how the autoscaler will operate for secondary workers.  Structure is documented below.
    """

    worker_config: pulumi.Output[Optional['outputs.AutoscalingPolicyWorkerConfig']] = pulumi.property("workerConfig")
    """
