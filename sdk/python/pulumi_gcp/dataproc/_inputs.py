...
class AutoscalingPolicyBasicAlgorithmArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "yarnConfig", yarn_config)
...
class AutoscalingPolicyBasicAlgorithmYarnConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[float] scale_up_min_worker_fraction: Minimum scale-up threshold as a fraction of total cluster size before scaling
               ...
               Bounds: [0.0, 1.0]. Default: 0.0.
        """
        pulumi.set(__self__, "gracefulDecommissionTimeout", graceful_decommission_timeout)
        pulumi.set(__self__, "scaleDownFactor", scale_down_factor)
        pulumi.set(__self__, "scaleUpFactor", scale_up_factor)
        pulumi.set(__self__, "scaleDownMinWorkerFraction", scale_down_min_worker_fraction)
        pulumi.set(__self__, "scaleUpMinWorkerFraction", scale_up_min_worker_fraction)
...
class ClusterClusterConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ClusterClusterConfigWorkerConfigArgs'] worker_config: The Google Compute Engine config settings for the worker instances
               in a cluster.. Structure defined below.
        """
        pulumi.set(__self__, "autoscalingConfig", autoscaling_config)
        pulumi.set(__self__, "bucket", bucket)
        pulumi.set(__self__, "encryptionConfig", encryption_config)
        pulumi.set(__self__, "endpointConfig", endpoint_config)
        pulumi.set(__self__, "gceClusterConfig", gce_cluster_config)
        pulumi.set(__self__, "initializationActions", initialization_actions)
        pulumi.set(__self__, "lifecycleConfig", lifecycle_config)
        pulumi.set(__self__, "masterConfig", master_config)
        pulumi.set(__self__, "preemptibleWorkerConfig", preemptible_worker_config)
        pulumi.set(__self__, "securityConfig", security_config)
        pulumi.set(__self__, "softwareConfig", software_config)
        pulumi.set(__self__, "stagingBucket", staging_bucket)
        pulumi.set(__self__, "workerConfig", worker_config)
...
class ClusterClusterConfigAutoscalingConfigArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "policyUri", policy_uri)
...
class ClusterClusterConfigEndpointConfigArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "enableHttpPortAccess", enable_http_port_access)
        pulumi.set(__self__, "httpPorts", http_ports)
...
class ClusterClusterConfigGceClusterConfigArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "internalIpOnly", internal_ip_only)
        pulumi.set(__self__, "metadata", metadata)
        pulumi.set(__self__, "network", network)
        pulumi.set(__self__, "serviceAccount", service_account)
        pulumi.set(__self__, "serviceAccountScopes", service_account_scopes)
...
class ClusterClusterConfigInitializationActionArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "timeoutSec", timeout_sec)
...
class ClusterClusterConfigLifecycleConfigArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "autoDeleteTime", auto_delete_time)
        pulumi.set(__self__, "idleDeleteTtl", idle_delete_ttl)
        pulumi.set(__self__, "idleStartTime", idle_start_time)
...
class ClusterClusterConfigMasterConfigArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "diskConfig", disk_config)
        pulumi.set(__self__, "imageUri", image_uri)
        pulumi.set(__self__, "instanceNames", instance_names)
        pulumi.set(__self__, "machineType", machine_type)
        pulumi.set(__self__, "minCpuPlatform", min_cpu_platform)
        pulumi.set(__self__, "numInstances", num_instances)
...
class ClusterClusterConfigMasterConfigDiskConfigArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "bootDiskSizeGb", boot_disk_size_gb)
        pulumi.set(__self__, "bootDiskType", boot_disk_type)
        pulumi.set(__self__, "numLocalSsds", num_local_ssds)
...
class ClusterClusterConfigSecurityConfigArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "kerberosConfig", kerberos_config)
...
class ClusterClusterConfigSecurityConfigKerberosConfigArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "kmsKeyUri", kms_key_uri)
        pulumi.set(__self__, "rootPrincipalPasswordUri", root_principal_password_uri)
        pulumi.set(__self__, "crossRealmTrustAdminServer", cross_realm_trust_admin_server)
        pulumi.set(__self__, "crossRealmTrustKdc", cross_realm_trust_kdc)
        pulumi.set(__self__, "crossRealmTrustRealm", cross_realm_trust_realm)
        pulumi.set(__self__, "crossRealmTrustSharedPasswordUri", cross_realm_trust_shared_password_uri)
        pulumi.set(__self__, "enableKerberos", enable_kerberos)
        pulumi.set(__self__, "kdcDbKeyUri", kdc_db_key_uri)
        pulumi.set(__self__, "keyPasswordUri", key_password_uri)
        pulumi.set(__self__, "keystorePasswordUri", keystore_password_uri)
        pulumi.set(__self__, "keystoreUri", keystore_uri)
        pulumi.set(__self__, "realm", realm)
        pulumi.set(__self__, "tgtLifetimeHours", tgt_lifetime_hours)
        pulumi.set(__self__, "truststorePasswordUri", truststore_password_uri)
        pulumi.set(__self__, "truststoreUri", truststore_uri)
...
class ClusterClusterConfigSoftwareConfigArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "imageVersion", image_version)
        pulumi.set(__self__, "optionalComponents", optional_components)
        pulumi.set(__self__, "overrideProperties", override_properties)
...
class JobHadoopConfigArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "archiveUris", archive_uris)
        pulumi.set(__self__, "args", args)
        pulumi.set(__self__, "fileUris", file_uris)
        pulumi.set(__self__, "jarFileUris", jar_file_uris)
        pulumi.set(__self__, "loggingConfig", logging_config)
        pulumi.set(__self__, "mainClass", main_class)
        pulumi.set(__self__, "mainJarFileUri", main_jar_file_uri)
        pulumi.set(__self__, "properties", properties)
...
class JobHadoopConfigLoggingConfigArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "driverLogLevels", driver_log_levels)
...
class JobHiveConfigArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "continueOnFailure", continue_on_failure)
        pulumi.set(__self__, "jarFileUris", jar_file_uris)
        pulumi.set(__self__, "properties", properties)
        pulumi.set(__self__, "queryFileUri", query_file_uri)
        pulumi.set(__self__, "queryLists", query_lists)
        pulumi.set(__self__, "scriptVariables", script_variables)
...
class JobPlacementArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "clusterUuid", cluster_uuid)
...
class JobPysparkConfigArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "mainPythonFileUri", main_python_file_uri)
        pulumi.set(__self__, "archiveUris", archive_uris)
        pulumi.set(__self__, "args", args)
        pulumi.set(__self__, "fileUris", file_uris)
        pulumi.set(__self__, "jarFileUris", jar_file_uris)
        pulumi.set(__self__, "loggingConfig", logging_config)
        pulumi.set(__self__, "properties", properties)
        pulumi.set(__self__, "pythonFileUris", python_file_uris)
...
class JobReferenceArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "jobId", job_id)
...
class JobSchedulingArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "maxFailuresPerHour", max_failures_per_hour)
...
class JobStatusArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "stateStartTime", state_start_time)
