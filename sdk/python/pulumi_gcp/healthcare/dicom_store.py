...
class DicomStore(pulumi.CustomResource):
    ...
    ** Changing this property may recreate the Dicom store (removing all data) **
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, dataset=None, labels=None, name=None, notification_config=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        * How-to Guides
        ...
        :param pulumi.Input[str] name: The resource name for the DicomStore.
               ** Changing this property may recreate the Dicom store (removing all data) **
        :param pulumi.Input['DicomStoreNotificationConfigArgs'] notification_config: A nested object resource  Structure is documented below.
        """
