...
class FhirStoreIamBinding(pulumi.CustomResource):
    condition: pulumi.Output[Optional['outputs.FhirStoreIamBindingCondition']] = pulumi.output_property("condition")
    etag: pulumi.Output[str] = pulumi.output_property("etag")
    """
    (Computed) The etag of the FHIR store's IAM policy.
    """
    fhir_store_id: pulumi.Output[str] = pulumi.output_property("fhirStoreId")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, condition: Optional[pulumi.Input[pulumi.InputType['FhirStoreIamBindingConditionArgs']]] = None, fhir_store_id: Optional[pulumi.Input[str]] = None, members: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, role: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, condition: Optional[pulumi.Input[pulumi.InputType['FhirStoreIamBindingConditionArgs']]] = None, etag: Optional[pulumi.Input[str]] = None, fhir_store_id: Optional[pulumi.Input[str]] = None, members: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, role: Optional[pulumi.Input[str]] = None) -> 'FhirStoreIamBinding':
        """
