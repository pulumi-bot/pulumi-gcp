...
__all__ = ['Hl7StoreIamMember']


class Hl7StoreIamMember(pulumi.CustomResource):
    condition: pulumi.Output[Optional['outputs.Hl7StoreIamMemberCondition']] = pulumi.output_property("condition")
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, condition: Optional[pulumi.Input[pulumi.InputType['Hl7StoreIamMemberConditionArgs']]] = None, etag: Optional[pulumi.Input[str]] = None, hl7_v2_store_id: Optional[pulumi.Input[str]] = None, member: Optional[pulumi.Input[str]] = None, role: Optional[pulumi.Input[str]] = None) -> 'Hl7StoreIamMember':
        """
