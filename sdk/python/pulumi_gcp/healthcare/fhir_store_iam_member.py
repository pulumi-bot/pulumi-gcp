...
class FhirStoreIamMember(pulumi.CustomResource):
    condition: pulumi.Output[Optional['outputs.FhirStoreIamMemberCondition']] = pulumi.property("condition")
    ...
    fhir_store_id: pulumi.Output[str] = pulumi.property("fhirStoreId")
    """
