...
__all__ = ['FhirStoreIamMember']


class FhirStoreIamMember(pulumi.CustomResource):
    condition: pulumi.Output[Optional['outputs.FhirStoreIamMemberCondition']] = pulumi.output_property("condition")
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, condition: Optional[pulumi.Input[pulumi.InputType['FhirStoreIamMemberConditionArgs']]] = None, etag: Optional[pulumi.Input[str]] = None, fhir_store_id: Optional[pulumi.Input[str]] = None, member: Optional[pulumi.Input[str]] = None, role: Optional[pulumi.Input[str]] = None) -> 'FhirStoreIamMember':
        """
