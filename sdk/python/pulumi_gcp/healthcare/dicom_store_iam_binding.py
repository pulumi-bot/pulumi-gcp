...
__all__ = ['DicomStoreIamBinding']


class DicomStoreIamBinding(pulumi.CustomResource):
    condition: pulumi.Output[Optional['outputs.DicomStoreIamBindingCondition']] = pulumi.output_property("condition")
    dicom_store_id: pulumi.Output[str] = pulumi.output_property("dicomStoreId")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, condition: Optional[pulumi.Input[pulumi.InputType['DicomStoreIamBindingConditionArgs']]] = None, dicom_store_id: Optional[pulumi.Input[str]] = None, members: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, role: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, condition: Optional[pulumi.Input[pulumi.InputType['DicomStoreIamBindingConditionArgs']]] = None, dicom_store_id: Optional[pulumi.Input[str]] = None, etag: Optional[pulumi.Input[str]] = None, members: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, role: Optional[pulumi.Input[str]] = None) -> 'DicomStoreIamBinding':
        """
