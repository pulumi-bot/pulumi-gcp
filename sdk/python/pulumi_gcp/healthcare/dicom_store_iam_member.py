...
class DicomStoreIamMember(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, dicom_store_id=None, member=None, role=None, __props__=None, __name__=None, __opts__=None):
        """
        Create a DicomStoreIamMember resource with the given unique name, props, and options.
    ...
    @staticmethod
    def get(resource_name, id, opts=None, dicom_store_id=None, etag=None, member=None, role=None):
        """
