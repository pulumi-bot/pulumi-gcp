...
class FhirStoreStreamConfigBigqueryDestinationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['FhirStoreStreamConfigBigqueryDestinationSchemaConfigArgs'] schema_config: The configuration for the exported BigQuery schema.
               Structure is documented below.
        """
        pulumi.set(__self__, "datasetUri", dataset_uri)
        pulumi.set(__self__, "schemaConfig", schema_config)
...
class FhirStoreStreamConfigBigqueryDestinationSchemaConfigArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "recursiveStructureDepth", recursive_structure_depth)
        pulumi.set(__self__, "schemaType", schema_type)
...
class Hl7StoreParserConfigArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "allowNullHeader", allow_null_header)
        pulumi.set(__self__, "schema", schema)
        pulumi.set(__self__, "segmentTerminator", segment_terminator)
