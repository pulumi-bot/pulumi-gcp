...
class Hl7StoreIamBinding(pulumi.CustomResource):
    condition: pulumi.Output[Optional['outputs.Hl7StoreIamBindingCondition']] = pulumi.property("condition")
    ...
    hl7_v2_store_id: pulumi.Output[str] = pulumi.property("hl7V2StoreId")
    """
