...
class Hl7StoreIamBinding(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, hl7_v2_store_id=None, members=None, role=None, __props__=None, __name__=None, __opts__=None):
        """
        Create a Hl7StoreIamBinding resource with the given unique name, props, and options.
    ...
    @staticmethod
    def get(resource_name, id, opts=None, etag=None, hl7_v2_store_id=None, members=None, role=None):
        """
