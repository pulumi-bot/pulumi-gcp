...
class DicomStoreIamPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, dicom_store_id=None, policy_data=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
