...
class Hl7Store(pulumi.CustomResource):
    ...
    ** Changing this property may recreate the Hl7v2 store (removing all data) **
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, dataset=None, labels=None, name=None, notification_config=None, notification_configs=None, parser_config=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        * How-to Guides
        ...
        :param pulumi.Input['Hl7StoreNotificationConfigArgs'] notification_config: -
               (Optional, Deprecated)
               A nested object resource  Structure is documented below.
        :param pulumi.Input[List[pulumi.Input['Hl7StoreNotificationConfigsArgs']]] notification_configs: A list of notification configs. Each configuration uses a filter to determine whether to publish a
               message (both Ingest & Create) on the corresponding notification destination. Only the message name
               is sent as part of the notification. Supplied by the client.  Structure is documented below.
        :param pulumi.Input['Hl7StoreParserConfigArgs'] parser_config: A nested object resource  Structure is documented below.
        """
