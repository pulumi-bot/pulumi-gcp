...
class Budget(pulumi.CustomResource):
    all_updates_rule: pulumi.Output[Optional['outputs.BudgetAllUpdatesRule']] = pulumi.property("allUpdatesRule")
    """
    ...
    amount: pulumi.Output['outputs.BudgetAmount'] = pulumi.property("amount")
    """
    ...
    budget_filter: pulumi.Output[Optional['outputs.BudgetBudgetFilter']] = pulumi.property("budgetFilter")
    """
    ...
    threshold_rules: pulumi.Output[List['outputs.BudgetThresholdRule']] = pulumi.property("thresholdRules")
    """
