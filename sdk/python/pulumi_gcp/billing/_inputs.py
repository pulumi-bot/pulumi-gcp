...
class BudgetAllUpdatesRuleArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "monitoringNotificationChannels", monitoring_notification_channels)
        pulumi.set(__self__, "pubsubTopic", pubsub_topic)
        pulumi.set(__self__, "schemaVersion", schema_version)
...
class BudgetAmountArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "specifiedAmount", specified_amount)
...
class BudgetAmountSpecifiedAmountArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "currencyCode", currency_code)
...
class BudgetBudgetFilterArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "creditTypesTreatment", credit_types_treatment)
...
class BudgetThresholdRuleArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "thresholdPercent", threshold_percent)
        pulumi.set(__self__, "spendBasis", spend_basis)
