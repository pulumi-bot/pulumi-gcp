...
class AccountIamBinding(pulumi.CustomResource):
    billing_account_id: pulumi.Output[str] = pulumi.property("billingAccountId")
    """
    The billing account id.
    """

    condition: pulumi.Output[Optional['outputs.AccountIamBindingCondition']] = pulumi.property("condition")
