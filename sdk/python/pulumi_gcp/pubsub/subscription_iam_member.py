...
class SubscriptionIAMMember(pulumi.CustomResource):
    condition: pulumi.Output[Optional['outputs.SubscriptionIAMMemberCondition']] = pulumi.property("condition")
    ...
    subscription: pulumi.Output[str] = pulumi.property("subscription")
    """
