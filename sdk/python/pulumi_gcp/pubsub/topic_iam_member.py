...
class TopicIAMMember(pulumi.CustomResource):
    condition: pulumi.Output[Optional['outputs.TopicIAMMemberCondition']] = pulumi.output_property("condition")
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, condition: Optional[pulumi.Input[pulumi.InputType['TopicIAMMemberConditionArgs']]] = None, etag: Optional[pulumi.Input[str]] = None, member: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, role: Optional[pulumi.Input[str]] = None, topic: Optional[pulumi.Input[str]] = None) -> 'TopicIAMMember':
        """
