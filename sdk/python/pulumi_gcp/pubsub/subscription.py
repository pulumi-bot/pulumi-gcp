...
class Subscription(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, ack_deadline_seconds: Optional[pulumi.Input[float]] = None, dead_letter_policy: Optional[pulumi.Input[pulumi.InputType['SubscriptionDeadLetterPolicyArgs']]] = None, expiration_policy: Optional[pulumi.Input[pulumi.InputType['SubscriptionExpirationPolicyArgs']]] = None, labels: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, message_retention_duration: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, push_config: Optional[pulumi.Input[pulumi.InputType['SubscriptionPushConfigArgs']]] = None, retain_acked_messages: Optional[pulumi.Input[bool]] = None, topic: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, ack_deadline_seconds: Optional[pulumi.Input[float]] = None, dead_letter_policy: Optional[pulumi.Input[pulumi.InputType['SubscriptionDeadLetterPolicyArgs']]] = None, expiration_policy: Optional[pulumi.Input[pulumi.InputType['SubscriptionExpirationPolicyArgs']]] = None, labels: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, message_retention_duration: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, path: Optional[pulumi.Input[str]] = None, project: Optional[pulumi.Input[str]] = None, push_config: Optional[pulumi.Input[pulumi.InputType['SubscriptionPushConfigArgs']]] = None, retain_acked_messages: Optional[pulumi.Input[bool]] = None, topic: Optional[pulumi.Input[str]] = None) -> 'Subscription':
        """
