...
class Subscription(pulumi.CustomResource):
    ack_deadline_seconds: pulumi.Output[float] = pulumi.property("ackDeadlineSeconds")
    """
    ...
    dead_letter_policy: pulumi.Output[Optional['outputs.SubscriptionDeadLetterPolicy']] = pulumi.property("deadLetterPolicy")
    """
    ...
    expiration_policy: pulumi.Output['outputs.SubscriptionExpirationPolicy'] = pulumi.property("expirationPolicy")
    """
    ...
    filter: pulumi.Output[Optional[str]] = pulumi.property("filter")
    """
    ...
    message_retention_duration: pulumi.Output[Optional[str]] = pulumi.property("messageRetentionDuration")
    """
    ...
    push_config: pulumi.Output[Optional['outputs.SubscriptionPushConfig']] = pulumi.property("pushConfig")
    """
    ...
    retain_acked_messages: pulumi.Output[Optional[bool]] = pulumi.property("retainAckedMessages")
    """
