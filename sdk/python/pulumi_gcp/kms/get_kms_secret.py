...
class GetKMSSecretResult:
    ...
    def __init__(__self__, additional_authenticated_data=None, ciphertext=None, crypto_key=None, id=None, plaintext=None) -> None:
...
def get_kms_secret(additional_authenticated_data: Optional[str] = None, ciphertext: Optional[str] = None, crypto_key: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetKMSSecretResult:
    """
