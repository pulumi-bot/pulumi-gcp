...
__all__ = ['CryptoKeyIAMMember']


class CryptoKeyIAMMember(pulumi.CustomResource):
    condition: pulumi.Output[Optional['outputs.CryptoKeyIAMMemberCondition']] = pulumi.output_property("condition")
    """
    An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
    Structure is documented below.
    """
    crypto_key_id: pulumi.Output[str] = pulumi.output_property("cryptoKeyId")
    """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, condition: Optional[pulumi.Input[pulumi.InputType['CryptoKeyIAMMemberConditionArgs']]] = None, crypto_key_id: Optional[pulumi.Input[str]] = None, etag: Optional[pulumi.Input[str]] = None, member: Optional[pulumi.Input[str]] = None, role: Optional[pulumi.Input[str]] = None) -> 'CryptoKeyIAMMember':
        """
