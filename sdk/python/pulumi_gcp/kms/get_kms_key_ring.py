...
class GetKMSKeyRingResult:
    ...
    def __init__(__self__, id=None, location=None, name=None, project=None, self_link=None) -> None:
...
def get_kms_key_ring(location: Optional[str] = None, name: Optional[str] = None, project: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetKMSKeyRingResult:
    """
