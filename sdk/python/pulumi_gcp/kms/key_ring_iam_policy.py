...
class KeyRingIAMPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, key_ring_id=None, policy_data=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, etag=None, key_ring_id=None, policy_data=None):
        """
