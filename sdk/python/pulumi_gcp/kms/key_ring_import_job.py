...
class KeyRingImportJob(pulumi.CustomResource):
    attestation: pulumi.Output['outputs.KeyRingImportJobAttestation'] = pulumi.property("attestation")
    """
    ...
    import_job_id: pulumi.Output[str] = pulumi.property("importJobId")
    """
    It must be unique within a KeyRing and match the regular expression [a-zA-Z0-9_-]{1,63}
    """

    import_method: pulumi.Output[str] = pulumi.property("importMethod")
    """
    ...
    protection_level: pulumi.Output[str] = pulumi.property("protectionLevel")
    """
    ...
    public_key: pulumi.Output['outputs.KeyRingImportJobPublicKey'] = pulumi.property("publicKey")
    """
