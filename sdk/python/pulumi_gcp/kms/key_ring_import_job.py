...
class KeyRingImportJob(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, import_job_id=None, import_method=None, key_ring=None, protection_level=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    def get(resource_name, id, opts=None, attestation=None, expire_time=None, import_job_id=None, import_method=None, key_ring=None, name=None, protection_level=None, public_key=None, state=None):
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input['KeyRingImportJobAttestationArgs'] attestation: Statement that was generated and signed by the key creator (for example, an HSM) at key creation time. Use this
               statement to verify attributes of the key as stored on the HSM, independently of Google. Only present if the chosen
               ImportMethod is one with a protection level of HSM.
        ...
        :param pulumi.Input[str] protection_level: The protection level of the ImportJob. This must match the protectionLevel of the
               versionTemplate on the CryptoKey you attempt to import into.
        :param pulumi.Input['KeyRingImportJobPublicKeyArgs'] public_key: The public key with which to wrap key material prior to import. Only returned if state is 'ACTIVE'.
