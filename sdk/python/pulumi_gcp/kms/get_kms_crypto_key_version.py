...
class GetKMSCryptoKeyVersionResult:
    ...
    def __init__(__self__, algorithm=None, crypto_key=None, id=None, protection_level=None, public_key=None, state=None, version=None) -> None:
...
def get_kms_crypto_key_version(crypto_key: Optional[str] = None, version: Optional[float] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetKMSCryptoKeyVersionResult:
    """
