...
def get_kms_crypto_key_version(crypto_key=None, version=None, opts=None):
    ...
    my_key_ring = gcp.kms.get_kms_key_ring(gcp.kms.GetKMSKeyRingArgsArgs(
        name="my-key-ring",
        location="us-central1",
    ))
    my_crypto_key = gcp.kms.get_kms_crypto_key(gcp.kms.GetKMSCryptoKeyArgsArgs(
        name="my-crypto-key",
        key_ring=my_key_ring.self_link,
    ))
    my_crypto_key_version = gcp.kms.get_kms_crypto_key_version(gcp.kms.GetKMSCryptoKeyVersionArgsArgs(
