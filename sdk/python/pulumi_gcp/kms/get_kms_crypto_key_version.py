...
@pulumi.output_type
class _GetKMSCryptoKeyVersionResult(dict):
    algorithm: str = pulumi.property("algorithm")
    crypto_key: str = pulumi.property("cryptoKey")
    id: str = pulumi.property("id")
    protection_level: str = pulumi.property("protectionLevel")
    public_key: 'outputs.GetKMSCryptoKeyVersionPublicKeyResult' = pulumi.property("publicKey")
    state: str = pulumi.property("state")
    version: Optional[float] = pulumi.property("version")
...
def get_kms_crypto_key_version(crypto_key: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('gcp:kms/getKMSCryptoKeyVersion:getKMSCryptoKeyVersion', __args__, opts=opts, typ=_GetKMSCryptoKeyVersionResult).value

    return AwaitableGetKMSCryptoKeyVersionResult(
        algorithm=_utilities.get_dict_value(__ret__, 'algorithm'),
        crypto_key=_utilities.get_dict_value(__ret__, 'cryptoKey'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        protection_level=_utilities.get_dict_value(__ret__, 'protectionLevel'),
        public_key=_utilities.get_dict_value(__ret__, 'publicKey'),
