    ...
    def __init__(__self__, resource_name, opts=None, description=None, enable_stackdriver_logging=None, enable_stackdriver_monitoring=None, labels=None, name=None, network_config=None, options=None, private_instance=None, project=None, region=None, type=None, __props__=None, __name__=None, __opts__=None):
        ...
        * How-to Guides
        ...
        :param pulumi.Input[str] description: -
               (Optional)
               An optional description of the instance.
        :param pulumi.Input[bool] enable_stackdriver_logging: -
               (Optional)
               Option to enable Stackdriver Logging.
        :param pulumi.Input[bool] enable_stackdriver_monitoring: -
               (Optional)
               Option to enable Stackdriver Monitoring.
        ...
        :param pulumi.Input[str] name: -
               (Required)
               The ID of the instance or a fully qualified identifier for the instance.
        :param pulumi.Input[dict] network_config: -
               (Optional)
               Network configuration options. These are required when a private Data Fusion instance is to be created.  Structure is documented below.
        :param pulumi.Input[dict] options: -
               (Optional)
               Map of additional options used to configure the behavior of Data Fusion instance.
        :param pulumi.Input[bool] private_instance: -
               (Optional)
               Specifies whether the Data Fusion instance should be private. If set to
               true, all Data Fusion nodes will have private IP addresses and will not be
               able to access the public internet.
