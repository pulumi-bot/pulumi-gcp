...
type gameServerConfigArgs struct {
	...
	Description *string `pulumi:"description"`
	// The fleet config contains list of fleet specs. In the Single Cloud, there will be only one.
	FleetConfigs []GameServerConfigFleetConfigArgs `pulumi:"fleetConfigs"`
	// The labels associated with this game server config. Each label is a key-value pair.
	Labels map[string]string `pulumi:"labels"`
	// Location of the Deployment.
	Location *string `pulumi:"location"`
	...
	Project *string `pulumi:"project"`
	// Optional. This contains the autoscaling settings.
	ScalingConfigs []GameServerConfigScalingConfigArgs `pulumi:"scalingConfigs"`
}
...
type GameServerConfigArgs struct {
	...
	Description pulumi.StringPtrInput
	// The fleet config contains list of fleet specs. In the Single Cloud, there will be only one.
	FleetConfigs GameServerConfigFleetConfigArgsArrayInput
	// The labels associated with this game server config. Each label is a key-value pair.
	Labels pulumi.StringMapInput
	// Location of the Deployment.
	Location pulumi.StringPtrInput
	...
	Project pulumi.StringPtrInput
	// Optional. This contains the autoscaling settings.
	ScalingConfigs GameServerConfigScalingConfigArgsArrayInput
}
