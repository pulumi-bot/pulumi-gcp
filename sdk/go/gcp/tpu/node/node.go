...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/tpu/NodeNetworkEndpoint"
	"https:/github.com/pulumi/pulumi-gcp/tpu/NodeSchedulingConfig"
)
...
type Node struct {
	...
	NetworkEndpoints tpuNodeNetworkEndpoint.NodeNetworkEndpointArrayOutput `pulumi:"networkEndpoints"`
	// The ID of the project in which the resource belongs.
	// If it is not provided, the provider project is used.
	Project pulumi.StringOutput `pulumi:"project"`
	// Sets the scheduling options for this TPU instance.
	SchedulingConfig tpuNodeSchedulingConfig.NodeSchedulingConfigPtrOutput `pulumi:"schedulingConfig"`
...
type nodeState struct {
	...
	// The network endpoints where TPU workers can be accessed and sent work. It is recommended that Tensorflow clients of the
	// node first reach out to the first (index 0) entry.
	NetworkEndpoints []tpuNodeNetworkEndpoint.NodeNetworkEndpoint `pulumi:"networkEndpoints"`
	// The ID of the project in which the resource belongs.
	// If it is not provided, the provider project is used.
	Project *string `pulumi:"project"`
	// Sets the scheduling options for this TPU instance.
	SchedulingConfig *tpuNodeSchedulingConfig.NodeSchedulingConfig `pulumi:"schedulingConfig"`
	// The service account used to run the tensor flow services within the node. To share resources, including Google Cloud
	// Storage data, with the Tensorflow job running in the Node, this account must have permissions to that data.
...
type NodeState struct {
	...
	// The network endpoints where TPU workers can be accessed and sent work. It is recommended that Tensorflow clients of the
	// node first reach out to the first (index 0) entry.
	NetworkEndpoints tpuNodeNetworkEndpoint.NodeNetworkEndpointArrayInput
	// The ID of the project in which the resource belongs.
	// If it is not provided, the provider project is used.
	Project pulumi.StringPtrInput
	// Sets the scheduling options for this TPU instance.
	SchedulingConfig tpuNodeSchedulingConfig.NodeSchedulingConfigPtrInput
	// The service account used to run the tensor flow services within the node. To share resources, including Google Cloud
	// Storage data, with the Tensorflow job running in the Node, this account must have permissions to that data.
