...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/billing/AccountIamMemberCondition"
)
...
type AccountIamMember struct {
	...
	Condition billingAccountIamMemberCondition.AccountIamMemberConditionPtrOutput `pulumi:"condition"`
...
type accountIamMemberState struct {
	...
	Condition *billingAccountIamMemberCondition.AccountIamMemberCondition `pulumi:"condition"`
	// (Computed) The etag of the billing account's IAM policy.
...
type AccountIamMemberState struct {
	...
	Condition billingAccountIamMemberCondition.AccountIamMemberConditionPtrInput
	// (Computed) The etag of the billing account's IAM policy.
