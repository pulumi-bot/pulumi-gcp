...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/billing/AccountIamBindingCondition"
)
...
type AccountIamBinding struct {
	...
	Condition billingAccountIamBindingCondition.AccountIamBindingConditionPtrOutput `pulumi:"condition"`
...
type accountIamBindingState struct {
	...
	Condition *billingAccountIamBindingCondition.AccountIamBindingCondition `pulumi:"condition"`
	// (Computed) The etag of the billing account's IAM policy.
...
type AccountIamBindingState struct {
	...
	Condition billingAccountIamBindingCondition.AccountIamBindingConditionPtrInput
	// (Computed) The etag of the billing account's IAM policy.
