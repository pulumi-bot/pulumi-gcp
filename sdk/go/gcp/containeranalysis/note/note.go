...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/containeranalysis/NoteAttestationAuthority"
...
type Note struct {
	...
	AttestationAuthority containeranalysisNoteAttestationAuthority.NoteAttestationAuthorityOutput `pulumi:"attestationAuthority"`
...
type noteState struct {
	...
	// ability for a principle to attach an Occurrence to a given Note. It also provides a single point of lookup to find all
	// attached Attestation Occurrences, even if they don't all live in the same project.
	AttestationAuthority *containeranalysisNoteAttestationAuthority.NoteAttestationAuthority `pulumi:"attestationAuthority"`
	// The name of the note.
...
type NoteState struct {
	...
	// ability for a principle to attach an Occurrence to a given Note. It also provides a single point of lookup to find all
	// attached Attestation Occurrences, even if they don't all live in the same project.
	AttestationAuthority containeranalysisNoteAttestationAuthority.NoteAttestationAuthorityPtrInput
	// The name of the note.
...
type NoteArgs struct {
	...
	// ability for a principle to attach an Occurrence to a given Note. It also provides a single point of lookup to find all
	// attached Attestation Occurrences, even if they don't all live in the same project.
	AttestationAuthority containeranalysisNoteAttestationAuthority.NoteAttestationAuthorityInput
	// The name of the note.
	Name pulumi.StringPtrInput
	Project pulumi.StringPtrInput
}
