...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/accesscontextmanager/AccessLevelBasic"
...
type AccessLevel struct {
	...
	Basic accesscontextmanagerAccessLevelBasic.AccessLevelBasicPtrOutput `pulumi:"basic"`
...
type accessLevelState struct {
	// A set of predefined conditions for the access level and a combining function.
	Basic *accesscontextmanagerAccessLevelBasic.AccessLevelBasic `pulumi:"basic"`
	// Description of the AccessLevel and its use. Does not affect behavior.
...
type AccessLevelState struct {
	// A set of predefined conditions for the access level and a combining function.
	Basic accesscontextmanagerAccessLevelBasic.AccessLevelBasicPtrInput
	// Description of the AccessLevel and its use. Does not affect behavior.
