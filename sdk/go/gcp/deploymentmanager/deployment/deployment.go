...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/deploymentmanager/DeploymentLabel"
	"https:/github.com/pulumi/pulumi-gcp/deploymentmanager/DeploymentTarget"
...
type Deployment struct {
	...
	Labels deploymentmanagerDeploymentLabel.DeploymentLabelArrayOutput `pulumi:"labels"`
	...
	Target deploymentmanagerDeploymentTarget.DeploymentTargetOutput `pulumi:"target"`
}
...
type deploymentState struct {
	...
	// Key-value pairs to apply to this labels.
	Labels []deploymentmanagerDeploymentLabel.DeploymentLabel `pulumi:"labels"`
	// Output only. URL of the manifest representing the last manifest that was successfully deployed.
	...
	// Parameters that define your deployment, including the deployment configuration and relevant templates.
	Target *deploymentmanagerDeploymentTarget.DeploymentTarget `pulumi:"target"`
}
...
type DeploymentState struct {
	...
	// Key-value pairs to apply to this labels.
	Labels deploymentmanagerDeploymentLabel.DeploymentLabelArrayInput
	// Output only. URL of the manifest representing the last manifest that was successfully deployed.
	...
	// Parameters that define your deployment, including the deployment configuration and relevant templates.
	Target deploymentmanagerDeploymentTarget.DeploymentTargetPtrInput
}
...
type DeploymentArgs struct {
	...
	Project pulumi.StringPtrInput
	// Parameters that define your deployment, including the deployment configuration and relevant templates.
	Target deploymentmanagerDeploymentTarget.DeploymentTargetInput
}
