...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/binaryauthorization/AttestorIamBindingCondition"
)
...
type AttestorIamBinding struct {
	...
	Condition binaryauthorizationAttestorIamBindingCondition.AttestorIamBindingConditionPtrOutput `pulumi:"condition"`
...
type attestorIamBindingState struct {
	...
	Condition *binaryauthorizationAttestorIamBindingCondition.AttestorIamBindingCondition `pulumi:"condition"`
	// (Computed) The etag of the IAM policy.
...
type AttestorIamBindingState struct {
	...
	Condition binaryauthorizationAttestorIamBindingCondition.AttestorIamBindingConditionPtrInput
	// (Computed) The etag of the IAM policy.
