...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/binaryauthorization/AttestorIamMemberCondition"
)
...
type AttestorIamMember struct {
	...
	Condition binaryauthorizationAttestorIamMemberCondition.AttestorIamMemberConditionPtrOutput `pulumi:"condition"`
...
type attestorIamMemberState struct {
	...
	Condition *binaryauthorizationAttestorIamMemberCondition.AttestorIamMemberCondition `pulumi:"condition"`
	// (Computed) The etag of the IAM policy.
...
type AttestorIamMemberState struct {
	...
	Condition binaryauthorizationAttestorIamMemberCondition.AttestorIamMemberConditionPtrInput
	// (Computed) The etag of the IAM policy.
