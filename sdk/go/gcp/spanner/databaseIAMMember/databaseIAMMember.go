...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/spanner/DatabaseIAMMemberCondition"
)
...
type DatabaseIAMMember struct {
	...
	Condition spannerDatabaseIAMMemberCondition.DatabaseIAMMemberConditionPtrOutput `pulumi:"condition"`
...
type databaseIAMMemberState struct {
	Condition *spannerDatabaseIAMMemberCondition.DatabaseIAMMemberCondition `pulumi:"condition"`
	// The name of the Spanner database.
...
type DatabaseIAMMemberState struct {
	Condition spannerDatabaseIAMMemberCondition.DatabaseIAMMemberConditionPtrInput
	// The name of the Spanner database.
