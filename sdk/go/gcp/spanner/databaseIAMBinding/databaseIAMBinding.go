...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/spanner/DatabaseIAMBindingCondition"
)
...
type DatabaseIAMBinding struct {
	...
	Condition spannerDatabaseIAMBindingCondition.DatabaseIAMBindingConditionPtrOutput `pulumi:"condition"`
...
type databaseIAMBindingState struct {
	Condition *spannerDatabaseIAMBindingCondition.DatabaseIAMBindingCondition `pulumi:"condition"`
	// The name of the Spanner database.
...
type DatabaseIAMBindingState struct {
	Condition spannerDatabaseIAMBindingCondition.DatabaseIAMBindingConditionPtrInput
	// The name of the Spanner database.
