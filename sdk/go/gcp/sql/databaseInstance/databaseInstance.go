...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/sql/DatabaseInstanceIpAddress"
	"https:/github.com/pulumi/pulumi-gcp/sql/DatabaseInstanceReplicaConfiguration"
	"https:/github.com/pulumi/pulumi-gcp/sql/DatabaseInstanceServerCaCert"
	"https:/github.com/pulumi/pulumi-gcp/sql/DatabaseInstanceSettings"
...
type DatabaseInstance struct {
	...
	IpAddresses sqlDatabaseInstanceIpAddress.DatabaseInstanceIpAddressArrayOutput `pulumi:"ipAddresses"`
	...
	ReplicaConfiguration sqlDatabaseInstanceReplicaConfiguration.DatabaseInstanceReplicaConfigurationOutput `pulumi:"replicaConfiguration"`
	// ) Initial root password. Required for MS SQL Server, ignored by MySQL and PostgreSQL.
	RootPassword pulumi.StringPtrOutput `pulumi:"rootPassword"`
	// The URI of the created resource.
	SelfLink pulumi.StringOutput `pulumi:"selfLink"`
	ServerCaCert sqlDatabaseInstanceServerCaCert.DatabaseInstanceServerCaCertOutput `pulumi:"serverCaCert"`
	...
	// configuration is detailed below.
	Settings sqlDatabaseInstanceSettings.DatabaseInstanceSettingsOutput `pulumi:"settings"`
}
...
type databaseInstanceState struct {
	...
	IpAddresses []sqlDatabaseInstanceIpAddress.DatabaseInstanceIpAddress `pulumi:"ipAddresses"`
	// The name of the instance that will act as
	// the master in the replication setup. Note, this requires the master to have
	// `binaryLogEnabled` set, as well as existing backups.
	...
	// The configuration for replication. The
	// configuration is detailed below.
	ReplicaConfiguration *sqlDatabaseInstanceReplicaConfiguration.DatabaseInstanceReplicaConfiguration `pulumi:"replicaConfiguration"`
	// ) Initial root password. Required for MS SQL Server, ignored by MySQL and PostgreSQL.
	RootPassword *string `pulumi:"rootPassword"`
	// The URI of the created resource.
	SelfLink *string `pulumi:"selfLink"`
	ServerCaCert *sqlDatabaseInstanceServerCaCert.DatabaseInstanceServerCaCert `pulumi:"serverCaCert"`
	// The service account email address assigned to the
	// instance. This property is applicable only to Second Generation instances.
	ServiceAccountEmailAddress *string `pulumi:"serviceAccountEmailAddress"`
	// The settings to use for the database. The
	// configuration is detailed below.
	Settings *sqlDatabaseInstanceSettings.DatabaseInstanceSettings `pulumi:"settings"`
}
...
type DatabaseInstanceState struct {
	...
	IpAddresses sqlDatabaseInstanceIpAddress.DatabaseInstanceIpAddressArrayInput
	// The name of the instance that will act as
	// the master in the replication setup. Note, this requires the master to have
	// `binaryLogEnabled` set, as well as existing backups.
	...
	// The configuration for replication. The
	// configuration is detailed below.
	ReplicaConfiguration sqlDatabaseInstanceReplicaConfiguration.DatabaseInstanceReplicaConfigurationPtrInput
	// ) Initial root password. Required for MS SQL Server, ignored by MySQL and PostgreSQL.
	RootPassword pulumi.StringPtrInput
	// The URI of the created resource.
	SelfLink pulumi.StringPtrInput
	ServerCaCert sqlDatabaseInstanceServerCaCert.DatabaseInstanceServerCaCertPtrInput
	// The service account email address assigned to the
	// instance. This property is applicable only to Second Generation instances.
	ServiceAccountEmailAddress pulumi.StringPtrInput
	// The settings to use for the database. The
	// configuration is detailed below.
	Settings sqlDatabaseInstanceSettings.DatabaseInstanceSettingsPtrInput
}
...
type DatabaseInstanceArgs struct {
	...
	// The settings to use for the database. The
	// configuration is detailed below.
	Settings sqlDatabaseInstanceSettings.DatabaseInstanceSettingsInput
}
