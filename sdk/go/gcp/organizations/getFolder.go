...
func LookupFolderApply(ctx *pulumi.Context, args LookupFolderApplyInput, opts ...pulumi.InvokeOption) LookupFolderResultOutput {
	return args.ToLookupFolderApplyOutput().ApplyT(func(v LookupFolderArgs) (LookupFolderResult, error) {
		r, err := LookupFolder(ctx, &v, opts...)
		return *r, err

	}).(LookupFolderResultOutput)
}

// LookupFolderApplyInput is an input type that accepts LookupFolderApplyArgs and LookupFolderApplyOutput values.
// You can construct a concrete instance of `LookupFolderApplyInput` via:
//
//          LookupFolderApplyArgs{...}
type LookupFolderApplyInput interface {
	pulumi.Input

	ToLookupFolderApplyOutput() LookupFolderApplyOutput
	ToLookupFolderApplyOutputWithContext(context.Context) LookupFolderApplyOutput
}

// A collection of arguments for invoking getFolder.
type LookupFolderApplyArgs struct {
	// The name of the Folder in the form `{folder_id}` or `folders/{folder_id}`.
...
func (LookupFolderApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupFolderArgs)(nil)).Elem()
}

func (i LookupFolderApplyArgs) ToLookupFolderApplyOutput() LookupFolderApplyOutput {
	return i.ToLookupFolderApplyOutputWithContext(context.Background())
}

func (i LookupFolderApplyArgs) ToLookupFolderApplyOutputWithContext(ctx context.Context) LookupFolderApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupFolderApplyOutput)
}

// A collection of arguments for invoking getFolder.
type LookupFolderApplyOutput struct{ *pulumi.OutputState }

func (LookupFolderApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupFolderArgs)(nil)).Elem()
}

func (o LookupFolderApplyOutput) ToLookupFolderApplyOutput() LookupFolderApplyOutput {
	return o
}

func (o LookupFolderApplyOutput) ToLookupFolderApplyOutputWithContext(ctx context.Context) LookupFolderApplyOutput {
	return o
}

// The name of the Folder in the form `{folder_id}` or `folders/{folder_id}`.
func (o LookupFolderApplyOutput) Folder() pulumi.StringOutput {
	return o.ApplyT(func(v LookupFolderArgs) string { return v.Folder }).(pulumi.StringOutput)
}

// `true` to find the organization that the folder belongs, `false` to avoid the lookup. It searches up the tree. (defaults to `false`)
func (o LookupFolderApplyOutput) LookupOrganization() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupFolderArgs) *bool { return v.LookupOrganization }).(pulumi.BoolPtrOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupFolderApplyOutput{})
