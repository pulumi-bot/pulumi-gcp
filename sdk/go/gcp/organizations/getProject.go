...
// The project ID. If it is not provided, the provider project is used.
func (o LookupProjectApplyOutput) ProjectId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupProjectArgs) *string { return v.ProjectId }).(pulumi.StringPtrOutput)
}
