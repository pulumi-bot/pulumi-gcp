...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/firestore/IndexField"
)
...
type Index struct {
	...
	Fields firestoreIndexField.IndexFieldArrayOutput `pulumi:"fields"`
...
type indexState struct {
	...
	// last field defined. If the final field in a composite index is not directional, the '__name__' will be ordered
	// '"ASCENDING"' (unless explicitly specified otherwise).
	Fields []firestoreIndexField.IndexField `pulumi:"fields"`
	// A server defined name for this index. Format:
	// 'projects/{{project}}/databases/{{database}}/collectionGroups/{{collection}}/indexes/{{server_generated_id}}'
...
type IndexState struct {
	...
	// last field defined. If the final field in a composite index is not directional, the '__name__' will be ordered
	// '"ASCENDING"' (unless explicitly specified otherwise).
	Fields firestoreIndexField.IndexFieldArrayInput
	// A server defined name for this index. Format:
	// 'projects/{{project}}/databases/{{database}}/collectionGroups/{{collection}}/indexes/{{server_generated_id}}'
