...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/identityplatform/InboundSamlConfigIdpConfig"
	"https:/github.com/pulumi/pulumi-gcp/identityplatform/InboundSamlConfigIdpConfigIdpCertificate"
	"https:/github.com/pulumi/pulumi-gcp/identityplatform/InboundSamlConfigSpConfig"
...
type InboundSamlConfig struct {
	...
	IdpConfig identityplatformInboundSamlConfigIdpConfig.InboundSamlConfigIdpConfigOutput `pulumi:"idpConfig"`
	...
	SpConfig identityplatformInboundSamlConfigSpConfig.InboundSamlConfigSpConfigOutput `pulumi:"spConfig"`
}
...
type inboundSamlConfigState struct {
	...
	// SAML IdP configuration when the project acts as the relying party
	IdpConfig *identityplatformInboundSamlConfigIdpConfig.InboundSamlConfigIdpConfig `pulumi:"idpConfig"`
	// The name of the InboundSamlConfig resource. Must start with 'saml.' and can only have alphanumeric characters, hyphens,
	// underscores or periods. The part after 'saml.' must also start with a lowercase letter, end with an alphanumeric
	// character, and have at least 2 characters.
	...
	// SAML SP (Service Provider) configuration when the project acts as the relying party to receive and accept an
	// authentication assertion issued by a SAML identity provider.
	SpConfig *identityplatformInboundSamlConfigSpConfig.InboundSamlConfigSpConfig `pulumi:"spConfig"`
}
...
type InboundSamlConfigState struct {
	...
	// SAML IdP configuration when the project acts as the relying party
	IdpConfig identityplatformInboundSamlConfigIdpConfig.InboundSamlConfigIdpConfigPtrInput
	// The name of the InboundSamlConfig resource. Must start with 'saml.' and can only have alphanumeric characters, hyphens,
	// underscores or periods. The part after 'saml.' must also start with a lowercase letter, end with an alphanumeric
	// character, and have at least 2 characters.
	...
	// SAML SP (Service Provider) configuration when the project acts as the relying party to receive and accept an
	// authentication assertion issued by a SAML identity provider.
	SpConfig identityplatformInboundSamlConfigSpConfig.InboundSamlConfigSpConfigPtrInput
}
...
type InboundSamlConfigArgs struct {
	...
	Enabled pulumi.BoolPtrInput
	// SAML IdP configuration when the project acts as the relying party
	IdpConfig identityplatformInboundSamlConfigIdpConfig.InboundSamlConfigIdpConfigInput
	// The name of the InboundSamlConfig resource. Must start with 'saml.' and can only have alphanumeric characters, hyphens,
	// underscores or periods. The part after 'saml.' must also start with a lowercase letter, end with an alphanumeric
	// character, and have at least 2 characters.
	Name pulumi.StringPtrInput
	...
	// SAML SP (Service Provider) configuration when the project acts as the relying party to receive and accept an
	// authentication assertion issued by a SAML identity provider.
	SpConfig identityplatformInboundSamlConfigSpConfig.InboundSamlConfigSpConfigInput
}
