...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/sourcerepo/RepositoryIamBindingCondition"
)
...
type RepositoryIamBinding struct {
	...
	Condition sourcerepoRepositoryIamBindingCondition.RepositoryIamBindingConditionPtrOutput `pulumi:"condition"`
...
type repositoryIamBindingState struct {
	Condition *sourcerepoRepositoryIamBindingCondition.RepositoryIamBindingCondition `pulumi:"condition"`
	// (Computed) The etag of the IAM policy.
...
type RepositoryIamBindingState struct {
	Condition sourcerepoRepositoryIamBindingCondition.RepositoryIamBindingConditionPtrInput
	// (Computed) The etag of the IAM policy.
