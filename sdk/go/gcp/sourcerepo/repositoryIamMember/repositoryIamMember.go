...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/sourcerepo/RepositoryIamMemberCondition"
)
...
type RepositoryIamMember struct {
	...
	Condition sourcerepoRepositoryIamMemberCondition.RepositoryIamMemberConditionPtrOutput `pulumi:"condition"`
...
type repositoryIamMemberState struct {
	Condition *sourcerepoRepositoryIamMemberCondition.RepositoryIamMemberCondition `pulumi:"condition"`
	// (Computed) The etag of the IAM policy.
...
type RepositoryIamMemberState struct {
	Condition sourcerepoRepositoryIamMemberCondition.RepositoryIamMemberConditionPtrInput
	// (Computed) The etag of the IAM policy.
