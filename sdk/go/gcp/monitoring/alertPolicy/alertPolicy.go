...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/monitoring/AlertPolicyCondition"
	...
	"https:/github.com/pulumi/pulumi-gcp/monitoring/AlertPolicyCreationRecord"
	"https:/github.com/pulumi/pulumi-gcp/monitoring/AlertPolicyDocumentation"
)
...
type AlertPolicy struct {
	...
	Conditions monitoringAlertPolicyCondition.AlertPolicyConditionArrayOutput `pulumi:"conditions"`
	// A read-only record of the creation of the alerting policy. If provided in a call to create or update, this field will be
	// ignored.
	CreationRecord monitoringAlertPolicyCreationRecord.AlertPolicyCreationRecordOutput `pulumi:"creationRecord"`
	...
	// don't use the same display name for multiple policies in the same project. The name is limited to 512 Unicode
	// characters.
	Documentation monitoringAlertPolicyDocumentation.AlertPolicyDocumentationPtrOutput `pulumi:"documentation"`
...
type alertPolicyState struct {
	...
	// A list of conditions for the policy. The conditions are combined by AND or OR according to the combiner field. If the
	// combined conditions evaluate to true, then an incident is created. A policy can have from one to six conditions.
	Conditions []monitoringAlertPolicyCondition.AlertPolicyCondition `pulumi:"conditions"`
	// A read-only record of the creation of the alerting policy. If provided in a call to create or update, this field will be
	// ignored.
	CreationRecord *monitoringAlertPolicyCreationRecord.AlertPolicyCreationRecord `pulumi:"creationRecord"`
	// A short name or phrase used to identify the policy in dashboards, notifications, and incidents. To avoid confusion,
	// don't use the same display name for multiple policies in the same project. The name is limited to 512 Unicode
	// characters.
	...
	// don't use the same display name for multiple policies in the same project. The name is limited to 512 Unicode
	// characters.
	Documentation *monitoringAlertPolicyDocumentation.AlertPolicyDocumentation `pulumi:"documentation"`
	// Whether or not the policy is enabled. The default is true.
...
type AlertPolicyState struct {
	...
	// A list of conditions for the policy. The conditions are combined by AND or OR according to the combiner field. If the
	// combined conditions evaluate to true, then an incident is created. A policy can have from one to six conditions.
	Conditions monitoringAlertPolicyCondition.AlertPolicyConditionArrayInput
	// A read-only record of the creation of the alerting policy. If provided in a call to create or update, this field will be
	// ignored.
	CreationRecord monitoringAlertPolicyCreationRecord.AlertPolicyCreationRecordPtrInput
	// A short name or phrase used to identify the policy in dashboards, notifications, and incidents. To avoid confusion,
	// don't use the same display name for multiple policies in the same project. The name is limited to 512 Unicode
	// characters.
	...
	// don't use the same display name for multiple policies in the same project. The name is limited to 512 Unicode
	// characters.
	Documentation monitoringAlertPolicyDocumentation.AlertPolicyDocumentationPtrInput
	// Whether or not the policy is enabled. The default is true.
