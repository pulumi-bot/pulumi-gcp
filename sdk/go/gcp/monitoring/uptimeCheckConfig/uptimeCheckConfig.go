...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/monitoring/UptimeCheckConfigContentMatcher"
	"https:/github.com/pulumi/pulumi-gcp/monitoring/UptimeCheckConfigHttpCheck"
	"https:/github.com/pulumi/pulumi-gcp/monitoring/UptimeCheckConfigHttpCheckAuthInfo"
	"https:/github.com/pulumi/pulumi-gcp/monitoring/UptimeCheckConfigMonitoredResource"
	"https:/github.com/pulumi/pulumi-gcp/monitoring/UptimeCheckConfigResourceGroup"
	"https:/github.com/pulumi/pulumi-gcp/monitoring/UptimeCheckConfigTcpCheck"
)
...
type UptimeCheckConfig struct {
	...
	ContentMatchers monitoringUptimeCheckConfigContentMatcher.UptimeCheckConfigContentMatcherArrayOutput `pulumi:"contentMatchers"`
	...
	HttpCheck monitoringUptimeCheckConfigHttpCheck.UptimeCheckConfigHttpCheckPtrOutput `pulumi:"httpCheck"`
	...
	MonitoredResource monitoringUptimeCheckConfigMonitoredResource.UptimeCheckConfigMonitoredResourcePtrOutput `pulumi:"monitoredResource"`
	...
	ResourceGroup monitoringUptimeCheckConfigResourceGroup.UptimeCheckConfigResourceGroupPtrOutput `pulumi:"resourceGroup"`
	...
	TcpCheck monitoringUptimeCheckConfigTcpCheck.UptimeCheckConfigTcpCheckPtrOutput `pulumi:"tcpCheck"`
...
type uptimeCheckConfigState struct {
	...
	// other entries will be ignored. The server will look for an exact match of the string in the page response's content.
	// This field is optional and should only be specified if a content match is required.
	ContentMatchers []monitoringUptimeCheckConfigContentMatcher.UptimeCheckConfigContentMatcher `pulumi:"contentMatchers"`
	// A human-friendly name for the uptime check configuration. The display name should be unique within a Stackdriver
	// Workspace in order to make it easier to identify; however, uniqueness is not enforced.
	DisplayName *string `pulumi:"displayName"`
	// Contains information needed to make an HTTP or HTTPS check.
	HttpCheck *monitoringUptimeCheckConfigHttpCheck.UptimeCheckConfigHttpCheck `pulumi:"httpCheck"`
	// The monitored resource (https://cloud.google.com/monitoring/api/resources) associated with the configuration. The
	// following monitored resource types are supported for uptime checks: uptime_url gce_instance gae_app aws_ec2_instance
	// aws_elb_load_balancer
	MonitoredResource *monitoringUptimeCheckConfigMonitoredResource.UptimeCheckConfigMonitoredResource `pulumi:"monitoredResource"`
	// A unique resource name for this UptimeCheckConfig. The format is
	// projects/[PROJECT_ID]/uptimeCheckConfigs/[UPTIME_CHECK_ID].
	...
	// The group resource associated with the configuration.
	ResourceGroup *monitoringUptimeCheckConfigResourceGroup.UptimeCheckConfigResourceGroup `pulumi:"resourceGroup"`
	// The list of regions from which the check will be run. Some regions contain one location, and others contain more than
	// one. If this field is specified, enough regions to include a minimum of 3 locations must be provided, or an error
	// message is returned. Not specifying this field will result in uptime checks running from all regions.
	SelectedRegions []string `pulumi:"selectedRegions"`
	// Contains information needed to make a TCP check.
	TcpCheck *monitoringUptimeCheckConfigTcpCheck.UptimeCheckConfigTcpCheck `pulumi:"tcpCheck"`
	// The maximum amount of time to wait for the request to complete (must be between 1 and 60 seconds). Accepted formats
	// https://developers.google.com/protocol-buffers/docs/reference/google.protobuf#google.protobuf.Duration
...
type UptimeCheckConfigState struct {
	...
	// other entries will be ignored. The server will look for an exact match of the string in the page response's content.
	// This field is optional and should only be specified if a content match is required.
	ContentMatchers monitoringUptimeCheckConfigContentMatcher.UptimeCheckConfigContentMatcherArrayInput
	// A human-friendly name for the uptime check configuration. The display name should be unique within a Stackdriver
	// Workspace in order to make it easier to identify; however, uniqueness is not enforced.
	DisplayName pulumi.StringPtrInput
	// Contains information needed to make an HTTP or HTTPS check.
	HttpCheck monitoringUptimeCheckConfigHttpCheck.UptimeCheckConfigHttpCheckPtrInput
	// The monitored resource (https://cloud.google.com/monitoring/api/resources) associated with the configuration. The
	// following monitored resource types are supported for uptime checks: uptime_url gce_instance gae_app aws_ec2_instance
	// aws_elb_load_balancer
	MonitoredResource monitoringUptimeCheckConfigMonitoredResource.UptimeCheckConfigMonitoredResourcePtrInput
	// A unique resource name for this UptimeCheckConfig. The format is
	// projects/[PROJECT_ID]/uptimeCheckConfigs/[UPTIME_CHECK_ID].
	...
	// The group resource associated with the configuration.
	ResourceGroup monitoringUptimeCheckConfigResourceGroup.UptimeCheckConfigResourceGroupPtrInput
	// The list of regions from which the check will be run. Some regions contain one location, and others contain more than
	// one. If this field is specified, enough regions to include a minimum of 3 locations must be provided, or an error
	// message is returned. Not specifying this field will result in uptime checks running from all regions.
	SelectedRegions pulumi.StringArrayInput
	// Contains information needed to make a TCP check.
	TcpCheck monitoringUptimeCheckConfigTcpCheck.UptimeCheckConfigTcpCheckPtrInput
	// The maximum amount of time to wait for the request to complete (must be between 1 and 60 seconds). Accepted formats
	// https://developers.google.com/protocol-buffers/docs/reference/google.protobuf#google.protobuf.Duration
