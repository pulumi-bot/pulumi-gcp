...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/iap/WebBackendServiceIamMemberCondition"
)
...
type WebBackendServiceIamMember struct {
	...
	Condition iapWebBackendServiceIamMemberCondition.WebBackendServiceIamMemberConditionPtrOutput `pulumi:"condition"`
...
type webBackendServiceIamMemberState struct {
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition *iapWebBackendServiceIamMemberCondition.WebBackendServiceIamMemberCondition `pulumi:"condition"`
	// (Computed) The etag of the IAM policy.
...
type WebBackendServiceIamMemberState struct {
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition iapWebBackendServiceIamMemberCondition.WebBackendServiceIamMemberConditionPtrInput
	// (Computed) The etag of the IAM policy.
