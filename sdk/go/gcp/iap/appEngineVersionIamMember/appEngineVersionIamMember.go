...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/iap/AppEngineVersionIamMemberCondition"
)
...
type AppEngineVersionIamMember struct {
	...
	Condition iapAppEngineVersionIamMemberCondition.AppEngineVersionIamMemberConditionPtrOutput `pulumi:"condition"`
...
type appEngineVersionIamMemberState struct {
	...
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition *iapAppEngineVersionIamMemberCondition.AppEngineVersionIamMemberCondition `pulumi:"condition"`
	// (Computed) The etag of the IAM policy.
...
type AppEngineVersionIamMemberState struct {
	...
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition iapAppEngineVersionIamMemberCondition.AppEngineVersionIamMemberConditionPtrInput
	// (Computed) The etag of the IAM policy.
