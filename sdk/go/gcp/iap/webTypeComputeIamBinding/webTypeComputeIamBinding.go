...
// nolint: lll
package webTypeComputeIamBinding
...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/iap/WebTypeComputeIamBindingCondition"
)
...
type WebTypeComputeIamBinding struct {
	...
	Condition iapWebTypeComputeIamBindingCondition.WebTypeComputeIamBindingConditionPtrOutput `pulumi:"condition"`
...
type webTypeComputeIamBindingState struct {
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition *iapWebTypeComputeIamBindingCondition.WebTypeComputeIamBindingCondition `pulumi:"condition"`
	// (Computed) The etag of the IAM policy.
...
type WebTypeComputeIamBindingState struct {
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition iapWebTypeComputeIamBindingCondition.WebTypeComputeIamBindingConditionPtrInput
	// (Computed) The etag of the IAM policy.
