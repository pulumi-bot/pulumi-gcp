...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/iap/WebIamBindingCondition"
)
...
type WebIamBinding struct {
	...
	Condition iapWebIamBindingCondition.WebIamBindingConditionPtrOutput `pulumi:"condition"`
...
type webIamBindingState struct {
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition *iapWebIamBindingCondition.WebIamBindingCondition `pulumi:"condition"`
	// (Computed) The etag of the IAM policy.
...
type WebIamBindingState struct {
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition iapWebIamBindingCondition.WebIamBindingConditionPtrInput
	// (Computed) The etag of the IAM policy.
