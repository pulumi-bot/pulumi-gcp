...
// nolint: lll
package tunnelInstanceIAMMember
...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/iap/TunnelInstanceIAMMemberCondition"
)
...
type TunnelInstanceIAMMember struct {
	...
	Condition iapTunnelInstanceIAMMemberCondition.TunnelInstanceIAMMemberConditionPtrOutput `pulumi:"condition"`
...
type tunnelInstanceIAMMemberState struct {
	Condition *iapTunnelInstanceIAMMemberCondition.TunnelInstanceIAMMemberCondition `pulumi:"condition"`
	// (Computed) The etag of the instance's IAM policy.
...
type TunnelInstanceIAMMemberState struct {
	Condition iapTunnelInstanceIAMMemberCondition.TunnelInstanceIAMMemberConditionPtrInput
	// (Computed) The etag of the instance's IAM policy.
