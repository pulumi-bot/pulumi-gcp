...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/iap/WebIamMemberCondition"
)
...
type WebIamMember struct {
	...
	Condition iapWebIamMemberCondition.WebIamMemberConditionPtrOutput `pulumi:"condition"`
...
type webIamMemberState struct {
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition *iapWebIamMemberCondition.WebIamMemberCondition `pulumi:"condition"`
	// (Computed) The etag of the IAM policy.
...
type WebIamMemberState struct {
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition iapWebIamMemberCondition.WebIamMemberConditionPtrInput
	// (Computed) The etag of the IAM policy.
