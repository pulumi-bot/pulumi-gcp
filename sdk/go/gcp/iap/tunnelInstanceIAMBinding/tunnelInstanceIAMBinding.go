...
// nolint: lll
package tunnelInstanceIAMBinding
...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/iap/TunnelInstanceIAMBindingCondition"
)
...
type TunnelInstanceIAMBinding struct {
	...
	Condition iapTunnelInstanceIAMBindingCondition.TunnelInstanceIAMBindingConditionPtrOutput `pulumi:"condition"`
...
type tunnelInstanceIAMBindingState struct {
	Condition *iapTunnelInstanceIAMBindingCondition.TunnelInstanceIAMBindingCondition `pulumi:"condition"`
	// (Computed) The etag of the instance's IAM policy.
...
type TunnelInstanceIAMBindingState struct {
	Condition iapTunnelInstanceIAMBindingCondition.TunnelInstanceIAMBindingConditionPtrInput
	// (Computed) The etag of the instance's IAM policy.
