...
// nolint: lll
package webTypeAppEngingIamBinding
...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/iap/WebTypeAppEngingIamBindingCondition"
)
...
type WebTypeAppEngingIamBinding struct {
	...
	Condition iapWebTypeAppEngingIamBindingCondition.WebTypeAppEngingIamBindingConditionPtrOutput `pulumi:"condition"`
...
type webTypeAppEngingIamBindingState struct {
	...
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition *iapWebTypeAppEngingIamBindingCondition.WebTypeAppEngingIamBindingCondition `pulumi:"condition"`
	// (Computed) The etag of the IAM policy.
...
type WebTypeAppEngingIamBindingState struct {
	...
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition iapWebTypeAppEngingIamBindingCondition.WebTypeAppEngingIamBindingConditionPtrInput
	// (Computed) The etag of the IAM policy.
