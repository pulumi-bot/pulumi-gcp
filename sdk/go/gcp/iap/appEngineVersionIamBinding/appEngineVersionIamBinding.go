...
// nolint: lll
package appEngineVersionIamBinding
...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/iap/AppEngineVersionIamBindingCondition"
)
...
type AppEngineVersionIamBinding struct {
	...
	Condition iapAppEngineVersionIamBindingCondition.AppEngineVersionIamBindingConditionPtrOutput `pulumi:"condition"`
...
type appEngineVersionIamBindingState struct {
	...
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition *iapAppEngineVersionIamBindingCondition.AppEngineVersionIamBindingCondition `pulumi:"condition"`
	// (Computed) The etag of the IAM policy.
...
type AppEngineVersionIamBindingState struct {
	...
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition iapAppEngineVersionIamBindingCondition.AppEngineVersionIamBindingConditionPtrInput
	// (Computed) The etag of the IAM policy.
