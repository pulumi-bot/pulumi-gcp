...
// nolint: lll
package webTypeAppEngingIamMember
...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/iap/WebTypeAppEngingIamMemberCondition"
)
...
type WebTypeAppEngingIamMember struct {
	...
	Condition iapWebTypeAppEngingIamMemberCondition.WebTypeAppEngingIamMemberConditionPtrOutput `pulumi:"condition"`
...
type webTypeAppEngingIamMemberState struct {
	...
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition *iapWebTypeAppEngingIamMemberCondition.WebTypeAppEngingIamMemberCondition `pulumi:"condition"`
	// (Computed) The etag of the IAM policy.
...
type WebTypeAppEngingIamMemberState struct {
	...
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition iapWebTypeAppEngingIamMemberCondition.WebTypeAppEngingIamMemberConditionPtrInput
	// (Computed) The etag of the IAM policy.
