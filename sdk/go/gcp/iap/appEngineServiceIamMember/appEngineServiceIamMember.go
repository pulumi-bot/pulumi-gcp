...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/iap/AppEngineServiceIamMemberCondition"
)
...
type AppEngineServiceIamMember struct {
	...
	Condition iapAppEngineServiceIamMemberCondition.AppEngineServiceIamMemberConditionPtrOutput `pulumi:"condition"`
...
type appEngineServiceIamMemberState struct {
	...
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition *iapAppEngineServiceIamMemberCondition.AppEngineServiceIamMemberCondition `pulumi:"condition"`
	// (Computed) The etag of the IAM policy.
...
type AppEngineServiceIamMemberState struct {
	...
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition iapAppEngineServiceIamMemberCondition.AppEngineServiceIamMemberConditionPtrInput
	// (Computed) The etag of the IAM policy.
