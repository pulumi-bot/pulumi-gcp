...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/iap/WebTypeComputeIamMemberCondition"
)
...
type WebTypeComputeIamMember struct {
	...
	Condition iapWebTypeComputeIamMemberCondition.WebTypeComputeIamMemberConditionPtrOutput `pulumi:"condition"`
...
type webTypeComputeIamMemberState struct {
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition *iapWebTypeComputeIamMemberCondition.WebTypeComputeIamMemberCondition `pulumi:"condition"`
	// (Computed) The etag of the IAM policy.
...
type WebTypeComputeIamMemberState struct {
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition iapWebTypeComputeIamMemberCondition.WebTypeComputeIamMemberConditionPtrInput
	// (Computed) The etag of the IAM policy.
