...
// nolint: lll
package appEngineServiceIamBinding
...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/iap/AppEngineServiceIamBindingCondition"
)
...
type AppEngineServiceIamBinding struct {
	...
	Condition iapAppEngineServiceIamBindingCondition.AppEngineServiceIamBindingConditionPtrOutput `pulumi:"condition"`
...
type appEngineServiceIamBindingState struct {
	...
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition *iapAppEngineServiceIamBindingCondition.AppEngineServiceIamBindingCondition `pulumi:"condition"`
	// (Computed) The etag of the IAM policy.
...
type AppEngineServiceIamBindingState struct {
	...
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition iapAppEngineServiceIamBindingCondition.AppEngineServiceIamBindingConditionPtrInput
	// (Computed) The etag of the IAM policy.
