...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/storage/BucketIAMMemberCondition"
)
...
type BucketIAMMember struct {
	...
	Condition storageBucketIAMMemberCondition.BucketIAMMemberConditionPtrOutput `pulumi:"condition"`
...
type bucketIAMMemberState struct {
	...
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition *storageBucketIAMMemberCondition.BucketIAMMemberCondition `pulumi:"condition"`
	// (Computed) The etag of the IAM policy.
...
type BucketIAMMemberState struct {
	...
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition storageBucketIAMMemberCondition.BucketIAMMemberConditionPtrInput
	// (Computed) The etag of the IAM policy.
