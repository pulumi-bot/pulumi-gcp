...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/storage/BucketIAMBindingCondition"
)
...
type BucketIAMBinding struct {
	...
	Condition storageBucketIAMBindingCondition.BucketIAMBindingConditionPtrOutput `pulumi:"condition"`
...
type bucketIAMBindingState struct {
	...
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition *storageBucketIAMBindingCondition.BucketIAMBindingCondition `pulumi:"condition"`
	// (Computed) The etag of the IAM policy.
...
type BucketIAMBindingState struct {
	...
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition storageBucketIAMBindingCondition.BucketIAMBindingConditionPtrInput
	// (Computed) The etag of the IAM policy.
