...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/logging/MetricBucketOptions"
	...
	"https:/github.com/pulumi/pulumi-gcp/logging/MetricMetricDescriptor"
...
type Metric struct {
	...
	BucketOptions loggingMetricBucketOptions.MetricBucketOptionsPtrOutput `pulumi:"bucketOptions"`
	...
	MetricDescriptor loggingMetricMetricDescriptor.MetricMetricDescriptorOutput `pulumi:"metricDescriptor"`
...
type metricState struct {
	// The bucketOptions are required when the logs-based metric is using a DISTRIBUTION value type and it describes the bucket
	// boundaries used to create a histogram of the extracted values.
	BucketOptions *loggingMetricBucketOptions.MetricBucketOptions `pulumi:"bucketOptions"`
	// A description of this metric, which is used in documentation. The maximum length of the description is 8000 characters.
	...
	// The metric descriptor associated with the logs-based metric.
	MetricDescriptor *loggingMetricMetricDescriptor.MetricMetricDescriptor `pulumi:"metricDescriptor"`
	// The client-assigned metric identifier. Examples - "error_count", "nginx/requests". Metric identifiers are limited to 100
	// characters and can include only the following characters A-Z, a-z, 0-9, and the special characters _-.,+!*',()%/. The
	// forward-slash character (/) denotes a hierarchy of name pieces, and it cannot be the first character of the name.
...
type MetricState struct {
	// The bucketOptions are required when the logs-based metric is using a DISTRIBUTION value type and it describes the bucket
	// boundaries used to create a histogram of the extracted values.
	BucketOptions loggingMetricBucketOptions.MetricBucketOptionsPtrInput
	// A description of this metric, which is used in documentation. The maximum length of the description is 8000 characters.
	...
	// The metric descriptor associated with the logs-based metric.
	MetricDescriptor loggingMetricMetricDescriptor.MetricMetricDescriptorPtrInput
	// The client-assigned metric identifier. Examples - "error_count", "nginx/requests". Metric identifiers are limited to 100
	// characters and can include only the following characters A-Z, a-z, 0-9, and the special characters _-.,+!*',()%/. The
	// forward-slash character (/) denotes a hierarchy of name pieces, and it cannot be the first character of the name.
...
type MetricArgs struct {
	...
	LabelExtractors pulumi.StringMapInput
	// The metric descriptor associated with the logs-based metric.
	MetricDescriptor loggingMetricMetricDescriptor.MetricMetricDescriptorInput
	// The client-assigned metric identifier. Examples - "error_count", "nginx/requests". Metric identifiers are limited to 100
	// characters and can include only the following characters A-Z, a-z, 0-9, and the special characters _-.,+!*',()%/. The
	// forward-slash character (/) denotes a hierarchy of name pieces, and it cannot be the first character of the name.
	Name pulumi.StringPtrInput
