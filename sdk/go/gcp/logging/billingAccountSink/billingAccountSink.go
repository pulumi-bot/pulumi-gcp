...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/logging/BillingAccountSinkBigqueryOptions"
)
...
type BillingAccountSink struct {
	...
	BigqueryOptions loggingBillingAccountSinkBigqueryOptions.BillingAccountSinkBigqueryOptionsPtrOutput `pulumi:"bigqueryOptions"`
...
type billingAccountSinkState struct {
	// Options that affect sinks exporting data to BigQuery. Structure documented below.
	BigqueryOptions *loggingBillingAccountSinkBigqueryOptions.BillingAccountSinkBigqueryOptions `pulumi:"bigqueryOptions"`
	// The billing account exported to the sink.
...
type BillingAccountSinkState struct {
	// Options that affect sinks exporting data to BigQuery. Structure documented below.
	BigqueryOptions loggingBillingAccountSinkBigqueryOptions.BillingAccountSinkBigqueryOptionsPtrInput
	// The billing account exported to the sink.
