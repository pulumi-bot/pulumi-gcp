...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/logging/ProjectSinkBigqueryOptions"
)
...
type ProjectSink struct {
	...
	BigqueryOptions loggingProjectSinkBigqueryOptions.ProjectSinkBigqueryOptionsPtrOutput `pulumi:"bigqueryOptions"`
...
type projectSinkState struct {
	// Options that affect sinks exporting data to BigQuery. Structure documented below.
	BigqueryOptions *loggingProjectSinkBigqueryOptions.ProjectSinkBigqueryOptions `pulumi:"bigqueryOptions"`
	// The destination of the sink (or, in other words, where logs are written to). Can be a
	// Cloud Storage bucket, a PubSub topic, or a BigQuery dataset. Examples:
	// The writer associated with the sink must have access to write to the above resource.
...
type ProjectSinkState struct {
	// Options that affect sinks exporting data to BigQuery. Structure documented below.
	BigqueryOptions loggingProjectSinkBigqueryOptions.ProjectSinkBigqueryOptionsPtrInput
	// The destination of the sink (or, in other words, where logs are written to). Can be a
	// Cloud Storage bucket, a PubSub topic, or a BigQuery dataset. Examples:
	// The writer associated with the sink must have access to write to the above resource.
