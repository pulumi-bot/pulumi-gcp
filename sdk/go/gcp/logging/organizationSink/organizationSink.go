...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/logging/OrganizationSinkBigqueryOptions"
)
...
type OrganizationSink struct {
	...
	BigqueryOptions loggingOrganizationSinkBigqueryOptions.OrganizationSinkBigqueryOptionsPtrOutput `pulumi:"bigqueryOptions"`
...
type organizationSinkState struct {
	// Options that affect sinks exporting data to BigQuery. Structure documented below.
	BigqueryOptions *loggingOrganizationSinkBigqueryOptions.OrganizationSinkBigqueryOptions `pulumi:"bigqueryOptions"`
	// The destination of the sink (or, in other words, where logs are written to). Can be a
	// Cloud Storage bucket, a PubSub topic, or a BigQuery dataset. Examples:
	// The writer associated with the sink must have access to write to the above resource.
...
type OrganizationSinkState struct {
	// Options that affect sinks exporting data to BigQuery. Structure documented below.
	BigqueryOptions loggingOrganizationSinkBigqueryOptions.OrganizationSinkBigqueryOptionsPtrInput
	// The destination of the sink (or, in other words, where logs are written to). Can be a
	// Cloud Storage bucket, a PubSub topic, or a BigQuery dataset. Examples:
	// The writer associated with the sink must have access to write to the above resource.
