...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/logging/FolderSinkBigqueryOptions"
)
...
type FolderSink struct {
	...
	BigqueryOptions loggingFolderSinkBigqueryOptions.FolderSinkBigqueryOptionsPtrOutput `pulumi:"bigqueryOptions"`
...
type folderSinkState struct {
	// Options that affect sinks exporting data to BigQuery. Structure documented below.
	BigqueryOptions *loggingFolderSinkBigqueryOptions.FolderSinkBigqueryOptions `pulumi:"bigqueryOptions"`
	// The destination of the sink (or, in other words, where logs are written to). Can be a
	// Cloud Storage bucket, a PubSub topic, or a BigQuery dataset. Examples:
	// The writer associated with the sink must have access to write to the above resource.
...
type FolderSinkState struct {
	// Options that affect sinks exporting data to BigQuery. Structure documented below.
	BigqueryOptions loggingFolderSinkBigqueryOptions.FolderSinkBigqueryOptionsPtrInput
	// The destination of the sink (or, in other words, where logs are written to). Can be a
	// Cloud Storage bucket, a PubSub topic, or a BigQuery dataset. Examples:
	// The writer associated with the sink must have access to write to the above resource.
