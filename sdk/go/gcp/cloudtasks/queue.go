...
type queueArgs struct {
	// Overrides for task-level appEngineRouting. These settings apply only to App Engine tasks in this queue
	AppEngineRoutingOverride *QueueAppEngineRoutingOverrideArgs `pulumi:"appEngineRoutingOverride"`
	// The location of the queue
	Location string `pulumi:"location"`
	// The queue name.
	Name *string `pulumi:"name"`
	...
	// Requests) or 503 (Service Unavailable) responses from the worker, high error rates, or to smooth sudden large traffic
	// spikes.
	RateLimits *QueueRateLimitsArgs `pulumi:"rateLimits"`
	// Settings that determine the retry behavior.
	RetryConfig *QueueRetryConfigArgs `pulumi:"retryConfig"`
}

// The set of arguments for constructing a Queue resource.
type QueueArgs struct {
	// Overrides for task-level appEngineRouting. These settings apply only to App Engine tasks in this queue
	AppEngineRoutingOverride QueueAppEngineRoutingOverrideArgsPtrInput
	// The location of the queue
	...
	// Requests) or 503 (Service Unavailable) responses from the worker, high error rates, or to smooth sudden large traffic
	// spikes.
	RateLimits QueueRateLimitsArgsPtrInput
	// Settings that determine the retry behavior.
	RetryConfig QueueRetryConfigArgsPtrInput
}
