...
type Provider struct {
	...
	Batching                           ProviderBatchingPtrOutput `pulumi:"batching"`
	...
	ImpersonateServiceAccountDelegates pulumi.StringArrayOutput  `pulumi:"impersonateServiceAccountDelegates"`
	...
	UserProjectOverride                pulumi.BoolPtrOutput      `pulumi:"userProjectOverride"`
