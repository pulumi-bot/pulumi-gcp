...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/endpoints/ServiceApi"
	"https:/github.com/pulumi/pulumi-gcp/endpoints/ServiceApiMethod"
	"https:/github.com/pulumi/pulumi-gcp/endpoints/ServiceEndpoint"
)
...
type Service struct {
	...
	Apis endpointsServiceApi.ServiceApiArrayOutput `pulumi:"apis"`
	ConfigId pulumi.StringOutput `pulumi:"configId"`
	DnsAddress pulumi.StringOutput `pulumi:"dnsAddress"`
	Endpoints endpointsServiceEndpoint.ServiceEndpointArrayOutput `pulumi:"endpoints"`
...
type serviceState struct {
	Apis []endpointsServiceApi.ServiceApi `pulumi:"apis"`
	ConfigId *string `pulumi:"configId"`
	DnsAddress *string `pulumi:"dnsAddress"`
	Endpoints []endpointsServiceEndpoint.ServiceEndpoint `pulumi:"endpoints"`
...
type ServiceState struct {
	Apis endpointsServiceApi.ServiceApiArrayInput
	ConfigId pulumi.StringPtrInput
	DnsAddress pulumi.StringPtrInput
	Endpoints endpointsServiceEndpoint.ServiceEndpointArrayInput
