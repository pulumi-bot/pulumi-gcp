...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/folder/OrganizationPolicyListPolicyAllow"
	"https:/github.com/pulumi/pulumi-gcp/folder/OrganizationPolicyListPolicyDeny"
)

type OrganizationPolicyListPolicy struct {
	Allow *folderOrganizationPolicyListPolicyAllow.OrganizationPolicyListPolicyAllow `pulumi:"allow"`
	Deny *folderOrganizationPolicyListPolicyDeny.OrganizationPolicyListPolicyDeny `pulumi:"deny"`
...
type OrganizationPolicyListPolicyArgs struct {
	Allow folderOrganizationPolicyListPolicyAllow.OrganizationPolicyListPolicyAllowPtrInput `pulumi:"allow"`
	Deny folderOrganizationPolicyListPolicyDeny.OrganizationPolicyListPolicyDenyPtrInput `pulumi:"deny"`
...
func (o OrganizationPolicyListPolicyOutput) Allow() folderOrganizationPolicyListPolicyAllow.OrganizationPolicyListPolicyAllowPtrOutput {
	return o.ApplyT(func (v OrganizationPolicyListPolicy) *folderOrganizationPolicyListPolicyAllow.OrganizationPolicyListPolicyAllow { return v.Allow }).(folderOrganizationPolicyListPolicyAllow.OrganizationPolicyListPolicyAllowPtrOutput)
}

func (o OrganizationPolicyListPolicyOutput) Deny() folderOrganizationPolicyListPolicyDeny.OrganizationPolicyListPolicyDenyPtrOutput {
	return o.ApplyT(func (v OrganizationPolicyListPolicy) *folderOrganizationPolicyListPolicyDeny.OrganizationPolicyListPolicyDeny { return v.Deny }).(folderOrganizationPolicyListPolicyDeny.OrganizationPolicyListPolicyDenyPtrOutput)
}
...
func (o OrganizationPolicyListPolicyPtrOutput) Allow() folderOrganizationPolicyListPolicyAllow.OrganizationPolicyListPolicyAllowPtrOutput {
	return o.ApplyT(func (v OrganizationPolicyListPolicy) *folderOrganizationPolicyListPolicyAllow.OrganizationPolicyListPolicyAllow { return v.Allow }).(folderOrganizationPolicyListPolicyAllow.OrganizationPolicyListPolicyAllowPtrOutput)
}

func (o OrganizationPolicyListPolicyPtrOutput) Deny() folderOrganizationPolicyListPolicyDeny.OrganizationPolicyListPolicyDenyPtrOutput {
	return o.ApplyT(func (v OrganizationPolicyListPolicy) *folderOrganizationPolicyListPolicyDeny.OrganizationPolicyListPolicyDeny { return v.Deny }).(folderOrganizationPolicyListPolicyDeny.OrganizationPolicyListPolicyDenyPtrOutput)
}
