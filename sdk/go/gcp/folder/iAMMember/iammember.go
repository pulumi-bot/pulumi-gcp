...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/folder/IAMMemberCondition"
)
...
type IAMMember struct {
	...
	Condition folderIAMMemberCondition.IAMMemberConditionPtrOutput `pulumi:"condition"`
...
type iammemberState struct {
	Condition *folderIAMMemberCondition.IAMMemberCondition `pulumi:"condition"`
	// (Computed) The etag of the folder's IAM policy.
...
type IAMMemberState struct {
	Condition folderIAMMemberCondition.IAMMemberConditionPtrInput
	// (Computed) The etag of the folder's IAM policy.
