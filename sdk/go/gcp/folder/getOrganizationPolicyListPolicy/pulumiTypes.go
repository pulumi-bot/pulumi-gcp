...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/folder/getOrganizationPolicyListPolicyAllow"
	"https:/github.com/pulumi/pulumi-gcp/folder/getOrganizationPolicyListPolicyDeny"
)

type GetOrganizationPolicyListPolicy struct {
	Allows []foldergetOrganizationPolicyListPolicyAllow.GetOrganizationPolicyListPolicyAllow `pulumi:"allows"`
	Denies []foldergetOrganizationPolicyListPolicyDeny.GetOrganizationPolicyListPolicyDeny `pulumi:"denies"`
...
type GetOrganizationPolicyListPolicyArgs struct {
	Allows foldergetOrganizationPolicyListPolicyAllow.GetOrganizationPolicyListPolicyAllowArrayInput `pulumi:"allows"`
	Denies foldergetOrganizationPolicyListPolicyDeny.GetOrganizationPolicyListPolicyDenyArrayInput `pulumi:"denies"`
...
func (o GetOrganizationPolicyListPolicyOutput) Allows() foldergetOrganizationPolicyListPolicyAllow.GetOrganizationPolicyListPolicyAllowArrayOutput {
	return o.ApplyT(func (v GetOrganizationPolicyListPolicy) []foldergetOrganizationPolicyListPolicyAllow.GetOrganizationPolicyListPolicyAllow { return v.Allows }).(foldergetOrganizationPolicyListPolicyAllow.GetOrganizationPolicyListPolicyAllowArrayOutput)
}

func (o GetOrganizationPolicyListPolicyOutput) Denies() foldergetOrganizationPolicyListPolicyDeny.GetOrganizationPolicyListPolicyDenyArrayOutput {
	return o.ApplyT(func (v GetOrganizationPolicyListPolicy) []foldergetOrganizationPolicyListPolicyDeny.GetOrganizationPolicyListPolicyDeny { return v.Denies }).(foldergetOrganizationPolicyListPolicyDeny.GetOrganizationPolicyListPolicyDenyArrayOutput)
}
