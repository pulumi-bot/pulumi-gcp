...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/folder/OrganizationPolicyBooleanPolicy"
	"https:/github.com/pulumi/pulumi-gcp/folder/OrganizationPolicyListPolicy"
	...
	"https:/github.com/pulumi/pulumi-gcp/folder/OrganizationPolicyRestorePolicy"
)
...
type OrganizationPolicy struct {
	...
	BooleanPolicy folderOrganizationPolicyBooleanPolicy.OrganizationPolicyBooleanPolicyPtrOutput `pulumi:"booleanPolicy"`
	...
	ListPolicy folderOrganizationPolicyListPolicy.OrganizationPolicyListPolicyPtrOutput `pulumi:"listPolicy"`
	// A restore policy is a constraint to restore the default policy. Structure is documented below.
	RestorePolicy folderOrganizationPolicyRestorePolicy.OrganizationPolicyRestorePolicyPtrOutput `pulumi:"restorePolicy"`
...
type organizationPolicyState struct {
	// A boolean policy is a constraint that is either enforced or not. Structure is documented below.
	BooleanPolicy *folderOrganizationPolicyBooleanPolicy.OrganizationPolicyBooleanPolicy `pulumi:"booleanPolicy"`
	// The name of the Constraint the Policy is configuring, for example, `serviceuser.services`. Check out the [complete list of available constraints](https://cloud.google.com/resource-manager/docs/organization-policy/understanding-constraints#available_constraints).
	...
	// A policy that can define specific values that are allowed or denied for the given constraint. It
	// can also be used to allow or deny all values. Structure is documented below.
	ListPolicy *folderOrganizationPolicyListPolicy.OrganizationPolicyListPolicy `pulumi:"listPolicy"`
	// A restore policy is a constraint to restore the default policy. Structure is documented below.
	RestorePolicy *folderOrganizationPolicyRestorePolicy.OrganizationPolicyRestorePolicy `pulumi:"restorePolicy"`
	// (Computed) The timestamp in RFC3339 UTC "Zulu" format, accurate to nanoseconds, representing when the variable was last updated. Example: "2016-10-09T12:33:37.578138407Z".
...
type OrganizationPolicyState struct {
	// A boolean policy is a constraint that is either enforced or not. Structure is documented below.
	BooleanPolicy folderOrganizationPolicyBooleanPolicy.OrganizationPolicyBooleanPolicyPtrInput
	// The name of the Constraint the Policy is configuring, for example, `serviceuser.services`. Check out the [complete list of available constraints](https://cloud.google.com/resource-manager/docs/organization-policy/understanding-constraints#available_constraints).
	...
	// A policy that can define specific values that are allowed or denied for the given constraint. It
	// can also be used to allow or deny all values. Structure is documented below.
	ListPolicy folderOrganizationPolicyListPolicy.OrganizationPolicyListPolicyPtrInput
	// A restore policy is a constraint to restore the default policy. Structure is documented below.
	RestorePolicy folderOrganizationPolicyRestorePolicy.OrganizationPolicyRestorePolicyPtrInput
	// (Computed) The timestamp in RFC3339 UTC "Zulu" format, accurate to nanoseconds, representing when the variable was last updated. Example: "2016-10-09T12:33:37.578138407Z".
