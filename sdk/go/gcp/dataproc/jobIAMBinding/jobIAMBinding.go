...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/dataproc/JobIAMBindingCondition"
)
...
type JobIAMBinding struct {
	...
	Condition dataprocJobIAMBindingCondition.JobIAMBindingConditionPtrOutput `pulumi:"condition"`
...
type jobIAMBindingState struct {
	Condition *dataprocJobIAMBindingCondition.JobIAMBindingCondition `pulumi:"condition"`
	// (Computed) The etag of the jobs's IAM policy.
...
type JobIAMBindingState struct {
	Condition dataprocJobIAMBindingCondition.JobIAMBindingConditionPtrInput
	// (Computed) The etag of the jobs's IAM policy.
