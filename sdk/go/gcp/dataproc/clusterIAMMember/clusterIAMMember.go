...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/dataproc/ClusterIAMMemberCondition"
)
...
type ClusterIAMMember struct {
	...
	Condition dataprocClusterIAMMemberCondition.ClusterIAMMemberConditionPtrOutput `pulumi:"condition"`
...
type clusterIAMMemberState struct {
	...
	Condition *dataprocClusterIAMMemberCondition.ClusterIAMMemberCondition `pulumi:"condition"`
	// (Computed) The etag of the clusters's IAM policy.
...
type ClusterIAMMemberState struct {
	...
	Condition dataprocClusterIAMMemberCondition.ClusterIAMMemberConditionPtrInput
	// (Computed) The etag of the clusters's IAM policy.
