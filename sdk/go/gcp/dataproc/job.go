...
type jobArgs struct {
	...
	// job is first cancelled before issuing the delete.
	ForceDelete  *bool                `pulumi:"forceDelete"`
	HadoopConfig *JobHadoopConfigArgs `pulumi:"hadoopConfig"`
	HiveConfig   *JobHiveConfigArgs   `pulumi:"hiveConfig"`
	// The list of labels (key/value pairs) to add to the job.
	Labels    map[string]string `pulumi:"labels"`
	PigConfig *JobPigConfigArgs `pulumi:"pigConfig"`
	Placement JobPlacementArgs  `pulumi:"placement"`
	// The project in which the `cluster` can be found and jobs
	// subsequently run against. If it is not provided, the provider project is used.
	Project       *string               `pulumi:"project"`
	PysparkConfig *JobPysparkConfigArgs `pulumi:"pysparkConfig"`
	Reference     *JobReferenceArgs     `pulumi:"reference"`
	// The Cloud Dataproc region. This essentially determines which clusters are available
	// for this job to be submitted to. If not specified, defaults to `global`.
	Region *string `pulumi:"region"`
	// Optional. Job scheduling configuration.
	Scheduling     *JobSchedulingArgs     `pulumi:"scheduling"`
	SparkConfig    *JobSparkConfigArgs    `pulumi:"sparkConfig"`
	SparksqlConfig *JobSparksqlConfigArgs `pulumi:"sparksqlConfig"`
}
...
type JobArgs struct {
	...
	// job is first cancelled before issuing the delete.
	ForceDelete  pulumi.BoolPtrInput
	HadoopConfig JobHadoopConfigArgsPtrInput
	HiveConfig   JobHiveConfigArgsPtrInput
	// The list of labels (key/value pairs) to add to the job.
	Labels    pulumi.StringMapInput
	PigConfig JobPigConfigArgsPtrInput
	Placement JobPlacementArgsInput
	// The project in which the `cluster` can be found and jobs
	// subsequently run against. If it is not provided, the provider project is used.
	Project       pulumi.StringPtrInput
	PysparkConfig JobPysparkConfigArgsPtrInput
	Reference     JobReferenceArgsPtrInput
	// The Cloud Dataproc region. This essentially determines which clusters are available
	// for this job to be submitted to. If not specified, defaults to `global`.
	Region pulumi.StringPtrInput
	// Optional. Job scheduling configuration.
	Scheduling     JobSchedulingArgsPtrInput
	SparkConfig    JobSparkConfigArgsPtrInput
	SparksqlConfig JobSparksqlConfigArgsPtrInput
}
