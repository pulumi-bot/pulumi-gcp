...
type autoscalingPolicyArgs struct {
	// Basic algorithm for autoscaling.
	BasicAlgorithm *AutoscalingPolicyBasicAlgorithmArgs `pulumi:"basicAlgorithm"`
	// The location where the autoscaling poicy should reside. The default value is 'global'.
	Location *string `pulumi:"location"`
	// The policy id. The id must contain only letters (a-z, A-Z), numbers (0-9), underscores (_), and hyphens (-). Cannot
	// begin or end with underscore or hyphen. Must consist of between 3 and 50 characters.
	...
	Project *string `pulumi:"project"`
	// Describes how the autoscaler will operate for secondary workers.
	SecondaryWorkerConfig *AutoscalingPolicySecondaryWorkerConfigArgs `pulumi:"secondaryWorkerConfig"`
	// Describes how the autoscaler will operate for primary workers.
	WorkerConfig *AutoscalingPolicyWorkerConfigArgs `pulumi:"workerConfig"`
}

// The set of arguments for constructing a AutoscalingPolicy resource.
type AutoscalingPolicyArgs struct {
	// Basic algorithm for autoscaling.
	BasicAlgorithm AutoscalingPolicyBasicAlgorithmArgsPtrInput
	// The location where the autoscaling poicy should reside. The default value is 'global'.
	Location pulumi.StringPtrInput
	// The policy id. The id must contain only letters (a-z, A-Z), numbers (0-9), underscores (_), and hyphens (-). Cannot
	// begin or end with underscore or hyphen. Must consist of between 3 and 50 characters.
	...
	Project pulumi.StringPtrInput
	// Describes how the autoscaler will operate for secondary workers.
	SecondaryWorkerConfig AutoscalingPolicySecondaryWorkerConfigArgsPtrInput
	// Describes how the autoscaler will operate for primary workers.
	WorkerConfig AutoscalingPolicyWorkerConfigArgsPtrInput
}
