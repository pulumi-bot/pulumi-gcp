...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/dataproc/ClusterClusterConfig"
...
type Cluster struct {
	...
	ClusterConfig dataprocClusterClusterConfig.ClusterClusterConfigOutput `pulumi:"clusterConfig"`
...
type clusterState struct {
	// Allows you to configure various aspects of the cluster.
	// Structure defined below.
	ClusterConfig *dataprocClusterClusterConfig.ClusterClusterConfig `pulumi:"clusterConfig"`
	// The list of labels (key/value pairs) to be applied to
	// instances in the cluster. GCP generates some itself including `goog-dataproc-cluster-name`
	// which is the name of the cluster.
...
type ClusterState struct {
	// Allows you to configure various aspects of the cluster.
	// Structure defined below.
	ClusterConfig dataprocClusterClusterConfig.ClusterClusterConfigPtrInput
	// The list of labels (key/value pairs) to be applied to
	// instances in the cluster. GCP generates some itself including `goog-dataproc-cluster-name`
	// which is the name of the cluster.
