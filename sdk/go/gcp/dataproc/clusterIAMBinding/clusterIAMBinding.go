...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/dataproc/ClusterIAMBindingCondition"
)
...
type ClusterIAMBinding struct {
	...
	Condition dataprocClusterIAMBindingCondition.ClusterIAMBindingConditionPtrOutput `pulumi:"condition"`
...
type clusterIAMBindingState struct {
	...
	Condition *dataprocClusterIAMBindingCondition.ClusterIAMBindingCondition `pulumi:"condition"`
	// (Computed) The etag of the clusters's IAM policy.
...
type ClusterIAMBindingState struct {
	...
	Condition dataprocClusterIAMBindingCondition.ClusterIAMBindingConditionPtrInput
	// (Computed) The etag of the clusters's IAM policy.
