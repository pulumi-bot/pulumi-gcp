...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/dataproc/JobIAMMemberCondition"
)
...
type JobIAMMember struct {
	...
	Condition dataprocJobIAMMemberCondition.JobIAMMemberConditionPtrOutput `pulumi:"condition"`
...
type jobIAMMemberState struct {
	Condition *dataprocJobIAMMemberCondition.JobIAMMemberCondition `pulumi:"condition"`
	// (Computed) The etag of the jobs's IAM policy.
...
type JobIAMMemberState struct {
	Condition dataprocJobIAMMemberCondition.JobIAMMemberConditionPtrInput
	// (Computed) The etag of the jobs's IAM policy.
