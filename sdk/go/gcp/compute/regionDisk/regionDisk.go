...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/RegionDiskDiskEncryptionKey"
	"https:/github.com/pulumi/pulumi-gcp/compute/RegionDiskSourceSnapshotEncryptionKey"
)
...
type RegionDisk struct {
	...
	DiskEncryptionKey computeRegionDiskDiskEncryptionKey.RegionDiskDiskEncryptionKeyPtrOutput `pulumi:"diskEncryptionKey"`
	...
	SourceSnapshotEncryptionKey computeRegionDiskSourceSnapshotEncryptionKey.RegionDiskSourceSnapshotEncryptionKeyPtrOutput `pulumi:"sourceSnapshotEncryptionKey"`
...
type regionDiskState struct {
	...
	// provide an encryption key when creating the disk, then the disk will be encrypted using an automatically generated key
	// and you do not need to provide a key to use the disk later.
	DiskEncryptionKey *computeRegionDiskDiskEncryptionKey.RegionDiskDiskEncryptionKey `pulumi:"diskEncryptionKey"`
	// The fingerprint used for optimistic locking of this resource. Used internally during updates.
	...
	// The customer-supplied encryption key of the source snapshot. Required if the source snapshot is protected by a
	// customer-supplied encryption key.
	SourceSnapshotEncryptionKey *computeRegionDiskSourceSnapshotEncryptionKey.RegionDiskSourceSnapshotEncryptionKey `pulumi:"sourceSnapshotEncryptionKey"`
	// The unique ID of the snapshot used to create this disk. This value identifies the exact snapshot that was used to create
	// this persistent disk. For example, if you created the persistent disk from a snapshot that was later deleted and
	// recreated under the same name, the source snapshot ID would identify the exact version of the snapshot that was used.
...
type RegionDiskState struct {
	...
	// provide an encryption key when creating the disk, then the disk will be encrypted using an automatically generated key
	// and you do not need to provide a key to use the disk later.
	DiskEncryptionKey computeRegionDiskDiskEncryptionKey.RegionDiskDiskEncryptionKeyPtrInput
	// The fingerprint used for optimistic locking of this resource. Used internally during updates.
	...
	// The customer-supplied encryption key of the source snapshot. Required if the source snapshot is protected by a
	// customer-supplied encryption key.
	SourceSnapshotEncryptionKey computeRegionDiskSourceSnapshotEncryptionKey.RegionDiskSourceSnapshotEncryptionKeyPtrInput
	// The unique ID of the snapshot used to create this disk. This value identifies the exact snapshot that was used to create
	// this persistent disk. For example, if you created the persistent disk from a snapshot that was later deleted and
	// recreated under the same name, the source snapshot ID would identify the exact version of the snapshot that was used.
