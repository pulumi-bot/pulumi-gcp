...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/FirewallAllow"
	"https:/github.com/pulumi/pulumi-gcp/compute/FirewallDeny"
)
...
type Firewall struct {
	...
	Allows computeFirewallAllow.FirewallAllowArrayOutput `pulumi:"allows"`
	...
	// denied connection.
	Denies computeFirewallDeny.FirewallDenyArrayOutput `pulumi:"denies"`
...
type firewallState struct {
	// The list of ALLOW rules specified by this firewall. Each rule specifies a protocol and port-range tuple that describes a
	// permitted connection.
	Allows []computeFirewallAllow.FirewallAllow `pulumi:"allows"`
	// Creation timestamp in RFC3339 text format.
	CreationTimestamp *string `pulumi:"creationTimestamp"`
	// The list of DENY rules specified by this firewall. Each rule specifies a protocol and port-range tuple that describes a
	// denied connection.
	Denies []computeFirewallDeny.FirewallDeny `pulumi:"denies"`
	// An optional description of this resource. Provide this property when you create the resource.
...
type FirewallState struct {
	// The list of ALLOW rules specified by this firewall. Each rule specifies a protocol and port-range tuple that describes a
	// permitted connection.
	Allows computeFirewallAllow.FirewallAllowArrayInput
	// Creation timestamp in RFC3339 text format.
	CreationTimestamp pulumi.StringPtrInput
	// The list of DENY rules specified by this firewall. Each rule specifies a protocol and port-range tuple that describes a
	// denied connection.
	Denies computeFirewallDeny.FirewallDenyArrayInput
	// An optional description of this resource. Provide this property when you create the resource.
