...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/InstanceIAMBindingCondition"
)
...
type InstanceIAMBinding struct {
	...
	Condition computeInstanceIAMBindingCondition.InstanceIAMBindingConditionPtrOutput `pulumi:"condition"`
...
type instanceIAMBindingState struct {
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition *computeInstanceIAMBindingCondition.InstanceIAMBindingCondition `pulumi:"condition"`
	// (Computed) The etag of the IAM policy.
...
type InstanceIAMBindingState struct {
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition computeInstanceIAMBindingCondition.InstanceIAMBindingConditionPtrInput
	// (Computed) The etag of the IAM policy.
