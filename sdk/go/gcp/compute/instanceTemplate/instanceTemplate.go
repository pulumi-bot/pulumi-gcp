...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/InstanceTemplateDisk"
	"https:/github.com/pulumi/pulumi-gcp/compute/InstanceTemplateDiskDiskEncryptionKey"
	"https:/github.com/pulumi/pulumi-gcp/compute/InstanceTemplateGuestAccelerator"
	"https:/github.com/pulumi/pulumi-gcp/compute/InstanceTemplateNetworkInterface"
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/InstanceTemplateScheduling"
	"https:/github.com/pulumi/pulumi-gcp/compute/InstanceTemplateSchedulingNodeAffinity"
	"https:/github.com/pulumi/pulumi-gcp/compute/InstanceTemplateServiceAccount"
	"https:/github.com/pulumi/pulumi-gcp/compute/InstanceTemplateShieldedInstanceConfig"
)
...
type InstanceTemplate struct {
	...
	// documented below.
	Disks computeInstanceTemplateDisk.InstanceTemplateDiskArrayOutput `pulumi:"disks"`
	...
	GuestAccelerators computeInstanceTemplateGuestAccelerator.InstanceTemplateGuestAcceleratorArrayOutput `pulumi:"guestAccelerators"`
	...
	NetworkInterfaces computeInstanceTemplateNetworkInterface.InstanceTemplateNetworkInterfaceArrayOutput `pulumi:"networkInterfaces"`
	...
	Scheduling computeInstanceTemplateScheduling.InstanceTemplateSchedulingOutput `pulumi:"scheduling"`
	// The URI of the created resource.
	SelfLink pulumi.StringOutput `pulumi:"selfLink"`
	// Service account to attach to the instance. Structure is documented below.
	ServiceAccount computeInstanceTemplateServiceAccount.InstanceTemplateServiceAccountPtrOutput `pulumi:"serviceAccount"`
	...
	ShieldedInstanceConfig computeInstanceTemplateShieldedInstanceConfig.InstanceTemplateShieldedInstanceConfigOutput `pulumi:"shieldedInstanceConfig"`
...
type instanceTemplateState struct {
	...
	// This can be specified multiple times for multiple disks. Structure is
	// documented below.
	Disks []computeInstanceTemplateDisk.InstanceTemplateDisk `pulumi:"disks"`
	// Enable [Virtual Displays](https://cloud.google.com/compute/docs/instances/enable-instance-virtual-display#verify_display_driver) on this instance.
	// **Note**: `allowStoppingForUpdate` must be set to true in order to update this field.
	EnableDisplay *bool `pulumi:"enableDisplay"`
	// List of the type and count of accelerator cards attached to the instance. Structure documented below.
	GuestAccelerators []computeInstanceTemplateGuestAccelerator.InstanceTemplateGuestAccelerator `pulumi:"guestAccelerators"`
	// A brief description to use for instances
	// created from this template.
	...
	// this template. This can be specified multiple times for multiple networks.
	// Structure is documented below.
	NetworkInterfaces []computeInstanceTemplateNetworkInterface.InstanceTemplateNetworkInterface `pulumi:"networkInterfaces"`
	// The ID of the project in which the resource belongs. If it
	// is not provided, the provider project is used.
	...
	// The scheduling strategy to use. More details about
	// this configuration option are detailed below.
	Scheduling *computeInstanceTemplateScheduling.InstanceTemplateScheduling `pulumi:"scheduling"`
	// The URI of the created resource.
	SelfLink *string `pulumi:"selfLink"`
	// Service account to attach to the instance. Structure is documented below.
	ServiceAccount *computeInstanceTemplateServiceAccount.InstanceTemplateServiceAccount `pulumi:"serviceAccount"`
	// Enable [Shielded VM](https://cloud.google.com/security/shielded-cloud/shielded-vm) on this instance. Shielded VM provides verifiable integrity to prevent against malware and rootkits. Defaults to disabled. Structure is documented below.
	// **Note**: `shieldedInstanceConfig` can only be used with boot images with shielded vm support. See the complete list [here](https://cloud.google.com/compute/docs/images#shielded-images).
	ShieldedInstanceConfig *computeInstanceTemplateShieldedInstanceConfig.InstanceTemplateShieldedInstanceConfig `pulumi:"shieldedInstanceConfig"`
	// Tags to attach to the instance.
...
type InstanceTemplateState struct {
	...
	// This can be specified multiple times for multiple disks. Structure is
	// documented below.
	Disks computeInstanceTemplateDisk.InstanceTemplateDiskArrayInput
	// Enable [Virtual Displays](https://cloud.google.com/compute/docs/instances/enable-instance-virtual-display#verify_display_driver) on this instance.
	// **Note**: `allowStoppingForUpdate` must be set to true in order to update this field.
	EnableDisplay pulumi.BoolPtrInput
	// List of the type and count of accelerator cards attached to the instance. Structure documented below.
	GuestAccelerators computeInstanceTemplateGuestAccelerator.InstanceTemplateGuestAcceleratorArrayInput
	// A brief description to use for instances
	// created from this template.
	...
	// this template. This can be specified multiple times for multiple networks.
	// Structure is documented below.
	NetworkInterfaces computeInstanceTemplateNetworkInterface.InstanceTemplateNetworkInterfaceArrayInput
	// The ID of the project in which the resource belongs. If it
	// is not provided, the provider project is used.
	...
	// The scheduling strategy to use. More details about
	// this configuration option are detailed below.
	Scheduling computeInstanceTemplateScheduling.InstanceTemplateSchedulingPtrInput
	// The URI of the created resource.
	SelfLink pulumi.StringPtrInput
	// Service account to attach to the instance. Structure is documented below.
	ServiceAccount computeInstanceTemplateServiceAccount.InstanceTemplateServiceAccountPtrInput
	// Enable [Shielded VM](https://cloud.google.com/security/shielded-cloud/shielded-vm) on this instance. Shielded VM provides verifiable integrity to prevent against malware and rootkits. Defaults to disabled. Structure is documented below.
	// **Note**: `shieldedInstanceConfig` can only be used with boot images with shielded vm support. See the complete list [here](https://cloud.google.com/compute/docs/images#shielded-images).
	ShieldedInstanceConfig computeInstanceTemplateShieldedInstanceConfig.InstanceTemplateShieldedInstanceConfigPtrInput
	// Tags to attach to the instance.
