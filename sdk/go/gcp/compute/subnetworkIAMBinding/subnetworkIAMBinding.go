...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/SubnetworkIAMBindingCondition"
)
...
type SubnetworkIAMBinding struct {
	...
	Condition computeSubnetworkIAMBindingCondition.SubnetworkIAMBindingConditionPtrOutput `pulumi:"condition"`
...
type subnetworkIAMBindingState struct {
	Condition *computeSubnetworkIAMBindingCondition.SubnetworkIAMBindingCondition `pulumi:"condition"`
	// (Computed) The etag of the IAM policy.
...
type SubnetworkIAMBindingState struct {
	Condition computeSubnetworkIAMBindingCondition.SubnetworkIAMBindingConditionPtrInput
	// (Computed) The etag of the IAM policy.
