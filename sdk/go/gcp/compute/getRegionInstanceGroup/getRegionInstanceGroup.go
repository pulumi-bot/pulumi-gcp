...
// nolint: lll
package getRegionInstanceGroup

import (
	"github.com/pulumi/pulumi/sdk/go/pulumi"
	"https:/github.com/pulumi/pulumi-gcp/compute/getRegionInstanceGroupInstance"
...
type GetRegionInstanceGroupResult struct {
	...
	Instances []computegetRegionInstanceGroupInstance.GetRegionInstanceGroupInstance `pulumi:"instances"`
	// String port name
	Name string `pulumi:"name"`
	Project string `pulumi:"project"`
	Region string `pulumi:"region"`
