...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/ExternalVpnGatewayInterface"
)
...
type ExternalVpnGateway struct {
	...
	Interfaces computeExternalVpnGatewayInterface.ExternalVpnGatewayInterfaceArrayOutput `pulumi:"interfaces"`
...
type externalVpnGatewayState struct {
	...
	// A list of interfaces on this external VPN gateway.
	Interfaces []computeExternalVpnGatewayInterface.ExternalVpnGatewayInterface `pulumi:"interfaces"`
	// Name of the resource. Provided by the client when the resource is created. The name must be 1-63 characters long, and
	// comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression
	// '[a-z]([-a-z0-9]*[a-z0-9])?' which means the first character must be a lowercase letter, and all following characters
	// must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
...
type ExternalVpnGatewayState struct {
	...
	// A list of interfaces on this external VPN gateway.
	Interfaces computeExternalVpnGatewayInterface.ExternalVpnGatewayInterfaceArrayInput
	// Name of the resource. Provided by the client when the resource is created. The name must be 1-63 characters long, and
	// comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression
	// '[a-z]([-a-z0-9]*[a-z0-9])?' which means the first character must be a lowercase letter, and all following characters
	// must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
