...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/SubnetworkLogConfig"
	"https:/github.com/pulumi/pulumi-gcp/compute/SubnetworkSecondaryIpRange"
)
...
type Subnetwork struct {
	...
	LogConfig computeSubnetworkLogConfig.SubnetworkLogConfigPtrOutput `pulumi:"logConfig"`
	...
	SecondaryIpRanges computeSubnetworkSecondaryIpRange.SubnetworkSecondaryIpRangeArrayOutput `pulumi:"secondaryIpRanges"`
...
type subnetworkState struct {
	...
	// Denotes the logging options for the subnetwork flow logs. If logging is enabled logs will be exported to Stackdriver.
	// This field cannot be set if the 'purpose' of this subnetwork is 'INTERNAL_HTTPS_LOAD_BALANCER'
	LogConfig *computeSubnetworkLogConfig.SubnetworkLogConfig `pulumi:"logConfig"`
	// The name of the resource, provided by the client when initially creating the resource. The name must be 1-63 characters
	// long, and comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression
	// '[a-z]([-a-z0-9]*[a-z0-9])?' which means the first character must be a lowercase letter, and all following characters
	// must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
	...
	// ranges. This field uses attr-as-block mode to avoid breaking users during the 0.12 upgrade. See [the Attr-as-Block
	// page](https://www.terraform.io/docs/configuration/attr-as-blocks.html) for more details.
	SecondaryIpRanges []computeSubnetworkSecondaryIpRange.SubnetworkSecondaryIpRange `pulumi:"secondaryIpRanges"`
	// The URI of the created resource.
...
type SubnetworkState struct {
	...
	// Denotes the logging options for the subnetwork flow logs. If logging is enabled logs will be exported to Stackdriver.
	// This field cannot be set if the 'purpose' of this subnetwork is 'INTERNAL_HTTPS_LOAD_BALANCER'
	LogConfig computeSubnetworkLogConfig.SubnetworkLogConfigPtrInput
	// The name of the resource, provided by the client when initially creating the resource. The name must be 1-63 characters
	// long, and comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression
	// '[a-z]([-a-z0-9]*[a-z0-9])?' which means the first character must be a lowercase letter, and all following characters
	// must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
	...
	// ranges. This field uses attr-as-block mode to avoid breaking users during the 0.12 upgrade. See [the Attr-as-Block
	// page](https://www.terraform.io/docs/configuration/attr-as-blocks.html) for more details.
	SecondaryIpRanges computeSubnetworkSecondaryIpRange.SubnetworkSecondaryIpRangeArrayInput
	// The URI of the created resource.
