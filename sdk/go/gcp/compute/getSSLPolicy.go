...
func LookupSSLPolicyApply(ctx *pulumi.Context, args LookupSSLPolicyApplyInput, opts ...pulumi.InvokeOption) LookupSSLPolicyResultOutput {
	return args.ToLookupSSLPolicyApplyOutput().ApplyT(func(v LookupSSLPolicyArgs) (LookupSSLPolicyResult, error) {
		r, err := LookupSSLPolicy(ctx, &v, opts...)
		return *r, err

	}).(LookupSSLPolicyResultOutput)
}

// LookupSSLPolicyApplyInput is an input type that accepts LookupSSLPolicyApplyArgs and LookupSSLPolicyApplyOutput values.
// You can construct a concrete instance of `LookupSSLPolicyApplyInput` via:
//
//          LookupSSLPolicyApplyArgs{...}
type LookupSSLPolicyApplyInput interface {
	pulumi.Input

	ToLookupSSLPolicyApplyOutput() LookupSSLPolicyApplyOutput
	ToLookupSSLPolicyApplyOutputWithContext(context.Context) LookupSSLPolicyApplyOutput
}

// A collection of arguments for invoking getSSLPolicy.
type LookupSSLPolicyApplyArgs struct {
	// The name of the SSL Policy.
...
func (LookupSSLPolicyApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupSSLPolicyArgs)(nil)).Elem()
}

func (i LookupSSLPolicyApplyArgs) ToLookupSSLPolicyApplyOutput() LookupSSLPolicyApplyOutput {
	return i.ToLookupSSLPolicyApplyOutputWithContext(context.Background())
}

func (i LookupSSLPolicyApplyArgs) ToLookupSSLPolicyApplyOutputWithContext(ctx context.Context) LookupSSLPolicyApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupSSLPolicyApplyOutput)
}

// A collection of arguments for invoking getSSLPolicy.
type LookupSSLPolicyApplyOutput struct{ *pulumi.OutputState }

func (LookupSSLPolicyApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupSSLPolicyArgs)(nil)).Elem()
}

func (o LookupSSLPolicyApplyOutput) ToLookupSSLPolicyApplyOutput() LookupSSLPolicyApplyOutput {
	return o
}

func (o LookupSSLPolicyApplyOutput) ToLookupSSLPolicyApplyOutputWithContext(ctx context.Context) LookupSSLPolicyApplyOutput {
	return o
}

// The name of the SSL Policy.
func (o LookupSSLPolicyApplyOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSSLPolicyArgs) string { return v.Name }).(pulumi.StringOutput)
}

// The ID of the project in which the resource belongs. If it
// is not provided, the provider project is used.
func (o LookupSSLPolicyApplyOutput) Project() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSSLPolicyArgs) *string { return v.Project }).(pulumi.StringPtrOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupSSLPolicyApplyOutput{})
