...
type snapshotArgs struct {
	...
	// The customer-supplied encryption key of the snapshot. Required if the source snapshot is protected by a
	// customer-supplied encryption key.
	SnapshotEncryptionKey *SnapshotSnapshotEncryptionKeyArgs `pulumi:"snapshotEncryptionKey"`
	// A reference to the disk used to create this snapshot.
	SourceDisk string `pulumi:"sourceDisk"`
	// The customer-supplied encryption key of the source snapshot. Required if the source snapshot is protected by a
	// customer-supplied encryption key.
	SourceDiskEncryptionKey *SnapshotSourceDiskEncryptionKeyArgs `pulumi:"sourceDiskEncryptionKey"`
	// A reference to the zone where the disk is hosted.
	Zone *string `pulumi:"zone"`
}
...
type SnapshotArgs struct {
	...
	// The customer-supplied encryption key of the snapshot. Required if the source snapshot is protected by a
	// customer-supplied encryption key.
	SnapshotEncryptionKey SnapshotSnapshotEncryptionKeyArgsPtrInput
	// A reference to the disk used to create this snapshot.
	SourceDisk pulumi.StringInput
	// The customer-supplied encryption key of the source snapshot. Required if the source snapshot is protected by a
	// customer-supplied encryption key.
	SourceDiskEncryptionKey SnapshotSourceDiskEncryptionKeyArgsPtrInput
	// A reference to the zone where the disk is hosted.
	Zone pulumi.StringPtrInput
}
