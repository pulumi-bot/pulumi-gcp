...
// nolint: lll
package getSubnetwork

import (
	"github.com/pulumi/pulumi/sdk/go/pulumi"
	"https:/github.com/pulumi/pulumi-gcp/compute/getSubnetworkSecondaryIpRange"
)
...
func GetSubnetwork(ctx *pulumi.Context, args *GetSubnetworkArgs, opts ...pulumi.InvokeOption) (*GetSubnetworkResult, error) {
	var rv GetSubnetworkResult
...
type GetSubnetworkResult struct {
	...
	SecondaryIpRanges []computegetSubnetworkSecondaryIpRange.GetSubnetworkSecondaryIpRange `pulumi:"secondaryIpRanges"`
	SelfLink string `pulumi:"selfLink"`
}
