...
type instanceArgs struct {
	...
	AllowStoppingForUpdate *bool `pulumi:"allowStoppingForUpdate"`
	// Additional disks to attach to the instance. Can be repeated multiple times for multiple disks. Structure is documented below.
	AttachedDisks []InstanceAttachedDiskArgs `pulumi:"attachedDisks"`
	// The boot disk for the instance.
	// Structure is documented below.
	BootDisk InstanceBootDiskArgs `pulumi:"bootDisk"`
	// Whether to allow sending and receiving of
	// packets with non-matching source or destination IPs.
	// This defaults to false.
	CanIpForward *bool `pulumi:"canIpForward"`
	...
	// List of the type and count of accelerator cards attached to the instance. Structure documented below.
	// **Note:** GPU accelerators can only be used with `onHostMaintenance` option set to TERMINATE.
	GuestAccelerators []InstanceGuestAcceleratorArgs `pulumi:"guestAccelerators"`
	// A custom hostname for the instance. Must be a fully qualified DNS name and RFC-1035-valid.
	// Valid format is a series of labels 1-63 characters long matching the regular expression `a-z`, concatenated with periods.
	// The entire hostname must not exceed 253 characters. Changing this forces a new resource to be created.
	Hostname *string `pulumi:"hostname"`
	...
	// The scheduling strategy to use. More details about
	// this configuration option are detailed below.
	Scheduling *InstanceSchedulingArgs `pulumi:"scheduling"`
	// Scratch disks to attach to the instance. This can be
	// specified multiple times for multiple scratch disks. Structure is documented below.
	ScratchDisks []InstanceScratchDiskArgs `pulumi:"scratchDisks"`
	// Service account to attach to the instance.
	// Structure is documented below.
	// **Note**: `allowStoppingForUpdate` must be set to true or your instance must have a `desiredStatus` of `TERMINATED` in order to update this field.
	ServiceAccount *InstanceServiceAccountArgs `pulumi:"serviceAccount"`
	// Enable [Shielded VM](https://cloud.google.com/security/shielded-cloud/shielded-vm) on this instance. Shielded VM provides verifiable integrity to prevent against malware and rootkits. Defaults to disabled. Structure is documented below.
	// **Note**: `shieldedInstanceConfig` can only be used with boot images with shielded vm support. See the complete list [here](https://cloud.google.com/compute/docs/images#shielded-images).
	ShieldedInstanceConfig *InstanceShieldedInstanceConfigArgs `pulumi:"shieldedInstanceConfig"`
	// A list of tags to attach to the instance.
	Tags []string `pulumi:"tags"`
	// The zone that the machine should be created in.
	Zone *string `pulumi:"zone"`
...
type InstanceArgs struct {
	...
	AllowStoppingForUpdate pulumi.BoolPtrInput
	// Additional disks to attach to the instance. Can be repeated multiple times for multiple disks. Structure is documented below.
	AttachedDisks InstanceAttachedDiskArgsArrayInput
	// The boot disk for the instance.
	// Structure is documented below.
	BootDisk InstanceBootDiskArgsInput
	// Whether to allow sending and receiving of
	// packets with non-matching source or destination IPs.
	// This defaults to false.
	CanIpForward pulumi.BoolPtrInput
	...
	// List of the type and count of accelerator cards attached to the instance. Structure documented below.
	// **Note:** GPU accelerators can only be used with `onHostMaintenance` option set to TERMINATE.
	GuestAccelerators InstanceGuestAcceleratorArgsArrayInput
	// A custom hostname for the instance. Must be a fully qualified DNS name and RFC-1035-valid.
	// Valid format is a series of labels 1-63 characters long matching the regular expression `a-z`, concatenated with periods.
	// The entire hostname must not exceed 253 characters. Changing this forces a new resource to be created.
	Hostname pulumi.StringPtrInput
	...
	// The scheduling strategy to use. More details about
	// this configuration option are detailed below.
	Scheduling InstanceSchedulingArgsPtrInput
	// Scratch disks to attach to the instance. This can be
	// specified multiple times for multiple scratch disks. Structure is documented below.
	ScratchDisks InstanceScratchDiskArgsArrayInput
	// Service account to attach to the instance.
	// Structure is documented below.
	// **Note**: `allowStoppingForUpdate` must be set to true or your instance must have a `desiredStatus` of `TERMINATED` in order to update this field.
	ServiceAccount InstanceServiceAccountArgsPtrInput
	// Enable [Shielded VM](https://cloud.google.com/security/shielded-cloud/shielded-vm) on this instance. Shielded VM provides verifiable integrity to prevent against malware and rootkits. Defaults to disabled. Structure is documented below.
	// **Note**: `shieldedInstanceConfig` can only be used with boot images with shielded vm support. See the complete list [here](https://cloud.google.com/compute/docs/images#shielded-images).
	ShieldedInstanceConfig InstanceShieldedInstanceConfigArgsPtrInput
	// A list of tags to attach to the instance.
	Tags pulumi.StringArrayInput
	// The zone that the machine should be created in.
	Zone pulumi.StringPtrInput
