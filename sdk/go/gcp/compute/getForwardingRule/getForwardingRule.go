...
func GetForwardingRule(ctx *pulumi.Context, args *GetForwardingRuleArgs, opts ...pulumi.InvokeOption) (*GetForwardingRuleResult, error) {
	var rv GetForwardingRuleResult
