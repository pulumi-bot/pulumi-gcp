...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/BackendBucketCdnPolicy"
)
...
type BackendBucket struct {
	...
	CdnPolicy computeBackendBucketCdnPolicy.BackendBucketCdnPolicyOutput `pulumi:"cdnPolicy"`
...
type backendBucketState struct {
	...
	// Cloud CDN configuration for this Backend Bucket.
	CdnPolicy *computeBackendBucketCdnPolicy.BackendBucketCdnPolicy `pulumi:"cdnPolicy"`
	// Creation timestamp in RFC3339 text format.
...
type BackendBucketState struct {
	...
	// Cloud CDN configuration for this Backend Bucket.
	CdnPolicy computeBackendBucketCdnPolicy.BackendBucketCdnPolicyPtrInput
	// Creation timestamp in RFC3339 text format.
