...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/SecurityPolicyRule"
...
type SecurityPolicy struct {
	...
	Rules computeSecurityPolicyRule.SecurityPolicyRuleArrayOutput `pulumi:"rules"`
...
type securityPolicyState struct {
	...
	// rule (rule with priority 2147483647 and match "\*"). If no rules are provided when creating a
	// security policy, a default rule with action "allow" will be added. Structure is documented below.
	Rules []computeSecurityPolicyRule.SecurityPolicyRule `pulumi:"rules"`
	// The URI of the created resource.
...
type SecurityPolicyState struct {
	...
	// rule (rule with priority 2147483647 and match "\*"). If no rules are provided when creating a
	// security policy, a default rule with action "allow" will be added. Structure is documented below.
	Rules computeSecurityPolicyRule.SecurityPolicyRuleArrayInput
	// The URI of the created resource.
