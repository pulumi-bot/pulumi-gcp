...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/InterconnectAttachmentPrivateInterconnectInfo"
)
...
type InterconnectAttachment struct {
	...
	PrivateInterconnectInfo computeInterconnectAttachmentPrivateInterconnectInfo.InterconnectAttachmentPrivateInterconnectInfoOutput `pulumi:"privateInterconnectInfo"`
...
type interconnectAttachmentState struct {
	...
	// Information specific to an InterconnectAttachment. This property is populated if the interconnect that this is attached
	// to is of type DEDICATED.
	PrivateInterconnectInfo *computeInterconnectAttachmentPrivateInterconnectInfo.InterconnectAttachmentPrivateInterconnectInfo `pulumi:"privateInterconnectInfo"`
	// The ID of the project in which the resource belongs.
	// If it is not provided, the provider project is used.
...
type InterconnectAttachmentState struct {
	...
	// Information specific to an InterconnectAttachment. This property is populated if the interconnect that this is attached
	// to is of type DEDICATED.
	PrivateInterconnectInfo computeInterconnectAttachmentPrivateInterconnectInfo.InterconnectAttachmentPrivateInterconnectInfoPtrInput
	// The ID of the project in which the resource belongs.
	// If it is not provided, the provider project is used.
