...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/NodeTemplateNodeTypeFlexibility"
	"https:/github.com/pulumi/pulumi-gcp/compute/NodeTemplateServerBinding"
)
...
type NodeTemplate struct {
	...
	NodeTypeFlexibility computeNodeTemplateNodeTypeFlexibility.NodeTemplateNodeTypeFlexibilityPtrOutput `pulumi:"nodeTypeFlexibility"`
	...
	// maintenance event.
	ServerBinding computeNodeTemplateServerBinding.NodeTemplateServerBindingOutput `pulumi:"serverBinding"`
}
...
type nodeTemplateState struct {
	...
	// Flexible properties for the desired node type. Node groups that use this node template will create nodes of a type that
	// matches these properties. Only one of nodeTypeFlexibility and nodeType can be specified.
	NodeTypeFlexibility *computeNodeTemplateNodeTypeFlexibility.NodeTemplateNodeTypeFlexibility `pulumi:"nodeTypeFlexibility"`
	// The ID of the project in which the resource belongs.
	// If it is not provided, the provider project is used.
	...
	// The server binding policy for nodes using this template. Determines where the nodes should restart following a
	// maintenance event.
	ServerBinding *computeNodeTemplateServerBinding.NodeTemplateServerBinding `pulumi:"serverBinding"`
}
...
type NodeTemplateState struct {
	...
	// Flexible properties for the desired node type. Node groups that use this node template will create nodes of a type that
	// matches these properties. Only one of nodeTypeFlexibility and nodeType can be specified.
	NodeTypeFlexibility computeNodeTemplateNodeTypeFlexibility.NodeTemplateNodeTypeFlexibilityPtrInput
	// The ID of the project in which the resource belongs.
	// If it is not provided, the provider project is used.
	...
	// The server binding policy for nodes using this template. Determines where the nodes should restart following a
	// maintenance event.
	ServerBinding computeNodeTemplateServerBinding.NodeTemplateServerBindingPtrInput
}
