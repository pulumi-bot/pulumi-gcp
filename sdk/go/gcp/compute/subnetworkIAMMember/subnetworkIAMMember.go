...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/SubnetworkIAMMemberCondition"
)
...
type SubnetworkIAMMember struct {
	...
	Condition computeSubnetworkIAMMemberCondition.SubnetworkIAMMemberConditionPtrOutput `pulumi:"condition"`
...
type subnetworkIAMMemberState struct {
	Condition *computeSubnetworkIAMMemberCondition.SubnetworkIAMMemberCondition `pulumi:"condition"`
	// (Computed) The etag of the IAM policy.
...
type SubnetworkIAMMemberState struct {
	Condition computeSubnetworkIAMMemberCondition.SubnetworkIAMMemberConditionPtrInput
	// (Computed) The etag of the IAM policy.
