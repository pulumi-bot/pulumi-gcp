...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/RegionAutoscalerAutoscalingPolicy"
...
type RegionAutoscaler struct {
	...
	AutoscalingPolicy computeRegionAutoscalerAutoscalingPolicy.RegionAutoscalerAutoscalingPolicyOutput `pulumi:"autoscalingPolicy"`
...
type regionAutoscalerState struct {
	...
	// autoscaler: cpuUtilization, customMetricUtilizations, and loadBalancingUtilization. If none of these are specified, the
	// default will be to autoscale based on cpuUtilization to 0.6 or 60%.
	AutoscalingPolicy *computeRegionAutoscalerAutoscalingPolicy.RegionAutoscalerAutoscalingPolicy `pulumi:"autoscalingPolicy"`
	// Creation timestamp in RFC3339 text format.
...
type RegionAutoscalerState struct {
	...
	// autoscaler: cpuUtilization, customMetricUtilizations, and loadBalancingUtilization. If none of these are specified, the
	// default will be to autoscale based on cpuUtilization to 0.6 or 60%.
	AutoscalingPolicy computeRegionAutoscalerAutoscalingPolicy.RegionAutoscalerAutoscalingPolicyPtrInput
	// Creation timestamp in RFC3339 text format.
...
type RegionAutoscalerArgs struct {
	...
	// autoscaler: cpuUtilization, customMetricUtilizations, and loadBalancingUtilization. If none of these are specified, the
	// default will be to autoscale based on cpuUtilization to 0.6 or 60%.
	AutoscalingPolicy computeRegionAutoscalerAutoscalingPolicy.RegionAutoscalerAutoscalingPolicyInput
	// An optional description of this resource.
	Description pulumi.StringPtrInput
	// Name of the resource. The name must be 1-63 characters long and match the regular expression
	// '[a-z]([-a-z0-9]*[a-z0-9])?' which means the first character must be a lowercase letter, and all following characters
