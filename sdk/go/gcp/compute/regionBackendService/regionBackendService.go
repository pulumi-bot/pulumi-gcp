...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/RegionBackendServiceBackend"
	"https:/github.com/pulumi/pulumi-gcp/compute/RegionBackendServiceCircuitBreakers"
	"https:/github.com/pulumi/pulumi-gcp/compute/RegionBackendServiceCircuitBreakersConnectTimeout"
	"https:/github.com/pulumi/pulumi-gcp/compute/RegionBackendServiceConsistentHash"
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/RegionBackendServiceFailoverPolicy"
	"https:/github.com/pulumi/pulumi-gcp/compute/RegionBackendServiceLogConfig"
	"https:/github.com/pulumi/pulumi-gcp/compute/RegionBackendServiceOutlierDetection"
...
type RegionBackendService struct {
	...
	Backends computeRegionBackendServiceBackend.RegionBackendServiceBackendArrayOutput `pulumi:"backends"`
	...
	CircuitBreakers computeRegionBackendServiceCircuitBreakers.RegionBackendServiceCircuitBreakersPtrOutput `pulumi:"circuitBreakers"`
	...
	ConsistentHash computeRegionBackendServiceConsistentHash.RegionBackendServiceConsistentHashPtrOutput `pulumi:"consistentHash"`
	// Creation timestamp in RFC3339 text format.
	CreationTimestamp pulumi.StringOutput `pulumi:"creationTimestamp"`
	// An optional description of this resource.
	Description pulumi.StringPtrOutput `pulumi:"description"`
	// Policy for failovers.
	FailoverPolicy computeRegionBackendServiceFailoverPolicy.RegionBackendServiceFailoverPolicyPtrOutput `pulumi:"failoverPolicy"`
	...
	LogConfig computeRegionBackendServiceLogConfig.RegionBackendServiceLogConfigPtrOutput `pulumi:"logConfig"`
	...
	// 'load_balancing_scheme' is set to INTERNAL_MANAGED and the 'protocol' is set to HTTP, HTTPS, or HTTP2.
	OutlierDetection computeRegionBackendServiceOutlierDetection.RegionBackendServiceOutlierDetectionPtrOutput `pulumi:"outlierDetection"`
...
type regionBackendServiceState struct {
	...
	// The set of backends that serve this RegionBackendService.
	Backends []computeRegionBackendServiceBackend.RegionBackendServiceBackend `pulumi:"backends"`
	// Settings controlling the volume of connections to a backend service. This field is applicable only when the
	// 'load_balancing_scheme' is set to INTERNAL_MANAGED and the 'protocol' is set to HTTP, HTTPS, or HTTP2.
	CircuitBreakers *computeRegionBackendServiceCircuitBreakers.RegionBackendServiceCircuitBreakers `pulumi:"circuitBreakers"`
	// Time for which instance will be drained (not accept new connections, but still work to finish started).
	...
	// 'load_balancing_scheme' is set to INTERNAL_MANAGED * 'protocol' is set to HTTP, HTTPS, or HTTP2 * 'locality_lb_policy'
	// is set to MAGLEV or RING_HASH
	ConsistentHash *computeRegionBackendServiceConsistentHash.RegionBackendServiceConsistentHash `pulumi:"consistentHash"`
	// Creation timestamp in RFC3339 text format.
	CreationTimestamp *string `pulumi:"creationTimestamp"`
	// An optional description of this resource.
	Description *string `pulumi:"description"`
	// Policy for failovers.
	FailoverPolicy *computeRegionBackendServiceFailoverPolicy.RegionBackendServiceFailoverPolicy `pulumi:"failoverPolicy"`
	// Fingerprint of this resource. A hash of the contents stored in this object. This field is used in optimistic locking.
	...
	// This field denotes the logging options for the load balancer traffic served by this backend service. If logging is
	// enabled, logs will be exported to Stackdriver.
	LogConfig *computeRegionBackendServiceLogConfig.RegionBackendServiceLogConfig `pulumi:"logConfig"`
	// Name of the resource. Provided by the client when the resource is created. The name must be 1-63 characters long, and
	// comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression
	// '[a-z]([-a-z0-9]*[a-z0-9])?' which means the first character must be a lowercase letter, and all following characters
	// must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
	...
	// Settings controlling eviction of unhealthy hosts from the load balancing pool. This field is applicable only when the
	// 'load_balancing_scheme' is set to INTERNAL_MANAGED and the 'protocol' is set to HTTP, HTTPS, or HTTP2.
	OutlierDetection *computeRegionBackendServiceOutlierDetection.RegionBackendServiceOutlierDetection `pulumi:"outlierDetection"`
	// The ID of the project in which the resource belongs.
	// If it is not provided, the provider project is used.
...
type RegionBackendServiceState struct {
	...
	// The set of backends that serve this RegionBackendService.
	Backends computeRegionBackendServiceBackend.RegionBackendServiceBackendArrayInput
	// Settings controlling the volume of connections to a backend service. This field is applicable only when the
	// 'load_balancing_scheme' is set to INTERNAL_MANAGED and the 'protocol' is set to HTTP, HTTPS, or HTTP2.
	CircuitBreakers computeRegionBackendServiceCircuitBreakers.RegionBackendServiceCircuitBreakersPtrInput
	// Time for which instance will be drained (not accept new connections, but still work to finish started).
	...
	// 'load_balancing_scheme' is set to INTERNAL_MANAGED * 'protocol' is set to HTTP, HTTPS, or HTTP2 * 'locality_lb_policy'
	// is set to MAGLEV or RING_HASH
	ConsistentHash computeRegionBackendServiceConsistentHash.RegionBackendServiceConsistentHashPtrInput
	// Creation timestamp in RFC3339 text format.
	CreationTimestamp pulumi.StringPtrInput
	// An optional description of this resource.
	Description pulumi.StringPtrInput
	// Policy for failovers.
	FailoverPolicy computeRegionBackendServiceFailoverPolicy.RegionBackendServiceFailoverPolicyPtrInput
	// Fingerprint of this resource. A hash of the contents stored in this object. This field is used in optimistic locking.
	...
	// This field denotes the logging options for the load balancer traffic served by this backend service. If logging is
	// enabled, logs will be exported to Stackdriver.
	LogConfig computeRegionBackendServiceLogConfig.RegionBackendServiceLogConfigPtrInput
	// Name of the resource. Provided by the client when the resource is created. The name must be 1-63 characters long, and
	// comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression
	// '[a-z]([-a-z0-9]*[a-z0-9])?' which means the first character must be a lowercase letter, and all following characters
	// must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
	...
	// Settings controlling eviction of unhealthy hosts from the load balancing pool. This field is applicable only when the
	// 'load_balancing_scheme' is set to INTERNAL_MANAGED and the 'protocol' is set to HTTP, HTTPS, or HTTP2.
	OutlierDetection computeRegionBackendServiceOutlierDetection.RegionBackendServiceOutlierDetectionPtrInput
	// The ID of the project in which the resource belongs.
	// If it is not provided, the provider project is used.
