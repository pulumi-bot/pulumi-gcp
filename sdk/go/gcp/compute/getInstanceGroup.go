...
func LookupInstanceGroupApply(ctx *pulumi.Context, args LookupInstanceGroupApplyInput, opts ...pulumi.InvokeOption) LookupInstanceGroupResultOutput {
	return args.ToLookupInstanceGroupApplyOutput().ApplyT(func(v LookupInstanceGroupArgs) (LookupInstanceGroupResult, error) {
		r, err := LookupInstanceGroup(ctx, &v, opts...)
		return *r, err

	}).(LookupInstanceGroupResultOutput)
}

// LookupInstanceGroupApplyInput is an input type that accepts LookupInstanceGroupApplyArgs and LookupInstanceGroupApplyOutput values.
// You can construct a concrete instance of `LookupInstanceGroupApplyInput` via:
//
//          LookupInstanceGroupApplyArgs{...}
type LookupInstanceGroupApplyInput interface {
	pulumi.Input

	ToLookupInstanceGroupApplyOutput() LookupInstanceGroupApplyOutput
	ToLookupInstanceGroupApplyOutputWithContext(context.Context) LookupInstanceGroupApplyOutput
}

// A collection of arguments for invoking getInstanceGroup.
type LookupInstanceGroupApplyArgs struct {
	// The name of the instance group. Either `name` or `selfLink` must be provided.
...
func (LookupInstanceGroupApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupInstanceGroupArgs)(nil)).Elem()
}

func (i LookupInstanceGroupApplyArgs) ToLookupInstanceGroupApplyOutput() LookupInstanceGroupApplyOutput {
	return i.ToLookupInstanceGroupApplyOutputWithContext(context.Background())
}

func (i LookupInstanceGroupApplyArgs) ToLookupInstanceGroupApplyOutputWithContext(ctx context.Context) LookupInstanceGroupApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupInstanceGroupApplyOutput)
}

// A collection of arguments for invoking getInstanceGroup.
type LookupInstanceGroupApplyOutput struct{ *pulumi.OutputState }

func (LookupInstanceGroupApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupInstanceGroupArgs)(nil)).Elem()
}

func (o LookupInstanceGroupApplyOutput) ToLookupInstanceGroupApplyOutput() LookupInstanceGroupApplyOutput {
	return o
}

func (o LookupInstanceGroupApplyOutput) ToLookupInstanceGroupApplyOutputWithContext(ctx context.Context) LookupInstanceGroupApplyOutput {
	return o
}

// The name of the instance group. Either `name` or `selfLink` must be provided.
func (o LookupInstanceGroupApplyOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupInstanceGroupArgs) *string { return v.Name }).(pulumi.StringPtrOutput)
}

// The ID of the project in which the resource belongs. If it
// is not provided, the provider project is used.
func (o LookupInstanceGroupApplyOutput) Project() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupInstanceGroupArgs) *string { return v.Project }).(pulumi.StringPtrOutput)
}

// The self link of the instance group. Either `name` or `selfLink` must be provided.
func (o LookupInstanceGroupApplyOutput) SelfLink() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupInstanceGroupArgs) *string { return v.SelfLink }).(pulumi.StringPtrOutput)
}

// The zone of the instance group. If referencing the instance group by name
// and `zone` is not provided, the provider zone is used.
func (o LookupInstanceGroupApplyOutput) Zone() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupInstanceGroupArgs) *string { return v.Zone }).(pulumi.StringPtrOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupInstanceGroupApplyOutput{})
