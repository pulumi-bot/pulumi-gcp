...
func GetGlobalAddress(ctx *pulumi.Context, args *GetGlobalAddressArgs, opts ...pulumi.InvokeOption) (*GetGlobalAddressResult, error) {
	var rv GetGlobalAddressResult
