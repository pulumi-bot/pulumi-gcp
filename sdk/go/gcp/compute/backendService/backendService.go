...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/BackendServiceBackend"
	"https:/github.com/pulumi/pulumi-gcp/compute/BackendServiceCdnPolicy"
	"https:/github.com/pulumi/pulumi-gcp/compute/BackendServiceCdnPolicyCacheKeyPolicy"
	"https:/github.com/pulumi/pulumi-gcp/compute/BackendServiceCircuitBreakers"
	"https:/github.com/pulumi/pulumi-gcp/compute/BackendServiceCircuitBreakersConnectTimeout"
	"https:/github.com/pulumi/pulumi-gcp/compute/BackendServiceConsistentHash"
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/BackendServiceIap"
	"https:/github.com/pulumi/pulumi-gcp/compute/BackendServiceLogConfig"
	"https:/github.com/pulumi/pulumi-gcp/compute/BackendServiceOutlierDetection"
...
type BackendService struct {
	...
	Backends computeBackendServiceBackend.BackendServiceBackendArrayOutput `pulumi:"backends"`
	// Cloud CDN configuration for this BackendService.
	CdnPolicy computeBackendServiceCdnPolicy.BackendServiceCdnPolicyOutput `pulumi:"cdnPolicy"`
	...
	CircuitBreakers computeBackendServiceCircuitBreakers.BackendServiceCircuitBreakersPtrOutput `pulumi:"circuitBreakers"`
	...
	ConsistentHash computeBackendServiceConsistentHash.BackendServiceConsistentHashPtrOutput `pulumi:"consistentHash"`
	...
	Iap computeBackendServiceIap.BackendServiceIapPtrOutput `pulumi:"iap"`
	...
	LogConfig computeBackendServiceLogConfig.BackendServiceLogConfigOutput `pulumi:"logConfig"`
	...
	// load_balancing_scheme is set to INTERNAL_SELF_MANAGED.
	OutlierDetection computeBackendServiceOutlierDetection.BackendServiceOutlierDetectionPtrOutput `pulumi:"outlierDetection"`
...
type backendServiceState struct {
	...
	// The set of backends that serve this BackendService.
	Backends []computeBackendServiceBackend.BackendServiceBackend `pulumi:"backends"`
	// Cloud CDN configuration for this BackendService.
	CdnPolicy *computeBackendServiceCdnPolicy.BackendServiceCdnPolicy `pulumi:"cdnPolicy"`
	// Settings controlling the volume of connections to a backend service. This field is applicable only when the
	// load_balancing_scheme is set to INTERNAL_SELF_MANAGED.
	CircuitBreakers *computeBackendServiceCircuitBreakers.BackendServiceCircuitBreakers `pulumi:"circuitBreakers"`
	// Time for which instance will be drained (not accept new connections, but still work to finish started).
	...
	// specifies parameters that control consistent hashing. This field only applies if the load_balancing_scheme is set to
	// INTERNAL_SELF_MANAGED. This field is only applicable when locality_lb_policy is set to MAGLEV or RING_HASH.
	ConsistentHash *computeBackendServiceConsistentHash.BackendServiceConsistentHash `pulumi:"consistentHash"`
	// Creation timestamp in RFC3339 text format.
	...
	// Settings for enabling Cloud Identity Aware Proxy
	Iap *computeBackendServiceIap.BackendServiceIap `pulumi:"iap"`
	// Indicates whether the backend service will be used with internal or external load balancing. A backend service created
	// for one type of load balancing cannot be used with the other. Must be 'EXTERNAL' or 'INTERNAL_SELF_MANAGED' for a global
	// backend service. Defaults to 'EXTERNAL'.
	...
	// This field denotes the logging options for the load balancer traffic served by this backend service. If logging is
	// enabled, logs will be exported to Stackdriver.
	LogConfig *computeBackendServiceLogConfig.BackendServiceLogConfig `pulumi:"logConfig"`
	// Name of the resource. Provided by the client when the resource is created. The name must be 1-63 characters long, and
	// comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression
	// '[a-z]([-a-z0-9]*[a-z0-9])?' which means the first character must be a lowercase letter, and all following characters
	// must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
	...
	// Settings controlling eviction of unhealthy hosts from the load balancing pool. This field is applicable only when the
	// load_balancing_scheme is set to INTERNAL_SELF_MANAGED.
	OutlierDetection *computeBackendServiceOutlierDetection.BackendServiceOutlierDetection `pulumi:"outlierDetection"`
	// Name of backend port. The same name should appear in the instance groups referenced by this service. Required when the
	// load balancing scheme is EXTERNAL.
...
type BackendServiceState struct {
	...
	// The set of backends that serve this BackendService.
	Backends computeBackendServiceBackend.BackendServiceBackendArrayInput
	// Cloud CDN configuration for this BackendService.
	CdnPolicy computeBackendServiceCdnPolicy.BackendServiceCdnPolicyPtrInput
	// Settings controlling the volume of connections to a backend service. This field is applicable only when the
	// load_balancing_scheme is set to INTERNAL_SELF_MANAGED.
	CircuitBreakers computeBackendServiceCircuitBreakers.BackendServiceCircuitBreakersPtrInput
	// Time for which instance will be drained (not accept new connections, but still work to finish started).
	...
	// specifies parameters that control consistent hashing. This field only applies if the load_balancing_scheme is set to
	// INTERNAL_SELF_MANAGED. This field is only applicable when locality_lb_policy is set to MAGLEV or RING_HASH.
	ConsistentHash computeBackendServiceConsistentHash.BackendServiceConsistentHashPtrInput
	// Creation timestamp in RFC3339 text format.
	...
	// Settings for enabling Cloud Identity Aware Proxy
	Iap computeBackendServiceIap.BackendServiceIapPtrInput
	// Indicates whether the backend service will be used with internal or external load balancing. A backend service created
	// for one type of load balancing cannot be used with the other. Must be 'EXTERNAL' or 'INTERNAL_SELF_MANAGED' for a global
	// backend service. Defaults to 'EXTERNAL'.
	...
	// This field denotes the logging options for the load balancer traffic served by this backend service. If logging is
	// enabled, logs will be exported to Stackdriver.
	LogConfig computeBackendServiceLogConfig.BackendServiceLogConfigPtrInput
	// Name of the resource. Provided by the client when the resource is created. The name must be 1-63 characters long, and
	// comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression
	// '[a-z]([-a-z0-9]*[a-z0-9])?' which means the first character must be a lowercase letter, and all following characters
	// must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
	...
	// Settings controlling eviction of unhealthy hosts from the load balancing pool. This field is applicable only when the
	// load_balancing_scheme is set to INTERNAL_SELF_MANAGED.
	OutlierDetection computeBackendServiceOutlierDetection.BackendServiceOutlierDetectionPtrInput
	// Name of backend port. The same name should appear in the instance groups referenced by this service. Required when the
	// load balancing scheme is EXTERNAL.
