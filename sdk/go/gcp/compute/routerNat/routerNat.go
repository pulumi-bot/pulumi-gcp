...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/RouterNatLogConfig"
	"https:/github.com/pulumi/pulumi-gcp/compute/RouterNatSubnetwork"
)
...
type RouterNat struct {
	...
	LogConfig computeRouterNatLogConfig.RouterNatLogConfigPtrOutput `pulumi:"logConfig"`
	...
	// 'LIST_OF_SUBNETWORKS'
	Subnetworks computeRouterNatSubnetwork.RouterNatSubnetworkArrayOutput `pulumi:"subnetworks"`
...
type routerNatState struct {
	...
	// Configuration for logging on NAT
	LogConfig *computeRouterNatLogConfig.RouterNatLogConfig `pulumi:"logConfig"`
	// Minimum number of ports allocated to a VM from this NAT.
	...
	// One or more subnetwork NAT configurations. Only used if 'source_subnetwork_ip_ranges_to_nat' is set to
	// 'LIST_OF_SUBNETWORKS'
	Subnetworks []computeRouterNatSubnetwork.RouterNatSubnetwork `pulumi:"subnetworks"`
	// Timeout (in seconds) for TCP established connections. Defaults to 1200s if not set.
...
type RouterNatState struct {
	...
	// Configuration for logging on NAT
	LogConfig computeRouterNatLogConfig.RouterNatLogConfigPtrInput
	// Minimum number of ports allocated to a VM from this NAT.
	...
	// One or more subnetwork NAT configurations. Only used if 'source_subnetwork_ip_ranges_to_nat' is set to
	// 'LIST_OF_SUBNETWORKS'
	Subnetworks computeRouterNatSubnetwork.RouterNatSubnetworkArrayInput
	// Timeout (in seconds) for TCP established connections. Defaults to 1200s if not set.
