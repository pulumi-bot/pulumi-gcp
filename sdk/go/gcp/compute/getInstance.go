...
// The name of the instance. One of `name` or `selfLink` must be provided.
func (o LookupInstanceApplyOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupInstanceArgs) *string { return v.Name }).(pulumi.StringPtrOutput)
}
...
// The self link of the instance. One of `name` or `selfLink` must be provided.
func (o LookupInstanceApplyOutput) SelfLink() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupInstanceArgs) *string { return v.SelfLink }).(pulumi.StringPtrOutput)
}

// The zone of the instance. If `selfLink` is provided, this
// value is ignored.  If neither `selfLink` nor `zone` are provided, the
// provider zone is used.
func (o LookupInstanceApplyOutput) Zone() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupInstanceArgs) *string { return v.Zone }).(pulumi.StringPtrOutput)
}
