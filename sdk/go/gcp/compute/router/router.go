...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/RouterBgp"
...
type Router struct {
	...
	Bgp computeRouterBgp.RouterBgpPtrOutput `pulumi:"bgp"`
...
type routerState struct {
	// BGP information specific to this router.
	Bgp *computeRouterBgp.RouterBgp `pulumi:"bgp"`
	// Creation timestamp in RFC3339 text format.
...
type RouterState struct {
	// BGP information specific to this router.
	Bgp computeRouterBgp.RouterBgpPtrInput
	// Creation timestamp in RFC3339 text format.
