...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/InstanceGroupNamedPort"
)
...
type InstanceGroup struct {
	...
	NamedPorts computeInstanceGroupNamedPort.InstanceGroupNamedPortArrayOutput `pulumi:"namedPorts"`
...
type instanceGroupState struct {
	...
	// The named port configuration. See the section below
	// for details on configuration.
	NamedPorts []computeInstanceGroupNamedPort.InstanceGroupNamedPort `pulumi:"namedPorts"`
	// The URL of the network the instance group is in. If
	// this is different from the network where the instances are in, the creation
	// fails. Defaults to the network where the instances are in (if neither
	// `network` nor `instances` is specified, this field will be blank).
...
type InstanceGroupState struct {
	...
	// The named port configuration. See the section below
	// for details on configuration.
	NamedPorts computeInstanceGroupNamedPort.InstanceGroupNamedPortArrayInput
	// The URL of the network the instance group is in. If
	// this is different from the network where the instances are in, the creation
	// fails. Defaults to the network where the instances are in (if neither
	// `network` nor `instances` is specified, this field will be blank).
