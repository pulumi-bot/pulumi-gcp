...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/AutoscalarAutoscalingPolicy"
...
type Autoscalar struct {
	...
	AutoscalingPolicy computeAutoscalarAutoscalingPolicy.AutoscalarAutoscalingPolicyOutput `pulumi:"autoscalingPolicy"`
...
type autoscalarState struct {
	...
	// autoscaler: cpuUtilization, customMetricUtilizations, and loadBalancingUtilization. If none of these are specified, the
	// default will be to autoscale based on cpuUtilization to 0.6 or 60%.
	AutoscalingPolicy *computeAutoscalarAutoscalingPolicy.AutoscalarAutoscalingPolicy `pulumi:"autoscalingPolicy"`
	// Creation timestamp in RFC3339 text format.
...
type AutoscalarState struct {
	...
	// autoscaler: cpuUtilization, customMetricUtilizations, and loadBalancingUtilization. If none of these are specified, the
	// default will be to autoscale based on cpuUtilization to 0.6 or 60%.
	AutoscalingPolicy computeAutoscalarAutoscalingPolicy.AutoscalarAutoscalingPolicyPtrInput
	// Creation timestamp in RFC3339 text format.
...
type AutoscalarArgs struct {
	...
	// autoscaler: cpuUtilization, customMetricUtilizations, and loadBalancingUtilization. If none of these are specified, the
	// default will be to autoscale based on cpuUtilization to 0.6 or 60%.
	AutoscalingPolicy computeAutoscalarAutoscalingPolicy.AutoscalarAutoscalingPolicyInput
	// An optional description of this resource.
	Description pulumi.StringPtrInput
	// Name of the resource. The name must be 1-63 characters long and match the regular expression
	// '[a-z]([-a-z0-9]*[a-z0-9])?' which means the first character must be a lowercase letter, and all following characters
