...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/ImageGuestOsFeature"
	"https:/github.com/pulumi/pulumi-gcp/compute/ImageRawDisk"
)
...
type Image struct {
	...
	GuestOsFeatures computeImageGuestOsFeature.ImageGuestOsFeatureArrayOutput `pulumi:"guestOsFeatures"`
	...
	RawDisk computeImageRawDisk.ImageRawDiskPtrOutput `pulumi:"rawDisk"`
...
type imageState struct {
	...
	// A list of features to enable on the guest operating system. Applicable only for bootable images.
	GuestOsFeatures []computeImageGuestOsFeature.ImageGuestOsFeature `pulumi:"guestOsFeatures"`
	// The fingerprint used for optimistic locking of this resource. Used internally during updates.
	...
	// The parameters of the raw disk image.
	RawDisk *computeImageRawDisk.ImageRawDisk `pulumi:"rawDisk"`
	// The URI of the created resource.
...
type ImageState struct {
	...
	// A list of features to enable on the guest operating system. Applicable only for bootable images.
	GuestOsFeatures computeImageGuestOsFeature.ImageGuestOsFeatureArrayInput
	// The fingerprint used for optimistic locking of this resource. Used internally during updates.
	...
	// The parameters of the raw disk image.
	RawDisk computeImageRawDisk.ImageRawDiskPtrInput
	// The URI of the created resource.
