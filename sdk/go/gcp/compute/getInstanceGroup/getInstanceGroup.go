...
// nolint: lll
package getInstanceGroup

import (
	"github.com/pulumi/pulumi/sdk/go/pulumi"
	"https:/github.com/pulumi/pulumi-gcp/compute/getInstanceGroupNamedPort"
)
...
func GetInstanceGroup(ctx *pulumi.Context, args *GetInstanceGroupArgs, opts ...pulumi.InvokeOption) (*GetInstanceGroupResult, error) {
	var rv GetInstanceGroupResult
...
type GetInstanceGroupResult struct {
	...
	NamedPorts []computegetInstanceGroupNamedPort.GetInstanceGroupNamedPort `pulumi:"namedPorts"`
