...
func GetSSLPolicy(ctx *pulumi.Context, args *GetSSLPolicyArgs, opts ...pulumi.InvokeOption) (*GetSSLPolicyResult, error) {
	var rv GetSSLPolicyResult
