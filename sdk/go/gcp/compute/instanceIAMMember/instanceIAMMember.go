...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/InstanceIAMMemberCondition"
)
...
type InstanceIAMMember struct {
	...
	Condition computeInstanceIAMMemberCondition.InstanceIAMMemberConditionPtrOutput `pulumi:"condition"`
...
type instanceIAMMemberState struct {
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition *computeInstanceIAMMemberCondition.InstanceIAMMemberCondition `pulumi:"condition"`
	// (Computed) The etag of the IAM policy.
...
type InstanceIAMMemberState struct {
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition computeInstanceIAMMemberCondition.InstanceIAMMemberConditionPtrInput
	// (Computed) The etag of the IAM policy.
