...
func LookupInstanceTemplateApply(ctx *pulumi.Context, args LookupInstanceTemplateApplyInput, opts ...pulumi.InvokeOption) LookupInstanceTemplateResultOutput {
	return args.ToLookupInstanceTemplateApplyOutput().ApplyT(func(v LookupInstanceTemplateArgs) (LookupInstanceTemplateResult, error) {
		r, err := LookupInstanceTemplate(ctx, &v, opts...)
		return *r, err

	}).(LookupInstanceTemplateResultOutput)
}

// LookupInstanceTemplateApplyInput is an input type that accepts LookupInstanceTemplateApplyArgs and LookupInstanceTemplateApplyOutput values.
// You can construct a concrete instance of `LookupInstanceTemplateApplyInput` via:
//
//          LookupInstanceTemplateApplyArgs{...}
type LookupInstanceTemplateApplyInput interface {
	pulumi.Input

	ToLookupInstanceTemplateApplyOutput() LookupInstanceTemplateApplyOutput
	ToLookupInstanceTemplateApplyOutputWithContext(context.Context) LookupInstanceTemplateApplyOutput
}

// A collection of arguments for invoking getInstanceTemplate.
type LookupInstanceTemplateApplyArgs struct {
	// A filter to retrieve the instance templates.
	// See [gcloud topic filters](https://cloud.google.com/sdk/gcloud/reference/topic/filters) for reference.
	// If multiple instance templates match, either adjust the filter or specify `mostRecent`. One of `name` or `filter` must be provided.
...
func (LookupInstanceTemplateApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupInstanceTemplateArgs)(nil)).Elem()
}

func (i LookupInstanceTemplateApplyArgs) ToLookupInstanceTemplateApplyOutput() LookupInstanceTemplateApplyOutput {
	return i.ToLookupInstanceTemplateApplyOutputWithContext(context.Background())
}

func (i LookupInstanceTemplateApplyArgs) ToLookupInstanceTemplateApplyOutputWithContext(ctx context.Context) LookupInstanceTemplateApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupInstanceTemplateApplyOutput)
}

// A collection of arguments for invoking getInstanceTemplate.
type LookupInstanceTemplateApplyOutput struct{ *pulumi.OutputState }

func (LookupInstanceTemplateApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupInstanceTemplateArgs)(nil)).Elem()
}

func (o LookupInstanceTemplateApplyOutput) ToLookupInstanceTemplateApplyOutput() LookupInstanceTemplateApplyOutput {
	return o
}

func (o LookupInstanceTemplateApplyOutput) ToLookupInstanceTemplateApplyOutputWithContext(ctx context.Context) LookupInstanceTemplateApplyOutput {
	return o
}
...
// See [gcloud topic filters](https://cloud.google.com/sdk/gcloud/reference/topic/filters) for reference.
// If multiple instance templates match, either adjust the filter or specify `mostRecent`. One of `name` or `filter` must be provided.
func (o LookupInstanceTemplateApplyOutput) Filter() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupInstanceTemplateArgs) *string { return v.Filter }).(pulumi.StringPtrOutput)
}

// If `filter` is provided, ensures the most recent template is returned when multiple instance templates match. One of `name` or `filter` must be provided.
func (o LookupInstanceTemplateApplyOutput) MostRecent() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupInstanceTemplateArgs) *bool { return v.MostRecent }).(pulumi.BoolPtrOutput)
}

// The name of the instance template. One of `name` or `filter` must be provided.
func (o LookupInstanceTemplateApplyOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupInstanceTemplateArgs) *string { return v.Name }).(pulumi.StringPtrOutput)
}

// The ID of the project in which the resource belongs.
// If `project` is not provideded, the provider project is used.
func (o LookupInstanceTemplateApplyOutput) Project() pulumi.StringOutput {
	return o.ApplyT(func(v LookupInstanceTemplateArgs) string { return v.Project }).(pulumi.StringOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupInstanceTemplateApplyOutput{})
