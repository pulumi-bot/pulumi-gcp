...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/GlobalForwardingRuleMetadataFilter"
...
type GlobalForwardingRule struct {
	...
	MetadataFilters computeGlobalForwardingRuleMetadataFilter.GlobalForwardingRuleMetadataFilterArrayOutput `pulumi:"metadataFilters"`
...
type globalForwardingRuleState struct {
	...
	// ForwardingRule references. metadataFilters only applies to Loadbalancers that have their loadBalancingScheme set to
	// INTERNAL_SELF_MANAGED.
	MetadataFilters []computeGlobalForwardingRuleMetadataFilter.GlobalForwardingRuleMetadataFilter `pulumi:"metadataFilters"`
	// Name of the resource; provided by the client when the resource is created. The name must be 1-63 characters long, and
	// comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression
	// '[a-z]([-a-z0-9]*[a-z0-9])?' which means the first character must be a lowercase letter, and all following characters
	// must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
...
type GlobalForwardingRuleState struct {
	...
	// ForwardingRule references. metadataFilters only applies to Loadbalancers that have their loadBalancingScheme set to
	// INTERNAL_SELF_MANAGED.
	MetadataFilters computeGlobalForwardingRuleMetadataFilter.GlobalForwardingRuleMetadataFilterArrayInput
	// Name of the resource; provided by the client when the resource is created. The name must be 1-63 characters long, and
	// comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression
	// '[a-z]([-a-z0-9]*[a-z0-9])?' which means the first character must be a lowercase letter, and all following characters
	// must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
