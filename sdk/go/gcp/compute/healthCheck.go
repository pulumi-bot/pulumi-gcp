...
type healthCheckArgs struct {
	...
	HealthyThreshold *int `pulumi:"healthyThreshold"`
	// A nested object resource
	Http2HealthCheck *HealthCheckHttp2HealthCheckArgs `pulumi:"http2HealthCheck"`
	// A nested object resource
	HttpHealthCheck *HealthCheckHttpHealthCheckArgs `pulumi:"httpHealthCheck"`
	// A nested object resource
	HttpsHealthCheck *HealthCheckHttpsHealthCheckArgs `pulumi:"httpsHealthCheck"`
	// Name of the resource. Provided by the client when the resource is created. The name must be 1-63 characters long, and
	// comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression
	// '[a-z]([-a-z0-9]*[a-z0-9])?' which means the first character must be a lowercase letter, and all following characters
	// must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
	...
	Project *string `pulumi:"project"`
	// A nested object resource
	SslHealthCheck *HealthCheckSslHealthCheckArgs `pulumi:"sslHealthCheck"`
	// A nested object resource
	TcpHealthCheck *HealthCheckTcpHealthCheckArgs `pulumi:"tcpHealthCheck"`
	// How long (in seconds) to wait before claiming failure. The default value is 5 seconds. It is invalid for timeoutSec to
	// have greater value than checkIntervalSec.
	TimeoutSec *int `pulumi:"timeoutSec"`
	// A so-far healthy instance will be marked unhealthy after this many consecutive failures. The default value is 2.
...
type HealthCheckArgs struct {
	...
	HealthyThreshold pulumi.IntPtrInput
	// A nested object resource
	Http2HealthCheck HealthCheckHttp2HealthCheckArgsPtrInput
	// A nested object resource
	HttpHealthCheck HealthCheckHttpHealthCheckArgsPtrInput
	// A nested object resource
	HttpsHealthCheck HealthCheckHttpsHealthCheckArgsPtrInput
	// Name of the resource. Provided by the client when the resource is created. The name must be 1-63 characters long, and
	// comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression
	// '[a-z]([-a-z0-9]*[a-z0-9])?' which means the first character must be a lowercase letter, and all following characters
	// must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
	...
	Project pulumi.StringPtrInput
	// A nested object resource
	SslHealthCheck HealthCheckSslHealthCheckArgsPtrInput
	// A nested object resource
	TcpHealthCheck HealthCheckTcpHealthCheckArgsPtrInput
	// How long (in seconds) to wait before claiming failure. The default value is 5 seconds. It is invalid for timeoutSec to
	// have greater value than checkIntervalSec.
	TimeoutSec pulumi.IntPtrInput
	// A so-far healthy instance will be marked unhealthy after this many consecutive failures. The default value is 2.
