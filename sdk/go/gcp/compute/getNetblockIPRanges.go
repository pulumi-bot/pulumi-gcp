...
// 		netblock, err := compute.GetNetblockIPRanges(ctx, "gcp:compute:getNetblockIPRanges", nil)
// 		if err != nil {
// 			return err
// 		}
...
// 		legacy_hcs, err := compute.GetNetblockIPRanges(ctx, "gcp:compute:getNetblockIPRanges", &compute.GetNetblockIPRangesArgs{
// 			RangeType: &opt0,
// 		})
// 		if err != nil {
// 			return err
