...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/compute/ReservationSpecificReservation"
...
type Reservation struct {
	...
	SpecificReservation computeReservationSpecificReservation.ReservationSpecificReservationOutput `pulumi:"specificReservation"`
...
type reservationState struct {
	...
	// Reservation for instances with specific machine shapes.
	SpecificReservation *computeReservationSpecificReservation.ReservationSpecificReservation `pulumi:"specificReservation"`
	// When set to true, only VMs that target this reservation by name can consume this reservation. Otherwise, it can be
	// consumed by VMs with affinity for any reservation. Defaults to false.
...
type ReservationState struct {
	...
	// Reservation for instances with specific machine shapes.
	SpecificReservation computeReservationSpecificReservation.ReservationSpecificReservationPtrInput
	// When set to true, only VMs that target this reservation by name can consume this reservation. Otherwise, it can be
	// consumed by VMs with affinity for any reservation. Defaults to false.
...
type ReservationArgs struct {
	...
	Project pulumi.StringPtrInput
	// Reservation for instances with specific machine shapes.
	SpecificReservation computeReservationSpecificReservation.ReservationSpecificReservationInput
	// When set to true, only VMs that target this reservation by name can consume this reservation. Otherwise, it can be
	// consumed by VMs with affinity for any reservation. Defaults to false.
	SpecificReservationRequired pulumi.BoolPtrInput
	// The zone where the reservation is made.
