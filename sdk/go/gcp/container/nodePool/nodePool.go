...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/container/NodePoolAutoscaling"
	"https:/github.com/pulumi/pulumi-gcp/container/NodePoolManagement"
	"https:/github.com/pulumi/pulumi-gcp/container/NodePoolNodeConfig"
	...
	"https:/github.com/pulumi/pulumi-gcp/container/NodePoolUpgradeSettings"
)
...
type NodePool struct {
	...
	Autoscaling containerNodePoolAutoscaling.NodePoolAutoscalingPtrOutput `pulumi:"autoscaling"`
	...
	Management containerNodePoolManagement.NodePoolManagementOutput `pulumi:"management"`
	...
	NodeConfig containerNodePoolNodeConfig.NodePoolNodeConfigOutput `pulumi:"nodeConfig"`
	...
	UpgradeSettings containerNodePoolUpgradeSettings.NodePoolUpgradeSettingsPtrOutput `pulumi:"upgradeSettings"`
...
type nodePoolState struct {
	// Configuration required by cluster autoscaler to adjust
	// the size of the node pool to the current cluster usage. Structure is documented below.
	Autoscaling *containerNodePoolAutoscaling.NodePoolAutoscaling `pulumi:"autoscaling"`
	// The cluster to create the node pool for. Cluster must be present in `location` provided for zonal clusters.
	...
	// Node management configuration, wherein auto-repair and
	// auto-upgrade is configured. Structure is documented below.
	Management *containerNodePoolManagement.NodePoolManagement `pulumi:"management"`
	// ) The maximum number of pods per node in this node pool.
	// Note that this does not work on node pools which are "route-based" - that is, node
	// pools belonging to clusters that do not have IP Aliasing enabled.
	// See the [official documentation](https://cloud.google.com/kubernetes-engine/docs/how-to/flexible-pod-cidr)
	...
	// The node configuration of the pool. See
	// container.Cluster for schema.
	NodeConfig *containerNodePoolNodeConfig.NodePoolNodeConfig `pulumi:"nodeConfig"`
	// The number of nodes per instance group. This field can be used to
	// update the number of nodes per instance group but should not be used alongside `autoscaling`.
	...
	UpgradeSettings *containerNodePoolUpgradeSettings.NodePoolUpgradeSettings `pulumi:"upgradeSettings"`
	// The Kubernetes version for the nodes in this pool. Note that if this field
	// and `autoUpgrade` are both specified, they will fight each other for what the node version should
	// be, so setting both is highly discouraged. While a fuzzy version can be specified, it's
	// recommended that you specify explicit versions as this provider will see spurious diffs
...
type NodePoolState struct {
	// Configuration required by cluster autoscaler to adjust
	// the size of the node pool to the current cluster usage. Structure is documented below.
	Autoscaling containerNodePoolAutoscaling.NodePoolAutoscalingPtrInput
	// The cluster to create the node pool for. Cluster must be present in `location` provided for zonal clusters.
	...
	// Node management configuration, wherein auto-repair and
	// auto-upgrade is configured. Structure is documented below.
	Management containerNodePoolManagement.NodePoolManagementPtrInput
	// ) The maximum number of pods per node in this node pool.
	// Note that this does not work on node pools which are "route-based" - that is, node
	// pools belonging to clusters that do not have IP Aliasing enabled.
	// See the [official documentation](https://cloud.google.com/kubernetes-engine/docs/how-to/flexible-pod-cidr)
	...
	// The node configuration of the pool. See
	// container.Cluster for schema.
	NodeConfig containerNodePoolNodeConfig.NodePoolNodeConfigPtrInput
	// The number of nodes per instance group. This field can be used to
	// update the number of nodes per instance group but should not be used alongside `autoscaling`.
	...
	UpgradeSettings containerNodePoolUpgradeSettings.NodePoolUpgradeSettingsPtrInput
	// The Kubernetes version for the nodes in this pool. Note that if this field
	// and `autoUpgrade` are both specified, they will fight each other for what the node version should
	// be, so setting both is highly discouraged. While a fuzzy version can be specified, it's
	// recommended that you specify explicit versions as this provider will see spurious diffs
