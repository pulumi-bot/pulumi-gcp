...
// created in. One of `location`, `region`, `zone`, or a provider-level `zone` must
// be specified.
func (o LookupClusterApplyOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupClusterArgs) *string { return v.Location }).(pulumi.StringPtrOutput)
}
...
// The project in which the resource belongs. If it
// is not provided, the provider project is used.
func (o LookupClusterApplyOutput) Project() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupClusterArgs) *string { return v.Project }).(pulumi.StringPtrOutput)
}
