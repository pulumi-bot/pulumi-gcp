...
func LookupWorkloadIdentityPoolProviderApply(ctx *pulumi.Context, args LookupWorkloadIdentityPoolProviderApplyInput, opts ...pulumi.InvokeOption) LookupWorkloadIdentityPoolProviderResultOutput {
	return args.ToLookupWorkloadIdentityPoolProviderApplyOutput().ApplyT(func(v LookupWorkloadIdentityPoolProviderArgs) (LookupWorkloadIdentityPoolProviderResult, error) {
		r, err := LookupWorkloadIdentityPoolProvider(ctx, &v, opts...)
		return *r, err

	}).(LookupWorkloadIdentityPoolProviderResultOutput)
}

// LookupWorkloadIdentityPoolProviderApplyInput is an input type that accepts LookupWorkloadIdentityPoolProviderApplyArgs and LookupWorkloadIdentityPoolProviderApplyOutput values.
// You can construct a concrete instance of `LookupWorkloadIdentityPoolProviderApplyInput` via:
//
//          LookupWorkloadIdentityPoolProviderApplyArgs{...}
type LookupWorkloadIdentityPoolProviderApplyInput interface {
	pulumi.Input

	ToLookupWorkloadIdentityPoolProviderApplyOutput() LookupWorkloadIdentityPoolProviderApplyOutput
	ToLookupWorkloadIdentityPoolProviderApplyOutputWithContext(context.Context) LookupWorkloadIdentityPoolProviderApplyOutput
}

// A collection of arguments for invoking getWorkloadIdentityPoolProvider.
type LookupWorkloadIdentityPoolProviderApplyArgs struct {
	// The project in which the resource belongs. If it
	// is not provided, the provider project is used.
...
func (LookupWorkloadIdentityPoolProviderApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupWorkloadIdentityPoolProviderArgs)(nil)).Elem()
}

func (i LookupWorkloadIdentityPoolProviderApplyArgs) ToLookupWorkloadIdentityPoolProviderApplyOutput() LookupWorkloadIdentityPoolProviderApplyOutput {
	return i.ToLookupWorkloadIdentityPoolProviderApplyOutputWithContext(context.Background())
}

func (i LookupWorkloadIdentityPoolProviderApplyArgs) ToLookupWorkloadIdentityPoolProviderApplyOutputWithContext(ctx context.Context) LookupWorkloadIdentityPoolProviderApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupWorkloadIdentityPoolProviderApplyOutput)
}

// A collection of arguments for invoking getWorkloadIdentityPoolProvider.
type LookupWorkloadIdentityPoolProviderApplyOutput struct{ *pulumi.OutputState }

func (LookupWorkloadIdentityPoolProviderApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupWorkloadIdentityPoolProviderArgs)(nil)).Elem()
}

func (o LookupWorkloadIdentityPoolProviderApplyOutput) ToLookupWorkloadIdentityPoolProviderApplyOutput() LookupWorkloadIdentityPoolProviderApplyOutput {
	return o
}

func (o LookupWorkloadIdentityPoolProviderApplyOutput) ToLookupWorkloadIdentityPoolProviderApplyOutputWithContext(ctx context.Context) LookupWorkloadIdentityPoolProviderApplyOutput {
	return o
}

// The project in which the resource belongs. If it
// is not provided, the provider project is used.
func (o LookupWorkloadIdentityPoolProviderApplyOutput) Project() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupWorkloadIdentityPoolProviderArgs) *string { return v.Project }).(pulumi.StringPtrOutput)
}

// The id of the pool which is the
// final component of the pool resource name.
func (o LookupWorkloadIdentityPoolProviderApplyOutput) WorkloadIdentityPoolId() pulumi.StringOutput {
	return o.ApplyT(func(v LookupWorkloadIdentityPoolProviderArgs) string { return v.WorkloadIdentityPoolId }).(pulumi.StringOutput)
}

// The id of the provider which is the
// final component of the resource name.
func (o LookupWorkloadIdentityPoolProviderApplyOutput) WorkloadIdentityPoolProviderId() pulumi.StringOutput {
	return o.ApplyT(func(v LookupWorkloadIdentityPoolProviderArgs) string { return v.WorkloadIdentityPoolProviderId }).(pulumi.StringOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupWorkloadIdentityPoolProviderApplyOutput{})
