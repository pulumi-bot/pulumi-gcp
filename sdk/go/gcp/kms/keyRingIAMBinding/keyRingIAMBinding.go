...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/kms/KeyRingIAMBindingCondition"
)
...
type KeyRingIAMBinding struct {
	...
	Condition kmsKeyRingIAMBindingCondition.KeyRingIAMBindingConditionPtrOutput `pulumi:"condition"`
...
type keyRingIAMBindingState struct {
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition *kmsKeyRingIAMBindingCondition.KeyRingIAMBindingCondition `pulumi:"condition"`
	// (Computed) The etag of the key ring's IAM policy.
...
type KeyRingIAMBindingState struct {
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition kmsKeyRingIAMBindingCondition.KeyRingIAMBindingConditionPtrInput
	// (Computed) The etag of the key ring's IAM policy.
