...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/kms/CryptoKeyIAMMemberCondition"
)

type CryptoKeyIAMMember struct {
	pulumi.CustomResourceState

	Condition kmsCryptoKeyIAMMemberCondition.CryptoKeyIAMMemberConditionPtrOutput `pulumi:"condition"`
...
type cryptoKeyIAMMemberState struct {
	Condition *kmsCryptoKeyIAMMemberCondition.CryptoKeyIAMMemberCondition `pulumi:"condition"`
...
type CryptoKeyIAMMemberState struct {
	Condition kmsCryptoKeyIAMMemberCondition.CryptoKeyIAMMemberConditionPtrInput
