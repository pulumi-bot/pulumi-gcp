...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/kms/KeyRingIAMMemberCondition"
)
...
type KeyRingIAMMember struct {
	...
	Condition kmsKeyRingIAMMemberCondition.KeyRingIAMMemberConditionPtrOutput `pulumi:"condition"`
...
type keyRingIAMMemberState struct {
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition *kmsKeyRingIAMMemberCondition.KeyRingIAMMemberCondition `pulumi:"condition"`
	// (Computed) The etag of the key ring's IAM policy.
...
type KeyRingIAMMemberState struct {
	// ) An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
	// Structure is documented below.
	Condition kmsKeyRingIAMMemberCondition.KeyRingIAMMemberConditionPtrInput
	// (Computed) The etag of the key ring's IAM policy.
