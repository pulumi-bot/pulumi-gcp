...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/kms/CryptoKeyIAMBindingCondition"
)
...
type CryptoKeyIAMBinding struct {
	...
	Condition kmsCryptoKeyIAMBindingCondition.CryptoKeyIAMBindingConditionPtrOutput `pulumi:"condition"`
...
type cryptoKeyIAMBindingState struct {
	Condition *kmsCryptoKeyIAMBindingCondition.CryptoKeyIAMBindingCondition `pulumi:"condition"`
	// The crypto key ID, in the form
	// `{project_id}/{location_name}/{key_ring_name}/{crypto_key_name}` or
	// `{location_name}/{key_ring_name}/{crypto_key_name}`.
	// In the second form, the provider's project setting will be used as a fallback.
...
type CryptoKeyIAMBindingState struct {
	Condition kmsCryptoKeyIAMBindingCondition.CryptoKeyIAMBindingConditionPtrInput
	// The crypto key ID, in the form
	// `{project_id}/{location_name}/{key_ring_name}/{crypto_key_name}` or
	// `{location_name}/{key_ring_name}/{crypto_key_name}`.
	// In the second form, the provider's project setting will be used as a fallback.
