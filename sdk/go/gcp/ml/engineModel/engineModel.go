...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/ml/EngineModelDefaultVersion"
)
...
type EngineModel struct {
	...
	DefaultVersion mlEngineModelDefaultVersion.EngineModelDefaultVersionPtrOutput `pulumi:"defaultVersion"`
...
type engineModelState struct {
	// The default version of the model. This version will be used to handle prediction requests that do not specify a version.
	DefaultVersion *mlEngineModelDefaultVersion.EngineModelDefaultVersion `pulumi:"defaultVersion"`
	// The description specified for the model when it was created.
...
type EngineModelState struct {
	// The default version of the model. This version will be used to handle prediction requests that do not specify a version.
	DefaultVersion mlEngineModelDefaultVersion.EngineModelDefaultVersionPtrInput
	// The description specified for the model when it was created.
