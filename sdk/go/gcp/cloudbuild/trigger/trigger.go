...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/cloudbuild/TriggerBuild"
	...
	"https:/github.com/pulumi/pulumi-gcp/cloudbuild/TriggerGithub"
	...
	"https:/github.com/pulumi/pulumi-gcp/cloudbuild/TriggerTriggerTemplate"
)
...
type Trigger struct {
	...
	Build cloudbuildTriggerBuild.TriggerBuildPtrOutput `pulumi:"build"`
	...
	Github cloudbuildTriggerGithub.TriggerGithubPtrOutput `pulumi:"github"`
	...
	TriggerTemplate cloudbuildTriggerTriggerTemplate.TriggerTriggerTemplatePtrOutput `pulumi:"triggerTemplate"`
}
...
type triggerState struct {
	// Contents of the build template. Either a filename or build template must be provided.
	Build *cloudbuildTriggerBuild.TriggerBuild `pulumi:"build"`
	// Time when the trigger was created.
	...
	// Describes the configuration of a trigger that creates a build whenever a GitHub event is received. One of
	// 'trigger_template' or 'github' must be provided.
	Github *cloudbuildTriggerGithub.TriggerGithub `pulumi:"github"`
	// ignoredFiles and includedFiles are file glob matches using http://godoc/pkg/path/filepath#Match extended with support
	// for '**'. If ignoredFiles and changed files are both empty, then they are not used to determine whether or not to
	// trigger a build. If ignoredFiles is not empty, then we ignore any files that match any of the ignored_file globs. If the
	// change has no files that are outside of the ignoredFiles globs, then we do not trigger a build.
	...
	// interpreted as regular expressions. Any branch or tag change that matches that regular expression will trigger a build.
	// One of 'trigger_template' or 'github' must be provided.
	TriggerTemplate *cloudbuildTriggerTriggerTemplate.TriggerTriggerTemplate `pulumi:"triggerTemplate"`
}

type TriggerState struct {
	// Contents of the build template. Either a filename or build template must be provided.
	Build cloudbuildTriggerBuild.TriggerBuildPtrInput
	// Time when the trigger was created.
	...
	// Describes the configuration of a trigger that creates a build whenever a GitHub event is received. One of
	// 'trigger_template' or 'github' must be provided.
	Github cloudbuildTriggerGithub.TriggerGithubPtrInput
	// ignoredFiles and includedFiles are file glob matches using http://godoc/pkg/path/filepath#Match extended with support
	// for '**'. If ignoredFiles and changed files are both empty, then they are not used to determine whether or not to
	// trigger a build. If ignoredFiles is not empty, then we ignore any files that match any of the ignored_file globs. If the
	// change has no files that are outside of the ignoredFiles globs, then we do not trigger a build.
	...
	// interpreted as regular expressions. Any branch or tag change that matches that regular expression will trigger a build.
	// One of 'trigger_template' or 'github' must be provided.
	TriggerTemplate cloudbuildTriggerTriggerTemplate.TriggerTriggerTemplatePtrInput
}
