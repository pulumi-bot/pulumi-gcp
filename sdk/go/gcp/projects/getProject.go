...
// 		my_org_projects, err := projects.GetProject(ctx, "gcp:projects:getProject", &projects.GetProjectArgs{
...
// 		_, err = organizations.LookupProject(ctx, "gcp:organizations:getProject", &organizations.LookupProjectArgs{
// 			ProjectId: &opt0,
// 		})
// 		if err != nil {
// 			return err
