...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/projects/OrganizationPolicyBooleanPolicy"
	"https:/github.com/pulumi/pulumi-gcp/projects/OrganizationPolicyListPolicy"
	...
	"https:/github.com/pulumi/pulumi-gcp/projects/OrganizationPolicyRestorePolicy"
)
...
type OrganizationPolicy struct {
	...
	BooleanPolicy projectsOrganizationPolicyBooleanPolicy.OrganizationPolicyBooleanPolicyPtrOutput `pulumi:"booleanPolicy"`
	...
	ListPolicy projectsOrganizationPolicyListPolicy.OrganizationPolicyListPolicyPtrOutput `pulumi:"listPolicy"`
	// The project id of the project to set the policy for.
	Project pulumi.StringOutput `pulumi:"project"`
	// A restore policy is a constraint to restore the default policy. Structure is documented below.
	RestorePolicy projectsOrganizationPolicyRestorePolicy.OrganizationPolicyRestorePolicyPtrOutput `pulumi:"restorePolicy"`
...
type organizationPolicyState struct {
	// A boolean policy is a constraint that is either enforced or not. Structure is documented below.
	BooleanPolicy *projectsOrganizationPolicyBooleanPolicy.OrganizationPolicyBooleanPolicy `pulumi:"booleanPolicy"`
	// The name of the Constraint the Policy is configuring, for example, `serviceuser.services`. Check out the [complete list of available constraints](https://cloud.google.com/resource-manager/docs/organization-policy/understanding-constraints#available_constraints).
	Constraint *string `pulumi:"constraint"`
	// (Computed) The etag of the organization policy. `etag` is used for optimistic concurrency control as a way to help prevent simultaneous updates of a policy from overwriting each other.
	Etag *string `pulumi:"etag"`
	// A policy that can define specific values that are allowed or denied for the given constraint. It can also be used to allow or deny all values. Structure is documented below.
	ListPolicy *projectsOrganizationPolicyListPolicy.OrganizationPolicyListPolicy `pulumi:"listPolicy"`
	// The project id of the project to set the policy for.
	Project *string `pulumi:"project"`
	// A restore policy is a constraint to restore the default policy. Structure is documented below.
	RestorePolicy *projectsOrganizationPolicyRestorePolicy.OrganizationPolicyRestorePolicy `pulumi:"restorePolicy"`
	// (Computed) The timestamp in RFC3339 UTC "Zulu" format, accurate to nanoseconds, representing when the variable was last updated. Example: "2016-10-09T12:33:37.578138407Z".
...
type OrganizationPolicyState struct {
	// A boolean policy is a constraint that is either enforced or not. Structure is documented below.
	BooleanPolicy projectsOrganizationPolicyBooleanPolicy.OrganizationPolicyBooleanPolicyPtrInput
	// The name of the Constraint the Policy is configuring, for example, `serviceuser.services`. Check out the [complete list of available constraints](https://cloud.google.com/resource-manager/docs/organization-policy/understanding-constraints#available_constraints).
	Constraint pulumi.StringPtrInput
	// (Computed) The etag of the organization policy. `etag` is used for optimistic concurrency control as a way to help prevent simultaneous updates of a policy from overwriting each other.
	Etag pulumi.StringPtrInput
	// A policy that can define specific values that are allowed or denied for the given constraint. It can also be used to allow or deny all values. Structure is documented below.
	ListPolicy projectsOrganizationPolicyListPolicy.OrganizationPolicyListPolicyPtrInput
	// The project id of the project to set the policy for.
	Project pulumi.StringPtrInput
	// A restore policy is a constraint to restore the default policy. Structure is documented below.
	RestorePolicy projectsOrganizationPolicyRestorePolicy.OrganizationPolicyRestorePolicyPtrInput
	// (Computed) The timestamp in RFC3339 UTC "Zulu" format, accurate to nanoseconds, representing when the variable was last updated. Example: "2016-10-09T12:33:37.578138407Z".
