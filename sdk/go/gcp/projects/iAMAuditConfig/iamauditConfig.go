...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/projects/IAMAuditConfigAuditLogConfig"
)
...
type IAMAuditConfig struct {
	...
	AuditLogConfigs projectsIAMAuditConfigAuditLogConfig.IAMAuditConfigAuditLogConfigArrayOutput `pulumi:"auditLogConfigs"`
...
type iamauditConfigState struct {
	// The configuration for logging of each type of permission.  This can be specified multiple times.  Structure is documented below.
	AuditLogConfigs []projectsIAMAuditConfigAuditLogConfig.IAMAuditConfigAuditLogConfig `pulumi:"auditLogConfigs"`
	// (Computed) The etag of the project's IAM policy.
...
type IAMAuditConfigState struct {
	// The configuration for logging of each type of permission.  This can be specified multiple times.  Structure is documented below.
	AuditLogConfigs projectsIAMAuditConfigAuditLogConfig.IAMAuditConfigAuditLogConfigArrayInput
	// (Computed) The etag of the project's IAM policy.
