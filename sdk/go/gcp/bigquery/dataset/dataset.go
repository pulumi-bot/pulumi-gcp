...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/bigquery/DatasetAccess"
	"https:/github.com/pulumi/pulumi-gcp/bigquery/DatasetAccessView"
	"https:/github.com/pulumi/pulumi-gcp/bigquery/DatasetDefaultEncryptionConfiguration"
)
...
type Dataset struct {
	...
	Accesses bigqueryDatasetAccess.DatasetAccessArrayOutput `pulumi:"accesses"`
	...
	// key.
	DefaultEncryptionConfiguration bigqueryDatasetDefaultEncryptionConfiguration.DatasetDefaultEncryptionConfigurationPtrOutput `pulumi:"defaultEncryptionConfiguration"`
...
type datasetState struct {
	// An array of objects that define dataset access for one or more entities.
	Accesses []bigqueryDatasetAccess.DatasetAccess `pulumi:"accesses"`
	// The time when this dataset was created, in milliseconds since the epoch.
	...
	// tables in the dataset will have encryption key set to this value, unless table creation request (or query) overrides the
	// key.
	DefaultEncryptionConfiguration *bigqueryDatasetDefaultEncryptionConfiguration.DatasetDefaultEncryptionConfiguration `pulumi:"defaultEncryptionConfiguration"`
	// The default partition expiration for all partitioned tables in the dataset, in milliseconds. Once this property is set,
	// all newly-created partitioned tables in the dataset will have an 'expirationMs' property in the 'timePartitioning'
	// settings set to this value, and changing the value will only affect new tables, not existing ones. The storage in a
	// partition will have an expiration time of its partition time plus this value. Setting this property overrides the use of
...
type DatasetState struct {
	// An array of objects that define dataset access for one or more entities.
	Accesses bigqueryDatasetAccess.DatasetAccessArrayInput
	// The time when this dataset was created, in milliseconds since the epoch.
	...
	// tables in the dataset will have encryption key set to this value, unless table creation request (or query) overrides the
	// key.
	DefaultEncryptionConfiguration bigqueryDatasetDefaultEncryptionConfiguration.DatasetDefaultEncryptionConfigurationPtrInput
	// The default partition expiration for all partitioned tables in the dataset, in milliseconds. Once this property is set,
	// all newly-created partitioned tables in the dataset will have an 'expirationMs' property in the 'timePartitioning'
	// settings set to this value, and changing the value will only affect new tables, not existing ones. The storage in a
	// partition will have an expiration time of its partition time plus this value. Setting this property overrides the use of
