...
// 			DatasetId:    pulumi.String("jobQueryDataset"),
...
// 			TableId:   pulumi.String("jobQueryTable"),
// 		})
// 		if err != nil {
// 			return err
// 		}
// 		job, err := bigquery.NewJob(ctx, "job", &bigquery.JobArgs{
// 			JobId: pulumi.String("jobQuery"),
...
// 	pulumi.Run(func(ctx *pulumi.Context) error {
// 		bar, err := bigquery.NewDataset(ctx, "bar", &bigquery.DatasetArgs{
// 			DatasetId:    pulumi.String("jobLoadDataset"),
// 			FriendlyName: pulumi.String("test"),
// 			Description:  pulumi.String("This is a test description"),
// 			Location:     pulumi.String("US"),
// 		})
...
// 		foo, err := bigquery.NewTable(ctx, "foo", &bigquery.TableArgs{
// 			DatasetId: bar.DatasetId,
// 			TableId:   pulumi.String("jobLoadTable"),
// 		})
// 		if err != nil {
// 			return err
// 		}
// 		job, err := bigquery.NewJob(ctx, "job", &bigquery.JobArgs{
// 			JobId: pulumi.String("jobLoad"),
// 			Labels: map[string]interface{}{
// 				"myJob": "load",
// 			},
