...
type tableArgs struct {
	...
	// If left blank, the table will be encrypted with a Google-managed key; that process
	// is transparent to the user.  Structure is documented below.
	EncryptionConfiguration *TableEncryptionConfigurationArgs `pulumi:"encryptionConfiguration"`
	// The time when this table expires, in
	// milliseconds since the epoch. If not present, the table will persist
	// indefinitely. Expired tables will be deleted and their storage
	// reclaimed.
	...
	// By defining these properties, the data source can then be queried as
	// if it were a standard BigQuery table. Structure is documented below.
	ExternalDataConfiguration *TableExternalDataConfigurationArgs `pulumi:"externalDataConfiguration"`
	// A descriptive name for the table.
	FriendlyName *string `pulumi:"friendlyName"`
	// A mapping of labels to assign to the resource.
	Labels map[string]string `pulumi:"labels"`
	...
	// If specified, configures range-based
	// partitioning for this table. Structure is documented below.
	RangePartitioning *TableRangePartitioningArgs `pulumi:"rangePartitioning"`
	// A JSON schema for the table. Schema is required
	// for CSV and JSON formats and is disallowed for Google Cloud
	// Bigtable, Cloud Datastore backups, and Avro formats when using
	// external tables. For more information see the
	...
	// If specified, configures time-based
	// partitioning for this table. Structure is documented below.
	TimePartitioning *TableTimePartitioningArgs `pulumi:"timePartitioning"`
	// If specified, configures this table as a view.
	// Structure is documented below.
	View *TableViewArgs `pulumi:"view"`
}
...
type TableArgs struct {
	...
	// If left blank, the table will be encrypted with a Google-managed key; that process
	// is transparent to the user.  Structure is documented below.
	EncryptionConfiguration TableEncryptionConfigurationArgsPtrInput
	// The time when this table expires, in
	// milliseconds since the epoch. If not present, the table will persist
	// indefinitely. Expired tables will be deleted and their storage
	// reclaimed.
	...
	// By defining these properties, the data source can then be queried as
	// if it were a standard BigQuery table. Structure is documented below.
	ExternalDataConfiguration TableExternalDataConfigurationArgsPtrInput
	// A descriptive name for the table.
	FriendlyName pulumi.StringPtrInput
	// A mapping of labels to assign to the resource.
	Labels pulumi.StringMapInput
	...
	// If specified, configures range-based
	// partitioning for this table. Structure is documented below.
	RangePartitioning TableRangePartitioningArgsPtrInput
	// A JSON schema for the table. Schema is required
	// for CSV and JSON formats and is disallowed for Google Cloud
	// Bigtable, Cloud Datastore backups, and Avro formats when using
	// external tables. For more information see the
	...
	// If specified, configures time-based
	// partitioning for this table. Structure is documented below.
	TimePartitioning TableTimePartitioningArgsPtrInput
	// If specified, configures this table as a view.
	// Structure is documented below.
	View TableViewArgsPtrInput
}
