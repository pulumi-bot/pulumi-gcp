...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/appengine/DomainMappingResourceRecord"
	"https:/github.com/pulumi/pulumi-gcp/appengine/DomainMappingSslSettings"
)
...
type DomainMapping struct {
	...
	ResourceRecords appengineDomainMappingResourceRecord.DomainMappingResourceRecordArrayOutput `pulumi:"resourceRecords"`
	// SSL configuration for this domain. If unconfigured, this domain will not serve with SSL.
	SslSettings appengineDomainMappingSslSettings.DomainMappingSslSettingsPtrOutput `pulumi:"sslSettings"`
}
...
type domainMappingState struct {
	...
	// The resource records required to configure this domain mapping. These records must be added to the domain's DNS
	// configuration in order to serve the application via this domain mapping.
	ResourceRecords []appengineDomainMappingResourceRecord.DomainMappingResourceRecord `pulumi:"resourceRecords"`
	// SSL configuration for this domain. If unconfigured, this domain will not serve with SSL.
	SslSettings *appengineDomainMappingSslSettings.DomainMappingSslSettings `pulumi:"sslSettings"`
}
...
type DomainMappingState struct {
	...
	// The resource records required to configure this domain mapping. These records must be added to the domain's DNS
	// configuration in order to serve the application via this domain mapping.
	ResourceRecords appengineDomainMappingResourceRecord.DomainMappingResourceRecordArrayInput
	// SSL configuration for this domain. If unconfigured, this domain will not serve with SSL.
	SslSettings appengineDomainMappingSslSettings.DomainMappingSslSettingsPtrInput
}
