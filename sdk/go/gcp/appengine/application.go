...
type applicationArgs struct {
	...
	AuthDomain *string `pulumi:"authDomain"`
	// A block of optional settings to configure specific App Engine features:
	FeatureSettings *ApplicationFeatureSettingsArgs `pulumi:"featureSettings"`
	// Settings for enabling Cloud Identity Aware Proxy
	Iap *ApplicationIapArgs `pulumi:"iap"`
	// The [location](https://cloud.google.com/appengine/docs/locations)
	// to serve the app from.
	LocationId string `pulumi:"locationId"`
	// The project ID to create the application under.
...
type ApplicationArgs struct {
	...
	AuthDomain pulumi.StringPtrInput
	// A block of optional settings to configure specific App Engine features:
	FeatureSettings ApplicationFeatureSettingsArgsPtrInput
	// Settings for enabling Cloud Identity Aware Proxy
	Iap ApplicationIapArgsPtrInput
	// The [location](https://cloud.google.com/appengine/docs/locations)
	// to serve the app from.
