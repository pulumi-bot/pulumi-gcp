...
type flexibleAppVersionArgs struct {
	// Serving configuration for Google Cloud Endpoints.
	ApiConfig *FlexibleAppVersionApiConfigArgs `pulumi:"apiConfig"`
	// Automatic scaling is based on request rate, response latencies, and other application metrics.
	AutomaticScaling *FlexibleAppVersionAutomaticScalingArgs `pulumi:"automaticScaling"`
	// Metadata settings that are supplied to this version to enable beta runtime features.
	BetaSettings map[string]string `pulumi:"betaSettings"`
	// Duration that static files should be cached by web proxies and browsers. Only applicable if the corresponding
	// StaticFilesHandler does not specify its own expiration time.
	...
	DeleteServiceOnDestroy *bool `pulumi:"deleteServiceOnDestroy"`
	// Code and application artifacts that make up this version.
	Deployment *FlexibleAppVersionDeploymentArgs `pulumi:"deployment"`
	// Code and application artifacts that make up this version.
	EndpointsApiService *FlexibleAppVersionEndpointsApiServiceArgs `pulumi:"endpointsApiService"`
	// The entrypoint for the application.
	Entrypoint *FlexibleAppVersionEntrypointArgs `pulumi:"entrypoint"`
	// Environment variables available to the application. As these are not returned in the API request, Terraform will not
	// detect any changes made outside of the Terraform config.
	EnvVariables map[string]string `pulumi:"envVariables"`
	// Before an application can receive email or XMPP messages, the application must be configured to enable the service.
	...
	InstanceClass *string `pulumi:"instanceClass"`
	// Health checking configuration for VM instances. Unhealthy instances are killed and replaced with new instances.
	LivenessCheck FlexibleAppVersionLivenessCheckArgs `pulumi:"livenessCheck"`
	// A service with manual scaling runs continuously, allowing you to perform complex initialization and rely on the state of
	// its memory over time.
	ManualScaling *FlexibleAppVersionManualScalingArgs `pulumi:"manualScaling"`
	// Extra network settings
	Network *FlexibleAppVersionNetworkArgs `pulumi:"network"`
	// Files that match this pattern will not be built into this version. Only applicable for Go runtimes.
	NobuildFilesRegex *string `pulumi:"nobuildFilesRegex"`
	// If set to `true`, the application version will not be deleted.
	NoopOnDestroy *bool `pulumi:"noopOnDestroy"`
	...
	Project *string `pulumi:"project"`
	// Configures readiness health checking for instances. Unhealthy instances are not put into the backend traffic rotation.
	ReadinessCheck FlexibleAppVersionReadinessCheckArgs `pulumi:"readinessCheck"`
	// Machine resources for a version.
	Resources *FlexibleAppVersionResourcesArgs `pulumi:"resources"`
	// Desired runtime. Example python27.
	Runtime string `pulumi:"runtime"`
	// The version of the API in the given runtime environment. Please see the app.yaml reference for valid values at
	// https://cloud.google.com/appengine/docs/standard//config/appref
	...
	VersionId *string `pulumi:"versionId"`
	// Enables VPC connectivity for standard apps.
	VpcAccessConnector *FlexibleAppVersionVpcAccessConnectorArgs `pulumi:"vpcAccessConnector"`
}

// The set of arguments for constructing a FlexibleAppVersion resource.
type FlexibleAppVersionArgs struct {
	// Serving configuration for Google Cloud Endpoints.
	ApiConfig FlexibleAppVersionApiConfigArgsPtrInput
	// Automatic scaling is based on request rate, response latencies, and other application metrics.
	AutomaticScaling FlexibleAppVersionAutomaticScalingArgsPtrInput
	// Metadata settings that are supplied to this version to enable beta runtime features.
	BetaSettings pulumi.StringMapInput
	// Duration that static files should be cached by web proxies and browsers. Only applicable if the corresponding
	// StaticFilesHandler does not specify its own expiration time.
	...
	DeleteServiceOnDestroy pulumi.BoolPtrInput
	// Code and application artifacts that make up this version.
	Deployment FlexibleAppVersionDeploymentArgsPtrInput
	// Code and application artifacts that make up this version.
	EndpointsApiService FlexibleAppVersionEndpointsApiServiceArgsPtrInput
	// The entrypoint for the application.
	Entrypoint FlexibleAppVersionEntrypointArgsPtrInput
	// Environment variables available to the application. As these are not returned in the API request, Terraform will not
	// detect any changes made outside of the Terraform config.
	EnvVariables pulumi.StringMapInput
	// Before an application can receive email or XMPP messages, the application must be configured to enable the service.
	...
	InstanceClass pulumi.StringPtrInput
	// Health checking configuration for VM instances. Unhealthy instances are killed and replaced with new instances.
	LivenessCheck FlexibleAppVersionLivenessCheckArgsInput
	// A service with manual scaling runs continuously, allowing you to perform complex initialization and rely on the state of
	// its memory over time.
	ManualScaling FlexibleAppVersionManualScalingArgsPtrInput
	// Extra network settings
	Network FlexibleAppVersionNetworkArgsPtrInput
	// Files that match this pattern will not be built into this version. Only applicable for Go runtimes.
	NobuildFilesRegex pulumi.StringPtrInput
	// If set to `true`, the application version will not be deleted.
	NoopOnDestroy pulumi.BoolPtrInput
	...
	Project pulumi.StringPtrInput
	// Configures readiness health checking for instances. Unhealthy instances are not put into the backend traffic rotation.
	ReadinessCheck FlexibleAppVersionReadinessCheckArgsInput
	// Machine resources for a version.
	Resources FlexibleAppVersionResourcesArgsPtrInput
	// Desired runtime. Example python27.
	...
	VersionId pulumi.StringPtrInput
	// Enables VPC connectivity for standard apps.
	VpcAccessConnector FlexibleAppVersionVpcAccessConnectorArgsPtrInput
}
