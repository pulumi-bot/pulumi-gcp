...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/appengine/ApplicationUrlDispatchRulesDispatchRule"
)
...
type ApplicationUrlDispatchRules struct {
	...
	DispatchRules appengineApplicationUrlDispatchRulesDispatchRule.ApplicationUrlDispatchRulesDispatchRuleArrayOutput `pulumi:"dispatchRules"`
...
type applicationUrlDispatchRulesState struct {
	// Rules to match an HTTP request and dispatch that request to a service.
	DispatchRules []appengineApplicationUrlDispatchRulesDispatchRule.ApplicationUrlDispatchRulesDispatchRule `pulumi:"dispatchRules"`
	Project *string `pulumi:"project"`
}

type ApplicationUrlDispatchRulesState struct {
	// Rules to match an HTTP request and dispatch that request to a service.
	DispatchRules appengineApplicationUrlDispatchRulesDispatchRule.ApplicationUrlDispatchRulesDispatchRuleArrayInput
