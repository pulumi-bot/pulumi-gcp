...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/appengine/ApplicationFeatureSettings"
	"https:/github.com/pulumi/pulumi-gcp/appengine/ApplicationUrlDispatchRule"
)
...
type Application struct {
	...
	FeatureSettings appengineApplicationFeatureSettings.ApplicationFeatureSettingsOutput `pulumi:"featureSettings"`
	...
	UrlDispatchRules appengineApplicationUrlDispatchRule.ApplicationUrlDispatchRuleArrayOutput `pulumi:"urlDispatchRules"`
}
...
type applicationState struct {
	...
	// A block of optional settings to configure specific App Engine features:
	FeatureSettings *appengineApplicationFeatureSettings.ApplicationFeatureSettings `pulumi:"featureSettings"`
	// The GCR domain used for storing managed Docker images for this app.
	...
	// A list of dispatch rule blocks. Each block has a `domain`, `path`, and `service` field.
	UrlDispatchRules []appengineApplicationUrlDispatchRule.ApplicationUrlDispatchRule `pulumi:"urlDispatchRules"`
}
...
type ApplicationState struct {
	...
	// A block of optional settings to configure specific App Engine features:
	FeatureSettings appengineApplicationFeatureSettings.ApplicationFeatureSettingsPtrInput
	// The GCR domain used for storing managed Docker images for this app.
	...
	// A list of dispatch rule blocks. Each block has a `domain`, `path`, and `service` field.
	UrlDispatchRules appengineApplicationUrlDispatchRule.ApplicationUrlDispatchRuleArrayInput
}
