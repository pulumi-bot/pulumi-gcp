...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/runtimeconfig/ConfigIamBindingCondition"
)
...
type ConfigIamBinding struct {
	...
	Condition runtimeconfigConfigIamBindingCondition.ConfigIamBindingConditionPtrOutput `pulumi:"condition"`
...
type configIamBindingState struct {
	Condition *runtimeconfigConfigIamBindingCondition.ConfigIamBindingCondition `pulumi:"condition"`
	// Used to find the parent resource to bind the IAM policy to
...
type ConfigIamBindingState struct {
	Condition runtimeconfigConfigIamBindingCondition.ConfigIamBindingConditionPtrInput
	// Used to find the parent resource to bind the IAM policy to
