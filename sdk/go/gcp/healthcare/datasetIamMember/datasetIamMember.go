...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/healthcare/DatasetIamMemberCondition"
)
...
type DatasetIamMember struct {
	...
	Condition healthcareDatasetIamMemberCondition.DatasetIamMemberConditionPtrOutput `pulumi:"condition"`
...
type datasetIamMemberState struct {
	Condition *healthcareDatasetIamMemberCondition.DatasetIamMemberCondition `pulumi:"condition"`
	// The dataset ID, in the form
	// `{project_id}/{location_name}/{dataset_name}` or
	// `{location_name}/{dataset_name}`. In the second form, the provider's
	// project setting will be used as a fallback.
...
type DatasetIamMemberState struct {
	Condition healthcareDatasetIamMemberCondition.DatasetIamMemberConditionPtrInput
	// The dataset ID, in the form
	// `{project_id}/{location_name}/{dataset_name}` or
	// `{location_name}/{dataset_name}`. In the second form, the provider's
	// project setting will be used as a fallback.
