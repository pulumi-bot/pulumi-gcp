...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/healthcare/Hl7StoreIamBindingCondition"
)
...
type Hl7StoreIamBinding struct {
	...
	Condition healthcareHl7StoreIamBindingCondition.Hl7StoreIamBindingConditionPtrOutput `pulumi:"condition"`
...
type hl7StoreIamBindingState struct {
	Condition *healthcareHl7StoreIamBindingCondition.Hl7StoreIamBindingCondition `pulumi:"condition"`
	// (Computed) The etag of the HL7v2 store's IAM policy.
...
type Hl7StoreIamBindingState struct {
	Condition healthcareHl7StoreIamBindingCondition.Hl7StoreIamBindingConditionPtrInput
	// (Computed) The etag of the HL7v2 store's IAM policy.
