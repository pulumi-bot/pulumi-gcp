...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/healthcare/DicomStoreIamBindingCondition"
)
...
type DicomStoreIamBinding struct {
	...
	Condition healthcareDicomStoreIamBindingCondition.DicomStoreIamBindingConditionPtrOutput `pulumi:"condition"`
...
type dicomStoreIamBindingState struct {
	Condition *healthcareDicomStoreIamBindingCondition.DicomStoreIamBindingCondition `pulumi:"condition"`
	// The DICOM store ID, in the form
	// `{project_id}/{location_name}/{dataset_name}/{dicom_store_name}` or
	// `{location_name}/{dataset_name}/{dicom_store_name}`. In the second form, the provider's
	// project setting will be used as a fallback.
...
type DicomStoreIamBindingState struct {
	Condition healthcareDicomStoreIamBindingCondition.DicomStoreIamBindingConditionPtrInput
	// The DICOM store ID, in the form
	// `{project_id}/{location_name}/{dataset_name}/{dicom_store_name}` or
	// `{location_name}/{dataset_name}/{dicom_store_name}`. In the second form, the provider's
	// project setting will be used as a fallback.
