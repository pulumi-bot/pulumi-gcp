...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/healthcare/Hl7StoreIamMemberCondition"
)
...
type Hl7StoreIamMember struct {
	...
	Condition healthcareHl7StoreIamMemberCondition.Hl7StoreIamMemberConditionPtrOutput `pulumi:"condition"`
...
type hl7StoreIamMemberState struct {
	Condition *healthcareHl7StoreIamMemberCondition.Hl7StoreIamMemberCondition `pulumi:"condition"`
	// (Computed) The etag of the HL7v2 store's IAM policy.
...
type Hl7StoreIamMemberState struct {
	Condition healthcareHl7StoreIamMemberCondition.Hl7StoreIamMemberConditionPtrInput
	// (Computed) The etag of the HL7v2 store's IAM policy.
