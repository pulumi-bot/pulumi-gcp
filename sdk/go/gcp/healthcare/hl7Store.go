...
type hl7StoreArgs struct {
	...
	Name *string `pulumi:"name"`
	// A nested object resource
	NotificationConfig *Hl7StoreNotificationConfigArgs `pulumi:"notificationConfig"`
	// A nested object resource
	ParserConfig *Hl7StoreParserConfigArgs `pulumi:"parserConfig"`
}
...
type Hl7StoreArgs struct {
	...
	Name pulumi.StringPtrInput
	// A nested object resource
	NotificationConfig Hl7StoreNotificationConfigArgsPtrInput
	// A nested object resource
	ParserConfig Hl7StoreParserConfigArgsPtrInput
}
