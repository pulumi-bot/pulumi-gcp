...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/healthcare/DicomStoreIamMemberCondition"
)
...
type DicomStoreIamMember struct {
	...
	Condition healthcareDicomStoreIamMemberCondition.DicomStoreIamMemberConditionPtrOutput `pulumi:"condition"`
...
type dicomStoreIamMemberState struct {
	Condition *healthcareDicomStoreIamMemberCondition.DicomStoreIamMemberCondition `pulumi:"condition"`
	// The DICOM store ID, in the form
	// `{project_id}/{location_name}/{dataset_name}/{dicom_store_name}` or
	// `{location_name}/{dataset_name}/{dicom_store_name}`. In the second form, the provider's
	// project setting will be used as a fallback.
...
type DicomStoreIamMemberState struct {
	Condition healthcareDicomStoreIamMemberCondition.DicomStoreIamMemberConditionPtrInput
	// The DICOM store ID, in the form
	// `{project_id}/{location_name}/{dataset_name}/{dicom_store_name}` or
	// `{location_name}/{dataset_name}/{dicom_store_name}`. In the second form, the provider's
	// project setting will be used as a fallback.
