...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/healthcare/DatasetIamBindingCondition"
)
...
type DatasetIamBinding struct {
	...
	Condition healthcareDatasetIamBindingCondition.DatasetIamBindingConditionPtrOutput `pulumi:"condition"`
...
type datasetIamBindingState struct {
	Condition *healthcareDatasetIamBindingCondition.DatasetIamBindingCondition `pulumi:"condition"`
	// The dataset ID, in the form
	// `{project_id}/{location_name}/{dataset_name}` or
	// `{location_name}/{dataset_name}`. In the second form, the provider's
	// project setting will be used as a fallback.
...
type DatasetIamBindingState struct {
	Condition healthcareDatasetIamBindingCondition.DatasetIamBindingConditionPtrInput
	// The dataset ID, in the form
	// `{project_id}/{location_name}/{dataset_name}` or
	// `{location_name}/{dataset_name}`. In the second form, the provider's
	// project setting will be used as a fallback.
