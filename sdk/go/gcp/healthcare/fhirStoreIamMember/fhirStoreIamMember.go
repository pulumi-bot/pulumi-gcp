...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/healthcare/FhirStoreIamMemberCondition"
)
...
type FhirStoreIamMember struct {
	...
	Condition healthcareFhirStoreIamMemberCondition.FhirStoreIamMemberConditionPtrOutput `pulumi:"condition"`
...
type fhirStoreIamMemberState struct {
	Condition *healthcareFhirStoreIamMemberCondition.FhirStoreIamMemberCondition `pulumi:"condition"`
	// (Computed) The etag of the FHIR store's IAM policy.
...
type FhirStoreIamMemberState struct {
	Condition healthcareFhirStoreIamMemberCondition.FhirStoreIamMemberConditionPtrInput
	// (Computed) The etag of the FHIR store's IAM policy.
