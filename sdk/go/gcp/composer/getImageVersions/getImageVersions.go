...
// nolint: lll
package getImageVersions

import (
	"github.com/pulumi/pulumi/sdk/go/pulumi"
	"https:/github.com/pulumi/pulumi-gcp/composer/getImageVersionsImageVersion"
)
...
type GetImageVersionsResult struct {
	...
	ImageVersions []composergetImageVersionsImageVersion.GetImageVersionsImageVersion `pulumi:"imageVersions"`
	Project string `pulumi:"project"`
	Region string `pulumi:"region"`
}
