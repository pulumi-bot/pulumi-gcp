...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/cloudfunctions/FunctionIamMemberCondition"
)
...
type FunctionIamMember struct {
	...
	Condition cloudfunctionsFunctionIamMemberCondition.FunctionIamMemberConditionPtrOutput `pulumi:"condition"`
...
type functionIamMemberState struct {
	...
	Condition *cloudfunctionsFunctionIamMemberCondition.FunctionIamMemberCondition `pulumi:"condition"`
	// (Computed) The etag of the IAM policy.
...
type FunctionIamMemberState struct {
	...
	Condition cloudfunctionsFunctionIamMemberCondition.FunctionIamMemberConditionPtrInput
	// (Computed) The etag of the IAM policy.
