...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/cloudfunctions/FunctionIamBindingCondition"
)
...
type FunctionIamBinding struct {
	...
	Condition cloudfunctionsFunctionIamBindingCondition.FunctionIamBindingConditionPtrOutput `pulumi:"condition"`
...
type functionIamBindingState struct {
	...
	Condition *cloudfunctionsFunctionIamBindingCondition.FunctionIamBindingCondition `pulumi:"condition"`
	// (Computed) The etag of the IAM policy.
...
type FunctionIamBindingState struct {
	...
	Condition cloudfunctionsFunctionIamBindingCondition.FunctionIamBindingConditionPtrInput
	// (Computed) The etag of the IAM policy.
