...
func LookupFunctionApply(ctx *pulumi.Context, args LookupFunctionApplyInput, opts ...pulumi.InvokeOption) LookupFunctionResultOutput {
	return args.ToLookupFunctionApplyOutput().ApplyT(func(v LookupFunctionArgs) (LookupFunctionResult, error) {
		r, err := LookupFunction(ctx, &v, opts...)
		return *r, err

	}).(LookupFunctionResultOutput)
}

// LookupFunctionApplyInput is an input type that accepts LookupFunctionApplyArgs and LookupFunctionApplyOutput values.
// You can construct a concrete instance of `LookupFunctionApplyInput` via:
//
//          LookupFunctionApplyArgs{...}
type LookupFunctionApplyInput interface {
	pulumi.Input

	ToLookupFunctionApplyOutput() LookupFunctionApplyOutput
	ToLookupFunctionApplyOutputWithContext(context.Context) LookupFunctionApplyOutput
}

// A collection of arguments for invoking getFunction.
type LookupFunctionApplyArgs struct {
	// The name of a Cloud Function.
...
func (LookupFunctionApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupFunctionArgs)(nil)).Elem()
}

func (i LookupFunctionApplyArgs) ToLookupFunctionApplyOutput() LookupFunctionApplyOutput {
	return i.ToLookupFunctionApplyOutputWithContext(context.Background())
}

func (i LookupFunctionApplyArgs) ToLookupFunctionApplyOutputWithContext(ctx context.Context) LookupFunctionApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupFunctionApplyOutput)
}

// A collection of arguments for invoking getFunction.
type LookupFunctionApplyOutput struct{ *pulumi.OutputState }

func (LookupFunctionApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupFunctionArgs)(nil)).Elem()
}

func (o LookupFunctionApplyOutput) ToLookupFunctionApplyOutput() LookupFunctionApplyOutput {
	return o
}

func (o LookupFunctionApplyOutput) ToLookupFunctionApplyOutputWithContext(ctx context.Context) LookupFunctionApplyOutput {
	return o
}

// The name of a Cloud Function.
func (o LookupFunctionApplyOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v LookupFunctionArgs) string { return v.Name }).(pulumi.StringOutput)
}

// The project in which the resource belongs. If it
// is not provided, the provider project is used.
func (o LookupFunctionApplyOutput) Project() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupFunctionArgs) *string { return v.Project }).(pulumi.StringPtrOutput)
}

// The region in which the resource belongs. If it
// is not provided, the provider region is used.
func (o LookupFunctionApplyOutput) Region() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupFunctionArgs) *string { return v.Region }).(pulumi.StringPtrOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupFunctionApplyOutput{})
