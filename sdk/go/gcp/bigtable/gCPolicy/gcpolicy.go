...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/bigtable/GCPolicyMaxAge"
	"https:/github.com/pulumi/pulumi-gcp/bigtable/GCPolicyMaxVersion"
)
...
type GCPolicy struct {
	...
	MaxAges bigtableGCPolicyMaxAge.GCPolicyMaxAgeArrayOutput `pulumi:"maxAges"`
	// GC policy that applies to all versions of a cell except for the most recent.
	MaxVersions bigtableGCPolicyMaxVersion.GCPolicyMaxVersionArrayOutput `pulumi:"maxVersions"`
...
type gcpolicyState struct {
	...
	// GC policy that applies to all cells older than the given age.
	MaxAges []bigtableGCPolicyMaxAge.GCPolicyMaxAge `pulumi:"maxAges"`
	// GC policy that applies to all versions of a cell except for the most recent.
	MaxVersions []bigtableGCPolicyMaxVersion.GCPolicyMaxVersion `pulumi:"maxVersions"`
	// If multiple policies are set, you should choose between `UNION` OR `INTERSECTION`.
...
type GCPolicyState struct {
	...
	// GC policy that applies to all cells older than the given age.
	MaxAges bigtableGCPolicyMaxAge.GCPolicyMaxAgeArrayInput
	// GC policy that applies to all versions of a cell except for the most recent.
	MaxVersions bigtableGCPolicyMaxVersion.GCPolicyMaxVersionArrayInput
	// If multiple policies are set, you should choose between `UNION` OR `INTERSECTION`.
