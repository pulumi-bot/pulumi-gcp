...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/bigtable/InstanceCluster"
)
...
type Instance struct {
	...
	Clusters bigtableInstanceCluster.InstanceClusterArrayOutput `pulumi:"clusters"`
...
type instanceState struct {
	// A block of cluster configuration options. This can be specified 1 or 2 times. See structure below.
	Clusters []bigtableInstanceCluster.InstanceCluster `pulumi:"clusters"`
	// The human-readable display name of the Bigtable instance. Defaults to the instance `name`.
...
type InstanceState struct {
	// A block of cluster configuration options. This can be specified 1 or 2 times. See structure below.
	Clusters bigtableInstanceCluster.InstanceClusterArrayInput
	// The human-readable display name of the Bigtable instance. Defaults to the instance `name`.
