...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/bigtable/TableColumnFamily"
)
...
type Table struct {
	...
	ColumnFamilies bigtableTableColumnFamily.TableColumnFamilyArrayOutput `pulumi:"columnFamilies"`
...
type tableState struct {
	// A group of columns within a table which share a common configuration. This can be specified multiple times. Structure is documented below.
	ColumnFamilies []bigtableTableColumnFamily.TableColumnFamily `pulumi:"columnFamilies"`
	// The name of the Bigtable instance.
...
type TableState struct {
	// A group of columns within a table which share a common configuration. This can be specified multiple times. Structure is documented below.
	ColumnFamilies bigtableTableColumnFamily.TableColumnFamilyArrayInput
	// The name of the Bigtable instance.
