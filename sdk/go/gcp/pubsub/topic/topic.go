...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/pubsub/TopicMessageStoragePolicy"
)
...
type Topic struct {
	...
	MessageStoragePolicy pubsubTopicMessageStoragePolicy.TopicMessageStoragePolicyOutput `pulumi:"messageStoragePolicy"`
	// Name of the topic.
...
type topicState struct {
	...
	// Policy constraining the set of Google Cloud Platform regions where messages published to the topic may be stored. If not
	// present, then no constraints are in effect.
	MessageStoragePolicy *pubsubTopicMessageStoragePolicy.TopicMessageStoragePolicy `pulumi:"messageStoragePolicy"`
	// Name of the topic.
...
type TopicState struct {
	...
	// Policy constraining the set of Google Cloud Platform regions where messages published to the topic may be stored. If not
	// present, then no constraints are in effect.
	MessageStoragePolicy pubsubTopicMessageStoragePolicy.TopicMessageStoragePolicyPtrInput
	// Name of the topic.
