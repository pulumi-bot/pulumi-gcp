...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/pubsub/SubscriptionIAMMemberCondition"
)
...
type SubscriptionIAMMember struct {
	...
	Condition pubsubSubscriptionIAMMemberCondition.SubscriptionIAMMemberConditionPtrOutput `pulumi:"condition"`
...
type subscriptionIAMMemberState struct {
	Condition *pubsubSubscriptionIAMMemberCondition.SubscriptionIAMMemberCondition `pulumi:"condition"`
	// (Computed) The etag of the subscription's IAM policy.
...
type SubscriptionIAMMemberState struct {
	Condition pubsubSubscriptionIAMMemberCondition.SubscriptionIAMMemberConditionPtrInput
	// (Computed) The etag of the subscription's IAM policy.
