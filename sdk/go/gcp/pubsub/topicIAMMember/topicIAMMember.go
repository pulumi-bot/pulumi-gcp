...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/pubsub/TopicIAMMemberCondition"
)
...
type TopicIAMMember struct {
	...
	Condition pubsubTopicIAMMemberCondition.TopicIAMMemberConditionPtrOutput `pulumi:"condition"`
...
type topicIAMMemberState struct {
	Condition *pubsubTopicIAMMemberCondition.TopicIAMMemberCondition `pulumi:"condition"`
	// (Computed) The etag of the IAM policy.
...
type TopicIAMMemberState struct {
	Condition pubsubTopicIAMMemberCondition.TopicIAMMemberConditionPtrInput
	// (Computed) The etag of the IAM policy.
