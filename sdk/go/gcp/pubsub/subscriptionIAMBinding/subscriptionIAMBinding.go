...
// nolint: lll
package subscriptionIAMBinding
...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/pubsub/SubscriptionIAMBindingCondition"
)
...
type SubscriptionIAMBinding struct {
	...
	Condition pubsubSubscriptionIAMBindingCondition.SubscriptionIAMBindingConditionPtrOutput `pulumi:"condition"`
...
type subscriptionIAMBindingState struct {
	Condition *pubsubSubscriptionIAMBindingCondition.SubscriptionIAMBindingCondition `pulumi:"condition"`
	// (Computed) The etag of the subscription's IAM policy.
...
type SubscriptionIAMBindingState struct {
	Condition pubsubSubscriptionIAMBindingCondition.SubscriptionIAMBindingConditionPtrInput
	// (Computed) The etag of the subscription's IAM policy.
