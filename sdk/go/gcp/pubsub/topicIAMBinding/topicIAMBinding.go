...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/pubsub/TopicIAMBindingCondition"
)
...
type TopicIAMBinding struct {
	...
	Condition pubsubTopicIAMBindingCondition.TopicIAMBindingConditionPtrOutput `pulumi:"condition"`
...
type topicIAMBindingState struct {
	Condition *pubsubTopicIAMBindingCondition.TopicIAMBindingCondition `pulumi:"condition"`
	// (Computed) The etag of the IAM policy.
...
type TopicIAMBindingState struct {
	Condition pubsubTopicIAMBindingCondition.TopicIAMBindingConditionPtrInput
	// (Computed) The etag of the IAM policy.
