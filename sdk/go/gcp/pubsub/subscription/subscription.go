...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/pubsub/SubscriptionExpirationPolicy"
	"https:/github.com/pulumi/pulumi-gcp/pubsub/SubscriptionPushConfig"
...
type Subscription struct {
	...
	ExpirationPolicy pubsubSubscriptionExpirationPolicy.SubscriptionExpirationPolicyOutput `pulumi:"expirationPolicy"`
	...
	PushConfig pubsubSubscriptionPushConfig.SubscriptionPushConfigPtrOutput `pulumi:"pushConfig"`
...
type subscriptionState struct {
	...
	// subscription. If expirationPolicy is not set, a default policy with ttl of 31 days will be used. If it is set but ttl is
	// "", the resource never expires. The minimum allowed value for expirationPolicy.ttl is 1 day.
	ExpirationPolicy *pubsubSubscriptionExpirationPolicy.SubscriptionExpirationPolicy `pulumi:"expirationPolicy"`
	// A set of key/value label pairs to assign to this Subscription.
	...
	// If push delivery is used with this subscription, this field is used to configure it. An empty pushConfig signifies that
	// the subscriber will pull and ack messages using API methods.
	PushConfig *pubsubSubscriptionPushConfig.SubscriptionPushConfig `pulumi:"pushConfig"`
	// Indicates whether to retain acknowledged messages. If 'true', then messages are not expunged from the subscription's
	// backlog, even if they are acknowledged, until they fall out of the messageRetentionDuration window.
...
type SubscriptionState struct {
	...
	// subscription. If expirationPolicy is not set, a default policy with ttl of 31 days will be used. If it is set but ttl is
	// "", the resource never expires. The minimum allowed value for expirationPolicy.ttl is 1 day.
	ExpirationPolicy pubsubSubscriptionExpirationPolicy.SubscriptionExpirationPolicyPtrInput
	// A set of key/value label pairs to assign to this Subscription.
	...
	// If push delivery is used with this subscription, this field is used to configure it. An empty pushConfig signifies that
	// the subscriber will pull and ack messages using API methods.
	PushConfig pubsubSubscriptionPushConfig.SubscriptionPushConfigPtrInput
	// Indicates whether to retain acknowledged messages. If 'true', then messages are not expunged from the subscription's
	// backlog, even if they are acknowledged, until they fall out of the messageRetentionDuration window.
