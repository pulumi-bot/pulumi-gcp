...
import (
	...
	"https:/github.com/pulumi/pulumi-gcp/dns/PolicyAlternativeNameServerConfig"
	"https:/github.com/pulumi/pulumi-gcp/dns/PolicyAlternativeNameServerConfigTargetNameServer"
	"https:/github.com/pulumi/pulumi-gcp/dns/PolicyNetwork"
)
...
type Policy struct {
	...
	AlternativeNameServerConfig dnsPolicyAlternativeNameServerConfig.PolicyAlternativeNameServerConfigPtrOutput `pulumi:"alternativeNameServerConfig"`
	...
	Networks dnsPolicyNetwork.PolicyNetworkArrayOutput `pulumi:"networks"`
...
type policyState struct {
	// Sets an alternative name server for the associated networks. When specified, all DNS queries are forwarded to a name
	// server that you choose. Names such as .internal are not available when an alternative name server is specified.
	AlternativeNameServerConfig *dnsPolicyAlternativeNameServerConfig.PolicyAlternativeNameServerConfig `pulumi:"alternativeNameServerConfig"`
	// A textual description field. Defaults to 'Managed by Terraform'.
	...
	// List of network names specifying networks to which this policy is applied.
	Networks []dnsPolicyNetwork.PolicyNetwork `pulumi:"networks"`
	// The ID of the project in which the resource belongs.
	// If it is not provided, the provider project is used.
...
type PolicyState struct {
	// Sets an alternative name server for the associated networks. When specified, all DNS queries are forwarded to a name
	// server that you choose. Names such as .internal are not available when an alternative name server is specified.
	AlternativeNameServerConfig dnsPolicyAlternativeNameServerConfig.PolicyAlternativeNameServerConfigPtrInput
	// A textual description field. Defaults to 'Managed by Terraform'.
	...
	// List of network names specifying networks to which this policy is applied.
	Networks dnsPolicyNetwork.PolicyNetworkArrayInput
	// The ID of the project in which the resource belongs.
	// If it is not provided, the provider project is used.
