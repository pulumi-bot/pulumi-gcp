...
func GetManagedZone(ctx *pulumi.Context, args *GetManagedZoneArgs, opts ...pulumi.InvokeOption) (*GetManagedZoneResult, error) {
	var rv GetManagedZoneResult
