...
type managedZoneArgs struct {
	...
	DnsName string `pulumi:"dnsName"`
	// DNSSEC configuration
	DnssecConfig *ManagedZoneDnssecConfigArgs `pulumi:"dnssecConfig"`
	// The presence for this field indicates that outbound forwarding is enabled for this zone. The value of this field
	// contains the set of destinations to forward to.
	ForwardingConfig *ManagedZoneForwardingConfigArgs `pulumi:"forwardingConfig"`
	// A set of key/value label pairs to assign to this ManagedZone.
	Labels map[string]string `pulumi:"labels"`
	// User assigned name for this resource. Must be unique within the project.
	Name *string `pulumi:"name"`
	// The presence of this field indicates that DNS Peering is enabled for this zone. The value of this field contains the
	// network to peer with.
	PeeringConfig *ManagedZonePeeringConfigArgs `pulumi:"peeringConfig"`
	// For privately visible zones, the set of Virtual Private Cloud resources that the zone is visible from.
	PrivateVisibilityConfig *ManagedZonePrivateVisibilityConfigArgs `pulumi:"privateVisibilityConfig"`
	// The ID of the project in which the resource belongs.
	// If it is not provided, the provider project is used.
	Project *string `pulumi:"project"`
	// Specifies if this is a managed reverse lookup zone. If true, Cloud DNS will resolve reverse lookup queries using
...
type ManagedZoneArgs struct {
	...
	// DNSSEC configuration
	DnssecConfig ManagedZoneDnssecConfigArgsPtrInput
	// The presence for this field indicates that outbound forwarding is enabled for this zone. The value of this field
	// contains the set of destinations to forward to.
	ForwardingConfig ManagedZoneForwardingConfigArgsPtrInput
	// A set of key/value label pairs to assign to this ManagedZone.
	Labels pulumi.StringMapInput
	// User assigned name for this resource. Must be unique within the project.
	Name pulumi.StringPtrInput
	// The presence of this field indicates that DNS Peering is enabled for this zone. The value of this field contains the
	// network to peer with.
	PeeringConfig ManagedZonePeeringConfigArgsPtrInput
	// For privately visible zones, the set of Virtual Private Cloud resources that the zone is visible from.
	PrivateVisibilityConfig ManagedZonePrivateVisibilityConfigArgsPtrInput
	// The ID of the project in which the resource belongs.
	// If it is not provided, the provider project is used.
	Project pulumi.StringPtrInput
	// Specifies if this is a managed reverse lookup zone. If true, Cloud DNS will resolve reverse lookup queries using
