...
namespace Pulumi.Gcp.ArtifactRegistry
{
    ...
    ///     public MyStack()
    ///     {
    ///         var my-repo = new Gcp.ArtifactRegistry.Repository("my-repo", new Gcp.ArtifactRegistry.RepositoryArgs
    ///         {
    ...
    ///             Format = "DOCKER",
    ///         });
    ///         var test-account = new Gcp.ServiceAccount.Account("test-account", new Gcp.ServiceAccount.AccountArgs
    ///         {
    ///             AccountId = "my-account",
    ///             DisplayName = "Test Service Account",
    ///         });
    ///         var test-iam = new Gcp.ArtifactRegistry.RepositoryIamMember("test-iam", new Gcp.ArtifactRegistry.RepositoryIamMemberArgs
    ///         {
    ///             Location = my-repo.Location,
    ///             Repository = my-repo.Name,
    ///             Role = "roles/artifactregistry.reader",
    ///             Member = test-account.Email.Apply(email =&gt; $"serviceAccount:{email}"),
    ///         });
    ///     }
    /// 
    /// }
