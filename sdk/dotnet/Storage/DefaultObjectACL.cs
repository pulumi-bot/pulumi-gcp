...
namespace Pulumi.Gcp.Storage
{
    ...
    ///     public MyStack()
    ///     {
    ///         var image-store = new Gcp.Storage.Bucket("image-store", new Gcp.Storage.BucketArgs
    ///         {
    ///             Location = "EU",
    ///         });
    ///         var image-store-default-acl = new Gcp.Storage.DefaultObjectACL("image-store-default-acl", new Gcp.Storage.DefaultObjectACLArgs
    ///         {
