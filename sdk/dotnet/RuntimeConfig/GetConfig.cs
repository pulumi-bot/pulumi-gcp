...
namespace Pulumi.Gcp.RuntimeConfig
{
    public static class GetConfig
    {
        ...
        public static Output<GetConfigResult> Apply(GetConfigApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetConfigApplyArgs
    {
        /// <summary>
        /// The name of the Runtime Configurator configuration.
        /// </summary>
