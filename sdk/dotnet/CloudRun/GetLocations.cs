...
namespace Pulumi.Gcp.CloudRun
{
    public static class GetLocations
    {
        ...
        public static Output<GetLocationsResult> Apply(GetLocationsApplyArgs? args = null, InvokeOptions? options = null)
        {
            args = args ?? new GetLocationsApplyArgs();
    ...
    public sealed class GetLocationsApplyArgs
    {
        /// <summary>
        /// The project to list versions for. If it
        /// is not provided, the provider project is used.
