...
namespace Pulumi.Gcp.BigTable
{
    ...
    /// </summary>
    public partial class TableIamBinding : Pulumi.CustomResource
    {
        [Output("condition")]
    ...
    public sealed class TableIamBindingArgs : Pulumi.ResourceArgs
    {
        [Input("condition")]
    ...
    public sealed class TableIamBindingState : Pulumi.ResourceArgs
    {
        [Input("condition")]
