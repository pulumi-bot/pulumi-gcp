...
namespace Pulumi.Gcp.BigTable
{
    ...
    /// </summary>
    public partial class TableIamMember : Pulumi.CustomResource
    {
        [Output("condition")]
    ...
    public sealed class TableIamMemberArgs : Pulumi.ResourceArgs
    {
        [Input("condition")]
    ...
    public sealed class TableIamMemberState : Pulumi.ResourceArgs
    {
        [Input("condition")]
