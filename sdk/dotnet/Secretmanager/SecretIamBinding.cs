...
namespace Pulumi.Gcp.SecretManager
{
    public partial class SecretIamBinding : Pulumi.CustomResource
    {
        ...
        public SecretIamBinding(string name, SecretIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:secretmanager/secretIamBinding:SecretIamBinding", name, args ?? ResourceArgs.Empty, MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class SecretIamBindingConditionArgs : Pulumi.ResourceArgs
    {
        [Input("description")]
    ...
    public sealed class SecretIamBindingConditionGetArgs : Pulumi.ResourceArgs
    {
        [Input("description")]
        public Input<string>? Description { get; set; }
    ...
    [OutputType]
    public sealed class SecretIamBindingCondition
    {
        ...
        [OutputConstructor]
        private SecretIamBindingCondition(
            string? description,
            string expression,
            string title)
        {
