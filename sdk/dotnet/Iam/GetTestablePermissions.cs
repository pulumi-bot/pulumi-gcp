...
namespace Pulumi.Gcp.Iam
{
    public static class GetTestablePermissions
    {
        ...
        public static Output<GetTestablePermissionsResult> Invoke(GetTestablePermissionsOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetTestablePermissionsOutputArgs
    {
        /// <summary>
        /// The level of support for custom roles. Can be one of `"NOT_SUPPORTED"`, `"SUPPORTED"`, `"TESTING"`. Default is `"SUPPORTED"`
        /// </summary>
        ...
        public GetTestablePermissionsOutputArgs()
        {
        }
    }
