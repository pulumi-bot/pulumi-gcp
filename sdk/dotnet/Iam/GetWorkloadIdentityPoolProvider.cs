...
namespace Pulumi.Gcp.Iam
{
    public static class GetWorkloadIdentityPoolProvider
    {
        ...
        public static Output<GetWorkloadIdentityPoolProviderResult> Invoke(GetWorkloadIdentityPoolProviderOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetWorkloadIdentityPoolProviderOutputArgs
    {
        /// <summary>
        /// The project in which the resource belongs. If it
        /// is not provided, the provider project is used.
        ...
        public GetWorkloadIdentityPoolProviderOutputArgs()
        {
        }
    }
