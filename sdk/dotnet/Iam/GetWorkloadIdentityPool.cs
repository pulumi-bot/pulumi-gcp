...
namespace Pulumi.Gcp.Iam
{
    public static class GetWorkloadIdentityPool
    {
        ...
        public static Output<GetWorkloadIdentityPoolResult> Invoke(GetWorkloadIdentityPoolOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetWorkloadIdentityPoolOutputArgs
    {
        /// <summary>
        /// The project in which the resource belongs. If it
        /// is not provided, the provider project is used.
        ...
        public GetWorkloadIdentityPoolOutputArgs()
        {
        }
    }
