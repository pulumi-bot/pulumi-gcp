...
namespace Pulumi.Gcp.Tpu
{
    public static class GetTensorflowVersions
    {
        ...
        public static Output<GetTensorflowVersionsResult> Apply(GetTensorflowVersionsApplyArgs? args = null, InvokeOptions? options = null)
        {
            args = args ?? new GetTensorflowVersionsApplyArgs();
    ...
    public sealed class GetTensorflowVersionsApplyArgs
    {
        /// <summary>
        /// The project to list versions for. If it
        /// is not provided, the provider project is used.
        ...
        public GetTensorflowVersionsApplyArgs()
        {
        }
    }
