...
namespace Pulumi.Gcp.CloudIdentity
{
    public static class GetGroupMemberships
    {
        ...
        public static Output<GetGroupMembershipsResult> Apply(GetGroupMembershipsApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetGroupMembershipsApplyArgs
    {
        /// <summary>
        /// The parent Group resource under which to lookup the Membership names. Must be of the form groups/{group_id}.
        /// </summary>
        ...
        public GetGroupMembershipsApplyArgs()
        {
        }
    }
