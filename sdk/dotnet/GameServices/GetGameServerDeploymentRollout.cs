...
namespace Pulumi.Gcp.GameServices
{
    public static class GetGameServerDeploymentRollout
    {
        ...
        public static Output<GetGameServerDeploymentRolloutResult> Invoke(GetGameServerDeploymentRolloutOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetGameServerDeploymentRolloutOutputArgs
    {
        /// <summary>
        /// The deployment to get the rollout state from. Only 1 rollout must be associated with each deployment.
        /// </summary>
        ...
        public GetGameServerDeploymentRolloutOutputArgs()
        {
        }
    }
