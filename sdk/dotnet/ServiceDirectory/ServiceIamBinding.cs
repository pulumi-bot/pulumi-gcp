...
namespace Pulumi.Gcp.ServiceDirectory
{
    ...
    public partial class ServiceIamBinding : Pulumi.CustomResource
    {
        ...
        public ServiceIamBinding(string name, ServiceIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:servicedirectory/serviceIamBinding:ServiceIamBinding", name, args ?? new ServiceIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ServiceIamBinding(string name, Input<string> id, ServiceIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:servicedirectory/serviceIamBinding:ServiceIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
