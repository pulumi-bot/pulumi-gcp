...
namespace Pulumi.Gcp.Sql
{
    public static class GetCaCerts
    {
        ...
        public static Output<GetCaCertsResult> Invoke(GetCaCertsOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetCaCertsOutputArgs
    {
        /// <summary>
        /// The name or self link of the instance.
        /// </summary>
