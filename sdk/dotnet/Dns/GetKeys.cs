...
namespace Pulumi.Gcp.Dns
{
    public static class GetKeys
    {
        ...
        public static Output<GetKeysResult> Invoke(GetKeysOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetKeysOutputArgs
    {
        /// <summary>
        /// The name or id of the Cloud DNS managed zone.
        /// </summary>
