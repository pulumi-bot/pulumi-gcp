...
namespace Pulumi.Gcp.Firebase
{
    public static class GetWebAppConfig
    {
        ...
        public static Output<GetWebAppConfigResult> Invoke(GetWebAppConfigOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetWebAppConfigOutputArgs
    {
        /// <summary>
        /// The ID of the project in which the resource belongs. If it
        /// is not provided, the provider project is used.
        ...
        public GetWebAppConfigOutputArgs()
        {
        }
    }
