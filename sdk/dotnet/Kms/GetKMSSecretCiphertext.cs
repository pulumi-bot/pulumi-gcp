...
namespace Pulumi.Gcp.Kms
{
    public static class GetKMSSecretCiphertext
    {
        ...
        public static Output<GetKMSSecretCiphertextResult> Apply(GetKMSSecretCiphertextApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetKMSSecretCiphertextApplyArgs
    {
        /// <summary>
        /// The id of the CryptoKey that will be used to
        /// encrypt the provided plaintext. This is represented by the format
        ...
        public GetKMSSecretCiphertextApplyArgs()
        {
        }
    }
