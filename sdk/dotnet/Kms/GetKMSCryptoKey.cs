...
namespace Pulumi.Gcp.Kms
{
    public static class GetKMSCryptoKey
    {
        ...
        public static Output<GetKMSCryptoKeyResult> Apply(GetKMSCryptoKeyApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetKMSCryptoKeyApplyArgs
    {
        /// <summary>
        /// The `self_link` of the Google Cloud Platform KeyRing to which the key belongs.
        /// </summary>
        ...
        public GetKMSCryptoKeyApplyArgs()
        {
        }
    }
