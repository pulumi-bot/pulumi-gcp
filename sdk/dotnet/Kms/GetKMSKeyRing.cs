...
namespace Pulumi.Gcp.Kms
{
    public static class GetKMSKeyRing
    {
        ...
        public static Output<GetKMSKeyRingResult> Apply(GetKMSKeyRingApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetKMSKeyRingApplyArgs
    {
        /// <summary>
        /// The Google Cloud Platform location for the KeyRing.
        /// A full list of valid locations can be found by running `gcloud kms locations list`.
