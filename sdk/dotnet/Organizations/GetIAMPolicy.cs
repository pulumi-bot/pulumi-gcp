...
namespace Pulumi.Gcp.Organizations
{
    public static class GetIAMPolicy
    {
        ...
        public static Output<GetIAMPolicyResult> Invoke(GetIAMPolicyOutputArgs? args = null, InvokeOptions? options = null)
        {
            args = args ?? new GetIAMPolicyOutputArgs();
            return Pulumi.Output.All(
                args.AuditConfigs.ToList().Box(),
                args.Bindings.ToList().Box()
            ).Apply(a => {
    ...
    public sealed class GetIAMPolicyOutputArgs
    {
        [Input("auditConfigs")]
