...
namespace Pulumi.Gcp.Organizations
{
    public static class GetFolder
    {
        ...
        public static Output<GetFolderResult> Apply(GetFolderApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetFolderApplyArgs
    {
        /// <summary>
        /// The name of the Folder in the form `{folder_id}` or `folders/{folder_id}`.
        /// </summary>
