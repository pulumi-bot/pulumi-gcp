...
namespace Pulumi.Gcp.Compute
{
    public static class GetBackendBucket
    {
        ...
        public static Output<GetBackendBucketResult> Invoke(GetBackendBucketOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Name.Box(),
                args.Project.Box()
            ).Apply(a => {
                    var args = new GetBackendBucketArgs();
    ...
    public sealed class GetBackendBucketOutputArgs
    {
        /// <summary>
        /// Name of the resource.
        /// </summary>
        ...
        public GetBackendBucketOutputArgs()
        {
        }
    }
