...
namespace Pulumi.Gcp.Compute
{
    public static class GetNetwork
    {
        ...
        public static Output<GetNetworkResult> Apply(GetNetworkApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetNetworkApplyArgs
    {
        /// <summary>
        /// The name of the network.
        /// </summary>
