...
namespace Pulumi.Gcp.Compute
{
    public static class GetRegionInstanceGroup
    {
        ...
        public static Output<GetRegionInstanceGroupResult> Apply(GetRegionInstanceGroupApplyArgs? args = null, InvokeOptions? options = null)
        {
            args = args ?? new GetRegionInstanceGroupApplyArgs();
    ...
    public sealed class GetRegionInstanceGroupApplyArgs
    {
        /// <summary>
        /// The name of the instance group.  One of `name` or `self_link` must be provided.
        /// </summary>
        ...
        public GetRegionInstanceGroupApplyArgs()
        {
        }
    }
