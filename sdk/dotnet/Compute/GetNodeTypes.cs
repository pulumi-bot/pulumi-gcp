...
namespace Pulumi.Gcp.Compute
{
    public static class GetNodeTypes
    {
        ...
        public static Output<GetNodeTypesResult> Invoke(GetNodeTypesOutputArgs? args = null, InvokeOptions? options = null)
        {
            args = args ?? new GetNodeTypesOutputArgs();
    ...
    public sealed class GetNodeTypesOutputArgs
    {
        /// <summary>
        /// ID of the project to list available node types for.
        /// Should match the project the nodes of this type will be deployed to.
