...
namespace Pulumi.Gcp.Compute
{
    ...
    ///     public MyStack()
    ///     {
    ///         var prod-ssl-policy = new Gcp.Compute.SSLPolicy("prod-ssl-policy", new Gcp.Compute.SSLPolicyArgs
    ///         {
    ///             Profile = "MODERN",
    ///         });
    ///         var nonprod-ssl-policy = new Gcp.Compute.SSLPolicy("nonprod-ssl-policy", new Gcp.Compute.SSLPolicyArgs
    ///         {
    ///             MinTlsVersion = "TLS_1_2",
    ///             Profile = "MODERN",
    ///         });
    ///         var custom-ssl-policy = new Gcp.Compute.SSLPolicy("custom-ssl-policy", new Gcp.Compute.SSLPolicyArgs
    ///         {
    ///             CustomFeatures = 
    ///             {
