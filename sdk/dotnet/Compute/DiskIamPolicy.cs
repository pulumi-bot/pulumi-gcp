...
namespace Pulumi.Gcp.Compute
{
    ...
    /// </summary>
    public partial class DiskIamPolicy : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DiskIamPolicy(string name, DiskIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp:compute/diskIamPolicy:DiskIamPolicy", name, args ?? new DiskIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiskIamPolicy(string name, Input<string> id, DiskIamPolicyState? state = null, CustomResourceOptions? options = null)
            : base("gcp:compute/diskIamPolicy:DiskIamPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DiskIamPolicy Get(string name, Input<string> id, DiskIamPolicyState? state = null, CustomResourceOptions? options = null)
        {
            return new DiskIamPolicy(name, id, state, options);
        }
    }

    public sealed class DiskIamPolicyArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Used to find the parent resource to bind the IAM policy to
        /// </summary>
    ...
    public sealed class DiskIamPolicyState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Computed) The etag of the IAM policy.
        /// </summary>
