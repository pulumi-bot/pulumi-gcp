...
namespace Pulumi.Gcp.Compute
{
    public static class GetInstanceSerialPort
    {
        ...
        public static Output<GetInstanceSerialPortResult> Invoke(GetInstanceSerialPortOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetInstanceSerialPortOutputArgs
    {
        /// <summary>
        /// The name of the Compute Instance to read output from.
        /// </summary>
        ...
        public GetInstanceSerialPortOutputArgs()
        {
        }
    }
