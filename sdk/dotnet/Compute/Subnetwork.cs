...
namespace Pulumi.Gcp.Compute
{
    ...
    ///     public MyStack()
    ///     {
    ///         var custom-test = new Gcp.Compute.Network("custom-test", new Gcp.Compute.NetworkArgs
    ///         {
    ///             AutoCreateSubnetworks = false,
    ///         });
    ///         var network-for-l7lb = new Gcp.Compute.Subnetwork("network-for-l7lb", new Gcp.Compute.SubnetworkArgs
    ///         {
