...
namespace Pulumi.Gcp.Compute
{
    ...
    public partial class HttpsHealthCheck : Pulumi.CustomResource
    {
        ...
        private HttpsHealthCheck(string name, Input<string> id, HttpsHealthCheckState? state = null, CustomResourceOptions? options = null)
            : base("gcp:compute/httpsHealthCheck:HttpsHealthCheck", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class HttpsHealthCheckState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// How often (in seconds) to send a health check. The default value is 5 seconds.
        /// </summary>
