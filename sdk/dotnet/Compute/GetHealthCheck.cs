...
namespace Pulumi.Gcp.Compute
{
    public static class GetHealthCheck
    {
        ...
        public static Output<GetHealthCheckResult> Invoke(GetHealthCheckOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Name.Box(),
                args.Project.Box()
            ).Apply(a => {
                    var args = new GetHealthCheckArgs();
    ...
    public sealed class GetHealthCheckOutputArgs
    {
        /// <summary>
        /// Name of the resource.
        /// </summary>
        ...
        public GetHealthCheckOutputArgs()
        {
        }
    }
