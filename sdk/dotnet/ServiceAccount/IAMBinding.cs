...
namespace Pulumi.Gcp.ServiceAccount
{
    ...
    ///         });
    ///         var admin-account-iam = new Gcp.ServiceAccount.IAMPolicy("admin-account-iam", new Gcp.ServiceAccount.IAMPolicyArgs
    ///         {
    ...
    ///         });
    ///         var admin-account-iam = new Gcp.ServiceAccount.IAMBinding("admin-account-iam", new Gcp.ServiceAccount.IAMBindingArgs
    ///         {
    ///             ServiceAccountId = sa.Name,
    ///             Role = "roles/iam.serviceAccountUser",
    ///             Members = 
    ...
    ///         });
    ///         var admin-account-iam = new Gcp.ServiceAccount.IAMMember("admin-account-iam", new Gcp.ServiceAccount.IAMMemberArgs
    ///         {
    ///             ServiceAccountId = sa.Name,
    ///             Role = "roles/iam.serviceAccountUser",
    ...
    ///         var gce-default-account-iam = new Gcp.ServiceAccount.IAMMember("gce-default-account-iam", new Gcp.ServiceAccount.IAMMemberArgs
    ///         {
