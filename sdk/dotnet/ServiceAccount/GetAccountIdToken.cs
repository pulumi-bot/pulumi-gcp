...
namespace Pulumi.Gcp.ServiceAccount
{
    public static class GetAccountIdToken
    {
        ...
        public static Output<GetAccountIdTokenResult> Invoke(GetAccountIdTokenOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetAccountIdTokenOutputArgs
    {
        [Input("delegates")]
        ...
        public GetAccountIdTokenOutputArgs()
        {
        }
    }
