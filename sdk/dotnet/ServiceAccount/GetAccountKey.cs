...
namespace Pulumi.Gcp.ServiceAccount
{
    public static class GetAccountKey
    {
        ...
        public static Output<GetAccountKeyResult> Apply(GetAccountKeyApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetAccountKeyApplyArgs
    {
        /// <summary>
        /// The name of the service account key. This must have format
        /// `projects/{PROJECT_ID}/serviceAccounts/{ACCOUNT}/keys/{KEYID}`, where `{ACCOUNT}`
