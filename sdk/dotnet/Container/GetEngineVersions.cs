...
namespace Pulumi.Gcp.Container
{
    public static class GetEngineVersions
    {
        ...
        public static Output<GetEngineVersionsResult> Apply(GetEngineVersionsApplyArgs? args = null, InvokeOptions? options = null)
        {
            args = args ?? new GetEngineVersionsApplyArgs();
    ...
    public sealed class GetEngineVersionsApplyArgs
    {
        /// <summary>
        /// The location (region or zone) to list versions for.
        /// Must exactly match the location the cluster will be deployed in, or listed
        ...
        public GetEngineVersionsApplyArgs()
        {
        }
    }
