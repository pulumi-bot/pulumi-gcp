...
namespace Pulumi.Gcp.Container
{
    public static class GetRegistryImage
    {
        ...
        public static Output<GetRegistryImageResult> Invoke(GetRegistryImageOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetRegistryImageOutputArgs
    {
        [Input("digest")]
        ...
        public GetRegistryImageOutputArgs()
        {
        }
    }
