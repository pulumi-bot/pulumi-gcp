...
export class FhirStore extends pulumi.CustomResource {
    ...
    public readonly notificationConfig!: pulumi.Output<outputApi.healthcare.FhirStoreNotificationConfig | undefined>;
...
export interface FhirStoreState {
    ...
    readonly notificationConfig?: pulumi.Input<inputApi.healthcare.FhirStoreNotificationConfig>;
