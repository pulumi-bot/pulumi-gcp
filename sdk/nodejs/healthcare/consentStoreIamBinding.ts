...
export class ConsentStoreIamBinding extends pulumi.CustomResource {
    ...
    public readonly condition!: pulumi.Output<outputs.healthcare.ConsentStoreIamBindingCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ConsentStoreIamBindingArgs | ConsentStoreIamBindingState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ConsentStoreIamBinding.__pulumiType, name, inputs, opts);
    }
}
...
export interface ConsentStoreIamBindingState {
    readonly condition?: pulumi.Input<inputs.healthcare.ConsentStoreIamBindingCondition | undefined>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
    readonly consentStoreId?: pulumi.Input<string | undefined>;
    /**
     * Identifies the dataset addressed by this request. Must be in the format
     * 'projects/{project}/locations/{location}/datasets/{dataset}'
     * Used to find the parent resource to bind the IAM policy to
