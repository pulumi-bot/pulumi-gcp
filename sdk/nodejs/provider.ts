...
export class Provider extends pulumi.ProviderResource {
    ...
    constructor(name: string, args?: ProviderArgs, opts?: pulumi.ResourceOptions) {
        ...
        opts = opts || {};
        {
            ...
            inputs["project"] = (args ? args.project : undefined) ?? <any>utilities.getEnv("GOOGLE_PROJECT", "GOOGLE_CLOUD_PROJECT", "GCLOUD_PROJECT", "CLOUDSDK_CORE_PROJECT");
            ...
            inputs["region"] = (args ? args.region : undefined) ?? <any>utilities.getEnv("GOOGLE_REGION", "GCLOUD_REGION", "CLOUDSDK_COMPUTE_REGION");
            ...
            inputs["zone"] = (args ? args.zone : undefined) ?? <any>utilities.getEnv("GOOGLE_ZONE", "GCLOUD_ZONE", "CLOUDSDK_COMPUTE_ZONE");
        }
        if (!opts.version) {
