...
export class Attestor extends pulumi.CustomResource {
    ...
    public readonly attestationAuthorityNote!: pulumi.Output<outputApi.binaryauthorization.AttestorAttestationAuthorityNote>;
...
export interface AttestorState {
    readonly attestationAuthorityNote?: pulumi.Input<inputApi.binaryauthorization.AttestorAttestationAuthorityNote>;
