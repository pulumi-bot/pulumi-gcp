...
export function getTestablePermissionsApply(args: GetTestablePermissionsApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetTestablePermissionsResult> {
 ...
 * A collection of arguments for invoking getTestablePermissions.
 */
export interface GetTestablePermissionsApplyArgs {
    /**
     * The level of support for custom roles. Can be one of `"NOT_SUPPORTED"`, `"SUPPORTED"`, `"TESTING"`. Default is `"SUPPORTED"`
     */
