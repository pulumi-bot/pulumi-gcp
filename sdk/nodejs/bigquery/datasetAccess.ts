...
export interface DatasetAccessState {
     ...
     * stored in state as a different member type
     */
    readonly apiUpdatedMember?: pulumi.Input<boolean | undefined>;
    /**
     * The ID of the dataset containing this table.
     */
     ...
     * An email address of a Google Group to grant access to.
     */
    readonly groupByEmail?: pulumi.Input<string | undefined>;
    /**
     * Some other type of member that appears in the IAM Policy but isn't a user,
     * group, domain, or special group. For example: `allUsers`
     */
    readonly iamMember?: pulumi.Input<string | undefined>;
    /**
     * The ID of the project in which the resource belongs.
     * If it is not provided, the provider project is used.
     */
     ...
     * A special group to grant access to. Possible values include:
     */
    readonly specialGroup?: pulumi.Input<string | undefined>;
    /**
     * An email address of a user to grant access to. For example:
     * fred@example.com
     */
    readonly userByEmail?: pulumi.Input<string | undefined>;
    /**
     * A view from a different dataset to grant access to. Queries
     * executed against that view will have read access to tables in
     * this dataset. The role field is not required when this field is
     ...
     * Structure is documented below.
     */
    readonly view?: pulumi.Input<inputs.bigquery.DatasetAccessView | undefined>;
}
