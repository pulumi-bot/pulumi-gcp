...
export function getEnvironmentApply(args: GetEnvironmentApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetEnvironmentResult> {
 ...
 * A collection of arguments for invoking getEnvironment.
 */
export interface GetEnvironmentApplyArgs {
    /**
     * Name of the environment.
     */
