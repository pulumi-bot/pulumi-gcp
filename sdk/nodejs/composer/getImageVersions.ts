...
export function getImageVersionsApply(args?: GetImageVersionsApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetImageVersionsResult> {
 ...
 * A collection of arguments for invoking getImageVersions.
 */
export interface GetImageVersionsApplyArgs {
    /**
     * The ID of the project to list versions in.
     * If it is not provided, the provider project is used.
     */
