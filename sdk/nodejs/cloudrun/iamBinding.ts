...
export class IamBinding extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'gcp:cloudrun/iamBinding:IamBinding';
    ...
    public readonly condition!: pulumi.Output<outputs.cloudrun.IamBindingCondition | undefined>;
    /**
...
export interface IamBindingState {
    readonly condition?: pulumi.Input<inputs.cloudrun.IamBindingCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
