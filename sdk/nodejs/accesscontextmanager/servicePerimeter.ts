...
export class ServicePerimeter extends pulumi.CustomResource {
    ...
    public readonly status!: pulumi.Output<outputApi.accesscontextmanager.ServicePerimeterStatus | undefined>;
...
export interface ServicePerimeterState {
    ...
    readonly status?: pulumi.Input<inputApi.accesscontextmanager.ServicePerimeterStatus>;
