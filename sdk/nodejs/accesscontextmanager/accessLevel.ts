...
export class AccessLevel extends pulumi.CustomResource {
    ...
    public readonly basic!: pulumi.Output<outputApi.accesscontextmanager.AccessLevelBasic | undefined>;
...
export interface AccessLevelState {
    readonly basic?: pulumi.Input<inputApi.accesscontextmanager.AccessLevelBasic>;
