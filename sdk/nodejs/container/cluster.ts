...
export class Cluster extends pulumi.CustomResource {
     ...
     * you're using `google.container.NodePool` objects with no default node pool,
     ...
     * `google.container.NodePool` or a `nodePool` block; this configuration
     ...
     * See google.container.NodePool for schema.
     * **Warning:** node pools defined inside a cluster can't be changed (or added/removed) after
     * cluster creation without deleting and recreating the entire cluster. Unless you absolutely need the ability
     * to say "these are the _only_ node pools associated with this cluster", use the
     * google.container.NodePool resource instead of this property.
     */
     ...
     * pool upon cluster creation. If you're using `google.container.NodePool`
