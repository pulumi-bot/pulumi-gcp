 ...
 * 
 * const google_container_engine_versions_central1b = pulumi.output(gcp.container.getEngineVersions({
 *     zone: "us-central1-b",
 * }));
 * const google_container_cluster_foo = new gcp.container.Cluster("foo", {
 *     initialNodeCount: 1,
 *     masterAuth: {
 *         password: "adoy.rm",
 *         username: "mr.yoda",
 ...
 *     nodeVersion: google_container_engine_versions_central1b.apply(__arg0 => __arg0.latestNodeVersion),
 *     zone: "us-central1-b",
 * });
 * ```
 */
