 ...
 * import * as gcp from "@pulumi/gcp";
 * 
 * const google_container_cluster_regional = new gcp.container.Cluster("regional", {
 *     name: "marcellus-wallace",
 *     region: "us-central1",
 * });
 * const google_container_node_pool_regional_np = new gcp.container.NodePool("regional-np", {
 *     cluster: google_container_cluster_primary.name,
 *     name: "my-node-pool",
 *     nodeCount: 1,
 *     region: "us-central1",
