...
export interface NodePoolState {
     ...
     * the size of the node pool to the current cluster usage. Structure is documented below.
     */
    readonly autoscaling?: pulumi.Input<inputs.container.NodePoolAutoscaling | undefined>;
    /**
     * The cluster to create the node pool for. Cluster must be present in `location` provided for zonal clusters.
     */
     ...
     * auto-upgrade is configured. Structure is documented below.
     */
    readonly management?: pulumi.Input<inputs.container.NodePoolManagement | undefined>;
    /**
     * The maximum number of pods per node in this node pool.
     * Note that this does not work on node pools which are "route-based" - that is, node
     * pools belonging to clusters that do not have IP Aliasing enabled.
     ...
     * for more information.
     */
    readonly maxPodsPerNode?: pulumi.Input<number | undefined>;
    /**
     * The name of the node pool. If left blank, the provider will
     * auto-generate a unique name.
     */
     ...
     * gcp.container.Cluster for schema.
     */
    readonly nodeConfig?: pulumi.Input<inputs.container.NodePoolNodeConfig | undefined>;
    /**
     * The number of nodes per instance group. This field can be used to
     * update the number of nodes per instance group but should not be used alongside `autoscaling`.
     */
     ...
     * The maximum number of nodes upgraded simultaneously is limited to 20.
     */
    readonly upgradeSettings?: pulumi.Input<inputs.container.NodePoolUpgradeSettings | undefined>;
    /**
     * The Kubernetes version for the nodes in this pool. Note that if this field
     * and `autoUpgrade` are both specified, they will fight each other for what the node version should
     * be, so setting both is highly discouraged. While a fuzzy version can be specified, it's
