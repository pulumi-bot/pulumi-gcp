...
export class Function extends pulumi.CustomResource {
     ...
     */
    public readonly eventTrigger!: pulumi.Output<outputApi.cloudfunctions.FunctionEventTrigger>;
    /**
     ...
     */
    public readonly sourceRepository!: pulumi.Output<outputApi.cloudfunctions.FunctionSourceRepository | undefined>;
    /**
...
export interface FunctionState {
     ...
     * A source that fires events in response to a condition in another service. Structure is documented below. Cannot be used with `triggerHttp`.
     */
    readonly eventTrigger?: pulumi.Input<inputApi.cloudfunctions.FunctionEventTrigger>;
    /**
     * URL which triggers function execution. Returned only if `triggerHttp` is used.
     */
     ...
     * Cannot be set alongside `sourceArchiveBucket` or `sourceArchiveObject`. Structure is documented below.
     */
    readonly sourceRepository?: pulumi.Input<inputApi.cloudfunctions.FunctionSourceRepository>;
    /**
     * Timeout (in seconds) for the function. Default value is 60 seconds. Cannot be more than 540 seconds.
     */
