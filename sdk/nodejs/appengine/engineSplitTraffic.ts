 ...
 *     deployment: {
 *         zip: {
 *             sourceUrl: %v([pulumi.allbucket.name, object.name]).apply(([bucketName, objectName]) => `https://storage.googleapis.com/${bucketName}/${objectName}`),
 *         },
 *     },
 *     envVariables: {
 *         port: "8080",
 ...
 *     split: {
 *         shardBy: "IP",
 *         allocations: %v([pulumi.allliveappV1.versionId, liveappV2.versionId]).apply(([liveappV1VersionId, liveappV2VersionId]) => {
