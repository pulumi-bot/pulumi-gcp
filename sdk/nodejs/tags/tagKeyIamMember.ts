 ...
 */
export class TagKeyIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TagKeyIamMemberState, opts?: pulumi.CustomResourceOptions): TagKeyIamMember {
        return new TagKeyIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:tags/tagKeyIamMember:TagKeyIamMember';

    /**
     * Returns true if the given object is an instance of TagKeyIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TagKeyIamMember {
    ...
    public readonly condition!: pulumi.Output<outputs.tags.TagKeyIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: TagKeyIamMemberArgs | TagKeyIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TagKeyIamMemberState | undefined;
            ...
            const args = argsOrState as TagKeyIamMemberArgs | undefined;
