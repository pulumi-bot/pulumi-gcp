...
export function getIstioCanonicalServiceApply(args: GetIstioCanonicalServiceApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetIstioCanonicalServiceResult> {
 ...
 * A collection of arguments for invoking getIstioCanonicalService.
 */
export interface GetIstioCanonicalServiceApplyArgs {
    /**
     * The name of the canonical service underlying this service.
     * Corresponds to the destinationCanonicalServiceName metric label in label in Istio metrics.
     */
