...
export function getNotificationChannelApply(args?: GetNotificationChannelApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetNotificationChannelResult> {
 ...
 * A collection of arguments for invoking getNotificationChannel.
 */
export interface GetNotificationChannelApplyArgs {
    /**
     * The display name for this notification channel.
     */
