...
export class AlertPolicy extends pulumi.CustomResource {
    ...
    public readonly conditions!: pulumi.Output<outputApi.monitoring.AlertPolicyCondition[]>;
    public /*out*/ readonly creationRecord!: pulumi.Output<outputApi.monitoring.AlertPolicyCreationRecord>;
    public readonly displayName!: pulumi.Output<string>;
    public readonly documentation!: pulumi.Output<outputApi.monitoring.AlertPolicyDocumentation | undefined>;
...
export interface AlertPolicyState {
    ...
    readonly conditions?: pulumi.Input<pulumi.Input<inputApi.monitoring.AlertPolicyCondition>[]>;
    readonly creationRecord?: pulumi.Input<inputApi.monitoring.AlertPolicyCreationRecord>;
    readonly displayName?: pulumi.Input<string>;
    readonly documentation?: pulumi.Input<inputApi.monitoring.AlertPolicyDocumentation>;
