...
export interface RegistryState {
     ...
     * The structure is documented below.
     */
    readonly credentials?: pulumi.Input<pulumi.Input<inputs.iot.RegistryCredential>[] | undefined>;
    /**
     * List of configurations for event notifications, such as PubSub topics
     * to publish device events to.
     * Structure is documented below.
     */
    readonly eventNotificationConfigs?: pulumi.Input<pulumi.Input<inputs.iot.RegistryEventNotificationConfigItem>[] | undefined>;
    /**
     * Activate or deactivate HTTP.
     * The structure is documented below.
     */
    readonly httpConfig?: pulumi.Input<{[key: string]: any} | undefined>;
    /**
     * The default logging verbosity for activity from devices in this
     * registry. Specifies which events should be written to logs. For
     * example, if the LogLevel is ERROR, only events that terminate in
     ...
     * The structure is documented below.
     */
    readonly mqttConfig?: pulumi.Input<{[key: string]: any} | undefined>;
    /**
     * A unique name for the resource, required by device registry.
     */
     ...
     * The structure is documented below.
     */
    readonly stateNotificationConfig?: pulumi.Input<{[key: string]: any} | undefined>;
}
