...
export class TunnelIamBinding extends pulumi.CustomResource {
     ...
     */
    public readonly condition!: pulumi.Output<outputs.iap.TunnelIamBindingCondition | undefined>;
    /**
...
export interface TunnelIamBindingState {
     ...
     * Structure is documented below.
     */
    readonly condition?: pulumi.Input<inputs.iap.TunnelIamBindingCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
