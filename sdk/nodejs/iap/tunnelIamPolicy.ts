 ...
 */
export class TunnelIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TunnelIamPolicyState, opts?: pulumi.CustomResourceOptions): TunnelIamPolicy {
        return new TunnelIamPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:iap/tunnelIamPolicy:TunnelIamPolicy';

    /**
     * Returns true if the given object is an instance of TunnelIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TunnelIamPolicy {
    ...
    constructor(name: string, argsOrState?: TunnelIamPolicyArgs | TunnelIamPolicyState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as TunnelIamPolicyState | undefined;
            inputs["etag"] = state ? state.etag : undefined;
            inputs["policyData"] = state ? state.policyData : undefined;
            inputs["project"] = state ? state.project : undefined;
        } else {
            const args = argsOrState as TunnelIamPolicyArgs | undefined;
