 ...
 *     }],
 * }));
 * const google_pubsub_topic_iam_policy_editor = new gcp.pubsub.TopicIAMPolicy("editor", {
 ...
 * import * as gcp from "@pulumi/gcp";
 * 
 * const google_pubsub_topic_iam_binding_editor = new gcp.pubsub.TopicIAMBinding("editor", {
 *     members: ["user:jane@example.com"],
 *     role: "roles/editor",
 *     topic: "your-topic-name",
 * });
 ...
 * import * as gcp from "@pulumi/gcp";
 * 
 * const google_pubsub_topic_iam_member_editor = new gcp.pubsub.TopicIAMMember("editor", {
