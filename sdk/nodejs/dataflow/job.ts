...
export interface JobState {
     ...
     * List of experiments that should be used by the job. An example value is `["enableStackdriverAgentMetrics"]`.
     */
    readonly additionalExperiments?: pulumi.Input<pulumi.Input<string>[] | undefined>;
    /**
     * The configuration for VM IPs.  Options are `"WORKER_IP_PUBLIC"` or `"WORKER_IP_PRIVATE"`.
     */
    readonly ipConfiguration?: pulumi.Input<string | undefined>;
    /**
     * The unique ID of this job.
     */
     ...
     * The number of workers permitted to work on the job.  More workers may improve processing speed at additional cost.
     */
    readonly maxWorkers?: pulumi.Input<number | undefined>;
    /**
     * A unique name for the resource, required by Dataflow.
     */
     ...
     * A writeable location on GCS for the Dataflow job to dump its temporary data.
     */
    readonly tempGcsLocation?: pulumi.Input<string | undefined>;
    /**
     * The GCS path to the Dataflow job template.
     */
    readonly templateGcsPath?: pulumi.Input<string | undefined>;
    /**
     * Only applicable when updating a pipeline. Map of transform name prefixes of the job to be replaced with the corresponding name prefixes of the new job. This field is not used outside of update.
     */
    readonly transformNameMapping?: pulumi.Input<{[key: string]: any} | undefined>;
    /**
     * The type of this job, selected from the [JobType enum](https://cloud.google.com/dataflow/docs/reference/rest/v1b3/projects.jobs#Job.JobType)
     */
