...
export class RegionAutoscaler extends pulumi.CustomResource {
    ...
    public readonly autoscalingPolicy!: pulumi.Output<outputApi.compute.RegionAutoscalerAutoscalingPolicy>;
...
export interface RegionAutoscalerState {
    readonly autoscalingPolicy?: pulumi.Input<inputApi.compute.RegionAutoscalerAutoscalingPolicy>;
