...
export class Instance extends pulumi.CustomResource {
     ...
     */
    public readonly attachedDisks!: pulumi.Output<outputApi.compute.InstanceAttachedDisk[] | undefined>;
    /**
     * The boot disk for the instance.
     * Structure is documented below.
     */
    public readonly bootDisk!: pulumi.Output<outputApi.compute.InstanceBootDisk>;
    /**
     ...
     */
    public readonly guestAccelerators!: pulumi.Output<outputApi.compute.InstanceGuestAccelerator[]>;
    /**
     ...
     */
    public readonly networkInterfaces!: pulumi.Output<outputApi.compute.InstanceNetworkInterface[]>;
    /**
     ...
     */
    public readonly scheduling!: pulumi.Output<outputApi.compute.InstanceScheduling>;
    /**
     * Scratch disks to attach to the instance. This can be
     * specified multiple times for multiple scratch disks. Structure is documented below.
     */
    public readonly scratchDisks!: pulumi.Output<outputApi.compute.InstanceScratchDisk[] | undefined>;
    /**
     ...
     * **Note**: `allowStoppingForUpdate` must be set to true in order to update this field.
     */
    public readonly serviceAccount!: pulumi.Output<outputApi.compute.InstanceServiceAccount | undefined>;
    /**
     ...
     */
    public readonly shieldedInstanceConfig!: pulumi.Output<outputApi.compute.InstanceShieldedInstanceConfig>;
    /**
...
export interface InstanceState {
     ...
     * Additional disks to attach to the instance. Can be repeated multiple times for multiple disks. Structure is documented below.
     */
    readonly attachedDisks?: pulumi.Input<pulumi.Input<inputApi.compute.InstanceAttachedDisk>[]>;
    /**
     * The boot disk for the instance.
     * Structure is documented below.
     */
    readonly bootDisk?: pulumi.Input<inputApi.compute.InstanceBootDisk>;
    /**
     * Whether to allow sending and receiving of
     * packets with non-matching source or destination IPs.
     * This defaults to false.
     ...
     * **Note:** GPU accelerators can only be used with `onHostMaintenance` option set to TERMINATE.
     */
    readonly guestAccelerators?: pulumi.Input<pulumi.Input<inputApi.compute.InstanceGuestAccelerator>[]>;
    /**
     * A custom hostname for the instance. Must be a fully qualified DNS name and RFC-1035-valid.
     * Valid format is a series of labels 1-63 characters long matching the regular expression `a-z`, concatenated with periods.
     * The entire hostname must not exceed 253 characters. Changing this forces a new resource to be created.
     ...
     * be specified multiple times. Structure is documented below.
     */
    readonly networkInterfaces?: pulumi.Input<pulumi.Input<inputApi.compute.InstanceNetworkInterface>[]>;
    /**
     * The ID of the project in which the resource belongs. If it
     * is not provided, the provider project is used.
     */
     ...
     * this configuration option are detailed below.
     */
    readonly scheduling?: pulumi.Input<inputApi.compute.InstanceScheduling>;
    /**
     * Scratch disks to attach to the instance. This can be
     * specified multiple times for multiple scratch disks. Structure is documented below.
     */
    readonly scratchDisks?: pulumi.Input<pulumi.Input<inputApi.compute.InstanceScratchDisk>[]>;
    /**
     * The URI of the created resource.
     */
     ...
     * **Note**: `allowStoppingForUpdate` must be set to true in order to update this field.
     */
    readonly serviceAccount?: pulumi.Input<inputApi.compute.InstanceServiceAccount>;
    /**
     * Enable [Shielded VM](https://cloud.google.com/security/shielded-cloud/shielded-vm) on this instance. Shielded VM provides verifiable integrity to prevent against malware and rootkits. Defaults to disabled. Structure is documented below.
     * **Note**: `shieldedInstanceConfig` can only be used with boot images with shielded vm support. See the complete list [here](https://cloud.google.com/compute/docs/images#shielded-images).
     */
    readonly shieldedInstanceConfig?: pulumi.Input<inputApi.compute.InstanceShieldedInstanceConfig>;
    /**
     * A list of tags to attach to the instance.
     */
