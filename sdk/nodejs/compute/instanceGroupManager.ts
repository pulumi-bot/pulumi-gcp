...
export class InstanceGroupManager extends pulumi.CustomResource {
     ...
     */
    public readonly autoHealingPolicies!: pulumi.Output<outputApi.compute.InstanceGroupManagerAutoHealingPolicies | undefined>;
    /**
     ...
     */
    public readonly namedPorts!: pulumi.Output<outputApi.compute.InstanceGroupManagerNamedPort[] | undefined>;
    /**
     ...
     * - - -
     */
    public readonly updatePolicy!: pulumi.Output<outputApi.compute.InstanceGroupManagerUpdatePolicy>;
    /**
     * ) Application versions managed by this instance group. Each
     * version deals with a specific instance template, allowing canary release scenarios.
     * Structure is documented below.
     */
    public readonly versions!: pulumi.Output<outputApi.compute.InstanceGroupManagerVersion[]>;
    /**
...
export interface InstanceGroupManagerState {
     ...
     * group. You can specify only one value. Structure is documented below. For more information, see the [official documentation](https://cloud.google.com/compute/docs/instance-groups/creating-groups-of-managed-instances#monitoring_groups).
     */
    readonly autoHealingPolicies?: pulumi.Input<inputApi.compute.InstanceGroupManagerAutoHealingPolicies>;
    /**
     * The base instance name to use for
     * instances in this group. The value must be a valid
     * [RFC1035](https://www.ietf.org/rfc/rfc1035.txt) name. Supported characters
     ...
     * for details on configuration.
     */
    readonly namedPorts?: pulumi.Input<pulumi.Input<inputApi.compute.InstanceGroupManagerNamedPort>[]>;
    /**
     * The ID of the project in which the resource belongs. If it
     * is not provided, the provider project is used.
     */
     ...
     * - - -
     */
    readonly updatePolicy?: pulumi.Input<inputApi.compute.InstanceGroupManagerUpdatePolicy>;
    /**
     * ) Application versions managed by this instance group. Each
     * version deals with a specific instance template, allowing canary release scenarios.
     * Structure is documented below.
     */
    readonly versions?: pulumi.Input<pulumi.Input<inputApi.compute.InstanceGroupManagerVersion>[]>;
    /**
     * Whether to wait for all instances to be created/updated before
     * returning. Note that if this is set to true and the operation does not succeed, this provider will
     * continue trying until it times out.
