...
export function getInstanceGroupApply(args?: GetInstanceGroupApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetInstanceGroupResult> {
 ...
 * A collection of arguments for invoking getInstanceGroup.
 */
export interface GetInstanceGroupApplyArgs {
    /**
     * The name of the instance group. Either `name` or `selfLink` must be provided.
     */
