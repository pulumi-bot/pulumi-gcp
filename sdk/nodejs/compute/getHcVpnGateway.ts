...
export function getHcVpnGatewayApply(args: GetHcVpnGatewayApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetHcVpnGatewayResult> {
 ...
 * A collection of arguments for invoking getHcVpnGateway.
 */
export interface GetHcVpnGatewayApplyArgs {
    /**
     * The name of the forwarding rule.
     */
