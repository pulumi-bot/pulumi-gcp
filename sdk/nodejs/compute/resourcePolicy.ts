...
export class ResourcePolicy extends pulumi.CustomResource {
    ...
    public readonly snapshotSchedulePolicy!: pulumi.Output<outputApi.compute.ResourcePolicySnapshotSchedulePolicy | undefined>;
...
export interface ResourcePolicyState {
    ...
    readonly snapshotSchedulePolicy?: pulumi.Input<inputApi.compute.ResourcePolicySnapshotSchedulePolicy>;
}
