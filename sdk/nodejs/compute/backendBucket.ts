...
export class BackendBucket extends pulumi.CustomResource {
    ...
    public readonly cdnPolicy!: pulumi.Output<outputApi.compute.BackendBucketCdnPolicy>;
...
export interface BackendBucketState {
    ...
    readonly cdnPolicy?: pulumi.Input<inputApi.compute.BackendBucketCdnPolicy>;
