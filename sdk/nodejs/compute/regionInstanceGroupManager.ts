...
export class RegionInstanceGroupManager extends pulumi.CustomResource {
     ...
     */
    public readonly autoHealingPolicies!: pulumi.Output<outputApi.compute.RegionInstanceGroupManagerAutoHealingPolicies | undefined>;
    /**
     ...
     */
    public readonly namedPorts!: pulumi.Output<outputApi.compute.RegionInstanceGroupManagerNamedPort[] | undefined>;
    /**
     ...
     */
    public readonly updatePolicy!: pulumi.Output<outputApi.compute.RegionInstanceGroupManagerUpdatePolicy>;
    /**
     * ) Application versions managed by this instance group. Each
     * version deals with a specific instance template, allowing canary release scenarios.
     * Structure is documented below.
     */
    public readonly versions!: pulumi.Output<outputApi.compute.RegionInstanceGroupManagerVersion[]>;
    /**
...
export interface RegionInstanceGroupManagerState {
     ...
     * group. You can specify only one value. Structure is documented below. For more information, see the [official documentation](https://cloud.google.com/compute/docs/instance-groups/creating-groups-of-managed-instances#monitoring_groups).
     */
    readonly autoHealingPolicies?: pulumi.Input<inputApi.compute.RegionInstanceGroupManagerAutoHealingPolicies>;
    /**
     * The base instance name to use for
     * instances in this group. The value must be a valid
     * [RFC1035](https://www.ietf.org/rfc/rfc1035.txt) name. Supported characters
     ...
     * for details on configuration.
     */
    readonly namedPorts?: pulumi.Input<pulumi.Input<inputApi.compute.RegionInstanceGroupManagerNamedPort>[]>;
    /**
     * The ID of the project in which the resource belongs. If it
     * is not provided, the provider project is used.
     */
     ...
     * ) The update policy for this managed instance group. Structure is documented below. For more information, see the [official documentation](https://cloud.google.com/compute/docs/instance-groups/updating-managed-instance-groups) and [API](https://cloud.google.com/compute/docs/reference/rest/beta/regionInstanceGroupManagers/patch)
     */
    readonly updatePolicy?: pulumi.Input<inputApi.compute.RegionInstanceGroupManagerUpdatePolicy>;
    /**
     * ) Application versions managed by this instance group. Each
     * version deals with a specific instance template, allowing canary release scenarios.
     * Structure is documented below.
     */
    readonly versions?: pulumi.Input<pulumi.Input<inputApi.compute.RegionInstanceGroupManagerVersion>[]>;
    /**
     * Whether to wait for all instances to be created/updated before
     * returning. Note that if this is set to true and the operation does not succeed, this provider will
     * continue trying until it times out.
