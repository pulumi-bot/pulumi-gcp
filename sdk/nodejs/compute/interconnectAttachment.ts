...
export interface InterconnectAttachmentState {
     ...
     * PARTNER type this will Pre-Activate the interconnect attachment
     */
    readonly adminEnabled?: pulumi.Input<boolean | undefined>;
    /**
     * Provisioned bandwidth capacity for the interconnect attachment.
     * For attachments of type DEDICATED, the user can set the bandwidth.
     * For attachments of type PARTNER, the Google Partner that is operating the interconnect must set the bandwidth.
     ...
     * Possible values are `BPS_50M`, `BPS_100M`, `BPS_200M`, `BPS_300M`, `BPS_400M`, `BPS_500M`, `BPS_1G`, `BPS_2G`, `BPS_5G`, `BPS_10G`, `BPS_20G`, and `BPS_50G`.
     */
    readonly bandwidth?: pulumi.Input<string | undefined>;
    /**
     * Up to 16 candidate prefixes that can be used to restrict the allocation
     * of cloudRouterIpAddress and customerRouterIpAddress for this attachment.
     * All prefixes must be within link-local address space (169.254.0.0/16)
     ...
     * Google will randomly select an unused /29 from all of link-local space.
     */
    readonly candidateSubnets?: pulumi.Input<pulumi.Input<string>[] | undefined>;
    /**
     * IPv4 address + prefix length to be configured on Cloud Router Interface for this interconnect attachment.
     */
    readonly cloudRouterIpAddress?: pulumi.Input<string | undefined>;
    /**
     * Creation timestamp in RFC3339 text format.
     */
     ...
     * IPv4 address + prefix length to be configured on the customer router subinterface for this interconnect attachment.
     */
    readonly customerRouterIpAddress?: pulumi.Input<string | undefined>;
    /**
     * An optional description of this resource.
     */
     ...
     * domain. If not specified, the value will default to AVAILABILITY_DOMAIN_ANY.
     */
    readonly edgeAvailabilityDomain?: pulumi.Input<string | undefined>;
    /**
     * Google reference ID, to be used when raising support tickets with Google or otherwise to debug backend connectivity
     * issues.
     */
    readonly googleReferenceId?: pulumi.Input<string | undefined>;
    /**
     * URL of the underlying Interconnect object that this attachment's
     * traffic will traverse through. Required if type is DEDICATED, must not
     * be set if type is PARTNER.
     */
    readonly interconnect?: pulumi.Input<string | undefined>;
    /**
     * Name of the resource. Provided by the client when the resource is created. The
     * name must be 1-63 characters long, and comply with RFC1035. Specifically, the
     * name must be 1-63 characters long and match the regular expression
     ...
     * initiate provisioning with a selected partner. Of the form "XXXXX/region/domain"
     */
    readonly pairingKey?: pulumi.Input<string | undefined>;
    /**
     * [Output only for type PARTNER. Not present for DEDICATED]. Optional BGP ASN for the router that should be supplied by a
     * layer 3 Partner if they configured BGP on behalf of the customer.
     */
    readonly partnerAsn?: pulumi.Input<string | undefined>;
    /**
     * Information specific to an InterconnectAttachment. This property is populated if the interconnect that this is attached
     * to is of type DEDICATED.
     */
    readonly privateInterconnectInfos?: pulumi.Input<pulumi.Input<inputs.compute.InterconnectAttachmentPrivateInterconnectInfo>[] | undefined>;
    /**
     * The ID of the project in which the resource belongs.
     * If it is not provided, the provider project is used.
     */
     ...
     * using PARTNER type this will be managed upstream.
     */
    readonly vlanTag8021q?: pulumi.Input<number | undefined>;
}
