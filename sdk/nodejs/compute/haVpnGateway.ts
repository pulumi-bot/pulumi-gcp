...
export class HaVpnGateway extends pulumi.CustomResource {
    ...
    public /*out*/ readonly vpnInterfaces!: pulumi.Output<outputApi.compute.HaVpnGatewayVpnInterface[]>;
...
export interface HaVpnGatewayState {
    ...
    readonly vpnInterfaces?: pulumi.Input<pulumi.Input<inputApi.compute.HaVpnGatewayVpnInterface>[]>;
}
