...
export interface RouterPeerState {
     ...
     * Possible values are `DEFAULT` and `CUSTOM`.
     */
    readonly advertiseMode?: pulumi.Input<string | undefined>;
    /**
     * User-specified list of prefix groups to advertise in custom
     * mode, which can take one of the following options:
     * * `ALL_SUBNETS`: Advertises all available subnets, including peer VPC subnets.
     ...
     * * `ALL_PEER_VPC_SUBNETS`: Advertises peer subnets of the router's VPC network.
     */
    readonly advertisedGroups?: pulumi.Input<pulumi.Input<string>[] | undefined>;
    /**
     * User-specified list of individual IP ranges to advertise in
     * custom mode. This field can only be populated if advertiseMode
     * is `CUSTOM` and is advertised to all peers of the router. These IP
     ...
     * Structure is documented below.
     */
    readonly advertisedIpRanges?: pulumi.Input<pulumi.Input<inputs.compute.RouterPeerAdvertisedIpRange>[] | undefined>;
    /**
     * The priority of routes advertised to this BGP peer.
     * Where there is more than one matching route of maximum
     * length, the routes with the lowest priority value win.
     */
    readonly advertisedRoutePriority?: pulumi.Input<number | undefined>;
    /**
     * Name of the interface the BGP peer is associated with.
     */
     ...
     * of BGP peer when the PARTNER InterconnectAttachment is created, updated, or deleted.
     */
    readonly managementType?: pulumi.Input<string | undefined>;
    /**
     * Name of this BGP peer. The name must be 1-63 characters long,
     * and comply with RFC1035. Specifically, the name must be 1-63 characters
     * long and match the regular expression `a-z?` which
     ...
     * Each BGP interface may use a different value.
     */
    readonly peerAsn?: pulumi.Input<number | undefined>;
    /**
     * IP address of the BGP interface outside Google Cloud Platform.
     * Only IPv4 is supported.
     */
    readonly peerIpAddress?: pulumi.Input<string | undefined>;
    /**
     * The ID of the project in which the resource belongs.
     * If it is not provided, the provider project is used.
     */
