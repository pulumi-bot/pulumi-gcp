...
export class SecurityScanConfig extends pulumi.CustomResource {
    ...
    public readonly authentication!: pulumi.Output<outputApi.compute.SecurityScanConfigAuthentication | undefined>;
    ...
    public readonly schedule!: pulumi.Output<outputApi.compute.SecurityScanConfigSchedule | undefined>;
...
export interface SecurityScanConfigState {
    readonly authentication?: pulumi.Input<inputApi.compute.SecurityScanConfigAuthentication>;
    ...
    readonly schedule?: pulumi.Input<inputApi.compute.SecurityScanConfigSchedule>;
