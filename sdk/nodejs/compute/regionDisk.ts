...
export class RegionDisk extends pulumi.CustomResource {
    ...
    public readonly diskEncryptionKey!: pulumi.Output<outputApi.compute.RegionDiskDiskEncryptionKey | undefined>;
    ...
    public readonly sourceSnapshotEncryptionKey!: pulumi.Output<outputApi.compute.RegionDiskSourceSnapshotEncryptionKey | undefined>;
...
export interface RegionDiskState {
    ...
    readonly diskEncryptionKey?: pulumi.Input<inputApi.compute.RegionDiskDiskEncryptionKey>;
    ...
    readonly sourceSnapshotEncryptionKey?: pulumi.Input<inputApi.compute.RegionDiskSourceSnapshotEncryptionKey>;
