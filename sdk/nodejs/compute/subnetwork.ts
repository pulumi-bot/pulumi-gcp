...
export class Subnetwork extends pulumi.CustomResource {
    ...
    public readonly logConfig!: pulumi.Output<outputApi.compute.SubnetworkLogConfig>;
    ...
    public readonly secondaryIpRanges!: pulumi.Output<outputApi.compute.SubnetworkSecondaryIpRange[]>;
    /**
...
export interface SubnetworkState {
    ...
    readonly logConfig?: pulumi.Input<inputApi.compute.SubnetworkLogConfig>;
    ...
    readonly secondaryIpRanges?: pulumi.Input<pulumi.Input<inputApi.compute.SubnetworkSecondaryIpRange>[]>;
    /**
     * The URI of the created resource.
     */
