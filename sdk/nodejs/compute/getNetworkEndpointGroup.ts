...
export function getNetworkEndpointGroupApply(args?: GetNetworkEndpointGroupApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetNetworkEndpointGroupResult> {
 ...
 * A collection of arguments for invoking getNetworkEndpointGroup.
 */
export interface GetNetworkEndpointGroupApplyArgs {
    /**
     * The Network Endpoint Group name.
     * Provide either this or a `selfLink`.
     */
