...
export class InstanceGroup extends pulumi.CustomResource {
     ...
     */
    public readonly namedPorts!: pulumi.Output<outputApi.compute.InstanceGroupNamedPort[] | undefined>;
    /**
...
export interface InstanceGroupState {
     ...
     * for details on configuration.
     */
    readonly namedPorts?: pulumi.Input<pulumi.Input<inputApi.compute.InstanceGroupNamedPort>[]>;
    /**
     * The URL of the network the instance group is in. If
     * this is different from the network where the instances are in, the creation
     * fails. Defaults to the network where the instances are in (if neither
