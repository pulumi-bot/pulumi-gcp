...
export function getSubnetworkApply(args?: GetSubnetworkApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetSubnetworkResult> {
 ...
 * A collection of arguments for invoking getSubnetwork.
 */
export interface GetSubnetworkApplyArgs {
    /**
     * The name of the subnetwork. One of `name` or `selfLink`
     * must be specified.
     */
