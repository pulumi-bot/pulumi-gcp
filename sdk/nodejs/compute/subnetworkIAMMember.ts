 ...
 *     }],
 * }));
 * const google_compute_subnetwork_iam_policy_subnet = new gcp.compute.SubnetworkIAMPolicy("subnet", {
 ...
 * import * as gcp from "@pulumi/gcp";
 * 
 * const google_compute_subnetwork_iam_binding_subnet = new gcp.compute.SubnetworkIAMBinding("subnet", {
 *     members: ["user:jane@example.com"],
 ...
 * import * as gcp from "@pulumi/gcp";
 * 
 * const google_compute_subnetwork_iam_member_subnet = new gcp.compute.SubnetworkIAMMember("subnet", {
