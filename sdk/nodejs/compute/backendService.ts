...
export class BackendService extends pulumi.CustomResource {
    ...
    public readonly backends!: pulumi.Output<outputApi.compute.BackendServiceBackend[] | undefined>;
    public readonly cdnPolicy!: pulumi.Output<outputApi.compute.BackendServiceCdnPolicy>;
    ...
    public readonly iap!: pulumi.Output<outputApi.compute.BackendServiceIap | undefined>;
...
export interface BackendServiceState {
    ...
    readonly backends?: pulumi.Input<pulumi.Input<inputApi.compute.BackendServiceBackend>[]>;
    readonly cdnPolicy?: pulumi.Input<inputApi.compute.BackendServiceCdnPolicy>;
    ...
    readonly iap?: pulumi.Input<inputApi.compute.BackendServiceIap>;
