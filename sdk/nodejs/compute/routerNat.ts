...
export class RouterNat extends pulumi.CustomResource {
    ...
    public readonly logConfig!: pulumi.Output<outputApi.compute.RouterNatLogConfig | undefined>;
    /**
     ...
     */
    public readonly subnetworks!: pulumi.Output<outputApi.compute.RouterNatSubnetwork[] | undefined>;
    /**
...
export interface RouterNatState {
    ...
    readonly logConfig?: pulumi.Input<inputApi.compute.RouterNatLogConfig>;
    /**
     * Minimum number of ports allocated to a VM
     * from this NAT config. If not set, a default number of ports is allocated to a VM.
     * Changing this forces a new NAT to be created.
     ...
     * the section below for details on configuration.
     */
    readonly subnetworks?: pulumi.Input<pulumi.Input<inputApi.compute.RouterNatSubnetwork>[]>;
    /**
     * Timeout (in seconds) for TCP
     * established connections. Defaults to 1200s if not set. Changing this forces
     * a new NAT to be created.
