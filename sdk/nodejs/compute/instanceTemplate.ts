 ...
 * import * as gcp from "@pulumi/gcp";
 * 
 * const google_compute_instance_template_instance_template = new gcp.compute.InstanceTemplate("instance_template", {
 *     disks: [{}],
 *     machineType: "n1-standard-1",
 ...
 *     region: "us-central1",
 * });
 * const google_compute_instance_group_manager_instance_group_manager = new gcp.compute.InstanceGroupManager("instance_group_manager", {
 *     baseInstanceName: "instance-group-manager",
 *     instanceTemplate: google_compute_instance_template_instance_template.selfLink,
 *     name: "instance-group-manager",
 *     targetSize: Number.parseFloat("1"),
 *     zone: "us-central1-f",
 * });
 * ```
 * 
