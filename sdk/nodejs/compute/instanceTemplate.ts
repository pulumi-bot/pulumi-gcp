...
export class InstanceTemplate extends pulumi.CustomResource {
     ...
     * documented below.
     */
    public readonly disks!: pulumi.Output<outputApi.compute.InstanceTemplateDisk[]>;
    /**
     * List of the type and count of accelerator cards attached to the instance. Structure documented below.
     */
    public readonly guestAccelerators!: pulumi.Output<outputApi.compute.InstanceTemplateGuestAccelerator[] | undefined>;
    /**
     ...
     */
    public readonly networkInterfaces!: pulumi.Output<outputApi.compute.InstanceTemplateNetworkInterface[] | undefined>;
    /**
     ...
     */
    public readonly scheduling!: pulumi.Output<outputApi.compute.InstanceTemplateScheduling>;
    /**
     ...
     */
    public readonly serviceAccount!: pulumi.Output<outputApi.compute.InstanceTemplateServiceAccount | undefined>;
    /**
     ...
     */
    public readonly shieldedInstanceConfig!: pulumi.Output<outputApi.compute.InstanceTemplateShieldedInstanceConfig>;
    /**
...
export interface InstanceTemplateState {
     ...
     * documented below.
     */
    readonly disks?: pulumi.Input<pulumi.Input<inputApi.compute.InstanceTemplateDisk>[]>;
    /**
     * List of the type and count of accelerator cards attached to the instance. Structure documented below.
     */
    readonly guestAccelerators?: pulumi.Input<pulumi.Input<inputApi.compute.InstanceTemplateGuestAccelerator>[]>;
    /**
     * A brief description to use for instances
     * created from this template.
     */
     ...
     * Structure is documented below.
     */
    readonly networkInterfaces?: pulumi.Input<pulumi.Input<inputApi.compute.InstanceTemplateNetworkInterface>[]>;
    /**
     * The ID of the project in which the resource belongs. If it
     * is not provided, the provider project is used.
     */
     ...
     * this configuration option are detailed below.
     */
    readonly scheduling?: pulumi.Input<inputApi.compute.InstanceTemplateScheduling>;
    /**
     * The URI of the created resource.
     */
     ...
     * Service account to attach to the instance. Structure is documented below.
     */
    readonly serviceAccount?: pulumi.Input<inputApi.compute.InstanceTemplateServiceAccount>;
    /**
     * Enable [Shielded VM](https://cloud.google.com/security/shielded-cloud/shielded-vm) on this instance. Shielded VM provides verifiable integrity to prevent against malware and rootkits. Defaults to disabled. Structure is documented below.
     * **Note**: `shieldedInstanceConfig` can only be used with boot images with shielded vm support. See the complete list [here](https://cloud.google.com/compute/docs/images#shielded-images).
     */
    readonly shieldedInstanceConfig?: pulumi.Input<inputApi.compute.InstanceTemplateShieldedInstanceConfig>;
    /**
     * Tags to attach to the instance.
     */
