...
export class URLMap extends pulumi.CustomResource {
    ...
    public readonly hostRules!: pulumi.Output<outputApi.compute.URLMapHostRule[] | undefined>;
    public /*out*/ readonly mapId!: pulumi.Output<number>;
    public readonly name!: pulumi.Output<string>;
    public readonly pathMatchers!: pulumi.Output<outputApi.compute.URLMapPathMatcher[] | undefined>;
    /**
    ...
    public readonly tests!: pulumi.Output<outputApi.compute.URLMapTest[] | undefined>;
...
export interface URLMapState {
    ...
    readonly hostRules?: pulumi.Input<pulumi.Input<inputApi.compute.URLMapHostRule>[]>;
    readonly mapId?: pulumi.Input<number>;
    readonly name?: pulumi.Input<string>;
    readonly pathMatchers?: pulumi.Input<pulumi.Input<inputApi.compute.URLMapPathMatcher>[]>;
    /**
     * The ID of the project in which the resource belongs.
     * If it is not provided, the provider project is used.
     */
    ...
    readonly tests?: pulumi.Input<pulumi.Input<inputApi.compute.URLMapTest>[]>;
}
