...
export interface GetBackendServiceResult {
     ...
     */
    readonly backends: outputApi.compute.GetBackendServiceBackend[];
    readonly cdnPolicies: outputApi.compute.GetBackendServiceCdnPolicy[];
    /**
    ...
    readonly iaps: outputApi.compute.GetBackendServiceIap[];
