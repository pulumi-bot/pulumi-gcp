...
export class ExternalVpnGateway extends pulumi.CustomResource {
    ...
    public readonly interfaces!: pulumi.Output<outputApi.compute.ExternalVpnGatewayInterface[] | undefined>;
...
export interface ExternalVpnGatewayState {
    ...
    readonly interfaces?: pulumi.Input<pulumi.Input<inputApi.compute.ExternalVpnGatewayInterface>[]>;
