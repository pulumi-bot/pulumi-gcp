...
export class IAMAuditConfig extends pulumi.CustomResource {
    ...
    public readonly auditLogConfigs!: pulumi.Output<outputApi.projects.IAMAuditConfigAuditLogConfig[]>;
...
export interface IAMAuditConfigState {
    readonly auditLogConfigs?: pulumi.Input<pulumi.Input<inputApi.projects.IAMAuditConfigAuditLogConfig>[]>;
