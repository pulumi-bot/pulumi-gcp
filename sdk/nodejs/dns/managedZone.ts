...
export class ManagedZone extends pulumi.CustomResource {
    ...
    public readonly dnssecConfig!: pulumi.Output<outputApi.dns.ManagedZoneDnssecConfig | undefined>;
    public readonly forwardingConfig!: pulumi.Output<outputApi.dns.ManagedZoneForwardingConfig | undefined>;
    public readonly labels!: pulumi.Output<{[key: string]: string} | undefined>;
    public readonly name!: pulumi.Output<string>;
    public /*out*/ readonly nameServers!: pulumi.Output<string[]>;
    public readonly peeringConfig!: pulumi.Output<outputApi.dns.ManagedZonePeeringConfig | undefined>;
    public readonly privateVisibilityConfig!: pulumi.Output<outputApi.dns.ManagedZonePrivateVisibilityConfig | undefined>;
    /**
...
export interface ManagedZoneState {
    ...
    readonly dnssecConfig?: pulumi.Input<inputApi.dns.ManagedZoneDnssecConfig>;
    readonly forwardingConfig?: pulumi.Input<inputApi.dns.ManagedZoneForwardingConfig>;
    readonly labels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
    readonly name?: pulumi.Input<string>;
    readonly nameServers?: pulumi.Input<pulumi.Input<string>[]>;
    readonly peeringConfig?: pulumi.Input<inputApi.dns.ManagedZonePeeringConfig>;
    readonly privateVisibilityConfig?: pulumi.Input<inputApi.dns.ManagedZonePrivateVisibilityConfig>;
    /**
     * The ID of the project in which the resource belongs.
     * If it is not provided, the provider project is used.
     */
