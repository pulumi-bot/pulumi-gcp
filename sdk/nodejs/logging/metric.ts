...
export interface MetricState {
     ...
     * Structure is documented below.
     */
    readonly bucketOptions?: pulumi.Input<inputs.logging.MetricBucketOptions | undefined>;
    /**
     * A description of this metric, which is used in documentation. The maximum length of the
     * description is 8000 characters.
     */
     ...
     * the same as for the valueExtractor field.
     */
    readonly labelExtractors?: pulumi.Input<{[key: string]: pulumi.Input<string>} | undefined>;
    /**
     * The metric descriptor associated with the logs-based metric.
     * Structure is documented below.
     */
    readonly metricDescriptor?: pulumi.Input<inputs.logging.MetricMetricDescriptor | undefined>;
    /**
     * The client-assigned metric identifier. Examples - "errorCount", "nginx/requests".
     * Metric identifiers are limited to 100 characters and can include only the following
     * characters A-Z, a-z, 0-9, and the special characters _-.,+!*',()%/. The forward-slash
     ...
     * error to specify a regex that does not include exactly one capture group.
     */
    readonly valueExtractor?: pulumi.Input<string | undefined>;
}
