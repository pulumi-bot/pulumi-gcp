...
export class Instance extends pulumi.CustomResource {
     ...
     */
    public readonly clusters!: pulumi.Output<outputApi.bigtable.InstanceCluster[]>;
    /**
...
export interface InstanceState {
     ...
     * A block of cluster configuration options. This can be specified 1 or 2 times. See structure below.
     */
    readonly clusters?: pulumi.Input<pulumi.Input<inputApi.bigtable.InstanceCluster>[]>;
    /**
     * The human-readable display name of the Bigtable instance. Defaults to the instance `name`.
     */
