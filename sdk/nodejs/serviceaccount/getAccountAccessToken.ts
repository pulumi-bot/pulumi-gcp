...
export function getAccountAccessTokenApply(args: GetAccountAccessTokenApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAccountAccessTokenResult> {
 ...
 * A collection of arguments for invoking getAccountAccessToken.
 */
export interface GetAccountAccessTokenApplyArgs {
    /**
     * Delegate chain of approvals needed to perform full impersonation. Specify the fully qualified service account name.  (e.g. `["projects/-/serviceAccounts/delegate-svc-account@project-id.iam.gserviceaccount.com"]`)
     */
