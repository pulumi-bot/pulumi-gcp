...
export interface SecretCiphertextState {
     ...
     * **Note**: This property is sensitive and will not be displayed in the plan.
     */
    readonly additionalAuthenticatedData?: pulumi.Input<string | undefined>;
    /**
     * Contains the result of encrypting the provided plaintext, encoded in base64.
     */
    readonly ciphertext?: pulumi.Input<string | undefined>;
    /**
     * The full name of the CryptoKey that will be used to encrypt the provided plaintext.
     * Format: `'projects/{{project}}/locations/{{location}}/keyRings/{{keyRing}}/cryptoKeys/{{cryptoKey}}'`
     */
    readonly cryptoKey?: pulumi.Input<string | undefined>;
    /**
     * The plaintext to be encrypted.
     * **Note**: This property is sensitive and will not be displayed in the plan.
     */
    readonly plaintext?: pulumi.Input<string | undefined>;
}
