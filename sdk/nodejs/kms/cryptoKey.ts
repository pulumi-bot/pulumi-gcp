...
export class CryptoKey extends pulumi.CustomResource {
    ...
    public readonly versionTemplate!: pulumi.Output<outputApi.kms.CryptoKeyVersionTemplate>;
...
export interface CryptoKeyState {
    ...
    readonly versionTemplate?: pulumi.Input<inputApi.kms.CryptoKeyVersionTemplate>;
}
