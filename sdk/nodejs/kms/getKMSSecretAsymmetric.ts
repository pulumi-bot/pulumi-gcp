...
export function getKMSSecretAsymmetricApply(args: GetKMSSecretAsymmetricApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetKMSSecretAsymmetricResult> {
 ...
 * A collection of arguments for invoking getKMSSecretAsymmetric.
 */
export interface GetKMSSecretAsymmetricApplyArgs {
    /**
     * The ciphertext to be decrypted, encoded in base64
     */
