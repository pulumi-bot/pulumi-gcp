...
export function getKMSKeyRingApply(args: GetKMSKeyRingApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetKMSKeyRingResult> {
 ...
 * A collection of arguments for invoking getKMSKeyRing.
 */
export interface GetKMSKeyRingApplyArgs {
    /**
     * The Google Cloud Platform location for the KeyRing.
     * A full list of valid locations can be found by running `gcloud kms locations list`.
     */
