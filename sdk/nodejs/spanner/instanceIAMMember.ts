 ...
 *     }],
 * }));
 * const google_spanner_instance_iam_policy_instance = new gcp.spanner.InstanceIAMPolicy("instance", {
 ...
 * import * as gcp from "@pulumi/gcp";
 * 
 * const google_spanner_instance_iam_binding_instance = new gcp.spanner.InstanceIAMBinding("instance", {
 *     instance: "your-instance-name",
 *     members: ["user:jane@example.com"],
 ...
 * import * as gcp from "@pulumi/gcp";
 * 
 * const google_spanner_instance_iam_member_instance = new gcp.spanner.InstanceIAMMember("instance", {
 *     instance: "your-instance-name",
