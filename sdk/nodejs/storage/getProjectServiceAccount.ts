...
export function getProjectServiceAccountApply(args?: GetProjectServiceAccountApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetProjectServiceAccountResult> {
 ...
 * A collection of arguments for invoking getProjectServiceAccount.
 */
export interface GetProjectServiceAccountApplyArgs {
    /**
     * The project the unique service account was created for. If it is not provided, the provider project is used.
     */
