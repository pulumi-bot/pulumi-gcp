 ...
 * 
 * const google_storage_bucket_iam_binding_binding = new gcp.storage.BucketIAMBinding("binding", {
 ...
 * import * as gcp from "@pulumi/gcp";
 * 
 * const google_storage_bucket_iam_member_member = new gcp.storage.BucketIAMMember("member", {
 *     bucket: "your-bucket-name",
 ...
 * import * as gcp from "@pulumi/gcp";
 * 
 * const google_iam_policy_foo_policy = pulumi.output(gcp.organizations.getIAMPolicy({
 *     bindings: [{
 *         members: ["group:yourgroup@example.com"],
 *         role: "roles/your-role",
 *     }],
 * }));
 * const google_storage_bucket_iam_policy_member = new gcp.storage.BucketIAMPolicy("member", {
 *     bucket: "your-bucket-name",
 *     policyData: google_iam_policy_foo_policy.apply(__arg0 => __arg0.policyData),
 * });
 * ```
 */
