...
export function getObjectSignedUrlApply(args: GetObjectSignedUrlApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetObjectSignedUrlResult> {
 ...
 * A collection of arguments for invoking getObjectSignedUrl.
 */
export interface GetObjectSignedUrlApplyArgs {
    /**
     * The name of the bucket to read the object from
     */
