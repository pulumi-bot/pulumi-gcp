 ...
 * [ACLs](https://cloud.google.com/storage/docs/access-control/lists) can be applied using the `google.storage.ObjectACL` resource.
...
export class BucketObject extends pulumi.CustomResource {
    ...
    /**
     * (Computed) The name of the object. Use this field in interpolations with `google.storage.ObjectACL` to recreate
     * `google.storage.ObjectACL` resources when your `google.storage.BucketObject` is recreated.
     */
