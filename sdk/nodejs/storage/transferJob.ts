...
export class TransferJob extends pulumi.CustomResource {
     ...
     */
    public readonly schedule!: pulumi.Output<outputApi.storage.TransferJobSchedule>;
    /**
     ...
     */
    public readonly transferSpec!: pulumi.Output<outputApi.storage.TransferJobTransferSpec>;
...
export interface TransferJobState {
     ...
     * Schedule specification defining when the Transfer Job should be scheduled to start, end and and what time to run. Structure documented below.
     */
    readonly schedule?: pulumi.Input<inputApi.storage.TransferJobSchedule>;
    /**
     * Status of the job. Default: `ENABLED`. **NOTE: The effect of the new job status takes place during a subsequent job run. For example, if you change the job status from ENABLED to DISABLED, and an operation spawned by the transfer is running, the status change would not affect the current operation.**
     */
     ...
     * Transfer specification. Structure documented below.
     */
    readonly transferSpec?: pulumi.Input<inputApi.storage.TransferJobTransferSpec>;
}
