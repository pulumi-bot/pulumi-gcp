 ...
 * Cloud Storage (GCS) bucket. Removing a `google.storage.ObjectACL` sets the
 ...
 * 
 * > Want fine-grained control over object ACLs? Use `google.storage.ObjectAccessControl` to control individual
 * role entity pairs.
 * 
 * ## Example Usage
 * 
