...
export class ObjectAccessControl extends pulumi.CustomResource {
    ...
    public /*out*/ readonly projectTeam!: pulumi.Output<outputApi.storage.ObjectAccessControlProjectTeam>;
...
export interface ObjectAccessControlState {
    ...
    readonly projectTeam?: pulumi.Input<inputApi.storage.ObjectAccessControlProjectTeam>;
