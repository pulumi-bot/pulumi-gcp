...
export class DefaultObjectAccessControl extends pulumi.CustomResource {
    ...
    public /*out*/ readonly projectTeam!: pulumi.Output<outputApi.storage.DefaultObjectAccessControlProjectTeam>;
...
export interface DefaultObjectAccessControlState {
    ...
    readonly projectTeam?: pulumi.Input<inputApi.storage.DefaultObjectAccessControlProjectTeam>;
