...
export interface JobState {
     ...
     * Structure is documented below.
     */
    readonly appEngineHttpTarget?: pulumi.Input<inputs.cloudscheduler.JobAppEngineHttpTarget | undefined>;
    /**
     * The deadline for job attempts. If the request handler does not respond by this deadline then the request is
     * cancelled and the attempt is marked as a DEADLINE_EXCEEDED failure. The failed attempt can be viewed in
     * execution logs. Cloud Scheduler will retry the job according to the RetryConfig.
     ...
     * A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s"
     */
    readonly attemptDeadline?: pulumi.Input<string | undefined>;
    /**
     * A human-readable description for the job.
     * This string must not contain more than 500 characters.
     */
     ...
     * Structure is documented below.
     */
    readonly httpTarget?: pulumi.Input<inputs.cloudscheduler.JobHttpTarget | undefined>;
    /**
     * The name of the job.
     */
     ...
     * Structure is documented below.
     */
    readonly pubsubTarget?: pulumi.Input<inputs.cloudscheduler.JobPubsubTarget | undefined>;
    /**
     * Region where the scheduler job resides. If it is not provided, this provider will use the provider default.
     */
     ...
     * Structure is documented below.
     */
    readonly retryConfig?: pulumi.Input<inputs.cloudscheduler.JobRetryConfig | undefined>;
    /**
     * Describes the schedule on which the job will be executed.
     */
