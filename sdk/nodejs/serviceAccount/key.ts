 ...
 *     serviceAccountId: google_service_account_myaccount.name,
 * });
 * const kubernetes_secret_google_application_credentials = new kubernetes.Secret("google-application-credentials", {
 *     data: [{
 *         "credentials.json": google_service_account_key_mykey.privateKey.apply(__arg0 => Buffer.from(__arg0, "base64").toString()),
 *     }],
 *     metadata: [{
