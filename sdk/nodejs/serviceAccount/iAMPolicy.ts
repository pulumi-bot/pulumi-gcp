 ...
 *     }],
 * }));
 * const google_service_account_iam_policy_admin_account_iam = new gcp.serviceAccount.IAMPolicy("admin-account-iam", {
 ...
 * import * as gcp from "@pulumi/gcp";
 * 
 * const google_service_account_iam_binding_admin_account_iam = new gcp.serviceAccount.IAMBinding("admin-account-iam", {
 *     members: ["user:jane@example.com"],
 *     role: "roles/editor",
 *     serviceAccountId: "your-service-account-id",
 * });
 ...
 * import * as gcp from "@pulumi/gcp";
 * 
 * const google_service_account_iam_member_admin_account_iam = new gcp.serviceAccount.IAMMember("admin-account-iam", {
