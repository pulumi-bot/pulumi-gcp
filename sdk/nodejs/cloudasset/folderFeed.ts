...
export interface FolderFeedState {
     ...
     * See https://cloud.google.com/apis/design/resourceNames#fullResourceName for more info.
     */
    readonly assetNames?: pulumi.Input<pulumi.Input<string>[] | undefined>;
    /**
     * A list of types of the assets to receive updates. You must specify either or both of assetNames
     * and assetTypes. Only asset updates matching specified assetNames and assetTypes are exported to
     * the feed. For example: "compute.googleapis.com/Disk"
     ...
     * supported asset types.
     */
    readonly assetTypes?: pulumi.Input<pulumi.Input<string>[] | undefined>;
    /**
     * The project whose identity will be used when sending messages to the
     * destination pubsub topic. It also specifies the project for API
     * enablement check, quota, and billing.
     ...
     * Structure is documented below.
     */
    readonly condition?: pulumi.Input<inputs.cloudasset.FolderFeedCondition | undefined>;
    /**
     * Asset content type. If not specified, no content but the asset name and type will be returned.
     * Possible values are `CONTENT_TYPE_UNSPECIFIED`, `RESOURCE`, `IAM_POLICY`, `ORG_POLICY`, and `ACCESS_POLICY`.
     */
     ...
     * This is the client-assigned asset feed identifier and it needs to be unique under a specific parent.
     */
    readonly feedId?: pulumi.Input<string | undefined>;
    /**
     * Output configuration for asset feed destination.
     * Structure is documented below.
     */
    readonly feedOutputConfig?: pulumi.Input<inputs.cloudasset.FolderFeedFeedOutputConfig | undefined>;
    /**
     * The folder this feed should be created in.
     */
     ...
     * The ID of the folder where this feed has been created. Both [FOLDER_NUMBER] and folders/[FOLDER_NUMBER] are accepted.
     */
    readonly folderId?: pulumi.Input<string | undefined>;
    /**
     * The format will be folders/{folder_number}/feeds/{client-assigned_feed_identifier}.
     */
