...
export interface GetOrganizationPolicyResult {
    readonly booleanPolicies: outputApi.folder.GetOrganizationPolicyBooleanPolicy[];
    readonly constraint: string;
    readonly etag: string;
    readonly folder: string;
    readonly listPolicies: outputApi.folder.GetOrganizationPolicyListPolicy[];
    readonly restorePolicies: outputApi.folder.GetOrganizationPolicyRestorePolicy[];
