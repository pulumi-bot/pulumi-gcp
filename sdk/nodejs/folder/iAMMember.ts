 ...
 *    `google.folder.IAMPolicy` or they will fight over what your policy
 *    should be. Similarly, roles controlled by `google.folder.IAMBinding`
 *    should not be assigned to using `google.folder.IAMMember`.
 * 
 * ## Example Usage
 * 
 * ```typescript
