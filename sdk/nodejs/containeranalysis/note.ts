...
export class Note extends pulumi.CustomResource {
    ...
    public readonly attestationAuthority!: pulumi.Output<outputApi.containeranalysis.NoteAttestationAuthority>;
...
export interface NoteState {
    readonly attestationAuthority?: pulumi.Input<inputApi.containeranalysis.NoteAttestationAuthority>;
